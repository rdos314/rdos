...
module control_bar (
  ...
  output reg [3:0]        det_window_bits,
      ...
      begin
        ...
        begin
          case (rd_address)
            ...
            6: rp_data <= {28'h0000, det_window_bits};
        ...
        begin
          ...
          begin
            case (wr_address)
              ...
              begin
                if (wr_be[0])
                  det_phase_incr[7:0] <= wr_data[7:0];

                if (wr_be[1])
                  det_phase_incr[15:8] <= wr_data[15:8];

                if (wr_be[2])
                  det_phase_incr[17:16] <= wr_data[17:16];
              end

              6:
              begin
                if (wr_be[0])
                  det_window_bits[3:0] <= wr_data[3:0];
              end
