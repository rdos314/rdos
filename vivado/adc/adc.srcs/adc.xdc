...
set_clock_groups -name async_group -async -group pci_ref_clk -group rx_ref_clk -group tx_ref_clk -group user_clk -group sys_clk -group [get_clocks -of_objects [get_pins clk_up_inst/clk_out1]] -group [get_clocks -of_objects [get_pins pci_app_inst/pcie_i/inst/inst/gt_top_i/pipe_wrapper_i/pipe_clock_int.pipe_clock_i/mmcm_i/CLKOUT3]]
