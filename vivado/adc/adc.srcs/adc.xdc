...
set_false_path -from [get_pins -hierarchical *req_start*] -through [get_nets adc_running]
set_false_path -from [get_pins -hierarchical *req_stop*] -through [get_nets adc_running]
set_false_path -from [get_pins -hierarchical *adc_running*] -through [get_nets {adc_app_inst/req_start adc_app_inst/req_stop}]
set_false_path -from [get_pins -hierarchical *notify_sample_data*] -through [get_nets adc_app_inst/ack_sample_data]
set_false_path -from [get_pins -hierarchical *ack_sample_data*] -through [get_nets -hierarchical *notify_s*]
