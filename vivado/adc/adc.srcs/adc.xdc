...
set_false_path -from [get_pins -hierarchical *req_start*] -through [get_nets adc_app_inst/adc_on]
set_false_path -from [get_pins -hierarchical *req_stop*] -through [get_nets adc_app_inst/adc_on]
