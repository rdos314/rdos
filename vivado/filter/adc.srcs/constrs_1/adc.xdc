...
# ADC/DAC clocks
# 1 GHz
create_clock -period 1.000 -name rx_ref_clk [get_ports rx_ref_clk_p]
create_clock -period 1.000 -name tx_ref_clk [get_ports tx_ref_clk_p]
create_clock -period 2.000 -name rx_clk [get_pins daq2_app_inst/util_daq2_xcvr/inst/i_xch_0/i_gtxe2_channel/RXOUTCLK]
create_clock -period 2.000 -name tx_clk [get_pins daq2_app_inst/util_daq2_xcvr/inst/i_xch_0/i_gtxe2_channel/TXOUTCLK]
