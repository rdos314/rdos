...
/*##########################################################################
#
#   Name       : TQuizQ4::TQuizQ4
#
#   Purpose....: Constructor for TQuizQ4
#
...
#   Name       : TQuizQ4::~TQuizQ4
#
#   Purpose....: Destructor for TQuizQ4
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizQ4::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizQ4::WriteName(TFile &File)
{
    File.Write("Q4");
}
...
#
##########################################################################*/
void TQuizQ4::WriteLongName(TFile &File)
{
    File.Write("Q4");
}
...
void TQuizQ4::SetupTexts()
{
  ...
  ItemArr[2]->Text = "When you listen to music can you get so caught up in it that you don't notice anything else?";
  ItemArr[3]->Text = "Is your sense of humor different from mainstream or considered odd?";
  ItemArr[4]->Text = "Do you have an avid perseverance in gathering and/or cataloguing information on a topic of interest?";
  ItemArr[5]->Text = "Is it important for you to find a unique niche where you can acquire unique competence?";
  ...
  ItemArr[16]->Text = "Do you need to do things yourself in order to remember them?";
  ItemArr[17]->Text = "Do you find it difficult to take notes in lectures?";
  ...
  ItemArr[22]->Text = "Do you have extra sensitive hearing?";
  ItemArr[23]->Text = "Do you dislike it when people stamp their foot in the floor?";
  ItemArr[24]->Text = "Do you instinctively become frightened by the sound of a motor-bike?";
  ItemArr[25]->Text = "Are you sensitive to changes in humidity and air pressure?";
  ItemArr[26]->Text = "Are your eyes extra sensitive to strong light and glare?";
  ItemArr[27]->Text = "Do you dislike when people walk behind you?";
  ItemArr[28]->Text = "Do you like to create routines for things you've figured out so you don't have to figure it out again?";
  ItemArr[29]->Text = "Have you been talked into having sex even if you really didn't want to?";
  ...
  ItemArr[39]->Text = "Do you have problems recognizing faces (prosopagnosia)?";
  ItemArr[40]->Text = "Do you tap your ears or press your eyes (e.g. when thinking, when stressed or distressed)?";
  ItemArr[41]->Text = "Do you find engaging in stimming (e.g.,fidgeting, rocking) to be relaxing?";
  ItemArr[42]->Text = "In conversations, do you use small sounds that others don't seem to use?";
  ItemArr[43]->Text = "Do you get a pleasurable tingling sensation in the head, scalp or back of the body in response to certain sounds?";
  ItemArr[44]->Text = "Do you bite your lip, cheek or tongue (e.g. when thinking, when anxious or nervous)?";
  ItemArr[45]->Text = "Do you have a fascination for slowly flowing water?";
  ItemArr[46]->Text = "Do you feel an urge to peel flakes off yourself and / or others?";
  ItemArr[47]->Text = "Do you have an urge to jump over things?";
  ItemArr[48]->Text = "Do you pace (e.g. when thinking or anxious)?";
  ...
  ItemArr[51]->Text = "Do you tend to express your feelings in ways that may baffle others?";
  ItemArr[52]->Text = "Do you tend to say things that are considered socially inappropriate when you are tired, frustrated or when you act naturally?";
  ItemArr[53]->Text = "Do people sometimes think you are smiling at the wrong occasion?";
  ItemArr[54]->Text = "Do you tend to interpret things literally?";
  ItemArr[55]->Text = "Have you been accused of staring?";
  ItemArr[56]->Text = "Do others often misunderstand you?";
  ItemArr[57]->Text = "Have others told you that you have an odd posture or gait?";
  ItemArr[58]->Text = "Is it hard for you to see why some things upset people so much?";
  ItemArr[59]->Text = "Do you worry your friend doesn't really like you?";
  ItemArr[60]->Text = "Do you like to follow (walk behind) people you are attached to?";
  ItemArr[61]->Text = "Do you spend more than half the day (daytime) fantasizing or daydreaming?";
  ItemArr[62]->Text = "Do you have to keep an eye out to stop people from taking advantage of you?";
  ItemArr[63]->Text = "Do you prefer to learn the character of a potential romantic partner through observation rather than conversation?";
  ItemArr[64]->Text = "Do you have an urge to learn the routines of people you know?";
  ItemArr[65]->Text = "Do you feel as if you are being persecuted in some way?";
  ItemArr[66]->Text = "Have you experienced stronger than normal attachments to certain people?";
  ItemArr[67]->Text = "Do you examine the hair of people you like a lot?";
  ItemArr[68]->Text = "Have you sensed that somebody was around you even when you couldn't see anybody?";
  ItemArr[69]->Text = "Do you stare into the distance while you think of your loved one?";
  ItemArr[70]->Text = "Do you have, or used to have, imaginary relationships?";
  ItemArr[71]->Text = "Do you realize hours later that somebody that you have a romantic interest for actually showed interest for you, and then feel bad about the missed opportunity to connect?";
  ItemArr[72]->Text = "Do you tend to look a lot at people you like and little or not at all at people you dislike?";
  ItemArr[73]->Text = "Did you feel lonely as a child?";
  ItemArr[74]->Text = "Do you have unusual sexual preferences?";
  ...
  ItemArr[79]->Text = "Do you enjoy big events even if they are crowded?";
  ItemArr[80]->Text = "Do you enjoy traditional dating?";
  ItemArr[81]->Text = "Do you find yourself at ease in romantic situations?";
  ItemArr[82]->Text = "Do you enjoy travel?";
  ItemArr[83]->Text = "Do you like tongue-kissing?";
  ItemArr[84]->Text = "Are you asexual?";
  ItemArr[85]->Text = "Will you abandon your friends if your activities or ideals clash?";
  ItemArr[86]->Text = "In a conversation, do you tend to focus on your own thoughts rather than on what your listener might be thinking?";
  ...
  ItemArr[88]->Text = "Do you usually find faults with opinions that you don't share?";
  ItemArr[89]->Text = "Do you see your own activities as more important than other people's?";
  ItemArr[90]->Text = "Do you have difficulty accepting criticism, correction, and direction?";
  ...
  ItemArr[93]->Text = "Has it been harder for you than for others to keep friends?";
  ...
  ItemArr[97]->Text = "Do you dislike being hugged when you haven't asked for it?";
  ItemArr[98]->Text = "Do you practice what you want to say in conversations?";
  ItemArr[99]->Text = "Do you find it hard to be emotionally close to other people?";
  ItemArr[100]->Text = "Do you dislike it when people drop by to visit you uninvited?";
  ItemArr[101]->Text = "Do you find it easy to describe your feelings?";
  ItemArr[102]->Text = "Do you find it natural to wave or say 'hi' when you meet people?";
  ItemArr[103]->Text = "Are you good at team-work?";
  ItemArr[104]->Text = "Do you prefer to do things on your own even if you could use others' help or expertise?";
  ItemArr[105]->Text = "Do you find it easy to keep up with group discussions where everyone is speaking?";
  ...
  ItemArr[108]->Text = "Do you find it easy to estimate the age of people?";
  ItemArr[109]->Text = "Can you easily remember verbal instructions?";
  ItemArr[110]->Text = "Do you accept criticism, correction and direction?";
  ItemArr[111]->Text = "Do you find it natural to take notes?";
  ItemArr[112]->Text = "Do you remember how to get to a place you seldom visit?";
  ItemArr[113]->Text = "Do you recognize a lot of people?";
  ItemArr[114]->Text = "Do you have an odd posture or gait?";
  ItemArr[115]->Text = "Do you naturally approach somebody you have an romantic interest for?";
  ItemArr[116]->Text = "Do you have long-term friendships?";
  ItemArr[117]->Text = "Do you like it when people drop by and visit you uninvited?";
  ItemArr[118]->Text = "Do you prefer to use other people's help or expertise rather than trying to figure things out for yourself?";
  ItemArr[119]->Text = "Have you created routines for common tasks so you don't have to think about them?";
  ItemArr[120]->Text = "Do you like to use the same path when going somewhere, because it's familiar, and you don't have to figure out alternatives?";
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizQ4::ProcessRow(char *str)
{
    char *valstr;
    char *ptr;
    int fieldno;
...
void TQuizQ4::Load()
{
    ...
    int size;
    long pos = 0;
    TFile file("raw\\aspie-quiz-Q4.csv");
    char *ptr;
