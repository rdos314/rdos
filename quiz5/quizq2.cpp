...
void TQuizQ2::SetupTexts()
{
  ...
  ItemArr[45]->MyGroup = GROUP_ASPIE_RELATION;
  ...
  ItemArr[54]->MyGroup = GROUP_ASPIE_RELATION;
  ...
  ItemArr[66]->MyGroup = GROUP_NT_SENSORY;
  ...
  ItemArr[84]->MyGroup = GROUP_ASPIE_SOCIAL;
