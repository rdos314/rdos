...
void TQuizQ2::SetupTexts()
{
  ...
  ItemArr[31]->MyGroup = GROUP_NOT_USED;
  ...
  ItemArr[43]->MyGroup = GROUP_NOT_USED;
  ItemArr[44]->MyGroup = GROUP_NOT_USED;
  ItemArr[45]->MyGroup = GROUP_NT_NVC;
  ItemArr[46]->MyGroup = GROUP_NOT_USED;
  ItemArr[47]->MyGroup = GROUP_NOT_USED;
  ...
  ItemArr[54]->MyGroup = GROUP_NOT_USED;
  ...
  ItemArr[69]->MyGroup = GROUP_NOT_USED;
  ...
  ItemArr[96]->MyGroup = GROUP_ASPIE_RELATION;
  ...
  ItemArr[131]->MyGroup = GROUP_NOT_USED;
  ItemArr[132]->MyGroup = GROUP_NT_SOCIAL;
  ItemArr[133]->MyGroup = GROUP_ASPIE_TALENT;
  ItemArr[134]->MyGroup = GROUP_NOT_USED;
  ItemArr[135]->MyGroup = GROUP_NOT_USED;
  ItemArr[136]->MyGroup = GROUP_ASPIE_SENSORY;
  ItemArr[137]->MyGroup = GROUP_NOT_USED;
  ItemArr[138]->MyGroup = GROUP_NT_SOCIAL;
  ItemArr[139]->MyGroup = GROUP_NOT_USED;
  ItemArr[140]->MyGroup = GROUP_NOT_USED;
  ItemArr[141]->MyGroup = GROUP_NOT_USED;
  ItemArr[142]->MyGroup = GROUP_ASPIE_RELATION;
  ItemArr[143]->MyGroup = GROUP_ASPIE_RELATION;
  ItemArr[144]->MyGroup = GROUP_ASPIE_TALENT;
  ItemArr[145]->MyGroup = GROUP_NOT_USED;
  ItemArr[146]->MyGroup = GROUP_ASPIE_TALENT;
  ItemArr[147]->MyGroup = GROUP_ASPIE_TALENT;
  ItemArr[148]->MyGroup = GROUP_NOT_USED;
  ItemArr[149]->MyGroup = GROUP_NOT_USED;
  ItemArr[150]->MyGroup = GROUP_NT_SENSORY;
  ItemArr[151]->MyGroup = GROUP_ASPIE_RELATION;
  ItemArr[152]->MyGroup = GROUP_ASPIE_RELATION;
  ItemArr[153]->MyGroup = GROUP_NOT_USED;
  ItemArr[154]->MyGroup = GROUP_NOT_USED;
  ItemArr[155]->MyGroup = GROUP_NOT_USED;
  ItemArr[156]->MyGroup = GROUP_NOT_USED;
  ItemArr[157]->MyGroup = GROUP_NOT_USED;
  ItemArr[158]->MyGroup = GROUP_NOT_USED;
  ItemArr[159]->MyGroup = GROUP_NT_TALENT;
  ItemArr[160]->MyGroup = GROUP_NOT_USED;
  ItemArr[161]->MyGroup = GROUP_NT_SOCIAL;
  ItemArr[162]->MyGroup = GROUP_ASPIE_RELATION;
  ItemArr[163]->MyGroup = GROUP_NOT_USED;
  ItemArr[164]->MyGroup = GROUP_ASPIE_RELATION;
  ItemArr[165]->MyGroup = GROUP_NOT_USED;
  ItemArr[166]->MyGroup = GROUP_NOT_USED;
  ItemArr[167]->MyGroup = GROUP_ASPIE_RELATION;
  ItemArr[168]->MyGroup = GROUP_ASPIE_RELATION;
  ItemArr[169]->MyGroup = GROUP_NT_SOCIAL;
