...
void TQuizQ2::SetupTexts()
{
  ...
  ItemArr[32]->MyGroup = GROUP_NT_NVC;
  ...
  ItemArr[53]->MyGroup = GROUP_ASPIE_SENSORY;
  ...
  ItemArr[143]->MyGroup = GROUP_ASPIE_NVC;
  ItemArr[146]->MyGroup = GROUP_ASPIE_RELATION;
  ItemArr[149]->MyGroup = GROUP_ASPIE_NVC;
