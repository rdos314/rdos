...
/*##########################################################################
#
#   Name       : TQuizQ11::TQuizQ11
#
#   Purpose....: Constructor for TQuizQ11
#
...
#   Name       : TQuizQ11::~TQuizQ11
#
#   Purpose....: Destructor for TQuizQ11
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizQ11::GetCatCount(int Question)
{
    if (Question < 132)
        return 3;
...
#
##########################################################################*/
void TQuizQ11::WriteName(TFile &File)
{
    File.Write("Q11");
}
...
#
##########################################################################*/
void TQuizQ11::WriteLongName(TFile &File)
{
    File.Write("Q11");
}
...
void TQuizQ11::SetupTexts()
{
  ...
  ItemArr[119]->Text = "Do you become upset when something happens unexpectedly?";
  ItemArr[120]->Text = "Do you feel you're unable to control the things that are most important in your life?";
  ItemArr[121]->Text = "Do you feel nervous and 'stressed'?";
  ItemArr[122]->Text = "Do you feel confident about your ability to handle your personal problems?";
  ItemArr[123]->Text = "Do you generally feel things are going your way ?";
  ItemArr[124]->Text = "Are you able to control irritations in your life?";
  ItemArr[125]->Text = "Do you feel unable to cope with all the things you need to do?";
  ItemArr[126]->Text = "Do you generally feel on top of things?";
  ItemArr[127]->Text = "Do you get angry at things that are beyond your control?";
  ItemArr[128]->Text = "Do you feel problems pile up to such an extent that you cannot overcome them?";

  ItemArr[129]->Text = "Do you have regular depressions?";
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizQ11::ProcessRow(char *str)
{
    char *valstr;
    char *ptr;
    int fieldno;
...
void TQuizQ11::Load()
{
    ...
    int size;
    long pos = 0;
    TFile file("raw\\aspie-quiz-Q11.csv");
    char *ptr;
