...
{
  ItemArr[14]->Reverse = true;
  ItemArr[32]->Reverse = true;
  ItemArr[35]->Reverse = true;
  ItemArr[36]->Reverse = true;
  ItemArr[86]->Reverse = true;
  ItemArr[87]->Reverse = true;
  ItemArr[89]->Reverse = true;
  ItemArr[90]->Reverse = true;
  ItemArr[91]->Reverse = true;
  ItemArr[105]->Reverse = true;
  ItemArr[107]->Reverse = true;
  ItemArr[111]->Reverse = true;
  ItemArr[114]->Reverse = true;
  ItemArr[117]->Reverse = true;
  ItemArr[118]->Reverse = true;
  ItemArr[119]->Reverse = true;
  ItemArr[120]->Reverse = true;
  ...
  ItemArr[41]->MyGroup = GROUP_MIXED;
  ...
  ItemArr[117]->MyGroup = GROUP_MIXED;
  ItemArr[118]->MyGroup = GROUP_MIXED;
  ItemArr[119]->MyGroup = GROUP_MIXED;
  ItemArr[120]->MyGroup = GROUP_MIXED;
  ItemArr[121]->MyGroup = GROUP_MIXED;
  ItemArr[122]->MyGroup = GROUP_MIXED;
  ItemArr[123]->MyGroup = GROUP_MIXED;
  ItemArr[124]->MyGroup = GROUP_MIXED;
  ItemArr[125]->MyGroup = GROUP_MIXED;
  ItemArr[126]->MyGroup = GROUP_MIXED;
  ItemArr[127]->MyGroup = GROUP_MIXED;
  ItemArr[128]->MyGroup = GROUP_MIXED;
  ItemArr[129]->MyGroup = GROUP_MIXED;
  ItemArr[130]->MyGroup = GROUP_MIXED;
  ItemArr[131]->MyGroup = GROUP_MIXED;
  ItemArr[132]->MyGroup = GROUP_MIXED;
  ItemArr[133]->MyGroup = GROUP_MIXED;
  ItemArr[134]->MyGroup = GROUP_MIXED;
  ItemArr[135]->MyGroup = GROUP_MIXED;
  ItemArr[136]->MyGroup = GROUP_MIXED;
  ItemArr[137]->MyGroup = GROUP_MIXED;
  ItemArr[138]->MyGroup = GROUP_MIXED;
  ItemArr[139]->MyGroup = GROUP_MIXED;
  ItemArr[140]->MyGroup = GROUP_MIXED;
  ItemArr[141]->MyGroup = GROUP_MIXED;
  ItemArr[142]->MyGroup = GROUP_MIXED;
  ItemArr[143]->MyGroup = GROUP_MIXED;
  ItemArr[144]->MyGroup = GROUP_MIXED;
  ItemArr[145]->MyGroup = GROUP_MIXED;
  ItemArr[146]->MyGroup = GROUP_MIXED;
  ItemArr[147]->MyGroup = GROUP_MIXED;
  ItemArr[148]->MyGroup = GROUP_MIXED;
  ItemArr[149]->MyGroup = GROUP_MIXED;
  ItemArr[150]->MyGroup = GROUP_MIXED;
  ItemArr[151]->MyGroup = GROUP_MIXED;
  ItemArr[152]->MyGroup = GROUP_MIXED;
  ItemArr[153]->MyGroup = GROUP_MIXED;
  ItemArr[154]->MyGroup = GROUP_MIXED;
  ItemArr[155]->MyGroup = GROUP_MIXED;
  ItemArr[156]->MyGroup = GROUP_MIXED;
  ItemArr[157]->MyGroup = GROUP_MIXED;
  ItemArr[158]->MyGroup = GROUP_MIXED;
  ItemArr[159]->MyGroup = GROUP_MIXED;
  ItemArr[160]->MyGroup = GROUP_MIXED;
  ItemArr[161]->MyGroup = GROUP_MIXED;
  ItemArr[162]->MyGroup = GROUP_MIXED;
  ItemArr[163]->MyGroup = GROUP_MIXED;
  ItemArr[164]->MyGroup = GROUP_MIXED;
  ItemArr[165]->MyGroup = GROUP_MIXED;
  ItemArr[166]->MyGroup = GROUP_MIXED;
  ItemArr[167]->MyGroup = GROUP_MIXED;
  ItemArr[168]->MyGroup = GROUP_MIXED;
  ItemArr[169]->MyGroup = GROUP_MIXED;
  ItemArr[170]->MyGroup = GROUP_MIXED;
  ItemArr[171]->MyGroup = GROUP_MIXED;
  ItemArr[172]->MyGroup = GROUP_MIXED;
  ItemArr[173]->MyGroup = GROUP_MIXED;
  ItemArr[174]->MyGroup = GROUP_MIXED;
  ItemArr[175]->MyGroup = GROUP_MIXED;
  ItemArr[176]->MyGroup = GROUP_MIXED;
  ItemArr[177]->MyGroup = GROUP_MIXED;
  ItemArr[178]->MyGroup = GROUP_MIXED;
  ItemArr[179]->MyGroup = GROUP_MIXED;
  ItemArr[180]->MyGroup = GROUP_MIXED;
  ItemArr[181]->MyGroup = GROUP_MIXED;
  ItemArr[182]->MyGroup = GROUP_MIXED;
  ItemArr[183]->MyGroup = GROUP_MIXED;
  ItemArr[184]->MyGroup = GROUP_MIXED;
  ItemArr[185]->MyGroup = GROUP_MIXED;
  ItemArr[186]->MyGroup = GROUP_MIXED;
  ItemArr[187]->MyGroup = GROUP_MIXED;
  ItemArr[188]->MyGroup = GROUP_MIXED;
  ItemArr[189]->MyGroup = GROUP_MIXED;
  ItemArr[190]->MyGroup = GROUP_MIXED;
  ItemArr[191]->MyGroup = GROUP_MIXED;
  ItemArr[192]->MyGroup = GROUP_MIXED;
  ItemArr[193]->MyGroup = GROUP_MIXED;
  ItemArr[194]->MyGroup = GROUP_MIXED;
  ItemArr[195]->MyGroup = GROUP_MIXED;
  ItemArr[196]->MyGroup = GROUP_MIXED;
  ItemArr[197]->MyGroup = GROUP_MIXED;
  ItemArr[198]->MyGroup = GROUP_MIXED;
  ItemArr[199]->MyGroup = GROUP_MIXED;
  ItemArr[200]->MyGroup = GROUP_MIXED;
  ...
  ItemArr[122]->Text = "When you are focused on an activity, can you not recall all the information you might need to make good decisions?";
  ItemArr[123]->Text = "Do you find social situations chaotic?";
  ItemArr[124]->Text = "Do you find engaging in stimming (e.g.,fidgeting, rocking) to be relaxing?";
  ItemArr[125]->Text = "Is it distressing to be unexpectedly pulled away from something you are engaged in?";
  ItemArr[126]->Text = "Do you find it difficult to engage in a task of no interest to you even if it is important?";
  ItemArr[127]->Text = "Do you accidentally say something others find offensive/ rude when you are focused on a task?";
  ItemArr[128]->Text = "Do you engage in activities you are passionate about to escape from anxiety?";
  ItemArr[129]->Text = "Do you find sudden unexpected disruptions to your attention startling?";
  ItemArr[130]->Text = "Do you focus on an incident for a substantial time (days) after the event?";
  ItemArr[131]->Text = "Do you find yourself getting stuck in loops of thought?";
  ItemArr[132]->Text = "Do you avoid talking because you cannot reliably predict how others will react, especially strangers?";
  ItemArr[133]->Text = "Can making a decision be so hard you get physically stuck?";
  ItemArr[134]->Text = "Are you passionate about a few topics at any one time in your life?";
  ItemArr[135]->Text = "Do you need a quiet and predictable environment for you to switch from one task to another easily?";
  ItemArr[136]->Text = "Do you find simultaneously holding eye contact and making a verbal conversation with another person uncomfortable?";
  ItemArr[137]->Text = "Do you tend to feel quite self-conscious unless you're deeply absorbed in a task?";
  ItemArr[138]->Text = "Do you find it easy to keep up with group discussions where everyone is speaking?";
  ItemArr[139]->Text = "Are you still fascinated by many of the things you were interested in when you were much younger?";
  ItemArr[140]->Text = "Do you find a problem you can't solve distressing and/or hard to put down?";
  ItemArr[141]->Text = "After a period of instability, do you need a quiet and predictable environment?";
  ItemArr[142]->Text = "Do you have trouble filtering out sounds when you are not doing something you're focused on?";
  ItemArr[143]->Text = "Do people tell you that you get fixated on things?";
  ItemArr[144]->Text = "Do you become highly anxious by focusing on the many possible situations that might occur at a future event?";
  ItemArr[145]->Text = "Do you find social interactions more comfortable if communicating about atopic of interest to you?";
  ItemArr[146]->Text = "Do you find it difficult to switch topics after engaging in an activity for a longtime?";

  ItemArr[147]->Text = "Do you get overwhelmed by things your body senses?";
  ItemArr[148]->Text = "Do you have strong urges to make certain movements, even if you don't want to?";
  ItemArr[149]->Text = "Can you spend hours trying to start doing something that you want to do, but you can't get started?";
  ItemArr[150]->Text = "Do people get mad at you when you don't act the way they expect you to?";
  ItemArr[151]->Text = "When other people suffer, do you feel it strongly?";
  ItemArr[152]->Text = "Do people tell you your experiences aren't real?";
  ItemArr[153]->Text = "Do you a hard time getting other people's attention when you're in a group?";
  ItemArr[154]->Text = "Do you practice what you want to say in conversations?";
  ItemArr[155]->Text = "Have you recently tended to over-react to situations?";
  ItemArr[156]->Text = "Have you recently experienced trembling (eg, in the hands)?";
  ItemArr[157]->Text = "Have you recently found yourself getting agitated?";
  ItemArr[158]->Text = "Have you recently been intolerant of anything that kept you from getting on with what you were doing?";
  ItemArr[159]->Text = "Have you recently felt that you were rather touchy?";
  ItemArr[160]->Text = "Do you feel that you have no interest to be with other people?";
  ItemArr[161]->Text = "Do you cry about nothing?";
  ItemArr[162]->Text = "Do you feel that people look at you oddly because of your appearance?";
  ItemArr[163]->Text = "Do you feel tense?";
  ItemArr[164]->Text = "Have you sensed that somebody was around you even when you couldn't see anybody?";
  ItemArr[165]->Text = "When you listen to music can you get so caught up in it that you don't notice anything else?";
  ItemArr[166]->Text = "Can you wander off into your thoughts so completely while doing a routine task that you actually forget what you are doing and a few minutes later find that you have finished it?";
  ItemArr[167]->Text = "Can things that might seem meaningless to others make sense to you?";
  ItemArr[168]->Text = "Are you often delighted by small things (like the colors in soap bubbles and the five pointed star shape that appears when you cut an apple across the core)?";
  ItemArr[169]->Text = "Can the sound of a voice be so fascinating to you that you can just go on listening to it?";
  ItemArr[170]->Text = "Have you had the experience of someone calling you or speaking your name and not being sure whether it was really happening or you were imagining it?";
  ItemArr[171]->Text = "Do you like clear, precise border?";
  ItemArr[172]->Text = "Are you always at least a bit on your guard?";
  ItemArr[173]->Text = "Do you expect other people to keep a certain distance?";
  ItemArr[174]->Text = "Do you have a clear and distinct sense of time?";
  ItemArr[175]->Text = "Do you spend more than half the day (daytime) fantasizing or daydreaming?";
  ItemArr[176]->Text = "Did you feel lonely as a child?";
  ItemArr[177]->Text = "Do you start fantasizing when things get boring?";
  ItemArr[178]->Text = "If you think about something cold, do you actually get cold?";
  ItemArr[179]->Text = "Do you feel that other people are watching you?";
  ItemArr[180]->Text = "Do you avoid going to places where there will be many people because you will get anxious?";
  ItemArr[181]->Text = "Do you get nervous when you have to make polite conversation?";
  ItemArr[182]->Text = "Do you feel uneasy talking to people you do not know well?";
  ItemArr[183]->Text = "Do you suddenly feel distracted by distant sounds that you are not normally aware of?";
  ItemArr[184]->Text = "Are your thoughts sometimes so strong that you can almost hear them?";
  ItemArr[185]->Text = "Do you find it hard to be emotionally close to other people?";
  ItemArr[186]->Text = "Do you forget what you are trying to say?";
  ItemArr[187]->Text = "Do you tend to wander off the topic when having a conversation?";
  ItemArr[188]->Text = "Are you poor at expressing your true feelings by the way you talk and look?";
  ItemArr[189]->Text = "Do you get concerned that friends or co-workers are not really loyal or trustworthy?";
  ItemArr[190]->Text = "Do you feel you have to be on your guard even with friends?";
  ItemArr[191]->Text = "Do you have to keep an eye out to stop people from taking advantage of you?";
  ItemArr[192]->Text = "Do people drop hints about you or say things with a double meaning?";
  ItemArr[193]->Text = "Are you sensitive to electromagnetic fields?";
  ItemArr[194]->Text = "I stare into the distance while I think of my loved one";
  ItemArr[195]->Text = "Are you so restless that it is hard to sit still?";
  ItemArr[196]->Text = "Do you obsess over people?";
  ItemArr[197]->Text = "Do you prefer to learn the character of a potential romantic partner through observation rather than conversation?";
  ItemArr[198]->Text = "Would you discuss relationship issues with your best friends?";
  ItemArr[199]->Text = "Do you worry your friend doesn't really like you?";
  ItemArr[200]->Text = "Do you dislike being hugged when you haven’t asked for it?";
