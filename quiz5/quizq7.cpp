...
/*##########################################################################
#
#   Name       : TQuizQ7::TQuizQ7
#
#   Purpose....: Constructor for TQuizQ7
#
...
#   Name       : TQuizQ7::~TQuizQ7
#
#   Purpose....: Destructor for TQuizQ7
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizQ7::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizQ7::WriteName(TFile &File)
{
    File.Write("Q7");
}
...
#
##########################################################################*/
void TQuizQ7::WriteLongName(TFile &File)
{
    File.Write("Q7");
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizQ7::ProcessRow(char *str)
{
    char *valstr;
    char *ptr;
    int fieldno;
...
void TQuizQ7::Load()
{
    ...
    int size;
    long pos = 0;
    TFile file("raw\\aspie-quiz-Q7.csv");
    char *ptr;
