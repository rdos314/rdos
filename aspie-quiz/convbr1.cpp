...
#
# convbr1.cpp
# Convert exported quiz-br1 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 145);
}

/*################## ConvBr1 ##########################
*   Purpose....: Convert quiz br1                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvBr1()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-br1.csv");
    TFile outfile("bin\\quizbr1.bin", 0);
    char *ptr;
