...
/*##########################################################################
#
#   Name       : TQuizL37::TQuizL37
#
#   Purpose....: Constructor for TQuizL37
#
...
#
##########################################################################*/
TQuizL37::TQuizL37(const char *FileName)
  : TQuiz(169),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL37::~TQuizL37
#
#   Purpose....: Destructor for TQuizL37
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL37::GetPcaCount()
{
        return 4;
}

/*##################  TQuizL37::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL37::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL37::WriteName(TFile &File)
{
    File.Write("L37");
}
...
#
##########################################################################*/
void TQuizL37::WriteLongName(TFile &File)
{
    File.Write("L37");
}
...
void TQuizL37::SetupTexts()
{
  ...
  Quiz[158].MyGroup = GROUP_ASPIE_SENSORY;
  ...
  Quiz[122].Text = "Can you experience anxiety over matters you have little certainty over?";
  Quiz[123].Text = "When you are focused on an activity, can you not recall all the information you might need to make good decisions?";
  Quiz[124].Text = "Do you find social situations chaotic?";
  Quiz[125].Text = "Do you find engaging in stimming (e.g.,fidgeting, rocking) to be relaxing?";
  Quiz[126].Text = "Is it distressing to be unexpectedly pulled away from something you are engaged in?";
  Quiz[127].Text = "Do you find it difficult to engage in a task of no interest to you even if it is important?";
  Quiz[128].Text = "Do routines provide an important source of stability and safety?";
  Quiz[129].Text = "When you are working on something, are you open to helpful suggestions?";
  Quiz[130].Text = "When you are focused on activities, do you not notice you need the bathroom?";
  Quiz[131].Text = "When you are interested in a topic, Do you like to learn everything you can about that topic?";
  Quiz[132].Text = "Do you accidentally say something others find offensive/ rude when you are focused on a task?";
  Quiz[133].Text = "Do you tend to do activities because you find them interesting, instead of due to societal expectations?";
  Quiz[134].Text = "Do you engage in activities you are passionate about to escape from anxiety?";
  Quiz[135].Text = "Do you find sudden unexpected disruptions to your attention startling?";
  Quiz[136].Text = "Do you focus on an incident for a substantial time (days) after the event?";
  Quiz[137].Text = "Do you find yourself getting stuck in loops of thought?";
  Quiz[138].Text = "Do you avoid talking because you cannot reliably predict how others will react, especially strangers?";
  Quiz[139].Text = "Can making a decision be so hard you get physically stuck?";
  Quiz[140].Text = "When there is a lot of information to consider, do you struggle to make a decision?";
  Quiz[141].Text = "Are you passionate about a few topics at any one time in your life?";  
  Quiz[142].Text = "Can get quite good at something even if you're not especially interested in it?";
  Quiz[143].Text = "Do you lose sense of time when engaging in activities you are passionate about?";
  Quiz[144].Text = "Do you struggle to concentrate in busy and/or unpredictable environments?";
  Quiz[145].Text = "Do you need a quiet and predictable environment for you to switch from one task to another easily?";
  Quiz[146].Text = "Do you find simultaneously holding eye contact and making a verbal conversation with another person uncomfortable?";
  Quiz[147].Text = "Do you engage in lengthy discussions on topics you find interesting even though your conversational partner(s) do not?";
  Quiz[148].Text = "Don't you mind if someone interrupts you when you're in the middle of an activity?";
  Quiz[149].Text = "Do you manage uncertainty by creating routines?";
  Quiz[150].Text = "Do you loop back to previous thoughts?";
  Quiz[151].Text = "Do you tend to feel quite self-conscious unless you're deeply absorbed in a task?";
  Quiz[152].Text = "Are you totally focused on activities you are passionate about, to the point you are unaware of other events?";
  Quiz[153].Text = "Do you find it easy to keep up with group discussions where everyone is speaking?";
  Quiz[154].Text = "Do you get stuck thinking about all the possibilities that might come out of a decision?";
  Quiz[155].Text = "Are you still fascinated by many of the things you were interested in when you were much younger?";
  Quiz[156].Text = "Do you notice details that others do not?";
  Quiz[157].Text = "Do you find a problem you can't solve distressing and/or hard to put down?";
  Quiz[158].Text = "After a period of instability, do you need a quiet and predictable environment?";
  Quiz[159].Text = "When you are focused on activities, do you not notice you are thirsty or hungry?";
  Quiz[160].Text = "Do you have trouble filtering out sounds when you are not doing something you're focused on?";
  Quiz[161].Text = "Do people tell you that you get fixated on things?";
  Quiz[162].Text = "Do you mean what you say and no more than that?";
  Quiz[163].Text = "Do involvement in an activity of interest reduce your anxiety level?";
  Quiz[164].Text = "Do you become highly anxious by focusing on the many possible situations that might occur at a future event?";
  Quiz[165].Text = "Do you find social interactions more comfortable if communicating about atopic of interest to you?";
  Quiz[166].Text = "When you are interested in something, do you tend to be passionate about it?";
  Quiz[167].Text = "Do you find it difficult to switch topics after engaging in an activity for a longtime?";

  Quiz[168].Text = "Do you feel you can control sexual attraction?";

}

/*##########################################################################
#
#   Name       : TQuizL37::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL37::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL37::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
