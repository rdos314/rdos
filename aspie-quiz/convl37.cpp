...
#
# convl37.cpp
# Convert exported quiz-l37 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 169);
}

/*################## ConvL37 ##########################
*   Purpose....: Convert quiz l37                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL37()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l37.csv");
    TFile outfile("bin\\quizl37.bin", 0);
    char *ptr;
