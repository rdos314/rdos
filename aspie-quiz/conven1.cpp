...
#
# conven1.cpp
# Convert exported quiz-en1 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvEn1()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-en1.csv");
    TFile outfile("bin\\quizen1.bin", 0);
    char *ptr;
