...
/*##########################################################################
#
#   Name       : TQuizF1::TQuizF1
#
#   Purpose....: Constructor for TQuizF1
#
...
#
##########################################################################*/
TQuizF1::TQuizF1(const char *FileName, TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd, TQuiz *Quiz5, TQuiz *Quiz6, TQuiz *Quiz7, TQuiz *Quiz8, TQuiz *Quiz9, TQuiz *QuizR1, TQuiz *QuizR2, TQuiz *QuizR3, TQuiz *QuizR4, TQuiz *QuizR5, TQuiz *QuizR6, TQuiz *QuizR7, TQuiz *QuizS1, TQuiz *QuizS2, TQuiz *QuizS3, TQuiz *QuizS4, TQuiz *QuizS5, TQuiz *QuizS6, TQuiz *QuizS7, TQuiz *QuizS8, TQuiz *QuizS9, TQuiz *QuizS10, TQuiz *QuizS11, TQuiz *QuizS12, TQuiz *QuizN1, TQuiz *QuizN2, TQuiz *QuizN3, TQuiz *QuizN4, TQuiz *QuizFI)
  : TQuizFinal(200, QuizI, QuizII, QuizIII, QuizNd, Quiz5, Quiz6, Quiz7, Quiz8, Quiz9, QuizR1, QuizR2, QuizR3, QuizR4, QuizR5, QuizR6, QuizR7, QuizS1, QuizS2, QuizS3, QuizS4, QuizS5, QuizS6, QuizS7, QuizS8, QuizS9, QuizS10, QuizS11, QuizS12, QuizN1, QuizN2, QuizN3, QuizN4),
	FDataFile(FileName)
{
	DefineCross(32, QuizFI);

	SetupTexts();
	SetupCross(QuizI, QuizII, QuizIII, QuizNd, Quiz5, Quiz6, Quiz7, Quiz8, Quiz9, QuizR1, QuizR2, QuizR3, QuizR4, QuizR5, QuizR6, QuizR7, QuizS1, QuizS2, QuizS3, QuizS4, QuizS5, QuizS6, QuizS7, QuizS8, QuizS9, QuizS10, QuizS11, QuizS12, QuizN1, QuizN2, QuizN3, QuizN4, QuizFI);
...
#   Name       : TQuizF1::~TQuizF1
#
#   Purpose....: Destructor for TQuizF1
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizF1::GetCatCount(int Question)
{
    if (Question < 150)
        return 3;
    else
...
#
##########################################################################*/
void TQuizF1::WriteName(TFile &File)
{
	 File.Write("F1");
}
...
#
##########################################################################*/
void TQuizF1::WriteLongName(TFile &File)
{
	 File.Write("final version 1");
}

/*##########################################################################
#
#   Name       : TQuizF1::SetupTexts
#
...
void TQuizF1::SetupTexts()
{
  ...
  Quiz[154].MyGroup = GROUP_ASPIE_SENSORY;
  ...
  Quiz[192].MyGroup = GROUP_ASPIE_OBSESSION;
  ...
  Quiz[198].MyGroup = GROUP_ASPIE_TALENT;
  Quiz[199].MyGroup = GROUP_NT_NVC;

 Quiz[150].Text = "AQ - I prefer to do things with others rather than on my own.";          
 Quiz[151].Text = "AQ - I prefer to do things the same way over and over again.";          
 Quiz[152].Text = "AQ - If I try to imagine something, I find it very easy to create a picture in my mind.";          
 Quiz[153].Text = "AQ - I frequently get so strongly absorbed in one thing that I lose sight of other things.";          
 Quiz[154].Text = "AQ - I often notice small sounds when others do not.";          
 Quiz[155].Text = "AQ - I usually notice car number plates or similar strings of information.";          
 Quiz[156].Text = "AQ - Other people frequently tell me that what I've said is impolite, even though I think it is polite.";          
 Quiz[157].Text = "AQ - When I'm reading a story, I can easily imagine what the characters might look like.";          
 Quiz[158].Text = "AQ - I am fascinated by dates.";          
 Quiz[159].Text = "AQ - In a social group, I can easily keep track of several different people's conversations.";          
 Quiz[160].Text = "AQ - I find social situations easy.";          
 Quiz[161].Text = "AQ - I tend to notice details that others do not.";          
 Quiz[162].Text = "AQ - I would rather go to a library than to a party.";          
 Quiz[163].Text = "AQ - I find making up stories easy.";          
 Quiz[164].Text = "AQ - I find myself drawn more strongly to people than to things.";          
 Quiz[165].Text = "AQ - I tend to have very strong interests, which I get upset about if I can't pursue.";          
 Quiz[166].Text = "AQ - I enjoy social chitchat.";          
 Quiz[167].Text = "AQ - When I talk, it isn't always easy for others to get a word in edgewise.";          
 Quiz[168].Text = "AQ - I am fascinated by numbers.";          
 Quiz[169].Text = "AQ - When I'm reading a story, I find it difficult to work out the characters' intentions.";          
 Quiz[170].Text = "AQ - I don't particularly enjoy reading fiction.";          
 Quiz[171].Text = "AQ - I find it hard to make new friends.";          
 Quiz[172].Text = "AQ - I notice patterns in things all the time.";          
 Quiz[173].Text = "AQ - I would rather go to the theater than to a museum.";          
 Quiz[174].Text = "AQ - It does not upset me if my daily routine is disturbed.";          
 Quiz[175].Text = "AQ - I frequently find that I don't know how to keep a conversation going.";          
 Quiz[176].Text = "AQ - I find it easy to 'read between the lines' when someone is talking to me.";          
 Quiz[177].Text = "AQ - I usually concentrate more on the whole picture, rather than on the small details.";          
 Quiz[178].Text = "AQ - I am not very good at remembering phone numbers.";          
 Quiz[179].Text = "AQ - I don't usually notice small changes in a situation or a person's appearance.";
 Quiz[180].Text = "AQ - I know how to tell if someone listening to me is getting bored.";          
 Quiz[181].Text = "AQ - I find it easy to do more than one thing at once.";          
 Quiz[182].Text = "AQ - When I talk on the phone, I'm not sure when it's my turn to speak.";          
 Quiz[183].Text = "AQ - I enjoy doing things spontaneously.";          
 Quiz[184].Text = "AQ - I am often the last to understand the point of a joke.";          
 Quiz[185].Text = "AQ - I find it easy to work out what someone is thinking or feeling just by looking at their face.";          
 Quiz[186].Text = "AQ - If there is an interruption, I can switch back to what I was doing very quickly.";          
 Quiz[187].Text = "AQ - I am good at social chitchat.";          
 Quiz[188].Text = "AQ - People often tell me that I keep going on and on about the same thing.";          
 Quiz[189].Text = "AQ - When I was young, I used to enjoy playing games involving pretending with other children.";          
 Quiz[190].Text = "AQ - I like to collect information about categories of things (e.g., types of cars, birds, trains, plants).";          
 Quiz[191].Text = "AQ - I find it difficult to imagine what it would be like to be someone else.";          
 Quiz[192].Text = "AQ - I like to carefully plan any activities I participate in.";          
 Quiz[193].Text = "AQ - I enjoy social occasions.";          
 Quiz[194].Text = "AQ - I find it difficult to work out people's intentions.";          
 Quiz[195].Text = "AQ - New situations make me anxious.";          
 Quiz[196].Text = "AQ - I enjoy meeting new people.";          
 Quiz[197].Text = "AQ - I am a good diplomat.";
 Quiz[198].Text = "AQ - I am not very good at remembering people's date of birth.";
 Quiz[199].Text = "AQ - I find it very easy to play games with children that involve pretending.";

}

/*##################  TQuizF1::LoadReferers ##########################
...
#
##########################################################################*/
void TQuizF1::SetupCross(TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd, TQuiz *Quiz5, TQuiz *Quiz6, TQuiz *Quiz7, TQuiz *Quiz8, TQuiz *Quiz9, TQuiz *QuizR1, TQuiz *QuizR2, TQuiz *QuizR3, TQuiz *QuizR4, TQuiz *QuizR5, TQuiz *QuizR6, TQuiz *QuizR7, TQuiz *QuizS1, TQuiz *QuizS2, TQuiz *QuizS3, TQuiz *QuizS4, TQuiz *QuizS5, TQuiz *QuizS6, TQuiz *QuizS7, TQuiz *QuizS8, TQuiz *QuizS9, TQuiz *QuizS10, TQuiz *QuizS11, TQuiz *QuizS12, TQuiz *QuizN1, TQuiz *QuizN2, TQuiz *QuizN3, TQuiz *QuizN4, TQuiz *QuizFI)
{
    int i;

    for (i = 0; i < 150; i++)
	    DefineCross(QuizFI, i, i);
...
#
##########################################################################*/
void TQuizF1::GetReferer(const char *referer, TPopulation *pop)
{
	int i;
	TReferer *ref;
	TQuizRow Row;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF1::ExportExcelCase(const char *filename, int PcaType)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF1::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF1::ExportExcelGroups(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF1::ImportMvsp(const char *filename, int PcaType)
{
	char buf[MAX_IN_ROW];
	int size;
	char *rowstr;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF1::WriteRace(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF1::WriteRetest(const char *filename)
{
	TQuizRow Row;
	int userid;
	int i;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF1::WriteAQ(const char *filename)
{
	int Count;
	long double AsSum;
	long double NtSum;
