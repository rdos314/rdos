...
/*##########################################################################
#
#   Name       : TQuizJE5::TQuizJE5
#
#   Purpose....: Constructor for TQuizJE5
#
...
#   Name       : TQuizJE5::~TQuizJE5
#
#   Purpose....: Destructor for TQuizJE5
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJE5::GetPcaCount()
{
        return 4;
}

/*##################  TQuizJE5::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJE5::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizJE5::WriteName(TFile &File)
{
    File.Write("JE5");
}
...
#
##########################################################################*/
void TQuizJE5::WriteLongName(TFile &File)
{
    File.Write("JE5");
}
...
void TQuizJE5::SetupTexts()
{
  ...
  Quiz[71].Text = "Do you forget you are in a social situation when something gets your attention?";
  Quiz[72].Text = "Do you tend to express your feelings in ways that may baffle others?";
  ...
  Quiz[75].Text = "As a teenager, were you usually unaware of social rules & boundaries unless they were clearly spelled out?";
  Quiz[76].Text = "Do people sometimes think you are smiling at the wrong occasion?";
  Quiz[77].Text = "Are you often surprised what people's motives are ?";
  Quiz[78].Text = "Do you tend to interpret things literally?";
  Quiz[79].Text = "Is it hard for you to see why some things upset people so much?";
  Quiz[80].Text = "Do you or others think that you have unconventional ways of solving problems?";
  Quiz[81].Text = "Is your sense of humor different from mainstream or considered odd?";
  ...
  Quiz[84].Text = "Do you feel an urge to peel flakes off yourself and / or others?";
  Quiz[85].Text = "Have people you formed strong attachments to taken advantage of you?";
  Quiz[86].Text = "Do you have an alternative view of what is attractive in the opposite sex?";
  Quiz[87].Text = "Does highly enjoyable things like sex make you mute?";
  Quiz[88].Text = "Do you have an urge to observe the habits of humans and/or animals?";
  Quiz[89].Text = "Do you tend to look a lot at people you like and little or not at all at people you dislike?";
  Quiz[90].Text = "Do you notice patterns in things all the time?";
  Quiz[91].Text = "Do you naturally fit into the expected gender stereotypes?";
  ...
  Quiz[94].Text = "Are you more sexually attracted to strangers than to people you know well?";
  Quiz[95].Text = "Do you prefer to have friends of the opposite gender?";
  Quiz[96].Text = "Would you accept polyamory if you knew your partner would?";
  Quiz[97].Text = "Has it been harder for you than for others to keep friends?";
  Quiz[98].Text = "Do you dislike shaking hands with strangers?";
  Quiz[99].Text = "Do you stay away from situations where people might express affection for you?";
  Quiz[100].Text = "Do you find it hard to be emotionally close to other people?";
  Quiz[101].Text = "Do you get very tired after socializing, and need to regenerate alone?";
  Quiz[102].Text = "Do you dislike it when people drop by to visit you uninvited?";
  Quiz[103].Text = "Do you enjoy big events even if they are crowded?";
  Quiz[104].Text = "Do you prefer to only meet people you know, one-on-one, or in small, familiar groups?";
  Quiz[105].Text = "Do you find it easy to describe your feelings?";
  Quiz[106].Text = "Do you prefer to keep to yourself?";
  Quiz[107].Text = "Do you find yourself at ease in romantic situations?";
  Quiz[108].Text = "Do you prefer to do things on your own even if you could use others' help or expertise?";
  Quiz[109].Text = "Is it hard for you to approach somebody you are attracted to?";
  Quiz[110].Text = "Do you prefer to socialize with familiar friends because you know what to expect from them?";
  Quiz[111].Text = "Do you avoid being the centre of attention?";
  Quiz[112].Text = "Do you enjoy hosting or arranging events?";
  Quiz[113].Text = "Do you have difficulty accepting criticism, correction, and direction?";
  Quiz[114].Text = "In a conversation, do you tend to focus on your own thoughts rather than on what your listener might be thinking?";
  Quiz[115].Text = "Do you expect other people to know your thoughts, experiences and opinions without you having to tell them?";
  Quiz[116].Text = "Are you impatient and have low frustration tolerance?";
  Quiz[117].Text = "Will you abandon your friends if your activities or ideals clash?";
  Quiz[118].Text = "Do you obstruct others' plans?";
  Quiz[119].Text = "Do you see your own activities as more important than other people's?";
  Quiz[120].Text = "Do you have trouble with authority?";
  Quiz[121].Text = "Do you usually find faults with opinions that you don't share?";
  Quiz[122].Text = "Have you have had long-lasting urges to take revenge?";
  Quiz[123].Text = "Do you argue a lot?";
  Quiz[124].Text = "Are you good at team-work?";
  Quiz[125].Text = "Do you find it natural to wave or say 'hi' when you meet people?";
  Quiz[126].Text = "Does it feel natural for you to say 'thank you' and 'sorry'?";
  Quiz[127].Text = "Have you felt kinship and belonging to others for all your life?";
  Quiz[128].Text = "Do you enjoy travel?";
  Quiz[129].Text = "Do you take pride in your appearance?";
  Quiz[130].Text = "Do you enjoy gossip?";
  Quiz[131].Text = "Do you like to follow (walk behind) people you are attached to?";
  Quiz[132].Text = "Do you have an urge to learn the routines of people you know?";
  Quiz[133].Text = "Do you tend to become obsessed with a potential partner and cannot let go of him/her?";
  Quiz[134].Text = "Do you have a need to confess?";
  Quiz[135].Text = "Have you experienced stronger than normal attachments to certain people?";
  Quiz[136].Text = "Do you feel an urge to show people you like your favorite places?";
  Quiz[137].Text = "Do you examine the hair of people you like a lot?";
  ...
  Quiz[140].Text = "Would you spend a lot of time actively seeking out a potential partner, possibly even going to the same places and/or activities as him/her?"; 
...
#
##########################################################################*/
void TQuizJE5::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizJE5::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
