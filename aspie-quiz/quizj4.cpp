...
/*##########################################################################
#
#   Name       : TQuizJ4::TQuizJ4
#
#   Purpose....: Constructor for TQuizJ4
#
...
#
##########################################################################*/
TQuizJ4::TQuizJ4(const char *FileName)
  : TQuiz(153),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizJ4::~TQuizJ4
#
#   Purpose....: Destructor for TQuizJ4
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJ4::GetCatCount(int Question)
{
   return 3;
}
...
#
##########################################################################*/
void TQuizJ4::WriteName(TFile &File)
{
    File.Write("J4");
}
...
#
##########################################################################*/
void TQuizJ4::WriteLongName(TFile &File)
{
    File.Write("J4");
}
...
void TQuizJ4::SetupTexts()
{
  ...
  Quiz[74].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[75].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[76].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[77].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[78].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[79].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[80].MyGroup = GROUP_NT_CONTACT;
  Quiz[81].MyGroup = GROUP_NT_CONTACT;
  Quiz[82].MyGroup = GROUP_NT_CONTACT;
  Quiz[83].MyGroup = GROUP_NT_CONTACT;
  Quiz[84].MyGroup = GROUP_NT_CONTACT;
  Quiz[85].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[111].MyGroup = GROUP_ASPIE_ATTACH;
  ...
  Quiz[119].MyGroup = GROUP_NT_ATTACH;  
  ...
  Quiz[49].Text = "Have others told you that you have an odd posture or gait?";
  Quiz[50].Text = "Do you have a fascination for slowly flowing water?";
  Quiz[51].Text = "Do recently heard tunes or rhythms tend to stick and replay themselves repeatedly in your head?";
  Quiz[52].Text = "Do you pace (e.g. when thinking or anxious)?";
  Quiz[53].Text = "Do you bite your lip, cheek or tongue (e.g. when thinking, when anxious or nervous)?";
  Quiz[54].Text = "Do you have an urge to observe the habits of humans and/or animals?";
  Quiz[55].Text = "Do you get a pleasurable tingling sensation in the head, scalp or back of the body in response to certain sounds?";
  Quiz[56].Text = "Do you feel an urge to peel flakes off yourself and / or others?";
  Quiz[57].Text = "Do you talk to yourself?";
  Quiz[58].Text = "Do you examine the hair of people you like a lot?";
  Quiz[59].Text = "Do you sometimes mix up pronouns and, for example, say \"you\" or \"we\" when you mean \"me\" or vice versa?";
  Quiz[60].Text = "Do you have an urge to jump over things?";
  Quiz[61].Text = "Do you enjoy spinning in circles?";
  Quiz[62].Text = "Do you have, or used to have, imaginary friends?";
  Quiz[63].Text = "Do you tend to express your feelings in ways that may baffle others?";
  Quiz[64].Text = "Do you tend to say things that are considered socially inappropriate when you are tired, frustrated or when you act naturally?";
  Quiz[65].Text = "Do others often misunderstand you?";
  Quiz[66].Text = "Do you forget you are in a social situation when something gets your attention?";
  Quiz[67].Text = "Is it hard for you to see why some things upset people so much?";
  Quiz[68].Text = "Do people sometimes think you are smiling at the wrong occasion?";
  Quiz[69].Text = "Is your sense of humor different from mainstream or considered odd?";
  Quiz[70].Text = "As a teenager, were you usually unaware of social rules & boundaries unless they were clearly spelled out?";
  Quiz[71].Text = "Do you or others think that you have unconventional ways of solving problems?";
  Quiz[72].Text = "Do you tend to interpret things literally?";
  Quiz[73].Text = "Do you have a monotonous voice?";
  Quiz[74].Text = "Do you find it easier to understand and communicate with odd & unusual people than with ordinary people?";
  Quiz[75].Text = "Do you have an alternative view of what is attractive in the opposite sex?";
  Quiz[76].Text = "Do you have unusual sexual preferences?";
  Quiz[77].Text = "Do you prefer to construct your own set of spiritual beliefs rather than following existing religions / belief-systems?";
  Quiz[78].Text = "Are you more sexually attracted to strangers than to people you know well?";
  Quiz[79].Text = "Would you accept polyamory if you knew your partner would?";
  Quiz[80].Text = "Do you have a tendency to become stuck when asked questions in social situation?";
  Quiz[81].Text = "Has it been harder for you than for others to keep friends?";
  Quiz[82].Text = "Do you find it hard to be emotionally close to other people?";
  Quiz[83].Text = "In conversations, do you need extra time to carefully think out your reply, so that there may be a pause before you answer?";
  Quiz[84].Text = "Do you stay away from situations where people might express affection for you?";
  Quiz[85].Text = "Do you get very tired after socializing, and need to regenerate alone?";
  Quiz[86].Text = "Do you prefer to keep to yourself?";
  Quiz[87].Text = "Do you find it easy to describe your feelings?";
  Quiz[88].Text = "Do you prefer to only meet people you know, one-on-one, or in small, familiar groups?";
  Quiz[89].Text = "Do you prefer to do things on your own even if you could use others' help or expertise?";
  Quiz[90].Text = "Do you dislike it when people drop by to visit you uninvited?";
  Quiz[91].Text = "Is it hard for you to approach somebody you are attracted to?";
  Quiz[92].Text = "In a conversation, do you tend to focus on your own thoughts rather than on what your listener might be thinking?";
  Quiz[93].Text = "Do you see your own activities as more important than other people's?";
  Quiz[94].Text = "Are you impatient and have low frustration tolerance?";
  Quiz[95].Text = "Do you expect other people to know your thoughts, experiences and opinions without you having to tell them?";
  Quiz[96].Text = "Will you abandon your friends if your activities or ideals clash?";
  Quiz[97].Text = "Do you have difficulty accepting criticism, correction, and direction?";
  Quiz[98].Text = "Do you usually find faults with opinions that you don't share?";
  Quiz[99].Text = "Do you obstruct others' plans?";
  Quiz[100].Text = "Do you have trouble with authority?";
  Quiz[101].Text = "Have you have had long-lasting urges to take revenge?";
  Quiz[102].Text = "Do you argue a lot?";
  Quiz[103].Text = "Are you good at team-work?";
  Quiz[104].Text = "Do you find it natural to wave or say 'hi' when you meet people?";
  Quiz[105].Text = "Do you enjoy big events even if they are crowded?";
  Quiz[106].Text = "Does it feel natural for you to say 'thank you' and 'sorry'?";
  Quiz[107].Text = "Do you enjoy travel?";
  Quiz[108].Text = "Do you take pride in your appearance?";
  Quiz[109].Text = "Do you enjoy gossip?";
  Quiz[110].Text = "Do you tend to look a lot at people you like and little or not at all at people you dislike?";
  Quiz[111].Text = "Have you experienced stronger than normal attachments to certain people?";
  Quiz[112].Text = "Do you like to follow (walk behind) people you are attached to?";
  Quiz[113].Text = "Do you have an urge to learn the routines of people you know?";
  Quiz[114].Text = "Have people you formed strong attachments to taken advantage of you?";
  Quiz[115].Text = "Do you have a need to confess?";
  Quiz[116].Text = "Do you like tongue-kissing?";
  Quiz[117].Text = "Do you get great pleasure from making love?";
  Quiz[118].Text = "Are you asexual?";
  Quiz[119].Text = "Do you dislike sexual intercourse other than as procreation?";
  Quiz[120].Text = "Is your sense of humor fairly conventional?";
  ...
  Quiz[124].Text = "Do you think the government interferes far too much in our everyday lives?";
  Quiz[125].Text = "Do you think that the government sometimes needs to make laws that keep people from hurting themselves?";
  Quiz[126].Text = "Do you think that it's not the government's business to try to protect people from themselves?";
  Quiz[127].Text = "Do you think that the government should stop telling people how to live their lives?";
  Quiz[128].Text = "Do you think that the government should do more to advance society's goals, even if that means limiting the freedom and choices of individuals?";
  Quiz[129].Text = "Do you think that the government should put limits on the choices individuals can make so that they don't get in the way of what's good for society?";
  Quiz[130].Text = "Do you think that too many people today expect society to do things for them that they should be doing for themselves?";
  Quiz[131].Text = "Do you think that it's society's responsibility to make sure everyone's basic needs are met?";
  Quiz[132].Text = "Do you think that it's a mistake to ask society to help every person in need?";
  Quiz[133].Text = "Do you think that people should be able to rely on the government for help when they need it?";
  Quiz[134].Text = "Do you think that society works best when it lets individuals take responsibility for their own lives without telling them what to do?";
  Quiz[135].Text = "Do you think that our government tries to do too many things for too many people, and that we just should let people take care of themselves?";
  Quiz[136].Text = "Do you think that if the government spent less time trying to fix everyone's problems, we'd all be a lot better off?";
  Quiz[137].Text = "Do you think that free markets--not government programs--are the best way to supply people with the things they need?";
  Quiz[138].Text = "Do you think that private profit is the main motive for hard work?";
  Quiz[139].Text = "Do you think that government regulations almost always are a waste of everyone's time and money?";
  Quiz[140].Text = "Do you think that we’ve gone too far in pushing equal rights in this country?";
  Quiz[141].Text = "Do you think that our society would be better off if the distribution of wealth was more equal?";
  Quiz[142].Text = "Do you think that we need to dramatically reduce inequalities between the rich and the poor, whites and people of color, and men and women?";
  Quiz[143].Text = "Do you think that discrimination against minorities still is a very serious problem in our society?";
  Quiz[144].Text = "Do you think that blacks, women, homosexuals and other groups don't want equal rights, but special rights just for them?";
  Quiz[145].Text = "Do you think that the criminals and welfare cheats get all the breaks, while the average citizen picks up the tab?";
  Quiz[146].Text = "Do you think that it's old-fashioned and wrong to think that one culture's set of values is better than any other culture's way of seeing the world?";
  Quiz[147].Text = "Do you think that the women's rights movement has gone too far?";
  Quiz[148].Text = "Do you think that we live in a sexist society that is fundamentally set up so that women can be discriminated against?";
  Quiz[149].Text = "Do you think that a lot of problems in our society today come from the decline in the traditional family, where the man works and the woman stays home?";
  Quiz[150].Text = "Do you think that society as a whole has become too soft and feminine?";
  Quiz[151].Text = "Do you think that parents should encourage young boys to be more sensitive and less rough and tough?";
  Quiz[152].Text = "Do you have odd hair (for example multiple whorls, standing up when short or other peculiarities)?";
}

/*##########################################################################
#
#   Name       : TQuizJ4::LoadPopulations
#
...
#
##########################################################################*/
void TQuizJ4::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizJ4::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
