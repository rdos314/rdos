...
#
# convpl4.cpp
# Convert exported quiz-pl4 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvPl4()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-pl4.csv");
    TFile outfile("bin\\quizpl4.bin", 0);
    char *ptr;
