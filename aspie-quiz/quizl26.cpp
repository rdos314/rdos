...
/*##########################################################################
#
#   Name       : TQuizL26::TQuizL26
#
#   Purpose....: Constructor for TQuizL26
#
...
#
##########################################################################*/
TQuizL26::TQuizL26(const char *FileName)
  : TQuiz(156),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL26::~TQuizL26
#
#   Purpose....: Destructor for TQuizL26
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL26::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL26::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL26::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL26::WriteName(TFile &File)
{
    File.Write("L26");
}
...
#
##########################################################################*/
void TQuizL26::WriteLongName(TFile &File)
{
    File.Write("L26");
}
...
void TQuizL26::SetupTexts()
{
  ...
  Quiz[146].Text = "Are you easily hurt?";
  Quiz[147].Text = "Are you a very sensitive person?";
  Quiz[148].Text = "Do you have regular depressions?";
  Quiz[149].Text = "Do you have panic attacks?";
  Quiz[150].Text = "Have you been sexually abused?";
  Quiz[151].Text = "Have you been talked into having sex even if you really didn't want to?";
  Quiz[152].Text = "Were you abused by parents as a child?";
  Quiz[153].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[154].Text = "Do you feel as if the thoughts in your head are not your own?";
  Quiz[155].Text = "Have you had paranormal experiences?";

}

/*##########################################################################
#
#   Name       : TQuizL26::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL26::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL26::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
