...
/*##########################################################################
#
#   Name       : TQuizK7::TQuizK7
#
#   Purpose....: Constructor for TQuizK7
#
...
#
##########################################################################*/
TQuizK7::TQuizK7(const char *FileName)
  : TQuiz(136),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizK7::~TQuizK7
#
#   Purpose....: Destructor for TQuizK7
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizK7::GetCatCount(int Question)
{
    if (Question < 128)
   return 3;
...
#
##########################################################################*/
void TQuizK7::WriteName(TFile &File)
{
    File.Write("K7");
}
...
#
##########################################################################*/
void TQuizK7::WriteLongName(TFile &File)
{
    File.Write("K7");
}
...
void TQuizK7::SetupTexts()
{
  ...
  Quiz[127].MyGroup = GROUP_ASPIE_ATTACH;
  ...
  Quiz[127].Text = "Do you like to protect people you are attached to even when they didn't ask for it?";
...
#
##########################################################################*/
void TQuizK7::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizK7::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
