...
void TQuizR5::SetupTexts()
{
  ...
  Quiz[19].MyGroup = GROUP_OCD;
  Quiz[20].MyGroup = GROUP_INSTINCT;
  ...
  Quiz[40].MyGroup = GROUP_INSTINCT;
  ...
  Quiz[67].MyGroup = GROUP_NONVERBAL;
  Quiz[68].MyGroup = GROUP_ASPIE_COMM;
  Quiz[69].MyGroup = GROUP_SEX;
  Quiz[70].MyGroup = GROUP_NT_BIOLOGY;
  ...
  Quiz[82].MyGroup = GROUP_INSTINCT;
  ...
  Quiz[123].MyGroup = GROUP_NT_BIOLOGY;
  ...
  Quiz[140].MyGroup = GROUP_INSTINCT;
