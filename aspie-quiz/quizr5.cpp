...
#
##########################################################################*/
void TQuizR5::GetDxData(int PopType, int GroupArr[MAX_GROUP_COUNT], int Arr[MAX_SCORE][2], int OnlyNtControl)
{
	TQuizRow Row;
	int res;
	int g;
...
void TQuizR5::SetupTexts()
{
  ...
  Quiz[69].MyGroup = GROUP_SEX;
  Quiz[70].MyGroup = GROUP_MIXED;
  Quiz[71].MyGroup = GROUP_ASPIE_NVC;
  Quiz[72].MyGroup = GROUP_ACTIVITY;
  Quiz[73].MyGroup = GROUP_ACTIVITY;
  Quiz[74].MyGroup = GROUP_NT_NVC;
  Quiz[75].MyGroup = GROUP_ACTIVITY;
