...
/*##########################################################################
#
#   Name       : TQuizJ3::TQuizJ3
#
#   Purpose....: Constructor for TQuizJ3
#
...
#   Name       : TQuizJ3::~TQuizJ3
#
#   Purpose....: Destructor for TQuizJ3
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJ3::GetCatCount(int Question)
{
   return 3;
}
...
#
##########################################################################*/
void TQuizJ3::WriteName(TFile &File)
{
    File.Write("J3");
}
...
#
##########################################################################*/
void TQuizJ3::WriteLongName(TFile &File)
{
    File.Write("J3");
}
...
void TQuizJ3::SetupTexts()
{
  ...
  Quiz[124].Text = "Is an action wrong if it makes someone suffer emotionally?";
  Quiz[125].Text = "Is it important to respect private property? ";
  Quiz[126].Text = "Is an action wrong if it includes treating some people differently than others?";
  Quiz[127].Text = "Should one show love for one’s country?";
  Quiz[128].Text = "Should one show respect for authority?";
  Quiz[129].Text = "Is it wrong to violate standards of purity and decency?";
  Quiz[130].Text = "Is it important to be good at math?";
  Quiz[131].Text = "Should one care for the weak and vulnerable?";
  Quiz[132].Text = "Is it wrong to act unfairly?";
  Quiz[133].Text = "Should everyone be free to do as they want?";
  Quiz[134].Text = "Is it wrong to betray one’s group?";
  Quiz[135].Text = "Should one conform to the traditions of society?";
  Quiz[136].Text = "Is it wrong to do something disgusting?";
  Quiz[137].Text = "Should one not be cruel?";
  Quiz[138].Text = "Is it wrong to deny someone their rights?";
  Quiz[139].Text = "Should one be loyal?";
  Quiz[140].Text = "Is an action wrong if it causes chaos or disorder?";
  Quiz[141].Text = "Is it important to act in a way that God would approve of?";
  Quiz[142].Text = "Is compassion for those who are suffering the most crucial virtue?";
  Quiz[143].Text = "When the government makes laws, should the number one principle be ensuring that everyone is treated fairly?";
  Quiz[144].Text = "Do people who are successful in business have a right to enjoy their wealth as they see fit?";
  Quiz[145].Text = "Are you proud of your country’s history?";
  Quiz[146].Text = "Is respect for authority something all children need to learn?";
  Quiz[147].Text = "Should people not do things that are disgusting, even if no one is harmed?";
  Quiz[148].Text = "Should property owners be allowed to develop their land or build their homes in any way they choose, as long as they don't endanger their neighbors?";
  Quiz[149].Text = "Is it better to do good than to do bad?";
  Quiz[150].Text = "Is one of the worst things a person could do to hurt a defenseless animal?";
  Quiz[151].Text = "Is justice the most important requirement for a society?";
  Quiz[152].Text = "Should people be loyal to their family members, even when they have done something wrong?";
  Quiz[153].Text = "Do you think everyone should be free to do as they choose, so long as they don't infringe upon the equal freedom of others?";
  Quiz[154].Text = "Do men and women each have different roles to play in society?";
  Quiz[155].Text = "Would you call some acts wrong on the grounds that they are unnatural?";
  Quiz[156].Text = "Would it never be right to kill a human being?";
  Quiz[157].Text = "Do you think it’s morally wrong that rich children inherit a lot of money while poor children inherit nothing?";
  Quiz[158].Text = "Is it more important to be a team player than to express oneself?";
...
#
##########################################################################*/
void TQuizJ3::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizJ3::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
