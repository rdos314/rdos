...
#
# convf15.cpp
# Convert exported quiz-f15 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 186);
}

/*################## ConvF15 ##########################
*   Purpose....: Convert quiz f15                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvF15()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-f15.csv");
    TFile outfile("bin\\quizf15.bin", 0);
    char *ptr;
