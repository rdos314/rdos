...
#
# convg3.cpp
# Convert exported quiz-g3 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-g3 VALUES(";

TFile quizfile("quizg3.bin", 0);
TFile ancfile("ancg3.bin", 0);
...
char *ProcessRow(char *str)
{
	...
	for (fieldno = 0; fieldno < 183; fieldno++)
	{
		valstr = str;
