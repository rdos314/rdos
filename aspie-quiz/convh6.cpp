...
#
# convh6.cpp
# Convert exported quiz-h6 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 188);
}

/*################## ConvH6 ##########################
*   Purpose....: Convert quiz h6                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvH6()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h6.csv");
    TFile outfile("bin\\quizh6.bin", 0);
    char *ptr;
