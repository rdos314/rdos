...
/*##########################################################################
#
#   Name       : TQuizF10::TQuizF10
#
#   Purpose....: Constructor for TQuizF10
#
	...
	FDataFile(FileName)
{
	...
	SetupTexts();
	SetupCross(QuizI, QuizII, QuizIII, QuizNd, Quiz5, Quiz6, Quiz7, Quiz8, Quiz9, QuizR1, QuizR2, QuizR3, QuizR4, QuizR5, QuizR6, QuizR7, QuizS1, QuizS2, QuizS3, QuizS4, QuizS5, QuizS6, QuizS7, QuizS8, QuizS9, QuizS10, QuizS11, QuizS12, QuizN1, QuizN2, QuizN3, QuizN4, QuizFI, QuizF1, QuizF2, QuizF3, QuizF4, QuizF5, QuizF6, QuizF7, QuizF8, QuizF9);
...
#   Name       : TQuizF10::~TQuizF10
#
#   Purpose....: Destructor for TQuizF10
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizF10::GetCatCount(int Question)
{
	return 3;
}
...
#
##########################################################################*/
void TQuizF10::WriteName(TFile &File)
{
	 File.Write("F10");
}
...
#
##########################################################################*/
void TQuizF10::WriteLongName(TFile &File)
{
	 File.Write("final version 10");
}

/*##########################################################################
#
#   Name       : TQuizF10::SetupTexts
#
...
void TQuizF10::SetupTexts()
{
  ...
  Quiz[165].MyGroup = GROUP_NT_HUNTING;
  Quiz[166].MyGroup = GROUP_NT_HUNTING;
  Quiz[167].MyGroup = GROUP_NT_HUNTING;
  Quiz[168].MyGroup = GROUP_NT_HUNTING;
  Quiz[169].MyGroup = GROUP_NT_HUNTING;

  Quiz[150].Text = "DYSLEXIA - Do you find difficulty in telling left from right?";
  Quiz[151].Text = "DYSLEXIA - Is map reading or finding your way to a strange place confusing?";
  Quiz[152].Text = "DYSLEXIA - Do you dislike reading aloud?";
  Quiz[153].Text = "DYSLEXIA - Do you take longer than you should to read a page of a book?";
  Quiz[154].Text = "DYSLEXIA - Do you find it difficult to remember the sense of what you have read?";
  Quiz[155].Text = "DYSLEXIA - Do you dislike reading long books?";
  Quiz[156].Text = "DYSLEXIA - Is your spelling poor?";
  Quiz[157].Text = "DYSLEXIA - Is your writing difficult to read?";
  Quiz[158].Text = "DYSLEXIA - Do you get confused if you have to speak in public?";
  Quiz[159].Text = "DYSLEXIA - Do you find it difficult to take messages on the telephone and pass them on correctly?";
  Quiz[160].Text = "DYSLEXIA - When you have to say a long word, do you sometimes find it difficult to get all the sounds in the right order?";
  Quiz[161].Text = "DYSLEXIA - Do you find it difficult to do sums in your head without using your fingers or paper?";
  Quiz[162].Text = "DYSLEXIA - When using the telephone, do you tend to get the numbers mixed up when you dial?";
  Quiz[163].Text = "DYSLEXIA - Do you find it difficult to say the months of the year forwards in a fluent manner?";
  Quiz[164].Text = "DYSLEXIA - Do you find it difficult to say the months of the year backwards?";
  Quiz[165].Text = "DYSLEXIA - Do you mix up dates and times and miss appointments?";
  Quiz[166].Text = "DYSLEXIA - When writing cheques, do you frequently find yourself making mistakes?";
  Quiz[167].Text = "DYSLEXIA - Do you find forms difficult and confusing?";
  Quiz[168].Text = "DYSLEXIA - Do you mix up bus numbers like 95 and 59?";
  Quiz[169].Text = "DYSLEXIA - When you were at school, did you find it hard to learn your multiplication tables?";
}

/*##################  TQuizF10::LoadReferers ##########################
...
#
##########################################################################*/
void TQuizF10::SetupCross(TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd, TQuiz *Quiz5, TQuiz *Quiz6, TQuiz *Quiz7, TQuiz *Quiz8, TQuiz *Quiz9, TQuiz *QuizR1, TQuiz *QuizR2, TQuiz *QuizR3, TQuiz *QuizR4, TQuiz *QuizR5, TQuiz *QuizR6, TQuiz *QuizR7, TQuiz *QuizS1, TQuiz *QuizS2, TQuiz *QuizS3, TQuiz *QuizS4, TQuiz *QuizS5, TQuiz *QuizS6, TQuiz *QuizS7, TQuiz *QuizS8, TQuiz *QuizS9, TQuiz *QuizS10, TQuiz *QuizS11, TQuiz *QuizS12, TQuiz *QuizN1, TQuiz *QuizN2, TQuiz *QuizN3, TQuiz *QuizN4, TQuiz *QuizFI, TQuiz *QuizF1, TQuiz *QuizF2, TQuiz *QuizF3, TQuiz *QuizF4, TQuiz *QuizF5, TQuiz *QuizF6, TQuiz *QuizF7, TQuiz *QuizF8, TQuiz *QuizF9)
{
    int i;

    for (i = 0; i < 150; i++)
  	    DefineCross(QuizF9, i, i);

    for (i = 0; i < 20; i++)
        DefineCross(QuizS10, 150 + i, 168 + i);
}

/*##########################################################################
#
#   Name       : TQuizF10::GetReferer
#
...
#
##########################################################################*/
void TQuizF10::GetReferer(const char *referer, TPopulation *pop)
{
	int i;
	TReferer *ref;
	TQuizRow Row;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF10::ExportExcelCase(const char *filename, int PcaType)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF10::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF10::ExportExcelGroups(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF10::ImportMvsp(const char *filename, int PcaType)
{
	char buf[MAX_IN_ROW];
	int size;
	char *rowstr;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF10::WriteRace(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF10::WriteRetest(const char *filename)
{
	TQuizRow Row;
	int userid;
	int i;
