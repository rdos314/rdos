...
/*##########################################################################
#
#   Name       : TQuizH23::TQuizH23
#
#   Purpose....: Constructor for TQuizH23
#
...
#
##########################################################################*/
TQuizH23::TQuizH23(const char *FileName)
  : TQuiz(173),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH23::~TQuizH23
#
#   Purpose....: Destructor for TQuizH23
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH23::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH23::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH23::GetCatCount(int Question)
{
        return 3;
}
...
#
##########################################################################*/
void TQuizH23::WriteName(TFile &File)
{
         File.Write("H23");
}
...
#
##########################################################################*/
void TQuizH23::WriteLongName(TFile &File)
{
         File.Write("H23");
}
...
#
##########################################################################*/
void TQuizH23::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH23::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
