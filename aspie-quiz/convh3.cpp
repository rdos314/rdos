...
#
# convh3.cpp
# Convert exported quiz-h3 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvH3()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h3.csv");
    TFile outfile("bin\\quizh3.bin", 0);
    char *ptr;
