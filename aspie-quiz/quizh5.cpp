...
/*##########################################################################
#
#   Name       : TQuizH5::TQuizH5
#
#   Purpose....: Constructor for TQuizH5
#
...
#
##########################################################################*/
TQuizH5::TQuizH5(const char *FileName)
  : TQuiz(188),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH5::~TQuizH5
#
#   Purpose....: Destructor for TQuizH5
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH5::GetCatCount(int Question)
{
        return 3;
}
...
#
##########################################################################*/
void TQuizH5::WriteName(TFile &File)
{
         File.Write("H5");
}
...
#
##########################################################################*/
void TQuizH5::WriteLongName(TFile &File)
{
         File.Write("H5");
}
...
void TQuizH5::SetupTexts()
{
  ...
  Quiz[165].MyGroup = GROUP_NT_SENSORY;
  ...
  Quiz[175].MyGroup = GROUP_ASPIE_SENSORY;
  ...
  Quiz[180].MyGroup = GROUP_NT_OBSESSION;
  Quiz[181].MyGroup = GROUP_NT_OBSESSION;
  Quiz[182].MyGroup = GROUP_NT_OBSESSION;
  Quiz[183].MyGroup = GROUP_NT_OBSESSION;
  Quiz[184].MyGroup = GROUP_NT_OBSESSION;
  Quiz[185].MyGroup = GROUP_ASPIE_OBSESSION;
  Quiz[186].MyGroup = GROUP_ASPIE_OBSESSION;
  Quiz[187].MyGroup = GROUP_ASPIE_OBSESSION;
  ...
  Quiz[150].Text = "Would you like to move to a new place?";
  Quiz[151].Text = "Do you live close to where you were born?";
  Quiz[152].Text = "Do you like to travel?";
  Quiz[153].Text = "Do you like to explore distant places?";
  Quiz[154].Text = "Do you like to explore your nearby surroundings?";
  Quiz[155].Text = "Do you have favorite places nearby that you need to visit from time to time?";
  Quiz[156].Text = "Do you prefer to travel to different places every time?";
  Quiz[157].Text = "Would you like to live a life all by yourself?";
  Quiz[158].Text = "Would you consider switching friends / acquantances over time?";
  Quiz[159].Text = "Do you want to know your nearby surroundings in great detail?";
  Quiz[160].Text = "Is it important for you to find a unique niche where you can acquire unique competence?";
  Quiz[161].Text = "Do you admire people with high social status?";
  Quiz[162].Text = "Do you admire people with unique knowledge / competence?";
  Quiz[163].Text = "Is motivation important for you in order to learn things effectively?";
  Quiz[164].Text = "Are you easily motivated by authority figures to learn things you are expected to know?";
  Quiz[165].Text = "Did you have difficulties with forward rolls in gym class?";  
  Quiz[166].Text = "Do you have an urge to observe the habits of humans and/or animals?";
  Quiz[167].Text = "Do you like to visit people one at a time?";  
  Quiz[168].Text = "Do you like to know what people are thinking all the time?";
  Quiz[169].Text = "Is your personal space usually messy and disorganized?";
  Quiz[170].Text = "Do you think that you learn best without pressure?";
  Quiz[171].Text = "Do you dislike the routine aspects of your work (studies)?";
  Quiz[172].Text = "Do you have an urge to learn the routines of people you know?";
  Quiz[173].Text = "Do you think that compassion for those who are suffering is a crucial virtue?";
  Quiz[174].Text = "Do you think that one of the worst things a person could do is to hurt a defenseless animal?";
  Quiz[175].Text = "Is it never right to kill a human being?";
  Quiz[176].Text = "Do you think that the number one principle in making laws should be to ensure that everyone is treated fairly?";  
  Quiz[177].Text = "Do you think that justice is the most important requirement for a society?";
  Quiz[178].Text = "Do you find it morally wrong that rich children inherit a lot of money while poor children inherit nothing?";
  Quiz[179].Text = "Are you proud of your country's history?";
  Quiz[180].Text = "Do you think that people should be loyal to their family members, even if they've done something wrong?";
  Quiz[181].Text = "Is it more important to be a team player than to express oneself?";
  Quiz[182].Text = "Do you think that respect for authority is something all children needs to learn?";
  Quiz[183].Text = "Do you think men and woman have different roles to play in society?";
  Quiz[184].Text = "As a soldier, would you obey orders of a commanding officer even if you disagreed with/disliked them, because it would be your duty?";
  Quiz[185].Text = "Do you think that people should not do disgusting things, even if no one is harmed?";   
  Quiz[186].Text = "Would you judge some acts as wrong because they are unnatural?";
  Quiz[187].Text = "Do you find chastity an important and valuable virtue?";
}

/*##########################################################################
#
#   Name       : TQuizH5::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH5::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH5::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
