...
#
# convf8.cpp
# Convert exported quiz-f8 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-f8 VALUES(";

TFile quizfile("quizf8.bin", 0);
TFile ancfile("ancf8.bin", 0);
...
char *ProcessRow(char *str)
{
	...
	for (fieldno = 0; fieldno < 216; fieldno++)
	{
		valstr = str;
