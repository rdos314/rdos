...
void TQuizN2::SetupCross(TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd, TQuiz *Quiz5, TQuiz *Quiz6, TQuiz *Quiz7, TQuiz *Quiz8, TQuiz *Quiz9, TQuiz *QuizR1, TQuiz *QuizR2, TQuiz *QuizR3, TQuiz *QuizR4, TQuiz *QuizR5, TQuiz *QuizR6, TQuiz *QuizR7, TQuiz *QuizS1, TQuiz *QuizS2, TQuiz *QuizS3, TQuiz *QuizS4, TQuiz *QuizS5, TQuiz *QuizS6, TQuiz *QuizS7, TQuiz *QuizS8, TQuiz *QuizS9, TQuiz *QuizS10, TQuiz *QuizS11, TQuiz *QuizS12, TQuiz *QuizN1)
{
	 ...
	 DefineCross(QuizN1, 42, 50);
	 DefineCross(QuizN1, 43, 51);
	 DefineCross(QuizN1, 44, 54);
	 DefineCross(QuizN1, 45, 55);
	 DefineCross(QuizN1, 46, 56);
	 DefineCross(QuizN1, 47, 57);
	 DefineCross(QuizN1, 48, 59);
	 DefineCross(QuizN1, 49, 60);
	 DefineCross(QuizN1, 50, 61);
	 DefineCross(QuizN1, 51, 62);
	 DefineCross(QuizN1, 52, 63);
	 DefineCross(QuizN1, 53, 64);
	 DefineCross(QuizN1, 54, 66);
	 DefineCross(QuizN1, 55, 183);
	 DefineCross(QuizN1, 56, 67);
	 DefineCross(QuizN1, 57, 68);
	 DefineCross(QuizN1, 58, 69);
	 DefineCross(QuizN1, 59, 70);
	 DefineCross(QuizN1, 60, 71);
	 DefineCross(QuizN1, 61, 72);
	 DefineCross(QuizN1, 62, 73);
	 DefineCross(QuizN1, 63, 74);
	 DefineCross(QuizN1, 64, 75);
	 DefineCross(QuizN1, 65, 76);
	 DefineCross(QuizN1, 66, 77);
	 DefineCross(QuizN1, 67, 78);
	 DefineCross(QuizN1, 68, 79);
	 DefineCross(QuizN1, 69, 81);
	 DefineCross(QuizN1, 70, 80);
	 DefineCross(QuizN1, 71, 82);
	 DefineCross(QuizN1, 72, 83);
	 DefineCross(QuizN1, 73, 84);
	 DefineCross(QuizN1, 74, 85);
	 DefineCross(QuizN1, 75, 86);
	 DefineCross(QuizN1, 76, 87);
	 DefineCross(QuizN1, 77, 88);
	 DefineCross(QuizN1, 78, 89);
	 DefineCross(QuizN1, 79, 90);
	 DefineCross(QuizN1, 80, 91);
	 DefineCross(QuizN1, 81, 93);
	 DefineCross(QuizN1, 82, 94);
	 DefineCross(QuizN1, 83, 95);
	 DefineCross(QuizN1, 84, 96);
	 DefineCross(QuizN1, 85, 186);
	 DefineCross(QuizN1, 86, 97);
	 DefineCross(QuizN1, 87, 98);
	 DefineCross(QuizN1, 88, 100);
	 DefineCross(QuizN1, 89, 58);
	 DefineCross(QuizN1, 90, 101);
	 DefineCross(QuizN1, 91, 102);
	 DefineCross(QuizN1, 92, 104);
	 DefineCross(QuizN1, 93, 103);
	 DefineCross(QuizN1, 94, 107);
	 DefineCross(QuizN1, 95, 108);
	 DefineCross(QuizN1, 96, 105);
	 DefineCross(QuizN1, 97, 110);
	 DefineCross(QuizN1, 98, 109);
	 DefineCross(QuizN1, 99, 112);
	 DefineCross(QuizN1, 100, 113);
	 DefineCross(QuizN1, 101, 114);
	 DefineCross(QuizN1, 102, 116);
	 DefineCross(QuizN1, 103, 115);
	 DefineCross(QuizN1, 104, 117);
	 DefineCross(QuizN1, 105, 118);
	 DefineCross(QuizN1, 106, 119);
	 DefineCross(QuizN1, 107, 120);
	 DefineCross(QuizN1, 108, 121);
	 DefineCross(QuizN1, 109, 122);
	 DefineCross(QuizN1, 110, 123);
	 DefineCross(QuizN1, 111, 124);
	 DefineCross(QuizN1, 112, 126);
	 DefineCross(QuizN1, 113, 129);
	 DefineCross(QuizN1, 114, 130);
	 DefineCross(QuizN1, 115, 132);
	 DefineCross(QuizN1, 116, 133);
	 DefineCross(QuizN1, 117, 131);
	 DefineCross(QuizN1, 118, 134);
	 DefineCross(QuizN1, 119, 135);
	 DefineCross(QuizN1, 120, 136);
	 DefineCross(QuizN1, 121, 137);
	 DefineCross(QuizN1, 122, 138);
	 DefineCross(QuizN1, 123, 141);
	 DefineCross(QuizN1, 124, 142);
	 DefineCross(QuizN1, 125, 143);
	 DefineCross(QuizN1, 126, 144);
	 DefineCross(QuizN1, 127, 146);
	 DefineCross(QuizN1, 128, 145);
	 DefineCross(QuizN1, 129, 148);
	 DefineCross(QuizN1, 130, 149);
	 DefineCross(QuizN1, 131, 153);
	 DefineCross(QuizN1, 132, 155);
	 DefineCross(QuizN1, 133, 156);
	 DefineCross(QuizN1, 134, 157);
	 DefineCross(QuizN1, 135, 158);
	 DefineCross(QuizN1, 136, 159);
	 DefineCross(QuizN1, 137, 178);
	 DefineCross(QuizN1, 138, 162);
	 DefineCross(QuizN1, 139, 163);
	 DefineCross(QuizN1, 140, 164);
	 DefineCross(QuizN1, 141, 165);
	 DefineCross(QuizN1, 142, 168);
	 DefineCross(QuizN1, 143, 166);
	 DefineCross(QuizN1, 144, 167);
	 DefineCross(QuizN1, 145, 187);
	 DefineCross(QuizN1, 146, 169);
	 DefineCross(QuizN1, 147, 170);
	 DefineCross(QuizN1, 148, 184);
	 DefineCross(QuizN1, 149, 176);
	 DefineCross(QuizN1, 150, 172);
	 DefineCross(QuizN1, 151, 173);
	 DefineCross(QuizN1, 152, 174);
	 DefineCross(QuizN1, 153, 175);
}
