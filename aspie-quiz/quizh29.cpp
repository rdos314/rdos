...
/*##########################################################################
#
#   Name       : TQuizH29::TQuizH29
#
#   Purpose....: Constructor for TQuizH29
#
...
#
##########################################################################*/
TQuizH29::TQuizH29(const char *FileName)
  : TQuiz(193),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH29::~TQuizH29
#
#   Purpose....: Destructor for TQuizH29
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH29::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH29::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH29::GetCatCount(int Question)
{
    if (Question >= 192)
        return 5;
    else
...
#
##########################################################################*/
void TQuizH29::WriteName(TFile &File)
{
    File.Write("H29");
}
...
#
##########################################################################*/
void TQuizH29::WriteLongName(TFile &File)
{
    File.Write("H29");
}
...
void TQuizH29::SetupTexts()
{
  ...
  Quiz[151].Text = "If you found somebody's wallet, would you feel guilty about keeping the money?";
  Quiz[152].Text = "Do you believe most people would cheat to get ahead?";
  Quiz[153].Text = "Do you try to make friends with people who can be useful?";
  Quiz[154].Text = "Do you break inconvinient rules?";
  Quiz[155].Text = "Do you think it is alright to hurt your opponents in team sports?";
  Quiz[156].Text = "Did you start fires as a child that damaged property?";
  Quiz[157].Text = "Do you threaten to hit people when you get angry?";
  Quiz[158].Text = "Do you only feel safe when you are with people you are close to?";
  Quiz[159].Text = "Do you tend to follow people you are attached to around when worried?";
  Quiz[160].Text = "Do you only feel comfortable when you have the company of people you are attached to?";
  Quiz[161].Text = "Do you worry about being abondoned by the person you love?";
  Quiz[162].Text = "Do you resent it when a person you are attached to spends time away from you?";
  Quiz[163].Text = "Do you try to have people around you all of the time?";
  Quiz[164].Text = "Are intimate relationships very important in your life?";
  Quiz[165].Text = "Do you get great pleasure from making love?";
  Quiz[166].Text = "Do you want to share your life with someone?";
  Quiz[167].Text = "Would you yearn for an intimate relationship if you had no one?";
  Quiz[168].Text = "Do you avoid getting attached to people?";
  Quiz[169].Text = "Do you usually find faults with opinions that you don't share?";
  Quiz[170].Text = "Do you think that your views are the only right ones?";
  Quiz[171].Text = "Do you tend to like to help people by correcting them?";
  Quiz[172].Text = "Do you tend to take the lead and organize things?";
  Quiz[173].Text = "Do you rarely share your problems?";
  Quiz[174].Text = "Are you cautious about what you say about yourself even among close friends?";
  Quiz[175].Text = "Does it make you uneasy to talk about yourself?";
  Quiz[176].Text = "Do you try to avoid to talk about your warm feeling for other people?";
  Quiz[177].Text = "Do you continually watch for signs of danger?";
  Quiz[178].Text = "Do you often wonder about people real motives when the do something nice?";
  Quiz[179].Text = "Have you experienced stronger than normal attachments to certain people?";
  Quiz[180].Text = "Are you more sexually attracted to strangers than to people you know well?";
  Quiz[181].Text = "Do you examine the hair of people you like a lot?";
  Quiz[182].Text = "Do you want to always be around your partner (or imaginary partner) and do everything together?";
  Quiz[183].Text = "Do you have compulsive sexual behavior, e.g. spend too much time on sex";
  Quiz[184].Text = "Do you prefer to have friends of the opposite gender?";
  Quiz[185].Text = "Do you like to be naked?";
  Quiz[186].Text = "If you were single, would you find casual sex (one-night stands) rewarding?";
  Quiz[187].Text = "Have you been in love with more than one person at the same time?";
  Quiz[188].Text = "Are you asexual?";
  Quiz[189].Text = "Do you dislike sexual intercourse other than as procreation?";
  Quiz[190].Text = "Have you been sexually abused?";
  Quiz[191].Text = "Do you regard love and sex as synonymous?";
  Quiz[192].Text = "Courting vs following";

}

/*##########################################################################
#
#   Name       : TQuizH29::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH29::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH29::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
