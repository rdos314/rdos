...
/*##########################################################################
#
#   Name       : TQuizK5::TQuizK5
#
#   Purpose....: Constructor for TQuizK5
#
...
#
##########################################################################*/
TQuizK5::TQuizK5(const char *FileName)
  : TQuiz(134),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizK5::~TQuizK5
#
#   Purpose....: Destructor for TQuizK5
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizK5::GetCatCount(int Question)
{
    if (Question < 126)
       return 3;
...
#
##########################################################################*/
void TQuizK5::WriteName(TFile &File)
{
    File.Write("K5");
}
...
#
##########################################################################*/
void TQuizK5::WriteLongName(TFile &File)
{
    File.Write("K5");
}
...
void TQuizK5::SetupTexts()
{
  ...
  Quiz[125].Text = "Do you prefer to only hug a romantic partner?";

  Quiz[126].Text = "12-14 rate";
  Quiz[127].Text = "15-19 rate";
  Quiz[128].Text = "20-24 rate";
  Quiz[129].Text = "25-30 rate";

  Quiz[130].Text = "12-14 time";
  Quiz[131].Text = "15-19 time";
  Quiz[132].Text = "20-24 time";
  Quiz[133].Text = "25-30 time";

}

/*##########################################################################
#
#   Name       : TQuizK5::LoadPopulations
#
...
#
##########################################################################*/
void TQuizK5::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizK5::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
