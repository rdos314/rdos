...
void TQuizJ1::SetupTexts()
{
  ...
  Quiz[70].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[71].MyGroup = GROUP_ASPIE_CONTACT;
  ...
  Quiz[82].MyGroup = GROUP_NT_SENSORY;
  Quiz[83].MyGroup = GROUP_NT_NVC;
  Quiz[84].MyGroup = GROUP_NT_SENSORY;
  ...
  Quiz[103].MyGroup = GROUP_ASPIE_ATTACH;
