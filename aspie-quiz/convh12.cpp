...
#
# convh12.cpp
# Convert exported quiz-h12 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvH12()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h12.csv");
    TFile outfile("bin\\quizh12.bin", 0);
    char *ptr;
