...
#
# convh28.cpp
# Convert exported quiz-h28 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvH28()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h28.csv");
    TFile outfile("bin\\quizh28.bin", 0);
    char *ptr;
