...
#
# convh17.cpp
# Convert exported quiz-h17 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 159);
}

/*################## ConvH17 ##########################
*   Purpose....: Convert quiz h17                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvH17()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h17.csv");
    TFile outfile("bin\\quizh17.bin", 0);
    char *ptr;
