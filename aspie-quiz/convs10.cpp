...
#
# convs10.cpp
# Convert exported quiz-s10 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-s10 VALUES(";

TFile quizfile("quizs10.bin", 0);
...
char *ProcessRow(char *str)
{
   ...
   int j;
	...
	for (fieldno = 0; fieldno < 212; fieldno++)
	{
		valstr = str;
			...
			*ptr = 0;
			...
			switch (fieldno)
			{
				...
				case 13:
					...
					Row.Quiz[188] = Row.Dyslexia;
					break;

				case 14:
					Row.Dyscalculia = atoi(valstr);
					Row.Quiz[189] = Row.Dyscalculia;
					break;

				case 15:
					Row.OCD = atoi(valstr);
					Row.Quiz[190] = Row.OCD;
					break;

				case 16:
					Row.ODD = atoi(valstr);
					Row.Quiz[191] = Row.ODD;
					break;

				case 17:
					Row.Bipolar = atoi(valstr);
					Row.Quiz[192] = Row.Bipolar;
					break;
