...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 168);
}

/*##################  ConvS10 ##########################
 *   Purpose....: Conv quiz S10                                                           #
 *   In params..: *                                                          #
 *   Out params.: *                                                          #
 *   Returns....: *                                                          #
 *   Created....: 96-11-20 le                                                #
...
void ConvS10()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-s10.csv");
    TFile outfile("bin\\quizs10.bin", 0);
    char *ptr;
