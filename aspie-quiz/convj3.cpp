...
#
# convj3.cpp
# Convert exported quiz-j3 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 162);
}

/*################## ConvJ3 ##########################
*   Purpose....: Convert quiz j3                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvJ3()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-j3.csv");
    TFile outfile("bin\\quizj3.bin", 0);
    char *ptr;
