...
#
# convl10.cpp
# Convert exported quiz-l10 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("L10: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
    printf("\r\n");
}
...
void ConvL10()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l10.csv");
    TFile outfile("bin\\quizl10.bin", 0);
    char *ptr;
