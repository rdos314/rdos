...
#
##########################################################################*/
void TQuiz9::WriteLongName(TFile &File)
{
...
#
##########################################################################*/
void TQuiz9::GetDxData(int PopType, int GroupArr[MAX_GROUP_COUNT], int Arr[MAX_SCORE][2], int OnlyNtControl)
{
	TQuizRow Row;
	int res;
	int g;
...
void TQuiz9::SetupTexts()
{
  ...
  Quiz[82].MyGroup = GROUP_NT_OBSESSION;
  Quiz[83].MyGroup = GROUP_NT_OBSESSION;
  Quiz[84].MyGroup = GROUP_NT_OBSESSION;
  Quiz[85].MyGroup = GROUP_NT_OBSESSION;
  ...
  Quiz[115].MyGroup = GROUP_ASPIE_OBSESSION;
  Quiz[116].MyGroup = GROUP_ASPIE_OBSESSION;
  ...
  Quiz[137].MyGroup = GROUP_ASPIE_HUNTING;
  Quiz[138].MyGroup = GROUP_ASPIE_HUNTING;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuiz9::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
