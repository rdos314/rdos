...
#
# convcn4a.cpp
# Convert exported quiz-cn4a to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvCn4a()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-cn4a.csv");
    TFile outfile("bin\\quizcn4a.bin", 0);
    char *ptr;
