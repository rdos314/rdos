...
#
# convf5.cpp
# Convert exported quiz-f5 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-f5 VALUES(";

TFile quizfile("quizf5.bin", 0);
TFile ancfile("ancf5.bin", 0);
