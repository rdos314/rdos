...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 151);
}

/*################## ConvL23 ##########################
*   Purpose....: Convert quiz l23                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL23()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l23.csv");
    TFile outfile("bin\\quizl23.bin", 0);
    char *ptr;
