...
#
# convk3.cpp
# Convert exported quiz-k3 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("K3: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
...
void ConvK3()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-k3.csv");
    TFile outfile("bin\\quizk3.bin", 0);
    char *ptr;
