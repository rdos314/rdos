...
#
# convje2.cpp
# Convert exported quiz-je2 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvJE2()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-je2.csv");
    TFile outfile("bin\\quizje2.bin", 0);
    char *ptr;
