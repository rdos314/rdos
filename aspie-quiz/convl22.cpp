...
#
# convl22.cpp
# Convert exported quiz-l22 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("L22: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
    printf("\r\n");
}
...
void ConvL22()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l22.csv");
    TFile outfile("bin\\quizl22.bin", 0);
    char *ptr;
