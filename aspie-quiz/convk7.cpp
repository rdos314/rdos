...
#
# convk7.cpp
# Convert exported quiz-k7 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("K7: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
...
void ConvK7()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-k7.csv");
    TFile outfile("bin\\quizk7.bin", 0);
    char *ptr;
