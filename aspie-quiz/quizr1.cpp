...
#
##########################################################################*/
void TQuizR1::WriteLongName(TFile &File)
{
...
#
##########################################################################*/
void TQuizR1::GetDxData(int PopType, int GroupArr[MAX_GROUP_COUNT], int Arr[MAX_SCORE][2], int OnlyNtControl)
{
	TQuizRow Row;
	int res;
	int g;
...
void TQuizR1::SetupTexts()
{
  ...
  Quiz[52].MyGroup = GROUP_ASPIE_OBSESSION;
  ...
  Quiz[67].MyGroup = GROUP_ENVIRONMENT;
  ...
  Quiz[72].MyGroup = GROUP_ASPIE_SENSORY;
  Quiz[73].MyGroup = GROUP_ASPIE_SENSORY;
  Quiz[74].MyGroup = GROUP_ASPIE_SENSORY;
  ...
  Quiz[83].MyGroup = GROUP_ASPIE_SENSORY;
  Quiz[84].MyGroup = GROUP_SEX;
  Quiz[85].MyGroup = GROUP_ASPIE_NVC;
  Quiz[86].MyGroup = GROUP_NT_SENSORY;
  Quiz[87].MyGroup = GROUP_NT_SENSORY;
  Quiz[88].MyGroup = GROUP_NT_SENSORY;
  Quiz[89].MyGroup = GROUP_NT_SENSORY;
  Quiz[90].MyGroup = GROUP_NT_SENSORY;
  Quiz[91].MyGroup = GROUP_NT_SENSORY;
  Quiz[92].MyGroup = GROUP_NT_SENSORY;
  Quiz[93].MyGroup = GROUP_MIXED;
  Quiz[94].MyGroup = GROUP_NT_SENSORY;
  Quiz[95].MyGroup = GROUP_NT_SENSORY;
  ...
  Quiz[127].MyGroup = GROUP_ASPIE_HUNTING;
  Quiz[128].MyGroup = GROUP_ASPIE_HUNTING;
  Quiz[129].MyGroup = GROUP_ASPIE_HUNTING;
