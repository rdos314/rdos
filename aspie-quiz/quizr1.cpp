...
void TQuizR1::SetupTexts()
{
  ...
  Quiz[6].MyGroup = GROUP_NT_SOCIAL;
  Quiz[7].MyGroup = GROUP_NT_SOCIAL;
  Quiz[8].MyGroup = GROUP_NT_SOCIAL;
  Quiz[9].MyGroup = GROUP_ENVIRONMENT;
  Quiz[10].MyGroup = GROUP_NT_SOCIAL;
  ...
  Quiz[15].MyGroup = GROUP_NT_SOCIAL;
  Quiz[16].MyGroup = GROUP_NT_SOCIAL;
  Quiz[17].MyGroup = GROUP_NT_OBSESSION;
