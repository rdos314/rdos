...
/*##########################################################################
#
#   Name       : TQuizL36::TQuizL36
#
#   Purpose....: Constructor for TQuizL36
#
...
#   Name       : TQuizL36::~TQuizL36
#
#   Purpose....: Destructor for TQuizL36
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL36::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL36::GetCatCount ##########################
...
#
##########################################################################*/
void TQuizL36::WriteName(TFile &File)
{
    File.Write("L36");
}
...
#
##########################################################################*/
void TQuizL36::WriteLongName(TFile &File)
{
    File.Write("L36");
}
...
// student
  ...
  Quiz[121].Text = "Are you a University student?";
  Quiz[122].Text = "Do you think having friends is important?";
  Quiz[123].Text = "Do you think a large social network is important?";
  Quiz[124].Text = "Do you enjoy being by yourself?";
  Quiz[125].Text = "Projects/groups";
  Quiz[126].Text = "Lectures";
  Quiz[127].Text = "Classes";
  Quiz[128].Text = "Labs";
...
#
##########################################################################*/
void TQuizL36::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL36::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
