...
/*##########################################################################
#
#   Name       : TQuizH30::TQuizH30
#
#   Purpose....: Constructor for TQuizH30
#
...
#
##########################################################################*/
TQuizH30::TQuizH30(const char *FileName)
  : TQuiz(193),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH30::~TQuizH30
#
#   Purpose....: Destructor for TQuizH30
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH30::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH30::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH30::GetCatCount(int Question)
{
    if (Question >= 192)
        return 5;
    else
...
#
##########################################################################*/
void TQuizH30::WriteName(TFile &File)
{
    File.Write("H30");
}
...
#
##########################################################################*/
void TQuizH30::WriteLongName(TFile &File)
{
    File.Write("H30");
}
...
void TQuizH30::SetupTexts()
{
  ...
  Quiz[192].Text = "Bonding vs following";

}

/*##########################################################################
#
#   Name       : TQuizH30::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH30::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH30::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
