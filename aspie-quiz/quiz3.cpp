...
void TQuizIII::SetupTexts()
{
	...
	Quiz[14].MyGroup = GROUP_DISABILITY;
	...
	Quiz[42].MyGroup = GROUP_DISABILITY;
	...
	Quiz[69].MyGroup = GROUP_ABILITY;
	Quiz[70].MyGroup = GROUP_ABILITY;
	Quiz[71].MyGroup = GROUP_ABILITY;
	Quiz[72].MyGroup = GROUP_ABILITY;
	Quiz[73].MyGroup = GROUP_ABILITY;
	Quiz[74].MyGroup = GROUP_ABILITY;
	Quiz[75].MyGroup = GROUP_ABILITY;
	Quiz[76].MyGroup = GROUP_ABILITY;
	Quiz[77].MyGroup = GROUP_ABILITY;
	Quiz[78].MyGroup = GROUP_ABILITY;
