...
void TQuizIII::SetupTexts()
{
	...
	Quiz[55].MyGroup = GROUP_CONFORM;
	Quiz[56].MyGroup = GROUP_CONFORM;
	Quiz[57].MyGroup = GROUP_CONFORM;
	Quiz[58].MyGroup = GROUP_CONFORM;
	Quiz[59].MyGroup = GROUP_CONFORM;
	Quiz[60].MyGroup = GROUP_INSTINCT;
	Quiz[61].MyGroup = GROUP_CONFORM;
	Quiz[62].MyGroup = GROUP_CONFORM;
