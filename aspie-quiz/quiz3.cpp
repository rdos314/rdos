...
#
##########################################################################*/
void TQuizIII::WriteLongName(TFile &File)
{
	 File.Write("version III");
}

/*##########################################################################
#
#   Name       : TQuizIII::GetDxData
#
...
#
##########################################################################*/
void TQuizIII::GetDxData(int PopType, int GroupArr[MAX_GROUP_COUNT], int Arr[MAX_SCORE][2], int OnlyNtControl)
{
	TQuizRow Row;
	int res;
	int g;
...
void TQuizIII::SetupTexts()
{
	...
	Quiz[2].MyGroup = GROUP_ASPIE_SENSORY;
...
void TQuizIII::SetupCross(TQuiz *QuizI, TQuiz *QuizII)
{
	...
	DefineGlobalId(     19, 173);
	DefineGlobalId(     20, 174);
	DefineGlobalId(     21, 175);
	DefineGlobalId(     22, 176);
	DefineGlobalId(     23, 177);
	DefineGlobalId(     24, 178);
	...
	DefineGlobalId(     55, 179);
	DefineCross(QuizII, 56, 89);
	DefineCross(QuizII, 57, 80);
	DefineCross(QuizII, 58, 74);
	DefineGlobalId(     59, 180);
	DefineGlobalId(     60, 181);
	DefineGlobalId(     61, 182);
	DefineGlobalId(     62, 183);
	DefineCross(QuizII, 63, 57);
	DefineGlobalId(     64, 184);
	DefineGlobalId(     65, 185);
	DefineCross(QuizII, 66, 58);
	DefineGlobalId(     67, 186);
	DefineGlobalId(     68, 187);
	...
	DefineGlobalId(     90, 189);
	DefineGlobalId(     91, 190);
	DefineGlobalId(     92, 191);
	DefineGlobalId(     93, 192);
	DefineGlobalId(     94, 193);
	DefineGlobalId(     95, 194);
	DefineGlobalId(     96, 195);
	DefineGlobalId(     97, 196);
	DefineGlobalId(     98, 197);
	DefineGlobalId(     99, 198);
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizIII::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
