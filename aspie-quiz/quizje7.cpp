...
void TQuizJE7::SetupTexts()
{
  ...
  Quiz[11].MyGroup = GROUP_NT_CONTACT;
  Quiz[12].MyGroup = GROUP_NT_CONTACT;
  Quiz[13].MyGroup = GROUP_NT_TALENT;
  Quiz[14].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[119].MyGroup = GROUP_ASPIE_CONTACT;  
  Quiz[120].MyGroup = GROUP_NT_CONTACT;
  Quiz[121].MyGroup = GROUP_NT_CONTACT;
  Quiz[122].MyGroup = GROUP_NT_CONTACT;
