...
class TQuiz5 : public TQuiz
{
public:
    TQuiz5(const char *FileName, TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd);
    ~TQuiz5();
...
private:
    ...
    void SetupCross(TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd);
