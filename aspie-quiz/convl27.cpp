...
#
# convl27.cpp
# Convert exported quiz-l27 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 140);
}

/*################## ConvL27 ##########################
*   Purpose....: Convert quiz l27                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL27()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l27.csv");
    TFile outfile("bin\\quizl27.bin", 0);
    char *ptr;
