...
#
# convf11.cpp
# Convert exported quiz-f11 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 178);
}

/*################## ConvF11 ##########################
*   Purpose....: Convert quiz f11                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvF11()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-f11.csv");
    TFile outfile("bin\\quizf11.bin", 0);
    char *ptr;
