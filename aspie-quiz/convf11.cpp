...
const char InsertString[] = "INSERT INTO aspie-quiz-f11 VALUES(";

TFile quizfile("quizf11.bin", 0);
TFile ancfile("ancf11.bin", 0);
...
char *ProcessRow(char *str)
{
	...
	for (fieldno = 0; fieldno < 182; fieldno++)
	{
		valstr = str;
