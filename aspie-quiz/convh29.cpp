...
#
# convh29.cpp
# Convert exported quiz-h29 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 192);
}

/*################## ConvH29 ##########################
*   Purpose....: Convert quiz h29                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvH29()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h29.csv");
    TFile outfile("bin\\quizh29.bin", 0);
    char *ptr;
