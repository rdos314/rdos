...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 161);
}

/*##################  ConvN2 ##########################
 *   Purpose....: Conv quiz N2                                                           #
 *   In params..: *                                                          #
 *   Out params.: *                                                          #
 *   Returns....: *                                                          #
 *   Created....: 96-11-20 le                                                #
...
void ConvN2()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-n2.csv");
    TFile outfile("bin\\quizn2.bin", 0);
    char *ptr;
