...
/*##########################################################################
#
#   Name       : TQuizL15::TQuizL15
#
#   Purpose....: Constructor for TQuizL15
#
...
#
##########################################################################*/
TQuizL15::TQuizL15(const char *FileName)
  : TQuiz(163),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL15::~TQuizL15
#
#   Purpose....: Destructor for TQuizL15
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL15::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL15::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL15::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL15::WriteName(TFile &File)
{
    File.Write("L15");
}
...
#
##########################################################################*/
void TQuizL15::WriteLongName(TFile &File)
{
    File.Write("L15");
}
...
void TQuizL15::SetupTexts()
{
  ...
  Quiz[121].Text = "Do you feel sad?";
  Quiz[122].Text = "Do you feel as if people seem to drop hints about you or say things with a double meaning?";
  Quiz[123].Text = "Do you feel that you are not a very animated person?";
  Quiz[124].Text = "Do you feel that you are not much of a talker when you are conversing with other people?";
  Quiz[125].Text = "Do you feel as if things in magazines or on TV were written especially for you?";
  Quiz[126].Text = "Do you feel as if some people are not what they seem to be?";
  Quiz[127].Text = "Do you feel as if you are being persecuted in some way?";
  Quiz[128].Text = "Do you feel that you experience few or no emotions at important events?";
  Quiz[129].Text = "Do you feel pessimistic about everything?";
  Quiz[130].Text = "Do you feel as if there is a conspiracy against you?";
  Quiz[131].Text = "Do you feel as if you are destined to be someone very important?";
  Quiz[132].Text = "Do you feel as if there is no future for you?";
  Quiz[133].Text = "Do you feel that you are a very special or unusual person?";
  Quiz[134].Text = "Do you feel as if you do not want to live anymore?";
  Quiz[135].Text = "Do you think that people can communicate telepathically?";
  Quiz[136].Text = "Do you feel that you have no interest to be with other people?";
  Quiz[137].Text = "Do you feel as if electrical devices such as computers can influence the way you think?";
  Quiz[138].Text = "Do you feel that you are lacking in motivation to do things?";
  Quiz[139].Text = "Do you cry about nothing?";
  Quiz[140].Text = "Do you believe in the power of witchcraft, voodoo or the occult?";
  Quiz[141].Text = "Do you feel that you are lacking in energy?";
  Quiz[142].Text = "Do you feel that people look at you oddly because of your appearance?";
  Quiz[143].Text = "Do you feel that your mind is empty?";
  Quiz[144].Text = "Do you feel as if the thoughts in your head are being taken away from you?";
  Quiz[145].Text = "Do you feel that you are spending all your days doing nothing?";
  Quiz[146].Text = "Do you feel as if the thoughts in your head are not your own?";
  Quiz[147].Text = "Do you feel that your feelings are lacking in intensity?";
  Quiz[148].Text = "Have your thoughts been so vivid that you were worried other people would hear them?";
  Quiz[149].Text = "Do you feel that you are lacking in spontaneity?";
  Quiz[150].Text = "Do you hear your own thoughts being echoed back to you?";
  Quiz[151].Text = "Do you feel as if you are under the control of some force or power other than yourself?";
  Quiz[152].Text = "Do you feel that your emotions are blunted?";
  Quiz[153].Text = "Do you hear voices when you are alone?";
  Quiz[154].Text = "Do you hear voices talking to each other when you are alone?";
  Quiz[155].Text = "Do you feel that you are neglecting your appearance or personal hygiene?";
  Quiz[156].Text = "Do you feel that you can never get things done?";
  Quiz[157].Text = "Do you feel that you have only few hobbies or interests?";
  Quiz[158].Text = "Do you feel guilty?";
  Quiz[159].Text = "Do you feel like a failure?";
  Quiz[160].Text = "Do you feel tense?";
  Quiz[161].Text = "Do you feel as if a double has taken the place of a family member, friend or acquaintance?";
  Quiz[162].Text = "Do you see objects, people or animals that other people cannot see? ";
}

/*##########################################################################
#
#   Name       : TQuizL15::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL15::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL15::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
