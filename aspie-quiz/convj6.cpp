...
#
# convj6.cpp
# Convert exported quiz-j6 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    for (fieldno = 0; ptr; fieldno++)
    {
        ...
        switch (fieldno)
        {
            ...
            case 15:
                 Row.Court = atoi(valstr);
                 Row.Quiz[125] = Row.Court;
                 break;
...
void ConvJ6()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-j6.csv");
    TFile outfile("bin\\quizj6.bin", 0);
    char *ptr;
