...
#
# convl31.cpp
# Convert exported quiz-l31 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 228);
}

/*################## ConvL31 ##########################
*   Purpose....: Convert quiz l31                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL31()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l31.csv");
    TFile outfile("bin\\quizl31.bin", 0);
    char *ptr;
