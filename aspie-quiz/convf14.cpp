...
const char InsertString[] = "INSERT INTO aspie-quiz-f14 VALUES(";

TFile quizfile("quizf14.bin", 0);
TFile ancfile("ancf14.bin", 0);
...
char *ProcessRow(char *str)
{
	...
	for (fieldno = 0; fieldno < 193; fieldno++)
	{
		valstr = str;
