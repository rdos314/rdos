...
#
# convf14.cpp
# Convert exported quiz-f14 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 176);
}

/*################## ConvF14 ##########################
*   Purpose....: Convert quiz f14                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvF14()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-f14.csv");
    TFile outfile("bin\\quizf14.bin", 0);
    char *ptr;
