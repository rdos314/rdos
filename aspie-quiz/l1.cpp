...
int main(int argc, char **argv)
{
    ...
    printf("read data\r\n");
    Quiz[0] = new TQuizL1("bin\\quizl1.bin");
    ...
    Quiz[0]->WriteSumaryTable("res\\quizl1.htm", FALSE);

    printf("rel\r\n");

    Quiz[0]->WriteIntercorr("res\\rell1.htm");
    ...
    printf("groupcorr\r\n");
    Quiz[0]->WriteGroupCorrTable("res\\groupl1.htm");
