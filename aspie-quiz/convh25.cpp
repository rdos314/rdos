...
#
# convh25.cpp
# Convert exported quiz-h25 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 199);
}

/*################## ConvH25 ##########################
*   Purpose....: Convert quiz h25                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvH25()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h25.csv");
    TFile outfile("bin\\quizh25.bin", 0);
    char *ptr;
