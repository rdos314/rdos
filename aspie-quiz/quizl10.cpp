...
/*##########################################################################
#
#   Name       : TQuizL10::TQuizL10
#
#   Purpose....: Constructor for TQuizL10
#
...
#
##########################################################################*/
TQuizL10::TQuizL10(const char *FileName)
  : TQuiz(123),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL10::~TQuizL10
#
#   Purpose....: Destructor for TQuizL10
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL10::GetPcaCount()
{
        return 4;
}

/*##################  TQuizL10::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL10::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL10::WriteName(TFile &File)
{
    File.Write("L10");
}
...
#
##########################################################################*/
void TQuizL10::WriteLongName(TFile &File)
{
    File.Write("L10");
}
...
void TQuizL10::SetupTexts()
{
  ...
  Quiz[121].Text = "If somebody showed romantic interest for you, would you tell everybody that you thought would be interested to know about it?";
  Quiz[122].Text = "Do you prefer to learn the character of a potential romantic partner through observation rather than conversation?";

}

/*##########################################################################
#
#   Name       : TQuizL10::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL10::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL10::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
