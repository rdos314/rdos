...
/*##########################################################################
#
#   Name       : TQuizL35::TQuizL35
#
#   Purpose....: Constructor for TQuizL35
#
...
#
##########################################################################*/
TQuizL35::TQuizL35(const char *FileName)
  : TQuiz(161),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL35::~TQuizL35
#
#   Purpose....: Destructor for TQuizL35
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL35::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL35::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL35::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL35::WriteName(TFile &File)
{
    File.Write("L35");
}
...
#
##########################################################################*/
void TQuizL35::WriteLongName(TFile &File)
{
    File.Write("L35");
}
...
// paranormal
  ...
  Quiz[121].Text = "Do you believe in ghosts, astrology or UFOs?";
  Quiz[122].Text = "Do you think you really know what some people mean when they talk about mystical experiences?";
  Quiz[123].Text = "Can you at times somehow feel the presence of someone who is not physically there?";
  Quiz[124].Text = "As a child, did you believe in the existence of dwarfs, elves and other fairy tale figures?";
  Quiz[125].Text = "Have you felt that you are communicating with another person telepathically (by mind-to-mind communication)?";
  Quiz[126].Text = "Do you experience thinking of someone and soon afterwards that particular person calls or shows up?";
  Quiz[127].Text = "Do you get a feeling that you can predict things that are bound to happen in the future?";
  Quiz[128].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[129].Text = "Have you noticed a common event or object that seemed to be a special sign for you?";
  Quiz[130].Text = "Can other people feel your feelings when they are not there?";
  Quiz[131].Text = "Can the feelings of somebody that is not nearby or in sight still affect you?";

// AEs

  Quiz[132].Text = "Do things around you seem to change their size and shape?";
  Quiz[133].Text = "Do your body sometimes seem to change its size and shape?";
  Quiz[134].Text = "Have you had the experience of not knowing whether you were imagining something or it was actually happening?";
  Quiz[135].Text = "Have you had the experience of someone calling you or speaking your name and not being sure whether it was really happening or you were imagining it?";
  Quiz[136].Text = "Have you seen things invisible to other people?";
  Quiz[137].Text = "Do textures - such as wool, sand, wood - remind you of colors or music?";
  Quiz[138].Text = "When you sing or write someting, do you sometimes have the feeling that someone or something outside yourself directs you?";
  Quiz[139].Text = "Do you feel that you have had an out of body experience?";
  Quiz[140].Text = "Have you experienced anomalous healing?";
  Quiz[141].Text = "As a child, did you have a feeling you were somebody else (e.g., a princess, an orphan, etc.)?";
  Quiz[142].Text = "If you think about something cold, do you actually get cold?";
  Quiz[143].Text = "Can you feel as if your mind could envelop the whole world?";
  Quiz[144].Text = "Do you have 'physical memories'; for example, after you've been swimming may feel as if you are still in the water?";
  Quiz[145].Text = "When you imagine you have eaten rotten food, do you really get nauseous?";

// fantasy

  Quiz[146].Text = "Do you start fantasizing when things get boring?";
  Quiz[147].Text = "Can thoughts and images come to you without any effort on your part?";
  Quiz[148].Text = "Do you spend more than half the day (daytime) fantasizing or daydreaming?";
  Quiz[149].Text = "Do your thoughts often occur as visual images rather than as words?";
  Quiz[150].Text = "If you stare at a picture and then look away from it, can you sometimes 'see' an image of the picture, almost as if you were still looking at it?";
  Quiz[151].Text = "Can you recall certain past experiences so clearly and vividly that it is like living them again?";
  Quiz[152].Text = "Are your thoughts sometimes so strong that you can almost hear them?";
  Quiz[153].Text = "Can music remind you of pictures or changing patterns of color?";
  Quiz[154].Text = "Do you have lucid dreams (knowing you are dreaming while dreaming)?";

// abuse

  Quiz[155].Text = "Do you have regular depressions?";
  Quiz[156].Text = "Do you have panic attacks?";
  Quiz[157].Text = "Have you been sexually abused?";
  Quiz[158].Text = "Have you been talked into having sex even if you really didn't want to?";
  Quiz[159].Text = "Were you abused by parents as a child?";
  Quiz[160].Text = "Were you bullied in school?";

}

/*##########################################################################
#
#   Name       : TQuizL35::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL35::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL35::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
