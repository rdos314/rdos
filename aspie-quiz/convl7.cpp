...
#
# convl7.cpp
# Convert exported quiz-l7 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("L7: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
    printf("\r\n");
}
...
void ConvL7()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l7.csv");
    TFile outfile("bin\\quizl7.bin", 0);
    char *ptr;
