...
/*##########################################################################
#
#   Name       : TQuizL28::TQuizL28
#
#   Purpose....: Constructor for TQuizL28
#
...
#
##########################################################################*/
TQuizL28::TQuizL28(const char *FileName)
  : TQuiz(194),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL28::~TQuizL28
#
#   Purpose....: Destructor for TQuizL28
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL28::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL28::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL28::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL28::WriteName(TFile &File)
{
    File.Write("L28");
}
...
#
##########################################################################*/
void TQuizL28::WriteLongName(TFile &File)
{
    File.Write("L28");
}
...
void TQuizL28::SetupTexts()
{
  ...
  Quiz[121].Text = "Do you feel and experience things as you did when you were a child?`";
  Quiz[122].Text = "Do you get greatly moved by eloquent or poetic language?";
  Quiz[123].Text = "While watching a movie, a TV show, or a play, may you become so involved that you forget about yourself and your surroundings, and experience the story as if it were real?";
  Quiz[124].Text = "If you stare at a picture and then look away from it, can you sometimes 'see' an image of the picture, almost as if you were still looking at it?";
  Quiz[125].Text = "Can you feel as if your mind could envelop the whole world?";
  Quiz[126].Text = "Do you like to watch cloud shapes change in the sky?";
  Quiz[127].Text = "If you wish can you imagine things so vividly that it's like watching a good movie or hearing a good story?";
  Quiz[128].Text = "Do you think you really know what some people mean when they talk about mystical experiences?";
  Quiz[129].Text = "Do you 'step outside' of your usual self and experience a completely different state of being?";
  Quiz[130].Text = "Do textures - such as wool, sand, wood - remind you of colors or music?";
  Quiz[131].Text = "Can you experience things as if they were doubly real?";
  Quiz[132].Text = "When you listen to music can you get so caught up in it that you don't notice anything else?";
  Quiz[133].Text = "If you wish, can you imagine that your body is so heavy that you cannot move it?";
  Quiz[134].Text = "Can you somehow sense the presence of another person before you actually see or hear him/her?";
  Quiz[135].Text = "Do the crackle and flames of a wood fire stimulate your imagination?";
  Quiz[136].Text = "When you are immersed in nature or in art can you feel as if your whole state of consciousness has somehow been temporarily changed?";
  Quiz[137].Text = "Do different colors have distinctive and special meanings for you?";
  Quiz[138].Text = "Can you wander off into your thoughts so completely while doing a routine task that you actually forget what you are doing and a few minutes later find that you have finished it?";
  Quiz[139].Text = "Can you recall certain past experiences so clearly and vividly that it is like living them again?";
  Quiz[140].Text = "Can things that might seem meaningless to others often make sense to you?";
  Quiz[141].Text = "If you acted in a play do you think that you would really feel the emotions of the character, and 'become' that person for the time being, forgetting both yourself and the audience?";
  Quiz[142].Text = "Do your thoughts often occur as visual images rather than as words?";
  Quiz[143].Text = "Are you often delighted by small things (like the colors in soap bubbles and the five pointed star shape that appears when you cut an apple across the core)?";
  Quiz[144].Text = "When listening to organ music or other powerful music, do you feel as if you are being lifted into the air?";
  Quiz[145].Text = "Can you change noise into music by the way you listen to it?";
  Quiz[146].Text = "Are your most vivid memories called up by scents and smells?";
  Quiz[147].Text = "Can music remind you of pictures or changing patterns of color?";
  Quiz[148].Text = "Do you often know what someone is going to say before he or she says it?";
  Quiz[149].Text = "Do you have 'physical memories'; for example, after you've been swimming may feel as if you are still in the water?";
  Quiz[150].Text = "Can the sound of a voice be so fascinating to you that you can just go on listening to it?";
  Quiz[151].Text = "Can you at times somehow feel the presence of someone who is not physically there?";
  Quiz[152].Text = "Can thoughts and images come to you without any effort on your part?";
  Quiz[153].Text = "Do different smells have different colors?";
  Quiz[154].Text = "Can you be deeply moved by a sunset?";
  Quiz[155].Text = "In your daydreams, can people kind of merge into one another or one person turns into another?";
  Quiz[156].Text = "Can you wake from one dream into another?";
  Quiz[157].Text = "Do you have daymares?";
  Quiz[158].Text = "In your dreams, can people sometimes merge into each other or become other people?";

  Quiz[159].Text = "As a child, did you think that dolls, teddy bears and stuffed animals that you played with were living creatures?";
  Quiz[160].Text = "As a child, did you believe in the existence of dwarfs, elves and other fairt tale figures?";
  Quiz[161].Text = "As a child, did you have your own make believe friend or animal?";
  Quiz[162].Text = "As a child, could you easily identify with the main character of a story and/or movie?";
  Quiz[163].Text = "As a child, did you have a feeling you were somebody else (e.g., a princess, an orphan, etc.)?";
  Quiz[164].Text = "As a child, were you encouraged by adults (parents, grandparents, brothers, sisters) to fully indulge yourself in your fantasies and daydreams?";
  Quiz[165].Text = "Did you feel lonely as a child?";
  Quiz[166].Text = "As a child, did you devote your time to playing a musical instrument, dancing, acting, and/or drawing?";
  Quiz[167].Text = "Do you spend more than half the day (daytime) fantasizing or daydreaming?";
  Quiz[168].Text = "Do your friends and/or relatives not know that you have such detailed fantasies?";
  Quiz[169].Text = "Do your fantasies have a realistic intensity?";
  Quiz[170].Text = "Are your fantasies just as lively as a good movie?";
  Quiz[171].Text = "Do you confuse fantasies with real memories?";
  Quiz[172].Text = "Do you start fantasizing when things get boring?";
  Quiz[173].Text = "Do you act as if you are somebody else and completely identify yourself with that role?";
  Quiz[174].Text = "Do you have vivid and lively memories of your childhood?";
  Quiz[175].Text = "Do you recall occurrences before the age of three?";
  Quiz[176].Text = "When you percieve violence on television, do you get so into it that you get upset?";
  Quiz[177].Text = "If you think about something cold, do you actually get cold?";
  Quiz[178].Text = "When you imagine you have eaten rotten food, do you really get nauseous?";
  Quiz[179].Text = "Do you get a feeling that you can predict things that are bound to happen in the future?";
  Quiz[180].Text = "Do you experience thinking of someone and soon afterwards that particulat person calls or shows up?";
  Quiz[181].Text = "Do you feel that you have had an out of body experience?";
  Quiz[182].Text = "When you sing or write someting, do you sometimes have the feeling that someone or something outside yourself directs you?";
  Quiz[183].Text = "During your life, have you had intense religious experiences which influenced you in a very strong manner?";

  Quiz[184].Text = "Are you easily hurt?";
  Quiz[185].Text = "Are you a very sensitive person?";
  Quiz[186].Text = "Do you have regular depressions?";
  Quiz[187].Text = "Do you have panic attacks?";
  Quiz[188].Text = "Have you been sexually abused?";
  Quiz[189].Text = "Have you been talked into having sex even if you really didn't want to?";
  Quiz[190].Text = "Were you abused by parents as a child?";
  Quiz[191].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[192].Text = "Do you feel as if the thoughts in your head are not your own?";
  Quiz[193].Text = "Have you had paranormal experiences?";
}

/*##########################################################################
#
#   Name       : TQuizL28::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL28::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL28::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
