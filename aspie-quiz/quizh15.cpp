...
/*##########################################################################
#
#   Name       : TQuizH15::TQuizH15
#
#   Purpose....: Constructor for TQuizH15
#
...
#
##########################################################################*/
TQuizH15::TQuizH15(const char *FileName)
  : TQuiz(178),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH15::~TQuizH15
#
#   Purpose....: Destructor for TQuizH15
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH15::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH15::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH15::GetCatCount(int Question)
{
        return 3;
}
...
#
##########################################################################*/
void TQuizH15::WriteName(TFile &File)
{
         File.Write("H15");
}
...
#
##########################################################################*/
void TQuizH15::WriteLongName(TFile &File)
{
         File.Write("H15");
}
...
void TQuizH15::SetupTexts()
{
  ...
  Quiz[150].Text = "in love over indifferent<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/1.jpg\">";
  Quiz[151].Text = "sad over staring<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/2.jpg\">";
  Quiz[152].Text = "staring over playful<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/3.jpg\">";
  Quiz[153].Text = "unsure over upset<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/4.jpg\">";
  Quiz[154].Text = "determined over rude<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/5.jpg\">";
  Quiz[155].Text = "remembering over scared<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/6.jpg\">";
  Quiz[156].Text = "interested over staring<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/7.jpg\">";
  Quiz[157].Text = "remembering over ill<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/8.jpg\">";
  Quiz[158].Text = "indifferent over bored<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/9.jpg\">";
  Quiz[159].Text = "skeptical over evil<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/10.jpg\">";
  Quiz[160].Text = "indifferent over hopeful<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/11.jpg\">";
  Quiz[161].Text = "staring over serious<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/12.jpg\">";
  Quiz[162].Text = "bored over daydreaming<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/13.jpg\">";
  Quiz[163].Text = "staring over relaxed<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/14.jpg\">";
  Quiz[164].Text = "staring over kind<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/15.jpg\">";
  Quiz[165].Text = "sexual over evil<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/16.jpg\">";
  Quiz[166].Text = "innocent over staring<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/17.jpg\">";
  Quiz[167].Text = "staring over nervous<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/18.jpg\">";
  Quiz[168].Text = "staring over friendly<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/19.jpg\">";
  Quiz[169].Text = "evil over suspicous<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/20.jpg\">";
  Quiz[170].Text = "interested over staring<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/21.jpg\">";
  Quiz[171].Text = "dreamy over fake<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/22.jpg\">";
  Quiz[172].Text = "staring over sexual<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/23.jpg\">";
  Quiz[173].Text = "evil over serious<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/24.jpg\">";
  Quiz[174].Text = "serious over staring<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/25.jpg\">";
  Quiz[175].Text = "playful over plotting<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/26.jpg\">";
  Quiz[176].Text = "hate over joking<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/27.jpg\">";
  Quiz[177].Text = "staring over happy<br><img width=530 height=215 src=\"http://www.rdos.net/mind-eyes/28.jpg\">";

}

/*##########################################################################
#
#   Name       : TQuizH15::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH15::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH15::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
