...
/*##########################################################################
#
#   Name       : TQuizL21::TQuizL21
#
#   Purpose....: Constructor for TQuizL21
#
...
#   Name       : TQuizL21::~TQuizL21
#
#   Purpose....: Destructor for TQuizL21
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL21::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL21::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL21::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL21::WriteName(TFile &File)
{
    File.Write("L21");
}
...
#
##########################################################################*/
void TQuizL21::WriteLongName(TFile &File)
{
    File.Write("L21");
}
...
void TQuizL21::SetupTexts()
{
  ...
  Quiz[121].Text = "Have you sensed that somebody was around you even when you couldn't see him/her?";
  Quiz[122].Text = "Is it harder for you than for others to get over a failed relationship?";
  Quiz[123].Text = "Do you believe in love at first sight?";
  Quiz[124].Text = "Do you flap your hands (e.g. when excited or upset)?";
  Quiz[125].Text = "Do you enjoy hanging upside down?";
  Quiz[126].Text = "Do you enjoy walking on your toes?";
...
#
##########################################################################*/
void TQuizL21::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL21::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
