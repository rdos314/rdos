...
/*##########################################################################
#
#   Name       : TQuizL1::TQuizL1
#
#   Purpose....: Constructor for TQuizL1
#
...
#
##########################################################################*/
TQuizL1::TQuizL1(const char *FileName)
  : TQuiz(132),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL1::~TQuizL1
#
#   Purpose....: Destructor for TQuizL1
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL1::GetCatCount(int Question)
{
    if (Question < 122)
       return 3;
    else
...
#
##########################################################################*/
void TQuizL1::WriteName(TFile &File)
{
    File.Write("L1");
}
...
#
##########################################################################*/
void TQuizL1::WriteLongName(TFile &File)
{
    File.Write("L1");
}
...
void TQuizL1::SetupTexts()
{
  ...
  Quiz[121].Text = "Have you been a target of catcalling?";
...
#
##########################################################################*/
void TQuizL1::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL1::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
