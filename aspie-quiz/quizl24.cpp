...
/*##########################################################################
#
#   Name       : TQuizL24::TQuizL24
#
#   Purpose....: Constructor for TQuizL24
#
...
#   Name       : TQuizL24::~TQuizL24
#
#   Purpose....: Destructor for TQuizL24
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL24::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL24::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL24::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL24::WriteName(TFile &File)
{
    File.Write("L24");
}
...
#
##########################################################################*/
void TQuizL24::WriteLongName(TFile &File)
{
    File.Write("L24");
}
...
void TQuizL24::SetupTexts()
{
  ...
  Quiz[121].Text = "Were you bullied in school?";
  Quiz[122].Text = "Do you feel nervous, anxious or on edge?";
  Quiz[123].Text = "Are you unable to stop or control worrying?";
  Quiz[124].Text = "Do you worry too much about several things?";
  Quiz[125].Text = "Do you have trouble to relax?";
  Quiz[126].Text = "Are you so restless that it is hard to sit still?";
  Quiz[127].Text = "Do you easily become annoyed or irritable?";
  Quiz[128].Text = "Do you feel afraid as if something awful might happen?";
  Quiz[129].Text = "Do you have regular depressions?";
...
#
##########################################################################*/
void TQuizL24::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL24::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
