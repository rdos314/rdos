...
#
# convh11.cpp
# Convert exported quiz-h11 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvH11()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h11.csv");
    TFile outfile("bin\\quizh11.bin", 0);
    char *ptr;
