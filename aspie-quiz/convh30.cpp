...
#
# convh30.cpp
# Convert exported quiz-h30 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvH30()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h30.csv");
    TFile outfile("bin\\quizh30.bin", 0);
    char *ptr;
