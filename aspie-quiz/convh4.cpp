...
#
# convh4.cpp
# Convert exported quiz-h4 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 191);
}

/*################## ConvH4 ##########################
*   Purpose....: Convert quiz h4                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvH4()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h4.csv");
    TFile outfile("bin\\quizh4.bin", 0);
    char *ptr;
