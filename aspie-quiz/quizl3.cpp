...
/*##########################################################################
#
#   Name       : TQuizL3::TQuizL3
#
#   Purpose....: Constructor for TQuizL3
#
...
#
##########################################################################*/
TQuizL3::TQuizL3(const char *FileName)
  : TQuiz(132),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL3::~TQuizL3
#
#   Purpose....: Destructor for TQuizL3
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL3::GetCatCount(int Question)
{
    if (Question < 122)
       return 3;
    else
...
#
##########################################################################*/
void TQuizL3::WriteName(TFile &File)
{
    File.Write("L3");
}
...
#
##########################################################################*/
void TQuizL3::WriteLongName(TFile &File)
{
    File.Write("L3");
}
...
void TQuizL3::SetupTexts()
{
  ...
  Quiz[85].MyGroup = GROUP_NT_RELATION;
  ...
  Quiz[85].Text = "Do you enjoy traditional dating?";
  Quiz[86].Text = "Do you find yourself at ease in romantic situations?";
  Quiz[87].Text = "Are you asexual?";
  Quiz[88].Text = "Do you like tongue-kissing?";
  Quiz[89].Text = "Do you enjoy travel?";
  Quiz[90].Text = "Do you take pride in your appearance?";
  Quiz[91].Text = "Do you see your own activities as more important than other people's?";
  Quiz[92].Text = "Would you  Quickly become impatient and irritated if you would not find a solution to a problem?";
  Quiz[93].Text = "Do you usually find faults with opinions that you don't share?";
  Quiz[94].Text = "Do you expect other people to know your thoughts, experiences and opinions without you having to tell them?";
  Quiz[95].Text = "Do you feel as if you are being persecuted in some way?";
  Quiz[96].Text = "Do you have difficulty accepting criticism, correction, and direction?";
  Quiz[97].Text = "Will you abandon your friends if your activities or ideals clash?";
  Quiz[98].Text = "Do you obstruct others' plans?";
  Quiz[99].Text = "Do you feel irritated when one person disagrees with what everyone else in a group believes?";
  Quiz[100].Text = "Do you prefer to keep to yourself?";
  Quiz[101].Text = "Do you find it hard to be emotionally close to other people?";
  Quiz[102].Text = "Do you have a tendency to become stuck when asked  Questions in social situation?";
  Quiz[103].Text = "Has it been harder for you than for others to keep friends?";
  Quiz[104].Text = "Are you good at team-work?";
  Quiz[105].Text = "Do you prefer to only meet people you know, one-on-one, or in small, familiar groups?";
  Quiz[106].Text = "Do you enjoy big events even if they are crowded?";
  Quiz[107].Text = "In conversations, do you need extra time to carefully think out your reply, so that there may be a pause before you answer?";
  Quiz[108].Text = "Do you stay away from situations where people might express affection for you?";
  Quiz[109].Text = "Do you prefer to do things on your own even if you could use others' help or expertise?";
  Quiz[110].Text = "Do you find it easy to describe your feelings?";
  Quiz[111].Text = "Do you dislike it when people drop by to visit you uninvited?";
  Quiz[112].Text = "Is it hard for you to approach somebody you are attracted to?";
  Quiz[113].Text = "Do you find it natural to wave or say 'hi' when you meet people?";
  Quiz[114].Text = "Are you shy?";
  Quiz[115].Text = "Do you prefer to hug only a romantic partner?";
  Quiz[116].Text = "Is your sense of humor fairly conventional?";
  Quiz[117].Text = "Can you easily remember verbal instructions?";
  Quiz[118].Text = "Do you accept criticism, correction and direction?";
  Quiz[119].Text = "Do you find it easy to estimate the age of people?";
  Quiz[120].Text = "Do you tend to get romantic feelings for people that persistently shows interest for you?";
  Quiz[121].Text = "Have you been the target of loud yells, whistling or vulgar comments of a sexual nature (catcalling)?";
  Quiz[122].Text = "Catcalling, her age";
  Quiz[123].Text = "Catcalling, their age";
  Quiz[124].Text = "Catcalling, guys";
  Quiz[125].Text = "Catcalling, girls";
  Quiz[126].Text = "Catcalling, guys with girl";
  Quiz[127].Text = "Catcalling, they approached";
  Quiz[128].Text = "Catcalling, you approached";
  Quiz[129].Text = "Catcalling, scared";
  Quiz[130].Text = "Catcalling, disgusted";
  Quiz[131].Text = "Catcalling, traumatized";
}

/*##########################################################################
#
#   Name       : TQuizL3::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL3::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL3::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
