...
//                                DsmAdd.Add(Row.ADHD, id, score);
                ...
                if (Row.IqResult <= 10)
                        LowIQ.Add(Row.AsResult, Row.NtResult, DxArr, Row.Gender, Row.Quiz, Row.GroupResult, Row.DxResult);

                if (Row.IQ >= 120)
                        HighIQ.Add(Row.AsResult, Row.NtResult, DxArr, Row.Gender, Row.Quiz, Row.GroupResult, Row.DxResult);
