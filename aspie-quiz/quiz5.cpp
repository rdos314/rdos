...
void TQuiz5::SetupTexts()
{
	...
	Quiz[18].MyGroup = GROUP_NT_HUNTING;
	...
	Quiz[67].MyGroup = GROUP_NT_HUNTING;
	...
	Quiz[85].MyGroup = GROUP_DYSC;
	Quiz[86].MyGroup = GROUP_DYSC;
	Quiz[87].MyGroup = GROUP_DYSC;
	Quiz[88].MyGroup = GROUP_NT_TALENT;
	Quiz[89].MyGroup = GROUP_NT_TALENT;
	Quiz[90].MyGroup = GROUP_DYSC;
	Quiz[91].MyGroup = GROUP_NT_TALENT;
	Quiz[92].MyGroup = GROUP_DYSC;
	Quiz[93].MyGroup = GROUP_DYSC;
	Quiz[94].MyGroup = GROUP_DYSC;
	Quiz[95].MyGroup = GROUP_DYSC;
	Quiz[96].MyGroup = GROUP_NT_TALENT;
	Quiz[97].MyGroup = GROUP_DYSC;
