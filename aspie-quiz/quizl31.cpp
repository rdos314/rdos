...
/*##########################################################################
#
#   Name       : TQuizL31::TQuizL31
#
#   Purpose....: Constructor for TQuizL31
#
...
#
##########################################################################*/
TQuizL31::TQuizL31(const char *FileName)
  : TQuiz(228),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL31::~TQuizL31
#
#   Purpose....: Destructor for TQuizL31
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL31::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL31::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL31::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL31::WriteName(TFile &File)
{
    File.Write("L31");
}
...
#
##########################################################################*/
void TQuizL31::WriteLongName(TFile &File)
{
    File.Write("L31");
}
...
void TQuizL31::SetupTexts()
{
  ...
  Quiz[195].Text = "As a child, did you think that dolls, teddy bears and stuffed animals that you played with were living creatures?";
  Quiz[196].Text = "As a child, did you believe in the existence of dwarfs, elves and other fairt tale figures?";
  Quiz[197].Text = "As a child, did you have your own make believe friend or animal?";
  Quiz[198].Text = "As a child, could you easily identify with the main character of a story and/or movie?";
  Quiz[199].Text = "As a child, did you have a feeling you were somebody else (e.g., a princess, an orphan, etc.)?";
  Quiz[200].Text = "As a child, were you encouraged by adults (parents, grandparents, brothers, sisters) to fully indulge yourself in your fantasies and daydreams?";
  Quiz[201].Text = "Did you feel lonely as a child?";
  Quiz[202].Text = "As a child, did you devote your time to playing a musical instrument, dancing, acting, and/or drawing?";
  Quiz[203].Text = "Do you spend more than half the day (daytime) fantasizing or daydreaming?";
  Quiz[204].Text = "Do your friends and/or relatives not know that you have such detailed fantasies?";
  Quiz[205].Text = "Do your fantasies have a realistic intensity?";
  Quiz[206].Text = "Are your fantasies just as lively as a good movie?";
  Quiz[207].Text = "Do you confuse fantasies with real memories?";
  Quiz[208].Text = "Do you start fantasizing when things get boring?";
  Quiz[209].Text = "Do you act as if you are somebody else and completely identify yourself with that role?";
  Quiz[210].Text = "Do you have vivid and lively memories of your childhood?";
  Quiz[211].Text = "Do you recall occurrences before the age of three?";
  Quiz[212].Text = "When you percieve violence on television, do you get so into it that you get upset?";
  Quiz[213].Text = "If you think about something cold, do you actually get cold?";
  Quiz[214].Text = "When you imagine you have eaten rotten food, do you really get nauseous?";
  Quiz[215].Text = "Do you get a feeling that you can predict things that are bound to happen in the future?";
  Quiz[216].Text = "Do you experience thinking of someone and soon afterwards that particulat person calls or shows up?";
  Quiz[217].Text = "Do you feel that you have had an out of body experience?";
  Quiz[218].Text = "When you sing or write someting, do you sometimes have the feeling that someone or something outside yourself directs you?";
  Quiz[219].Text = "During your life, have you had intense religious experiences which influenced you in a very strong manner?";

  Quiz[220].Text = "Do you have regular depressions?";
  Quiz[221].Text = "Do you have panic attacks?";
  Quiz[222].Text = "Have you been sexually abused?";
  Quiz[223].Text = "Have you been talked into having sex even if you really didn't want to?";
  Quiz[224].Text = "Were you abused by parents as a child?";
  Quiz[225].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[226].Text = "Do you feel as if the thoughts in your head are not your own?";
  Quiz[227].Text = "Have you had paranormal experiences?";

}

/*##########################################################################
#
#   Name       : TQuizL31::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL31::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL31::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
