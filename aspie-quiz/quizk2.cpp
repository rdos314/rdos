...
/*##########################################################################
#
#   Name       : TQuizK2::TQuizK2
#
#   Purpose....: Constructor for TQuizK2
#
...
#   Name       : TQuizK2::~TQuizK2
#
#   Purpose....: Destructor for TQuizK2
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizK2::GetCatCount(int Question)
{
    if (Question < 126)
       return 3;
    else
...
#
##########################################################################*/
void TQuizK2::WriteName(TFile &File)
{
    File.Write("K2");
}
...
#
##########################################################################*/
void TQuizK2::WriteLongName(TFile &File)
{
    File.Write("K2");
}
...
void TQuizK2::SetupTexts()
{
  ...
  Quiz[125].Text = "Have you seen a flasher?";

  Quiz[126].Text = "Place";
  Quiz[127].Text = "My age";
  Quiz[128].Text = "His age";
  Quiz[129].Text = "Girls";
  Quiz[130].Text = "Guys";
  Quiz[131].Text = "Time";
  Quiz[132].Text = "He talked";
  Quiz[133].Text = "You talked";
  Quiz[134].Text = "He approached";
  Quiz[135].Text = "You approached";
  Quiz[136].Text = "Notified";
  Quiz[137].Text = "Reported";
...
#
##########################################################################*/
void TQuizK2::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizK2::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
