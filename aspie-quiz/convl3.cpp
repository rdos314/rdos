...
#
# convl3.cpp
# Convert exported quiz-l3 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("L3: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
    printf("\r\n");
}
...
void ConvL3()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l3.csv");
    TFile outfile("bin\\quizl3.bin", 0);
    char *ptr;
