...
/*##########################################################################
#
#   Name       : TQuizL11::TQuizL11
#
#   Purpose....: Constructor for TQuizL11
#
...
#
##########################################################################*/
TQuizL11::TQuizL11(const char *FileName)
  : TQuiz(124),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL11::~TQuizL11
#
#   Purpose....: Destructor for TQuizL11
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL11::GetPcaCount()
{
        return 4;
}

/*##################  TQuizL11::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL11::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL11::WriteName(TFile &File)
{
    File.Write("L11");
}
...
#
##########################################################################*/
void TQuizL11::WriteLongName(TFile &File)
{
    File.Write("L11");
}
...
void TQuizL11::SetupTexts()
{
  ...
  Quiz[122].Text = "If somebody showed romantic interest for you, would you discuss it with your best friends?";
  Quiz[123].Text = "Would you discuss relationship issues with your best friends?";

}

/*##########################################################################
#
#   Name       : TQuizL11::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL11::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL11::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
