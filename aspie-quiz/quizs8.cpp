...
#
##########################################################################*/
void TQuizS8::WriteLongName(TFile &File)
{
	 File.Write("stable version 8");
}

/*##########################################################################
#
#   Name       : TQuizS8::DefineQuiz
#
#   Purpose....: Define quiz
#
#   In params..: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizS8::WriteRetest(const char *filename)
{
	TQuizRow Row;
	int userid;
	int i;
