...
#
# convh27.cpp
# Convert exported quiz-h27 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvH27()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h27.csv");
    TFile outfile("bin\\quizh27.bin", 0);
    char *ptr;
