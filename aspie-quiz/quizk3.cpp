...
/*##########################################################################
#
#   Name       : TQuizK3::TQuizK3
#
#   Purpose....: Constructor for TQuizK3
#
...
#
##########################################################################*/
TQuizK3::TQuizK3(const char *FileName)
  : TQuiz(133),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizK3::~TQuizK3
#
#   Purpose....: Destructor for TQuizK3
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizK3::GetCatCount(int Question)
{
    if (Question < 125)
       return 3;
...
#
##########################################################################*/
void TQuizK3::WriteName(TFile &File)
{
    File.Write("K3");
}
...
#
##########################################################################*/
void TQuizK3::WriteLongName(TFile &File)
{
    File.Write("K3");
}
...
void TQuizK3::SetupTexts()
{
  ...
  Quiz[58].Text = "Do you have, or used to have, imaginary friends?";
...
#
##########################################################################*/
void TQuizK3::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizK3::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
