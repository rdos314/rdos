...
#
# convje7.cpp
# Convert exported quiz-je7 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvJE7()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-je7.csv");
    TFile outfile("bin\\quizje7.bin", 0);
    char *ptr;
