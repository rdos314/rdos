...
void TQuizJE1::SetupTexts()
{
  ...
  Quiz[75].MyGroup = GROUP_NDNT;
  Quiz[76].MyGroup = GROUP_NDNT;
  Quiz[77].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[78].MyGroup = GROUP_NDNT;
  ...
  Quiz[85].MyGroup = GROUP_NDNT;
  Quiz[86].MyGroup = GROUP_NDNT;
  Quiz[87].MyGroup = GROUP_NDNT;
  ...
  Quiz[151].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[156].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[171].MyGroup = GROUP_NT_CONTACT;
  Quiz[172].MyGroup = GROUP_NT_CONTACT;
  Quiz[173].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[174].MyGroup = GROUP_NT_NVC;
  Quiz[175].MyGroup = GROUP_NT_SOCIAL;
  Quiz[176].MyGroup = GROUP_NT_CONTACT;
  Quiz[177].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[189].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[190].MyGroup = GROUP_NDNT;
  Quiz[191].MyGroup = GROUP_NT_CONTACT;
  Quiz[192].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[193].MyGroup = GROUP_NT_CONTACT;
  Quiz[194].MyGroup = GROUP_ASPIE_TALENT;
  Quiz[195].MyGroup = GROUP_ASPIE_TALENT;
  Quiz[196].MyGroup = GROUP_ASPIE_NVC;
  Quiz[197].MyGroup = GROUP_NT_CONTACT;
  Quiz[198].MyGroup = GROUP_ASPIE_NVC;
  ...
  Quiz[203].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[208].MyGroup = GROUP_ASPIE_NVC;
