...
void TQuizJE1::SetupTexts()
{
  ...
  Quiz[70].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[82].MyGroup = GROUP_ASPIE_ATTACH;
  ...
  Quiz[169].MyGroup = GROUP_NT_CONTACT;
  Quiz[170].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[200].MyGroup = GROUP_NT_ATTACH;
