...
void TQuizS9::SetupTexts()
{
  ...
  Quiz[46].MyGroup = GROUP_ENVIRONMENT;
  ...
  Quiz[98].MyGroup = GROUP_NT_OBSESSION;
  ...
  Quiz[228].MyGroup = GROUP_NT_SOCIAL;
  Quiz[229].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[230].MyGroup = GROUP_ENVIRONMENT;
  Quiz[231].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[232].MyGroup = GROUP_ASPIE_SOCIAL;
  ...
  Quiz[240].MyGroup = GROUP_ASPIE_SOCIAL;
