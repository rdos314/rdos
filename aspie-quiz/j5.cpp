...
int main(int argc, char **argv)
{
    ...
    printf("read data\r\n");
    Quiz[0] = new TQuizJ5("bin\\quizj5.bin");
    ...
    Quiz[0]->ImportMvsp("pca-done\\femJ5.txt", PCA_TYPE_FEMALE);
    Quiz[0]->ImportMvspAspie("pca-done\\grpJ5.txt");

    printf("details\r\n");

    Quiz[0]->WriteSumaryTable("res\\quizj5.htm", FALSE);

    printf("rel\r\n");

    Quiz[0]->WriteIntercorr("res\\relj5.htm");
