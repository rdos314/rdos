...
#
# convl5.cpp
# Convert exported quiz-l5 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("L5: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
    printf("\r\n");
}
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 128);
}

/*################## ConvL5 ##########################
*   Purpose....: Convert quiz l5                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL5()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l5.csv");
    TFile outfile("bin\\quizl5.bin", 0);
    char *ptr;
