...
#
# convg4.cpp
# Convert exported quiz-g4 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-g4 VALUES(";

TFile quizfile("quizg4.bin", 0);
TFile ancfile("ancg4.bin", 0);
...
char *ProcessRow(char *str)
{
	...
	for (fieldno = 0; fieldno < 210; fieldno++)
	{
		valstr = str;
