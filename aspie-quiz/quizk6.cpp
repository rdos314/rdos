...
/*##########################################################################
#
#   Name       : TQuizK6::TQuizK6
#
#   Purpose....: Constructor for TQuizK6
#
...
#   Name       : TQuizK6::~TQuizK6
#
#   Purpose....: Destructor for TQuizK6
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
#
##########################################################################*/
void TQuizK6::WriteName(TFile &File)
{
    File.Write("K6");
}
...
#
##########################################################################*/
void TQuizK6::WriteLongName(TFile &File)
{
    File.Write("K6");
}
...
#
##########################################################################*/
void TQuizK6::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizK6::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
