...
void TQuizExp2c::SetupTexts()
{
  ...
  Quiz[25].MyGroup = GROUP_NT_SOCIAL;
  ...
  Quiz[73].MyGroup = GROUP_ASPIE_HUNTING;
  ...
  Quiz[1].Text = "Tycker du själv eller din omgivning att du löser problem på okonventionella sätt?";
  Quiz[2].Text = "Brukade dina lekar mer bestå i att t ex sortera, bygga, undersöka eller ta isär saker än i sociala lekar med andra barn?";
  Quiz[3].Text = "Har du uthållighet i att samla in och katalogisera information kring ett ämne du är intressad av?";
  Quiz[4].Text = "Behöver du perioder av begrundande?";
  Quiz[5].Text = "Ser du mönster i saker hela tiden?";
  Quiz[6].Text = "Har du en speciell talang som du har jobbat på?";
  Quiz[7].Text = "Brukar du lägga märke till detaljer som andra inte lägger märke till?";
  Quiz[8].Text = "Blir du förvirrad av verbala instruktioner - särskilt flera på en gång?";
  Quiz[9].Text = "Har du svårt att sammanfatta och redogöra för t ex konversationer, händelser eller något du läst?";
  Quiz[10].Text = "Har du behov av att göra saker själv för att riktigt minnas dem?";
  Quiz[11].Text = "Om du blir avbruten, kan du snabbt återgå till vad du gjorde innan?";
  Quiz[12].Text = "Är det svårt för dig att lära dig sånt som du inte är intresserad av?";
  Quiz[13].Text = "Har du svårt att göra anteckningar under föreläsningar?";
  Quiz[14].Text = "Blir du lätt distraherad?";
  Quiz[15].Text = "Tycker du att det är lätt att göra mer än en sak åt gången?";
  Quiz[16].Text = "Känns det livsviktigt att få vara ifred när du ägnar dig åt dina specialintressen?";
  Quiz[17].Text = "Innan du gör något eller går någonstans, behöver du ha en inre bild av vad som kommer att hända så du kan förbereda dig?";
  Quiz[18].Text = "Föredrar du att använda samma kläder och/eller äta samma mat varje dag?";
  Quiz[19].Text = "Blir du frustrerad om en för dig viktig aktivitet blir avbruten?";
  Quiz[20].Text = "Blir du frustrerad om du inte får sitta på din favoritplats?";
  Quiz[21].Text = "Är du exceptionellt fäst vid vissa favoritsaker?";
  Quiz[22].Text = "Har du vissa rutiner som du behöver följa?";
  Quiz[23].Text = "Blir du störd eller upprörd när andra kommer antingen för för sent eller för tidigt?";
  Quiz[24].Text = "Behöver du listor och scheman för att få saker gjorda?";
  Quiz[25].Text = "Trivs du med att möta nya människor?";
  Quiz[26].Text = "Är dina åsikter typiska för dina jämnåriga?";
  Quiz[27].Text = "Passar du naturligt in i de förväntade könsrollerna?";
  Quiz[28].Text = "Är du intressad av nuvarande mode?";
  Quiz[29].Text = "Tycker du om skvaller?";
  Quiz[30].Text = "Umgås du helst med personer ur din egen generation?";
  Quiz[31].Text = "Är vänner av samma kön viktigt för dig?";
  Quiz[32].Text = "Tycker du det är lättare att förstå och kommunicera med udda & ovanliga människor än med vanliga människor?";
  Quiz[33].Text = "Är ditt sinne för humor annorlunda än andras eller ansett som udda?";
  Quiz[34].Text = "Tycker du själv eller din omgivning att du har ovanliga matvanor?";
  Quiz[35].Text = "Har du avvikande uppfattning om vad som är attraktivt hos det motsatta könet?";
  Quiz[36].Text = "Är du lite av en dagdrömmare, ofta borta i dina egna tankar?";
  Quiz[37].Text = "Brukar du bli så besatt av en potentiell partner att du inte kan släppa honom/henne?";
  Quiz[38].Text = "Tycker du att dina egna aktiviteter är viktigare än andra människors aktiviteter?" ;
  Quiz[39].Text = "Varierar dina känslor regelbundet mellan hopplöshet och extremt högt självförtroende";
  Quiz[40].Text = "Har du problem att starta och / eller slutföra projekt?";
  Quiz[41].Text = "Har du problem med auktoriteter?";
  Quiz[42].Text = "Har du otypisk eller oregelbunden sömnrytm (d v s som avviker från 24-timmarscykeln)?";
  Quiz[43].Text = "Tycker du att normerna för hygien är för strikta?";
  Quiz[44].Text = "Ligger du ibland vaken på nätterna på grund av alltför många tankar?";
  Quiz[45].Text = "Har du haft en långvarig önskan att hämnas?";
  Quiz[46].Text = "Har du ovanliga sexuella preferenser?";
  Quiz[47].Text = "Läser du instruktioner först när allt annat har misslyckats??";
  Quiz[48].Text = "Låser det sig för dig när du får frågor i sociala situationer?";
  Quiz[49].Text = "Känner du dig ofta ur fas med andra?";
  Quiz[50].Text = "Har du haft svårare än andra att behålla vänner?";
  Quiz[51].Text = "Undviker du att prata ansikte-mot-ansikte med folk du inte känner mycket väl?";
  Quiz[52].Text = "Brukar du bli utmattad av att umgås med folk och behöva vila ut ifred efteråt?";
  Quiz[53].Text = "Tycker folk att du är reserverad och distanserad?";
  ...
  Quiz[56].Text = "Ogillar du att behöva ta i hand med främlingar?";
  Quiz[57].Text = "Föredrar du djur framför människor?";
  Quiz[58].Text = "Känner du dig obekväm bland främmande människor?";
  Quiz[59].Text = "Föredrar du att göra saker på egen hand även om du skulle ha användning för andras hjälp och expertis?";
  Quiz[60].Text = "Tycker du om lagsporter?";
  Quiz[61].Text = "Ogillar du när folk kommer på besök oanmälda?";
  Quiz[62].Text = "Tycker du det är naturligt att vinka eller säga 'hej' när du möter folk?";
  Quiz[63].Text = "Ogillar du högläsning?";
  Quiz[64].Text = "Brukar folk kommentera ditt ovanliga uppförande och dina ovanliga vanor?";
  Quiz[65].Text = "Tycker andra ibland att du ler vid fel tillfällen?";
  Quiz[66].Text = "Har du ofta massor av tankar som du har svårt för att formulera i ord?";
  Quiz[67].Text = "Vet du ofta inte var du ska göra av dina armar?";
  Quiz[68].Text = "Har andra kommenterat eller har du själv observerat att du har ovanliga ansiktsuttryck?";
  Quiz[69].Text = "Har du en tendens att tala antingen för tyst eller för högt?";
  Quiz[70].Text = "Har du blivit anklagad för att stirra?";
  Quiz[71].Text = "Har andra kommenterat att du har udda kroppshållning eller gångstil?";
  Quiz[72].Text = "Brukar du gnugga händer, eller vrida händerna eller fingrarna om varandra?";
  Quiz[73].Text = "Misstar du ljud för röster?";
  Quiz[74].Text = "Brukar du gunga fram-&-tillbaka eller i sidled (t ex för att lunga ner dig, när du är upprymd eller övertimulerad)?";
  Quiz[75].Text = "I samtal, använder du små ljud som andra inte verkar använda?";
  Quiz[76].Text = "Brukar fraser, melodier eller rytmer du nyligen hört fastna i huvudet och fortsätta spelas upp om och om igen?";
  Quiz[77].Text = "Brukar du trumma på öronen eller trycka på ögonen (t ex när du tänker, när du är stressad eller upprörd)?";
  Quiz[78].Text = "Upprepar du vad andra sagt?";
  Quiz[79].Text = "Brukar du fingra på saker?";
  Quiz[80].Text = "Förväntar du dig att andra ska känna till dina tankar, upplevelser och åsikter utan att du behöver berätta?";
  Quiz[81].Text = "Brukar du vanka av och an (t ex när du tänker eller är orolig)?";
  Quiz[82].Text = "Stammar du när du blir stressad?";
  Quiz[83].Text = "Har du en tendens att titta mycket på människor du gillar och lite eller inte alls på människor du ogillar?";
  Quiz[84].Text = "Brukar du bita dig i läppen, kinden eller tungan (t ex när du tänker, när du är orolig eller nervös)?";
  Quiz[85].Text = "Känner du behov av att rycka loss hudflisor från dig själv (eller andra)?";
  Quiz[86].Text = "Brukar du prata med dig själv?";
  Quiz[87].Text = "Blandar du ibland ihop pronomen och t ex säger \"vi\" eller \"du\" när du menar \"jag\" eller tvärtom?";
  Quiz[88].Text = "Har du svårigheter med uttal?";
  Quiz[89].Text = "Är det svårt att veta hur du ska bete dig i olika situationer?";
  Quiz[90].Text = "I samtal, brukar du ha problem med saker som timing och turtagning?";
  Quiz[91].Text = "Brukar du uttrycka känslor på sätt som förbryllar andra?";
  Quiz[92].Text = "Blir du ofta missförstådd av andra?";
  Quiz[93].Text = "Glömmer du bort att du är i en social situation när något annat fångar ditt intresse?";
  Quiz[94].Text = "Brukar du säga saker som anses socialt opassande när du är trött, frustrerad eller när du agerar naturligt?";
  Quiz[95].Text = "Som tonåring var du oftast omedveten om sociala regler och gränser om de inte var klart uttalade?";
  Quiz[96].Text = "Har du en tendens att tolka saker bokstavligt och/eller svara på retoriska frågor?";
  Quiz[97].Text = "I samtal, brukar du behöva extra tid att noggant tänka ut vad du ska säga, så att det kan uppstå en paus innan du svarar?";
  Quiz[98].Text = "Säger andra ofta att du håller på och tjatar om samma sak gång på gång?";
  Quiz[99].Text = "I ett samtal, tenderar du att fokusera på dina egna tankar snarare än på vad dina lyssnares tankar?";
  Quiz[100].Text = "Har du svårt att förstå varför vissa saker gör människor så upprörda?";
  Quiz[101].Text = "Känner du instinktivt på dig när det är din tur att tala när du pratar i telefon?";
  Quiz[102].Text = "Är du naturligt bra på att återgälda social hövlighet?";
  Quiz[103].Text = "Känner du på dig när det förväntas att du ska be folk om ursäkt?";
  Quiz[104].Text = "Är du bra på att tolka ansiktsuttryck?";
  Quiz[105].Text = "Har du tagit initiativ som inte visat sig önskade?";
  Quiz[106].Text = "Trivs du i romantiska situationer?";
  Quiz[107].Text = "Har du lätt att beskriva dina känslor?";
  Quiz[108].Text = "Har du en monoton röst?";
  Quiz[109].Text = "Är du naturligt så ärlig och uppriktig att du tycker att alla borde vara sådana?";
  Quiz[110].Text = "Gillar du att titta på något som snurrar eller blinkar?";
  Quiz[111].Text = "Är du fascinerad av långsamt flytande vatten?";
  Quiz[112].Text = "Brukar du ibland ha ett behov av att hoppa över saker?";
  Quiz[113].Text = "Gillar du att härma djurläten?";
  Quiz[114].Text = "Are you or have you been hyperactive?";
  Quiz[115].Text = "Gillar du att gå på tå?";
  Quiz[116].Text = "Har du varit fascinerad av att tillverka fällor?";
  Quiz[117].Text = "Tycker du det är svårt att ta meddelenden på telefon och skicka dem vidare rätt?'";
  Quiz[118].Text = "Tappar du saker när din uppmärksamhet är på annat håll?";
  Quiz[119].Text = "Har du svårt att fylla i formulär?";
  Quiz[120].Text = "Har du svårt att känna igen telefonnummer om de sägs på ett annat sätt?";
  Quiz[121].Text = "Blandar du ihop siffor i tal som t.ex. 95 och 59?";
  Quiz[122].Text = "Har du svårigheter att läsa av klockor?";
  Quiz[123].Text = "Blir du plötsligt distraherad av avlägsna ljud?";
  Quiz[124].Text = "Har du svårt att filtrera bort störande bakgrundsljud när du talar med någon?";
  Quiz[125].Text = "Ogillar du när folk går bakom dig?";
  Quiz[126].Text = "Pinas du av skavande sömmar och etiketter i kläderna, av kläder som sitter åt eller som är gjorda i 'fel' material?";
  Quiz[127].Text = "Är du över- eller underkänslig för smärta eller t.o.m tycker om vissa sorters smärta?";
  Quiz[128].Text = "Har du extra känslig hörsel?";
  Quiz[129].Text = "Är dina ögon extra känsliga för starkt ljus och bländning?";
  Quiz[130].Text = "Är du känslig för omslag i luftryck och luftfuktighet?";
  Quiz[131].Text = "Ogillar du när folk stampar med foten i golvet?";
  Quiz[132].Text = "Blir du instinktivt rädd för ljudet från en motorcykel?";
  Quiz[133].Text = "Är det mer naturligt för dig att tänka i bilder än i ord?";
  Quiz[134].Text = "Har du dålig koll på eller kontroll över kroppen och tendens att ramla, snubbla eller springa in i saker?";
  Quiz[135].Text = "Har du svårt att imitera och tajma andras rörelser, t ex när du ska lära dig nya danssteg eller göra gymnastikpass i grupp?";
  Quiz[136].Text = "Har du dålig tidsuppfattning?";
  Quiz[137].Text = "Har du svårt för att bedöma andra människors ålder?";
  Quiz[138].Text = "Har du svårigheter att bedöma avstånd, höjd, djup eller fart?";
  Quiz[139].Text = "Har du svårigheter med aktiviteter som kräver finmotorisk precision, t ex att sy, knyta skosnören, knäppa knappar och hantera små föremål?";
  Quiz[140].Text = "Har du svårt att hitta till nya platser?";
  Quiz[141].Text = "Har du svårt att känna igen ansikten?";
  Quiz[142].Text = "Har du ett bra sinne för hur hårt man bör ta i när man gör saker med händerna?";
  Quiz[143].Text = "Brukar du stänga av eller bryta ihop när du blir stressad eller överväldigad?";
  Quiz[144].Text = "Har du haft svårare att klara dig själv än andra i samma ålder?";
  Quiz[145].Text = "Är du ibland rädd i ofarliga situationer?";
  Quiz[146].Text = "Har du svårt för att acceptera kritik, korrektion och direktiv?";
  Quiz[147].Text = "Brukar du få depressioner?";
  Quiz[148].Text = "Har du blivit mobbad, lurad, utnyttjad eller illa behandlad?";
  Quiz[149].Text = "Är du otålig och lättfrustrerad?";
  Quiz[150].Text = "Kommer du lätt ihåg verbala instruktioner?";
  Quiz[151].Text = "Är ditt sinne för humor ganska konventionellt?";
