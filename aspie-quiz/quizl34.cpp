...
/*##########################################################################
#
#   Name       : TQuizL34::TQuizL34
#
#   Purpose....: Constructor for TQuizL34
#
...
#
##########################################################################*/
TQuizL34::TQuizL34(const char *FileName)
  : TQuiz(161),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL34::~TQuizL34
#
#   Purpose....: Destructor for TQuizL34
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL34::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL34::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL34::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL34::WriteName(TFile &File)
{
    File.Write("L34");
}
...
#
##########################################################################*/
void TQuizL34::WriteLongName(TFile &File)
{
    File.Write("L34");
}
...
// paranormal
  ...
  Quiz[121].Text = "Do you believe in astrology?";
  Quiz[122].Text = "Do you believe in UFOs?";
  Quiz[123].Text = "Do you think you really know what some people mean when they talk about mystical experiences?";
  Quiz[124].Text = "Have you felt that you are communicating with another person telepathically (by mind-to-mind communication)?";
  Quiz[125].Text = "Do you experience thinking of someone and soon afterwards that particulat person calls or shows up?";
  Quiz[126].Text = "Do you get a feeling that you can predict things that are bound to happen in the future?";
  Quiz[127].Text = "Can you at times somehow feel the presence of someone who is not physically there?";
  Quiz[128].Text = "Have you noticed a common event or object that seemed to be a special sign for you?";
  Quiz[129].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[130].Text = "As a child, did you believe in the existence of dwarfs, elves and other fairt tale figures?";
  Quiz[131].Text = "Can other people feel your feelings when they are not there?";
  Quiz[132].Text = "Can the feelings of somebody that is not nearby and in sight still affect you?";

// AEs

  Quiz[132].Text = "Do things around you seem to change their size and shape?";
  Quiz[133].Text = "Do you have often had the experience of different senses coming together. For example, have you felt that you could smell a color, or see a sound, or hear an odor?";
  Quiz[134].Text = "When you look at a person, or yourself in a mirror, have you seen the face change right before your eyes?";
  Quiz[135].Text = "Do textures - such as wool, sand, wood - remind you of colors or music?";
  Quiz[136].Text = "Do your body sometimes seem to change its size and shape?";
  Quiz[137].Text = "Have you had the experience of not knowing whether you were imagining something or it was actually happening?";
  Quiz[138].Text = "Do you confuse fantasies with real memories?";
  Quiz[139].Text = "Have you had the experience of someone calling you or speaking your name and not being sure whether it was really happening or you were imagining it?";
  Quiz[140].Text = "If you think about something cold, do you actually get cold?";
  Quiz[141].Text = "When you sing or write someting, do you sometimes have the feeling that someone or something outside yourself directs you?";
  Quiz[142].Text = "Can music remind you of pictures or changing patterns of color?";
  Quiz[143].Text = "Have you mistaken objects or shadows for people, or noises for voices?";
  Quiz[144].Text = "Are your thoughts sometimes so strong that you can almost hear them?";
  Quiz[145].Text = "Have you seen things invisible to other people?";
  Quiz[146].Text = "Can you feel as if your mind could envelop the whole world?";
  Quiz[147].Text = "Do you feel that you have had an out of body experience?";
  Quiz[148].Text = "As a child, did you have a feeling you were somebody else (e.g., a princess, an orphan, etc.)?";
  ...
  Quiz[150].Text = "When you imagine you have eaten rotten food, do you really get nauseous?";

// fantasy

  Quiz[151].Text = "Are your fantasies just as lively as a good movie?";
  Quiz[152].Text = "Do you start fantasizing when things get boring?";
  Quiz[153].Text = "Can thoughts and images come to you without any effort on your part?";
  Quiz[154].Text = "Do you spend more than half the day (daytime) fantasizing or daydreaming?";
  Quiz[155].Text = "Do your thoughts often occur as visual images rather than as words?";
  Quiz[156].Text = "Can you recall certain past experiences so clearly and vividly that it is like living them again?";
  Quiz[157].Text = "If you stare at a picture and then look away from it, can you sometimes 'see' an image of the picture, almost as if you were still looking at it?";

// new

  Quiz[158].Text = "Do you have lucid dreams (knowing you are dreaming while dreaming)?";
  Quiz[159].Text = "Have you experienced anomalous healing?";
  Quiz[160].Text = "Do you believe in ghosts?";

}

/*##########################################################################
#
#   Name       : TQuizL34::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL34::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL34::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
