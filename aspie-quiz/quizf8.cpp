...
/*##########################################################################
#
#   Name       : TQuizF8::TQuizF8
#
#   Purpose....: Constructor for TQuizF8
#
	...
	FDataFile(FileName)
{
	...
	SetupTexts();
	SetupCross(QuizI, QuizII, QuizIII, QuizNd, Quiz5, Quiz6, Quiz7, Quiz8, Quiz9, QuizR1, QuizR2, QuizR3, QuizR4, QuizR5, QuizR6, QuizR7, QuizS1, QuizS2, QuizS3, QuizS4, QuizS5, QuizS6, QuizS7, QuizS8, QuizS9, QuizS10, QuizS11, QuizS12, QuizN1, QuizN2, QuizN3, QuizN4, QuizFI, QuizF1, QuizF2, QuizF3, QuizF4, QuizF5, QuizF6, QuizF7);
...
#   Name       : TQuizF8::~TQuizF8
#
#   Purpose....: Destructor for TQuizF8
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizF8::GetCatCount(int Question)
{
	return 3;
}
...
#
##########################################################################*/
void TQuizF8::WriteName(TFile &File)
{
	 File.Write("F8");
}
...
#
##########################################################################*/
void TQuizF8::WriteLongName(TFile &File)
{
	 File.Write("final version 8");
}

/*##########################################################################
#
#   Name       : TQuizF8::SetupTexts
#
...
void TQuizF8::SetupTexts()
{
  ...
  Quiz[192].MyGroup = GROUP_SOCIAL;
  Quiz[193].MyGroup = GROUP_SOCIAL;
  Quiz[194].MyGroup = GROUP_SOCIAL;
  Quiz[195].MyGroup = GROUP_SOCIAL;
  Quiz[196].MyGroup = GROUP_SOCIAL;
  Quiz[197].MyGroup = GROUP_SOCIAL;

  Quiz[150].Text = "LSAS - Fear - Using a telephone in public";
  Quiz[151].Text = "LSAS - Avoid - Using a telephone in public";
  Quiz[152].Text = "LSAS - Fear - Participating in a small group activity";
  Quiz[153].Text = "LSAS - Avoid - Participating in a small group activity";
  Quiz[154].Text = "LSAS - Fear - Eating in public";
  Quiz[155].Text = "LSAS - Avoid - Eating in public";
  Quiz[156].Text = "LSAS - Fear - Drinking with others";
  Quiz[157].Text = "LSAS - Avoid - Drinking with others";
  Quiz[158].Text = "LSAS - Fear - Talking to someone in authority";
  Quiz[159].Text = "LSAS - Avoid - Talking to someone in authority";
  Quiz[160].Text = "LSAS - Fear - Acting, performing, or speaking in front of an audience";
  Quiz[161].Text = "LSAS - Avoid - Acting, performing, or speaking in front of an audience";
  Quiz[162].Text = "LSAS - Fear - Going to a party";
  Quiz[163].Text = "LSAS - Avoid - Going to a party";
  Quiz[164].Text = "LSAS - Fear - Working while being observed";
  Quiz[165].Text = "LSAS - Avoid - Working while being observed";
  Quiz[166].Text = "LSAS - Fear - Writing while being observed";
  Quiz[167].Text = "LSAS - Avoid - Writing while being observed";
  Quiz[168].Text = "LSAS - Fear - Calling someone you don't know very well";
  Quiz[169].Text = "LSAS - Avoid - Calling someone you don't know very well";
  Quiz[170].Text = "LSAS - Fear - Talking face to face with someone you don't know very well";
  Quiz[171].Text = "LSAS - Avoid - Talking face to face with someone you don't know very well";
  Quiz[172].Text = "LSAS - Fear - Meeting strangers";
  Quiz[173].Text = "LSAS - Avoid - Meeting strangers";
  Quiz[174].Text = "LSAS - Fear - Urinating in a public bathroom";
  Quiz[175].Text = "LSAS - Avoid - Urinating in a public bathroom";
  Quiz[176].Text = "LSAS - Fear - Entering a room when others are already seated";
  Quiz[177].Text = "LSAS - Avoid - Entering a room when others are already seated";
  Quiz[178].Text = "LSAS - Fear - Being the center of attention";
  Quiz[179].Text = "LSAS - Avoid - Being the center of attention";
  Quiz[180].Text = "LSAS - Fear - Speaking up at a meeting";
  Quiz[181].Text = "LSAS - Avoid - Speaking up at a meeting";
  Quiz[182].Text = "LSAS - Fear - Taking a test of your ability, skill, or knowledge";
  Quiz[183].Text = "LSAS - Avoid - Taking a test of your ability, skill, or knowledge";
  Quiz[184].Text = "LSAS - Fear - Expressing disagreement or disapproval to someone you don't know very well";
  Quiz[185].Text = "LSAS - Avoid - Expressing disagreement or disapproval to someone you don't know very well";
  Quiz[186].Text = "LSAS - Fear - Looking someone who you don't know very well straight in the eyes";
  Quiz[187].Text = "LSAS - Avoid - Looking someone who you don't know very well straight in the eyes";
  Quiz[188].Text = "LSAS - Fear - Giving a prepared oral talk to a group";
  Quiz[189].Text = "LSAS - Avoid - Giving a prepared oral talk to a group";
  Quiz[190].Text = "LSAS - Fear - Trying to make someone's acquaintance for the purpose of a romantic/sexual relationship";
  Quiz[191].Text = "LSAS - Avoid - Trying to make someone's acquaintance for the purpose of a romantic/sexual relationship";
  Quiz[192].Text = "LSAS - Fear - Returning goods to a store for a refund";
  Quiz[193].Text = "LSAS - Avoid - Returning goods to a store for a refund";
  Quiz[194].Text = "LSAS - Fear - Giving a party";
  Quiz[195].Text = "LSAS - Avoid - Giving a party";
  Quiz[196].Text = "LSAS - Fear - Resisting a high pressure sales person";
  Quiz[197].Text = "LSAS - Avoid - Resisting a high pressure sales person";
  
}

/*##################  TQuizF8::LoadReferers ##########################
...
#
##########################################################################*/
void TQuizF8::SetupCross(TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd, TQuiz *Quiz5, TQuiz *Quiz6, TQuiz *Quiz7, TQuiz *Quiz8, TQuiz *Quiz9, TQuiz *QuizR1, TQuiz *QuizR2, TQuiz *QuizR3, TQuiz *QuizR4, TQuiz *QuizR5, TQuiz *QuizR6, TQuiz *QuizR7, TQuiz *QuizS1, TQuiz *QuizS2, TQuiz *QuizS3, TQuiz *QuizS4, TQuiz *QuizS5, TQuiz *QuizS6, TQuiz *QuizS7, TQuiz *QuizS8, TQuiz *QuizS9, TQuiz *QuizS10, TQuiz *QuizS11, TQuiz *QuizS12, TQuiz *QuizN1, TQuiz *QuizN2, TQuiz *QuizN3, TQuiz *QuizN4, TQuiz *QuizFI, TQuiz *QuizF1, TQuiz *QuizF2, TQuiz *QuizF3, TQuiz *QuizF4, TQuiz *QuizF5, TQuiz *QuizF6, TQuiz *QuizF7)
{
    int i;

    for (i = 0; i < 150; i++)
  	    DefineCross(QuizF7, i, i);

    for (i = 0; i < 48; i++)
        DefineCross(QuizS4, 150 + i, 149 + i);
}

/*##########################################################################
#
#   Name       : TQuizF8::GetReferer
#
...
#
##########################################################################*/
void TQuizF8::GetReferer(const char *referer, TPopulation *pop)
{
	int i;
	TReferer *ref;
	TQuizRow Row;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF8::ExportExcelCase(const char *filename, int PcaType)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF8::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF8::ExportExcelGroups(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF8::ImportMvsp(const char *filename, int PcaType)
{
	char buf[MAX_IN_ROW];
	int size;
	char *rowstr;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF8::WriteRace(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF8::WriteRetest(const char *filename)
{
	TQuizRow Row;
	int userid;
	int i;
