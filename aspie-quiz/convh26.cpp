...
#
# convh26.cpp
# Convert exported quiz-h26 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvH26()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h26.csv");
    TFile outfile("bin\\quizh26.bin", 0);
    char *ptr;
