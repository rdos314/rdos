...
/*##########################################################################
#
#   Name       : TQuizH17::TQuizH17
#
#   Purpose....: Constructor for TQuizH17
#
...
#
##########################################################################*/
TQuizH17::TQuizH17(const char *FileName)
  : TQuiz(191),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH17::~TQuizH17
#
#   Purpose....: Destructor for TQuizH17
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH17::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH17::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH17::GetCatCount(int Question)
{
    if (Question < 160)
        return 3;
    else
...
#
##########################################################################*/
void TQuizH17::WriteName(TFile &File)
{
         File.Write("H17");
}
...
#
##########################################################################*/
void TQuizH17::WriteLongName(TFile &File)
{
         File.Write("H17");
}
...
void TQuizH17::SetupTexts()
{
  ...
  Quiz[154].MyGroup = GROUP_ASPIE_HUNTING;
  ...
  Quiz[150].Text = "Are you interested in crows or ravens?";
  Quiz[151].Text = "Do you pull grass?";
  Quiz[152].Text = "Do you like sniffing people or things?";
  Quiz[153].Text = "Do you have regular periods of high activity interspaced with periods of lower activity?";
  Quiz[154].Text = "Do you have a fascination with fire?";
  Quiz[155].Text = "Do you enjoy hanging upside down?";
  Quiz[156].Text = "Do you naturally communicate feelings with animals?";
  Quiz[157].Text = "Do you enjoy chasing people or animals?";
  Quiz[158].Text = "Do you throwing small things like stones?";

  Quiz[159].Text = "Bumping car 1";
  Quiz[160].Text = "Bumping car 2";
  Quiz[161].Text = "Bumping car 3";
  Quiz[162].Text = "Bumping car 4";
  Quiz[163].Text = "Bumping car 5";
  Quiz[164].Text = "Bumping car 6";
  Quiz[165].Text = "Bumping car 7";
  Quiz[166].Text = "Bumping car 8";

  Quiz[167].Text = "Physical 1";
  Quiz[168].Text = "Physical 2";
  Quiz[169].Text = "Physical 3";
  Quiz[170].Text = "Physical 4";
  Quiz[171].Text = "Physical 5";
  Quiz[172].Text = "Physical 6";
  Quiz[173].Text = "Physical 7";
  Quiz[174].Text = "Physical 8";

  Quiz[175].Text = "Friends 1";
  Quiz[176].Text = "Friends 2";
  Quiz[177].Text = "Friends 3";
  Quiz[178].Text = "Friends 4";
  Quiz[179].Text = "Friends 5";
  Quiz[180].Text = "Friends 6";
  Quiz[181].Text = "Friends 7";
  Quiz[182].Text = "Friends 8";
  Quiz[183].Text = "Friends 9";
  Quiz[184].Text = "Friends 10";
  Quiz[185].Text = "Friends 11";
  Quiz[186].Text = "Friends 12";
  Quiz[187].Text = "Friends 13";
  Quiz[188].Text = "Friends 14";
  Quiz[189].Text = "Friends 15";
  Quiz[190].Text = "Friends 16";
}

/*##########################################################################
#
#   Name       : TQuizH17::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH17::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH17::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
