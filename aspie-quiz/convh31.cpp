...
#
# convh31.cpp
# Convert exported quiz-h31 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 195);
}

/*################## ConvH31 ##########################
*   Purpose....: Convert quiz h31                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvH31()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h31.csv");
    TFile outfile("bin\\quizh31.bin", 0);
    char *ptr;
