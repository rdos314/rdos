...
#
# convje1.cpp
# Convert exported quiz-je1 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvJE1()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-je1.csv");
    TFile outfile("bin\\quizje1.bin", 0);
    char *ptr;
