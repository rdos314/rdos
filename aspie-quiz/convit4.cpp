...
#
# convit4.cpp
# Convert exported quiz-it4 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvIt4()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-it4.csv");
    TFile outfile("bin\\quizit4.bin", 0);
    char *ptr;
