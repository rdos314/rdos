...
#
# convl15.cpp
# Convert exported quiz-l15 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 163);
}

/*################## ConvL15 ##########################
*   Purpose....: Convert quiz l15                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL15()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l15.csv");
    TFile outfile("bin\\quizl15.bin", 0);
    char *ptr;
