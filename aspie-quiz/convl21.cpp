...
#
# convl21.cpp
# Convert exported quiz-l21 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("L21: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
    printf("\r\n");
}
...
void ConvL21()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l21.csv");
    TFile outfile("bin\\quizl21.bin", 0);
    char *ptr;
