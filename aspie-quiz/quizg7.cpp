...
#
# quizg7.cpp
# Quiz final version 2, release 7 class
#
#######################################################################*/
...
/*##########################################################################
#
#   Name       : TQuizG7::TQuizG7
#
#   Purpose....: Constructor for TQuizG7
#
...
#   Name       : TQuizG7::~TQuizG7
#
#   Purpose....: Destructor for TQuizG7
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizG7::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizG7::WriteName(TFile &File)
{
	 File.Write("G7");
}
...
#
##########################################################################*/
void TQuizG7::WriteLongName(TFile &File)
{
	 File.Write("final version 2:7");
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG7::DefineQuiz()
{
}

/*##########################################################################
#
#   Name       : TQuizG7::SetupTexts
#
...
void TQuizG7::SetupTexts()
{
  ...
  Quiz[152].Text = "Do you feel regret?";
  Quiz[153].Text = "Do you feel gratitude?";
  Quiz[154].Text = "Are you more emotional than others?";
  Quiz[155].Text = "Are you less emotional than others?";
  Quiz[156].Text = "Do you become overwhelmed by emotions?";
  Quiz[157].Text = "Do you become emotional over favorite things?";
  Quiz[158].Text = "Do you get strong emotions when you succeed with something in your area of expertise?";
  Quiz[159].Text = "Do you naturally communicate feelings with animals?";

}

/*##################  TQuizG7::LoadReferers ##########################
...
#
##########################################################################*/
void TQuizG7::SetupCross(TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd, TQuiz *Quiz5, TQuiz *Quiz6, TQuiz *Quiz7, TQuiz *Quiz8, TQuiz *Quiz9, TQuiz *QuizR1, TQuiz *QuizR2, TQuiz *QuizR3, TQuiz *QuizR4, TQuiz *QuizR5, TQuiz *QuizR6, TQuiz *QuizR7, TQuiz *QuizS1, TQuiz *QuizS2, TQuiz *QuizS3, TQuiz *QuizS4, TQuiz *QuizS5, TQuiz *QuizS6, TQuiz *QuizS7, TQuiz *QuizS8, TQuiz *QuizS9, TQuiz *QuizS10, TQuiz *QuizS11, TQuiz *QuizS12, TQuiz *QuizN1, TQuiz *QuizN2, TQuiz *QuizN3, TQuiz *QuizN4, TQuiz *QuizFI, TQuiz *QuizF1, TQuiz *QuizF2, TQuiz *QuizF3, TQuiz *QuizF4, TQuiz *QuizF5, TQuiz *QuizF6, TQuiz *QuizF7, TQuiz *QuizF8, TQuiz *QuizF9, TQuiz *QuizF10, TQuiz *QuizF11, TQuiz *QuizF12, TQuiz *QuizF13, TQuiz *QuizF14, TQuiz *QuizF15, TQuiz *QuizGE, TQuiz *QuizGE2, TQuiz *QuizGE3, TQuiz *QuizG1, TQuiz *QuizG2, TQuiz *QuizG3, TQuiz *QuizG4, TQuiz *QuizG5, TQuiz *QuizG6)
{
    int i;

    for (i = 0; i < 150; i++)
	    DefineCross(QuizG6, i, i);

	DefineGlobalId(150, 1749);
	DefineGlobalId(151, 1750);
	DefineGlobalId(152, 1751);
	DefineGlobalId(153, 1752);
	DefineGlobalId(154, 1753);
	DefineGlobalId(155, 1754);
	DefineGlobalId(156, 1755);
	DefineGlobalId(157, 1756);
	DefineGlobalId(158, 1757);
	DefineGlobalId(159, 1758);

}

/*##########################################################################
#
#   Name       : TQuizG7::GetReferer
#
...
#
##########################################################################*/
void TQuizG7::GetReferer(const char *referer, TPopulation *pop)
{
	int i;
	TReferer *ref;
	TQuizRow Row;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG7::ExportExcelCase(const char *filename, int PcaType)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG7::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG7::ExportExcelGroups(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG7::ImportMvsp(const char *filename, int PcaType)
{
	char buf[MAX_IN_ROW];
	int size;
	char *rowstr;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG7::WriteRace(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG7::WriteRetest(const char *filename)
{
	TQuizRow Row;
	int userid;
	int i;
