...
/*##########################################################################
#
#   Name       : TQuizL30::TQuizL30
#
#   Purpose....: Constructor for TQuizL30
#
...
#
##########################################################################*/
TQuizL30::TQuizL30(const char *FileName)
  : TQuiz(240),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL30::~TQuizL30
#
#   Purpose....: Destructor for TQuizL30
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL30::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL30::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL30::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL30::WriteName(TFile &File)
{
    File.Write("L30");
}
...
#
##########################################################################*/
void TQuizL30::WriteLongName(TFile &File)
{
    File.Write("L30");
}
...
void TQuizL30::SetupTexts()
{
  ...
  Quiz[121].Text = "Do you feel that things you see on the TV or read in the newspaper have a special meaning for you?";
  Quiz[122].Text = "Are you aware that people notice you when you go out for a meal or to see a film?";
  Quiz[123].Text = "Do people drop hints about you or say things with a double meaning?";
  Quiz[124].Text = "Have you noticed a common event or object that seemed to be a special sign for you?";
  Quiz[125].Text = "Do you see special meanings in advertisements, shop windows, or in the way things are arranged around you?";
  Quiz[126].Text = "When shopping do you get the feeling that other people are taking notice of you?";
  Quiz[127].Text = "When you see people talking to each other, do you often wonder if they are talking about you?";
  Quiz[128].Text = "Do you feel that other people are watching you?";
  Quiz[129].Text = "Do you feel that people are talking about you?";
  Quiz[130].Text = "Do you avoid going to places where there will be many people because you will get anxious?";
  Quiz[131].Text = "Do you get nervous when you have to make polite conversation?";
  Quiz[132].Text = "Do you get nervous when someone is walking behind you?";
  Quiz[133].Text = "Do you get anxious when meeting people for the first time?";
  Quiz[134].Text = "Do you feel nervous when you are in a group of unfamiliar people?";
  Quiz[135].Text = "Do you feel uncomfortable in social situations involving unfamiliar people?";
  Quiz[136].Text = "Would you feel anxious if you had to give a speech in front of a large group of people?";
  Quiz[137].Text = "Do you feel uneasy talking to people you do not know well?";
  Quiz[138].Text = "Have you had experiences with the supernatural?";
  Quiz[139].Text = "Do you believe in telepathy (mind-to-mind communication)?";
  Quiz[140].Text = "Do you feel that other people can tell what you are thinking?";
  Quiz[141].Text = "Do you believe in clairvoyancy (psychic forces, fortune telling)?";
  Quiz[142].Text = "Can other people feel your feelings when they are not there?";
  Quiz[143].Text = "Have you had experiences with astrology, seeing the future, UFOs, ESP or a sixth sense?";
  Quiz[144].Text = "Have you felt that you are communicating with another person telepathically (by mind-to-mind communication)?";
  Quiz[145].Text = "Have you mistaken objects or shadows for people, or noises for voices?";
  Quiz[146].Text = "Have you had the sense that some person or force is around you, even though you cannot see anyone?";
  Quiz[147].Text = "When you look at a person, or yourself in a mirror, have you seen the face change right before your eyes?";
  Quiz[148].Text = "Do you hear a voice speaking your thoughts aloud?";
  Quiz[149].Text = "Have you seen things invisible to other people?";
  Quiz[150].Text = "Do everyday things seem unusually large or small?";
  Quiz[151].Text = "Does your sense of smell sometimes become unusually strong?";
  Quiz[152].Text = "Do you suddenly feel distracted by distant sounds that you are not normally aware of?";
  Quiz[153].Text = "Are your thoughts sometimes so strong that you can almost hear them?";
  Quiz[154].Text = "Do other people see you as slightly eccentric (odd)?";
  Quiz[155].Text = "Do people comment on your unusual mannerisms and habits?";
  Quiz[156].Text = "Do other people think that you are a little strange?";
  Quiz[157].Text = "Do some people think that you are a very bizarre person?";
  Quiz[158].Text = "Are you an odd, unusual person?";
  Quiz[159].Text = "Do you have some eccentric (odd) habits?";
  Quiz[160].Text = "Do people stare at you because of your odd appearance?";
  Quiz[161].Text = "Do you have little interest in getting to know other people?";
  Quiz[162].Text = "Do you prefer to keep to yourself?";
  Quiz[163].Text = "Are you mostly quiet when with other people?";
  Quiz[164].Text = "Do you find it hard to be emotionally close to other people?";
  Quiz[165].Text = "Do you feel that there is no-one you are really close to outside of your immediate family, or people you can confide in or talk to about personal problems?";
  Quiz[166].Text = "Is writing letters to friends more trouble than it is worth?";
  Quiz[167].Text = "Do you tend to keep in the background on social occasions?";
  Quiz[168].Text = "Do you attach little importance to having close friends?";
  Quiz[169].Text = "Do you feel that you are unable to get \"close\" to people?";
  Quiz[170].Text = "Do people find it hard to understand what you are saying?";
  Quiz[171].Text = "Do you jump quickly from one topic to another when speaking?";
  Quiz[172].Text = "Do you forget what you are trying to say?";
  Quiz[173].Text = "Do you ramble on too much when speaking?";
  Quiz[174].Text = "Do people find you a bit vague and elusive during a conversation?";
  Quiz[175].Text = "Do you use words in unusual ways?";
  Quiz[176].Text = "Do you tend to wander off the topic when having a conversation?";
  Quiz[177].Text = "Do you find it hard to communicate clearly what you want to say to people?";
  Quiz[178].Text = "Do people comment that your conversation is confusing?";
  Quiz[179].Text = "Do people find you aloof and distant?";
  Quiz[180].Text = "Are you poor at expressing your true feelings by the way you talk and look?";
  Quiz[181].Text = "Do you rarely laugh and smile?";
  Quiz[182].Text = "Is your \"non-verbal\" communication (smiling and nodding during a Y N conversation) poor?";
  Quiz[183].Text = "Are you poor at returning social courtesies and gestures?";
  Quiz[184].Text = "Do you tend to avoid eye contact when conversing with others?";
  Quiz[185].Text = "Do you lack an expressive and lively way of speaking?";
  Quiz[186].Text = "Do you tend to keep your feelings to yourself?";
  Quiz[187].Text = "Are you sure you are being talked about behind your back?";
  Quiz[188].Text = "Do you feel that other people have got it in for you?";
  ...
  Quiz[191].Text = "Do you pick up hidden threats or put-downs from what people say or do?";
  Quiz[192].Text = "Have you found that it is best not to let other people know too much about you?";
  Quiz[193].Text = "Do you feel that others have it in for you?";
  Quiz[194].Text = "Do you have to keep an eye out to stop people from taking advantage of you?";
  Quiz[195].Text = "Do you feel and experience things as you did when you were a child?`";
  Quiz[196].Text = "Do you get greatly moved by eloquent or poetic language?";
  Quiz[197].Text = "While watching a movie, a TV show, or a play, may you become so involved that you forget about yourself and your surroundings, and experience the story as if it were real?";
  Quiz[198].Text = "If you stare at a picture and then look away from it, can you sometimes 'see' an image of the picture, almost as if you were still looking at it?";
  Quiz[199].Text = "Can you feel as if your mind could envelop the whole world?";
  Quiz[200].Text = "Do you like to watch cloud shapes change in the sky?";
  Quiz[201].Text = "If you wish can you imagine things so vividly that it's like watching a good movie or hearing a good story?";
  Quiz[202].Text = "Do you think you really know what some people mean when they talk about mystical experiences?";
  Quiz[203].Text = "Do you 'step outside' of your usual self and experience a completely different state of being?";
  Quiz[204].Text = "Do textures - such as wool, sand, wood - remind you of colors or music?";
  Quiz[205].Text = "Can you experience things as if they were doubly real?";
  Quiz[206].Text = "When you listen to music can you get so caught up in it that you don't notice anything else?";
  Quiz[207].Text = "If you wish, can you imagine that your body is so heavy that you cannot move it?";
  Quiz[208].Text = "Can you somehow sense the presence of another person before you actually see or hear him/her?";
  Quiz[209].Text = "Do the crackle and flames of a wood fire stimulate your imagination?";
  Quiz[210].Text = "When you are immersed in nature or in art can you feel as if your whole state of consciousness has somehow been temporarily changed?";
  Quiz[211].Text = "Do different colors have distinctive and special meanings for you?";
  Quiz[212].Text = "Can you wander off into your thoughts so completely while doing a routine task that you actually forget what you are doing and a few minutes later find that you have finished it?";
  Quiz[213].Text = "Can you recall certain past experiences so clearly and vividly that it is like living them again?";
  Quiz[214].Text = "Can things that might seem meaningless to others often make sense to you?";
  Quiz[215].Text = "If you acted in a play do you think that you would really feel the emotions of the character, and 'become' that person for the time being, forgetting both yourself and the audience?";
  Quiz[216].Text = "Do your thoughts often occur as visual images rather than as words?";
  Quiz[217].Text = "Are you often delighted by small things (like the colors in soap bubbles and the five pointed star shape that appears when you cut an apple across the core)?";
  Quiz[218].Text = "When listening to organ music or other powerful music, do you feel as if you are being lifted into the air?";
  Quiz[219].Text = "Can you change noise into music by the way you listen to it?";
  Quiz[220].Text = "Are your most vivid memories called up by scents and smells?";
  Quiz[221].Text = "Can music remind you of pictures or changing patterns of color?";
  Quiz[222].Text = "Do you often know what someone is going to say before he or she says it?";
  Quiz[223].Text = "Do you have 'physical memories'; for example, after you've been swimming may feel as if you are still in the water?";
  Quiz[224].Text = "Can the sound of a voice be so fascinating to you that you can just go on listening to it?";
  Quiz[225].Text = "Can you at times somehow feel the presence of someone who is not physically there?";
  Quiz[226].Text = "Can thoughts and images come to you without any effort on your part?";
  Quiz[227].Text = "Do different smells have different colors?";
  Quiz[228].Text = "Can you be deeply moved by a sunset?";
  Quiz[229].Text = "In your daydreams, can people kind of merge into one another or one person turns into another?";
  Quiz[230].Text = "Can you wake from one dream into another?";
  Quiz[231].Text = "Do you have daymares?";

  Quiz[232].Text = "Do you have regular depressions?";
  Quiz[233].Text = "Do you have panic attacks?";
  Quiz[234].Text = "Have you been sexually abused?";
  Quiz[235].Text = "Have you been talked into having sex even if you really didn't want to?";
  Quiz[236].Text = "Were you abused by parents as a child?";
  Quiz[237].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[238].Text = "Do you feel as if the thoughts in your head are not your own?";
  Quiz[239].Text = "Have you had paranormal experiences?";

}

/*##########################################################################
#
#   Name       : TQuizL30::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL30::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL30::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
