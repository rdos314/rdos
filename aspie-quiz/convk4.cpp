...
#
# convk4.cpp
# Convert exported quiz-k4 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("K4: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
...
void ConvK4()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-k4.csv");
    TFile outfile("bin\\quizk4.bin", 0);
    char *ptr;
