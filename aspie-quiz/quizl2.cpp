...
/*##########################################################################
#
#   Name       : TQuizL2::TQuizL2
#
#   Purpose....: Constructor for TQuizL2
#
...
#
##########################################################################*/
TQuizL2::TQuizL2(const char *FileName)
  : TQuiz(132),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL2::~TQuizL2
#
#   Purpose....: Destructor for TQuizL2
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL2::GetCatCount(int Question)
{
    if (Question < 122)
       return 3;
    else
...
#
##########################################################################*/
void TQuizL2::WriteName(TFile &File)
{
    File.Write("L2");
}
...
#
##########################################################################*/
void TQuizL2::WriteLongName(TFile &File)
{
    File.Write("L2");
}
...
void TQuizL2::SetupTexts()
{
  ...
  Quiz[121].Text = "Have you been the subject of loud insults and ridicule of a sexual character?";
...
#
##########################################################################*/
void TQuizL2::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL2::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
