...
#
# convf2.cpp
# Convert exported quiz-f2 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-f2 VALUES(";

TFile quizfile("quizf2.bin", 0);
TFile ancfile("ancf2.bin", 0);
...
char *ProcessRow(char *str)
{
	...
	for (fieldno = 0; fieldno < 298; fieldno++)
	{
		valstr = str;
