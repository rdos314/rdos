...
/*##########################################################################
#
#   Name       : TQuizL9::TQuizL9
#
#   Purpose....: Constructor for TQuizL9
#
...
#
##########################################################################*/
TQuizL9::TQuizL9(const char *FileName)
  : TQuiz(124),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL9::~TQuizL9
#
#   Purpose....: Destructor for TQuizL9
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL9::GetCatCount(int Question)
{
    if (Question >= 121)
        return 5;
    else
...
#
##########################################################################*/
void TQuizL9::WriteName(TFile &File)
{
    File.Write("L9");
}
...
#
##########################################################################*/
void TQuizL9::WriteLongName(TFile &File)
{
    File.Write("L9");
}
...
void TQuizL9::SetupTexts()
{
  ...
  Quiz[121].Text = "Allow";
  Quiz[122].Text = "Trade for sex";
  Quiz[123].Text = "Invite to dinner";

}

/*##########################################################################
#
#   Name       : TQuizL9::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL9::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL9::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
