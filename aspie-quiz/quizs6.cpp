...
void TQuizS6::SetupTexts()
{
  ...
  Quiz[0].MyGroup = GROUP_INSTINCT;
  Quiz[1].MyGroup = GROUP_INSTINCT;
  Quiz[2].MyGroup = GROUP_INSTINCT;
  Quiz[3].MyGroup = GROUP_INSTINCT;
  Quiz[4].MyGroup = GROUP_INSTINCT;
  Quiz[5].MyGroup = GROUP_INSTINCT;
  Quiz[6].MyGroup = GROUP_INSTINCT;
  Quiz[7].MyGroup = GROUP_NT_BIOLOGY;
  ...
  Quiz[108].MyGroup = GROUP_OCD;
  Quiz[109].MyGroup = GROUP_OCD;
  Quiz[110].MyGroup = GROUP_OCD;
  Quiz[111].MyGroup = GROUP_OCD;
  Quiz[112].MyGroup = GROUP_OCD;
  Quiz[113].MyGroup = GROUP_OCD;
  Quiz[114].MyGroup = GROUP_OCD;
  Quiz[115].MyGroup = GROUP_PARANOID;
  Quiz[116].MyGroup = GROUP_PARANOID;
  Quiz[117].MyGroup = GROUP_PARANOID;
  Quiz[118].MyGroup = GROUP_PARANOID;
  ...
  Quiz[149].MyGroup = GROUP_CONFORM;
  Quiz[150].MyGroup = GROUP_CONFORM;
  Quiz[151].MyGroup = GROUP_CONFORM;
  Quiz[152].MyGroup = GROUP_CONFORM;
  Quiz[153].MyGroup = GROUP_CONFORM;
  Quiz[154].MyGroup = GROUP_CONFORM;
  Quiz[155].MyGroup = GROUP_CONFORM;
  Quiz[156].MyGroup = GROUP_CONFORM;
  Quiz[157].MyGroup = GROUP_CONFORM;
  Quiz[158].MyGroup = GROUP_CONFORM;
  Quiz[159].MyGroup = GROUP_CONFORM;
  Quiz[160].MyGroup = GROUP_CONFORM;
  Quiz[161].MyGroup = GROUP_CONFORM;
  Quiz[162].MyGroup = GROUP_CONFORM;
  Quiz[163].MyGroup = GROUP_CONFORM;
  Quiz[164].MyGroup = GROUP_CONFORM;
  Quiz[165].MyGroup = GROUP_CONFORM;
  Quiz[166].MyGroup = GROUP_CONFORM;
  Quiz[167].MyGroup = GROUP_CONFORM;
  Quiz[168].MyGroup = GROUP_CONFORM;
