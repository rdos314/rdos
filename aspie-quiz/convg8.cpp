...
#
# convg8.cpp
# Convert exported quiz-g8 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-g8 VALUES(";

TFile quizfile("quizg8.bin", 0);
TFile ancfile("ancg8.bin", 0);
...
char *ProcessRow(char *str)
{
	...
	for (fieldno = 0; fieldno < 220; fieldno++)
	{
		valstr = str;
		...
		if (*ptr == ',' || *ptr == ')')
		{
			*ptr = 0;
			...
			switch (fieldno)
			{
			    ...
			    case 17:
			        Row.GroupResult[0] = atoi(valstr);
					break;

				case 18:
					Row.GroupResult[1] = atoi(valstr);
					break;

				case 19:
					Row.GroupResult[2] = atoi(valstr);
					break;

				case 20:
					Row.GroupResult[3] = atoi(valstr);
					break;

				case 21:
					Row.GroupResult[4] = atoi(valstr);
					break;

				case 22:
					Row.GroupResult[5] = atoi(valstr);
					break;

				case 23:
					Row.GroupResult[6] = atoi(valstr);
					break;

				case 24:
					Row.GroupResult[7] = atoi(valstr);
					break;

				case 25:
					Row.GroupResult[8] = atoi(valstr);
					break;

				case 26:
					Row.GroupResult[9] = atoi(valstr);
					break;

				case 27:
					Row.GroupResult[10] = atoi(valstr);
					break;

				case 28:
					Row.GroupResult[11] = atoi(valstr);
					break;
