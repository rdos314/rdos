...
void TQuizF6::SetupTexts()
{
  ...
  Quiz[158].MyGroup = GROUP_PARANOID;
  Quiz[159].MyGroup = GROUP_PARANOID;
  Quiz[160].MyGroup = GROUP_SOCIAL;
  Quiz[161].MyGroup = GROUP_RELIGION;
  Quiz[162].MyGroup = GROUP_RELIGION;
  ...
  Quiz[168].MyGroup = GROUP_PARANOID;
  Quiz[169].MyGroup = GROUP_PARANOID;
  Quiz[170].MyGroup = GROUP_PARANOID;
  Quiz[171].MyGroup = GROUP_RELIGION;
  ...
  Quiz[176].MyGroup = GROUP_PARANOID;
  Quiz[177].MyGroup = GROUP_RELIGION;
  Quiz[178].MyGroup = GROUP_SOCIAL;
  Quiz[179].MyGroup = GROUP_RELIGION;
  Quiz[180].MyGroup = GROUP_PARANOID;
  Quiz[181].MyGroup = GROUP_PARANOID;
  Quiz[182].MyGroup = GROUP_SOCIAL;
  Quiz[183].MyGroup = GROUP_ASPIE_NVC;
  Quiz[184].MyGroup = GROUP_NT_NVC;
  Quiz[185].MyGroup = GROUP_PARANOID;
  Quiz[186].MyGroup = GROUP_RELIGION;
  Quiz[187].MyGroup = GROUP_SOCIAL;
  Quiz[188].MyGroup = GROUP_RELIGION;
  Quiz[189].MyGroup = GROUP_RELIGION;
  Quiz[190].MyGroup = GROUP_SOCIAL;
  Quiz[191].MyGroup = GROUP_PARANOID;
  Quiz[192].MyGroup = GROUP_NT_NVC;
  Quiz[193].MyGroup = GROUP_PARANOID;
  Quiz[194].MyGroup = GROUP_PARANOID;
  Quiz[195].MyGroup = GROUP_SOCIAL;
  Quiz[196].MyGroup = GROUP_RELIGION;
  Quiz[197].MyGroup = GROUP_PARANOID;
  Quiz[198].MyGroup = GROUP_SOCIAL;
  Quiz[199].MyGroup = GROUP_ASPIE_NVC;
  Quiz[200].MyGroup = GROUP_SOCIAL;
  Quiz[201].MyGroup = GROUP_PARANOID;
  Quiz[202].MyGroup = GROUP_PARANOID;
  Quiz[203].MyGroup = GROUP_SOCIAL;
  Quiz[204].MyGroup = GROUP_RELIGION;
  Quiz[205].MyGroup = GROUP_RELIGION;
  Quiz[206].MyGroup = GROUP_SOCIAL;
  Quiz[207].MyGroup = GROUP_ASPIE_NVC;
  Quiz[208].MyGroup = GROUP_PARANOID;
  Quiz[209].MyGroup = GROUP_PARANOID;
  Quiz[210].MyGroup = GROUP_RELIGION;
  Quiz[211].MyGroup = GROUP_SOCIAL;
  Quiz[212].MyGroup = GROUP_PARANOID;
  Quiz[213].MyGroup = GROUP_RELIGION;
  Quiz[214].MyGroup = GROUP_PARANOID;
  Quiz[215].MyGroup = GROUP_SOCIAL;
  Quiz[216].MyGroup = GROUP_SOCIAL;
  Quiz[217].MyGroup = GROUP_SOCIAL;
  ...
  Quiz[222].MyGroup = GROUP_SOCIAL;
  Quiz[223].MyGroup = GROUP_PARANOID;
