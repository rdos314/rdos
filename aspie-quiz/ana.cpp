...
//      Quiz[49]->CheckCross();
        ...
        printf("import\r\n");
         ...
         Quiz[58]->ImportMvsp("pca\\youngg8.txt", PCA_TYPE_YOUNG);
			...
			Quiz[59]->ImportMvsp("pca\\allh1.txt", PCA_TYPE_ALL);
			Quiz[59]->ImportMvsp("pca\\maleh1.txt", PCA_TYPE_MALE);
			Quiz[59]->ImportMvsp("pca\\femaleh1.txt", PCA_TYPE_FEMALE);
			Quiz[59]->ImportMvsp("pca\\oldh1.txt", PCA_TYPE_OLD);
			Quiz[59]->ImportMvsp("pca\\youngh1.txt", PCA_TYPE_YOUNG);
			Quiz[59]->ImportMvsp("pca\\asiah1.txt", PCA_TYPE_ASIA);
		  ...
		  printf("import aspie\r\n");
			...
			Quiz[59]->ImportMvspAspie("pca\\aspieh1.txt");
		  ...
		  printf("calc global\r\n");
			...
			printf("axis corr\r\n");
			Quiz[59]->ExportGenderCongruence("gender.txt");
			Quiz[59]->ExportAgeCongruence("age.txt");
			Quiz[59]->ExportAsiaCongruence("asia.txt");
			Quiz[59]->ExportFinalCongruence("final.txt", Quiz[32]);
			...
			Quiz[59]->ExportCongruence("conh1.txt");
...
//#endif
			...
			Quiz[59]->WriteReferers("eval\\refh1.htm");
		  ...
		  printf("details\r\n");
			...
			Quiz[59]->WriteSumaryTable("eval\\quizh1.htm", FALSE);
		  ...
		  printf("rel\r\n");
			...
			Quiz[59]->WriteIntercorr("eval\\relh1.htm");

		  printf("group\r\n");
			Quiz[59]->WriteGroupTable("eval\\group.htm", TRUE);
		  printf("groupcorr\r\n");
			Quiz[59]->WriteGroupCorrTable("eval\\groupcorr.htm");
		  printf("pcaload\r\n");
			Quiz[59]->WritePcaLoadTable("eval\\pcaload.htm");

		  printf("avgcorr\r\n");
			Quiz[59]->WriteAverageGroupCorrTable("eval\\avgcorr.htm");
		  printf("avgpca\r\n");
			Quiz[59]->WriteAveragePcaTable("eval\\avgpca.htm");
		  printf("avg\r\n");
			Quiz[59]->WriteAveragePcaCorrTable("eval\\avg.htm");

		  printf("pcacorr\r\n");
			Quiz[59]->WritePcaCorrTable("eval\\pcacorr.htm");

		  printf("axisload\r\n");
			Quiz[59]->WriteAxisLoadTable("eval\\axisload.htm");

		  printf("avgaxis\r\n");
			Quiz[59]->WriteAverageAxisTable("eval\\avgaxis.htm");

		  printf("dxload\r\n");
			Quiz[59]->WriteDxLoadTable("eval\\dxload.htm");

		  printf("avgdx\r\n");
			Quiz[59]->WriteAverageDxTable("eval\\avgdx.htm");

		  printf("main\r\n");
			Quiz[59]->WriteLinkReport("eval\\index.htm");
...
//#ifdef ALL
		  printf("special reports\r\n");
			...
			Quiz[59]->WriteRace("eval\\raceh1.htm");
...
//       Quiz[7]->WritePhpGlobalQuestions("global.php");
		  ...
		  printf("retest\r\n");
			...
			Quiz[59]->WriteRetest("eval\\retesth1.htm");
			Quiz[59]->WriteVersionRetest("eval\\vervar.htm");
		  ...
		  printf("pca\r\n");
			...
			Quiz[59]->WritePcaGroupCorr("eval\\pcah1.htm");
...
//       Quiz[32]->WriteAQ("");
		  ...
		  printf("version histogram\r\n");
			...
			Quiz[59]->ExportDiffHistogram("csv\\allh1.csv", POP_TYPE_ALL, FALSE);
		  ...
		  printf("type histograms\r\n");
			Quiz[59]->ExportDiffHistogram("csv\\all.csv", POP_TYPE_ALL, TRUE);

			Quiz[59]->ExportDiffHistogram("csv\\autism.csv", POP_TYPE_AUTISM, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\as.csv", POP_TYPE_AS, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\nt.csv", POP_TYPE_NT_CONTROL, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\soc.csv", POP_TYPE_SOCIAL_PHOBIA, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\add.csv", POP_TYPE_ADD, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\ts.csv", POP_TYPE_TS, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\pa.csv", POP_TYPE_PA, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\bip.csv", POP_TYPE_BIPOLAR, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\schizo.csv", POP_TYPE_SCHIZOPHRENIA, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\syn.csv", POP_TYPE_SYNAESTHESIA, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\dysl.csv", POP_TYPE_DYSLEXIA, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\dysc.csv", POP_TYPE_DYSCALCULIA, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\dysg.csv", POP_TYPE_DYSGRAPHIA, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\ocd.csv", POP_TYPE_OCD, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\odd.csv", POP_TYPE_ODD, TRUE);
			Quiz[59]->ExportDiffHistogram("csv\\dysp.csv", POP_TYPE_DYSPRAXIA, TRUE);

			TQuiz::ExportBirthMonthHistogram("csv\\birth.csv");


		  printf("SQL\r\n");
		  Quiz[59]->ExportGlobalSql("db\\global.sql");
		  Quiz[59]->ExportQuizVerSql("db\\quizver.sql");
		  Quiz[59]->ExportGroupSql("db\\group.sql");
		  Quiz[59]->ExportPopTypeSql("db\\poptype.sql");
		  Quiz[59]->ExportGlobalCorrSql("db\\gcorr.sql");
		  Quiz[59]->ExportGlobalAxisSql("db\\gaxis.sql");
		  Quiz[59]->ExportQuizCatPopSql("db\\qcatpop.sql");
		  Quiz[59]->ExportQuizGlobalSql("db\\qglobal.sql");
}
