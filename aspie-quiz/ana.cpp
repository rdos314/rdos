...
void ExportAncestry2(const char *filename, int Ancestry)
{
         ...
         for (v = 0; v < 8; v++)
        {
                  switch (v)
                {
                        ...
                        case 5:
                                infile = new TFile("ancg6.bin");
                                break;

                        case 6:
                                infile = new TFile("ancg7.bin");
                                break;
...
int main(int argc, char **argv)
{
        ...
        printf("G3\r\n");
        Quiz[53] = new TQuizG3("quizg3.bin", Quiz[0], Quiz[1], Quiz[2], Quiz[3], Quiz[4], Quiz[5], Quiz[6], Quiz[7], Quiz[8], Quiz[9], Quiz[10], Quiz[11], Quiz[12], Quiz[13], Quiz[14], Quiz[15], Quiz[16], Quiz[17], Quiz[18], Quiz[19], Quiz[20], Quiz[21], Quiz[22], Quiz[23], Quiz[24], Quiz[25], Quiz[26], Quiz[27], Quiz[28], Quiz[29], Quiz[30], Quiz[31], Quiz[32], Quiz[33], Quiz[34], Quiz[35], Quiz[36], Quiz[37], Quiz[38], Quiz[39], Quiz[40], Quiz[41], Quiz[42], Quiz[43], Quiz[44], Quiz[45], Quiz[46], Quiz[47], Quiz[48], Quiz[49], Quiz[50], Quiz[51], Quiz[52]);

        printf("G4\r\n");
        Quiz[54] = new TQuizG4("quizg4.bin", Quiz[0], Quiz[1], Quiz[2], Quiz[3], Quiz[4], Quiz[5], Quiz[6], Quiz[7], Quiz[8], Quiz[9], Quiz[10], Quiz[11], Quiz[12], Quiz[13], Quiz[14], Quiz[15], Quiz[16], Quiz[17], Quiz[18], Quiz[19], Quiz[20], Quiz[21], Quiz[22], Quiz[23], Quiz[24], Quiz[25], Quiz[26], Quiz[27], Quiz[28], Quiz[29], Quiz[30], Quiz[31], Quiz[32], Quiz[33], Quiz[34], Quiz[35], Quiz[36], Quiz[37], Quiz[38], Quiz[39], Quiz[40], Quiz[41], Quiz[42], Quiz[43], Quiz[44], Quiz[45], Quiz[46], Quiz[47], Quiz[48], Quiz[49], Quiz[50], Quiz[51], Quiz[52], Quiz[53]);

        printf("G5\r\n");
        Quiz[55] = new TQuizG5("quizg5.bin", Quiz[0], Quiz[1], Quiz[2], Quiz[3], Quiz[4], Quiz[5], Quiz[6], Quiz[7], Quiz[8], Quiz[9], Quiz[10], Quiz[11], Quiz[12], Quiz[13], Quiz[14], Quiz[15], Quiz[16], Quiz[17], Quiz[18], Quiz[19], Quiz[20], Quiz[21], Quiz[22], Quiz[23], Quiz[24], Quiz[25], Quiz[26], Quiz[27], Quiz[28], Quiz[29], Quiz[30], Quiz[31], Quiz[32], Quiz[33], Quiz[34], Quiz[35], Quiz[36], Quiz[37], Quiz[38], Quiz[39], Quiz[40], Quiz[41], Quiz[42], Quiz[43], Quiz[44], Quiz[45], Quiz[46], Quiz[47], Quiz[48], Quiz[49], Quiz[50], Quiz[51], Quiz[52], Quiz[53], Quiz[54]);

        printf("G6\r\n");
        Quiz[56] = new TQuizG6("quizg6.bin", Quiz[0], Quiz[1], Quiz[2], Quiz[3], Quiz[4], Quiz[5], Quiz[6], Quiz[7], Quiz[8], Quiz[9], Quiz[10], Quiz[11], Quiz[12], Quiz[13], Quiz[14], Quiz[15], Quiz[16], Quiz[17], Quiz[18], Quiz[19], Quiz[20], Quiz[21], Quiz[22], Quiz[23], Quiz[24], Quiz[25], Quiz[26], Quiz[27], Quiz[28], Quiz[29], Quiz[30], Quiz[31], Quiz[32], Quiz[33], Quiz[34], Quiz[35], Quiz[36], Quiz[37], Quiz[38], Quiz[39], Quiz[40], Quiz[41], Quiz[42], Quiz[43], Quiz[44], Quiz[45], Quiz[46], Quiz[47], Quiz[48], Quiz[49], Quiz[50], Quiz[51], Quiz[52], Quiz[53], Quiz[54], Quiz[55]);

        printf("G7\r\n");
        Quiz[57] = new TQuizG7("quizg7.bin", Quiz[0], Quiz[1], Quiz[2], Quiz[3], Quiz[4], Quiz[5], Quiz[6], Quiz[7], Quiz[8], Quiz[9], Quiz[10], Quiz[11], Quiz[12], Quiz[13], Quiz[14], Quiz[15], Quiz[16], Quiz[17], Quiz[18], Quiz[19], Quiz[20], Quiz[21], Quiz[22], Quiz[23], Quiz[24], Quiz[25], Quiz[26], Quiz[27], Quiz[28], Quiz[29], Quiz[30], Quiz[31], Quiz[32], Quiz[33], Quiz[34], Quiz[35], Quiz[36], Quiz[37], Quiz[38], Quiz[39], Quiz[40], Quiz[41], Quiz[42], Quiz[43], Quiz[44], Quiz[45], Quiz[46], Quiz[47], Quiz[48], Quiz[49], Quiz[50], Quiz[51], Quiz[52], Quiz[53], Quiz[54], Quiz[55], Quiz[56]);
...
//      Quiz[49]->CheckCross();
        ...
        printf("allf15\r\n");
         Quiz[47]->ExportExcelCase("pca\\allf15.dat", PCA_TYPE_ALL);
         Quiz[47]->ExportExcelCase("pca\\malef15.dat", PCA_TYPE_MALE);
         Quiz[47]->ExportExcelCase("pca\\femf15.dat", PCA_TYPE_FEMALE);
        ...
        printf("allge\r\n");
         Quiz[48]->ExportExcelCase("pca\\allge.dat", PCA_TYPE_ALL);
         Quiz[48]->ExportExcelCase("pca\\malege.dat", PCA_TYPE_MALE);
        ...
        printf("allge3\r\n");
         Quiz[50]->ExportExcelCase("pca\\allge3.dat", PCA_TYPE_ALL);
         Quiz[50]->ExportExcelCase("pca\\malege3.dat", PCA_TYPE_MALE);
         Quiz[50]->ExportExcelCase("pca\\femalege3.dat", PCA_TYPE_FEMALE);
        ...
        printf("allg1\r\n");
         ...
         Quiz[51]->ExportExcelCase("pca\\femaleg1.dat", PCA_TYPE_FEMALE);
        ...
        printf("allg3\r\n");
         Quiz[53]->ExportExcelCase("pca\\allg3.dat", PCA_TYPE_ALL);
         Quiz[53]->ExportExcelCase("pca\\maleg3.dat", PCA_TYPE_MALE);
         Quiz[53]->ExportExcelCase("pca\\femaleg3.dat", PCA_TYPE_FEMALE);
        Quiz[53]->ExportExcelCase("pca\\youngg3.dat", PCA_TYPE_YOUNG);
        Quiz[53]->ExportExcelCase("pca\\oldg3.dat", PCA_TYPE_OLD);

        printf("allg4\r\n");
         Quiz[54]->ExportExcelCase("pca\\allg4.dat", PCA_TYPE_ALL);
         Quiz[54]->ExportExcelCase("pca\\maleg4.dat", PCA_TYPE_MALE);
        ...
        printf("import\r\n");
         ...
         Quiz[47]->ImportMvsp("pca\\youngf15.txt", PCA_TYPE_YOUNG);
         Quiz[47]->ImportMvsp("pca\\asiaf15.txt", PCA_TYPE_ASIA);

         Quiz[48]->ImportMvsp("pca\\allge.txt", PCA_TYPE_ALL);
         Quiz[48]->ImportMvsp("pca\\malege.txt", PCA_TYPE_MALE);
         Quiz[48]->ImportMvsp("pca\\femalege.txt", PCA_TYPE_FEMALE);
         Quiz[48]->ImportMvsp("pca\\oldge.txt", PCA_TYPE_OLD);
         Quiz[48]->ImportMvsp("pca\\youngge.txt", PCA_TYPE_YOUNG);
         Quiz[48]->ImportMvsp("pca\\asiage.txt", PCA_TYPE_ASIA);

         Quiz[49]->ImportMvsp("pca\\allge2.txt", PCA_TYPE_ALL);
         Quiz[49]->ImportMvsp("pca\\malege2.txt", PCA_TYPE_MALE);
         ...
         Quiz[51]->ImportMvsp("pca\\allg1.txt", PCA_TYPE_ALL);
         Quiz[51]->ImportMvsp("pca\\maleg1.txt", PCA_TYPE_MALE);
         Quiz[51]->ImportMvsp("pca\\femaleg1.txt", PCA_TYPE_FEMALE);
         Quiz[51]->ImportMvsp("pca\\oldg1.txt", PCA_TYPE_OLD);
         ...
         Quiz[53]->ImportMvsp("pca\\asiag3.txt", PCA_TYPE_ASIA);

         Quiz[54]->ImportMvsp("pca\\allg4.txt", PCA_TYPE_ALL);
         Quiz[54]->ImportMvsp("pca\\maleg4.txt", PCA_TYPE_MALE);
         Quiz[54]->ImportMvsp("pca\\femaleg4.txt", PCA_TYPE_FEMALE);
         Quiz[54]->ImportMvsp("pca\\oldg4.txt", PCA_TYPE_OLD);
         Quiz[54]->ImportMvsp("pca\\youngg4.txt", PCA_TYPE_YOUNG);
         Quiz[54]->ImportMvsp("pca\\asiag4.txt", PCA_TYPE_ASIA);

         Quiz[55]->ImportMvsp("pca\\allg5.txt", PCA_TYPE_ALL);
         Quiz[55]->ImportMvsp("pca\\maleg5.txt", PCA_TYPE_MALE);
         Quiz[55]->ImportMvsp("pca\\femaleg5.txt", PCA_TYPE_FEMALE);
         Quiz[55]->ImportMvsp("pca\\oldg5.txt", PCA_TYPE_OLD);
         Quiz[55]->ImportMvsp("pca\\youngg5.txt", PCA_TYPE_YOUNG);
         Quiz[55]->ImportMvsp("pca\\asiag5.txt", PCA_TYPE_ASIA);

         Quiz[56]->ImportMvsp("pca\\allg6.txt", PCA_TYPE_ALL);
         ...
         Quiz[58]->ImportMvsp("pca\\allg8.txt", PCA_TYPE_ALL);
         Quiz[58]->ImportMvsp("pca\\maleg8.txt", PCA_TYPE_MALE);
         Quiz[58]->ImportMvsp("pca\\femaleg8.txt", PCA_TYPE_FEMALE);
         Quiz[58]->ImportMvsp("pca\\oldg8.txt", PCA_TYPE_OLD);
         Quiz[58]->ImportMvsp("pca\\youngg8.txt", PCA_TYPE_YOUNG);
         Quiz[58]->ImportMvsp("pca\\asiag8.txt", PCA_TYPE_ASIA);
        ...
        printf("import aspie\r\n");
         ...
         Quiz[46]->ImportMvspAspie("pca\\aspief14.txt");
         Quiz[47]->ImportMvspAspie("pca\\aspief15.txt");
        ...
        printf("import pop pca\r\n");
         ...
         printf("Cutoff\r\n");
          ...
          Quiz[46]->DsmCutoff("eval\\cutf13.htm", FALSE);
          Quiz[47]->DsmCutoff("eval\\cutf14.htm", FALSE);
          Quiz[48]->DsmCutoff("eval\\cutge.htm", FALSE);
          ...
          Quiz[53]->DsmCutoff("eval\\cutg3.htm", FALSE);
          Quiz[54]->DsmCutoff("eval\\cutg4.htm", FALSE);
          Quiz[55]->DsmCutoff("eval\\cutg5.htm", FALSE);
          Quiz[56]->DsmCutoff("eval\\cutg6.htm", FALSE);
          Quiz[57]->DsmCutoff("eval\\cutg7.htm", FALSE);
        ...
        printf("calc global\r\n");
         ...
         Quiz[53]->ExportCongruence("cong3.txt");
         Quiz[54]->ExportCongruence("cong4.txt");
         Quiz[55]->ExportCongruence("cong5.txt");
         Quiz[56]->ExportCongruence("cong6.txt");
         Quiz[57]->ExportCongruence("cong7.txt");
         Quiz[58]->ExportCongruence("cong8.txt");
...
//       Quiz[51]->WritePhpQuestions("q.php");
//       Quiz[55]->WriteSetupTexts("q.cpp");
//       Quiz[55]->WriteSetupCross("c.cpp");
...
//#endif
         ...
         Quiz[46]->WriteReferers("eval\\reff14.htm");
         Quiz[47]->WriteReferers("eval\\reff15.htm");
         Quiz[48]->WriteReferers("eval\\refge.htm");
         ...
         Quiz[53]->WriteReferers("eval\\refg3.htm");
        ...
        printf("details\r\n");
         ...
         Quiz[53]->WriteSumaryTable("eval\\quizg3.htm", FALSE);
         Quiz[54]->WriteSumaryTable("eval\\quizg4.htm", FALSE);
         Quiz[55]->WriteSumaryTable("eval\\quizg5.htm", FALSE);
         Quiz[56]->WriteSumaryTable("eval\\quizg6.htm", FALSE);
         Quiz[57]->WriteSumaryTable("eval\\quizg7.htm", FALSE);
         Quiz[58]->WriteSumaryTable("eval\\quizg8.htm", FALSE);
        ...
        printf("rel\r\n");
         ...
         Quiz[57]->WriteIntercorr("eval\\relg7.htm");
         Quiz[58]->WriteIntercorr("eval\\relg8.htm");

        printf("group\r\n");
         Quiz[58]->WriteGroupTable("eval\\group.htm", TRUE);
        printf("groupcorr\r\n");
         Quiz[58]->WriteGroupCorrTable("eval\\groupcorr.htm");
        printf("pcaload\r\n");
         Quiz[58]->WritePcaLoadTable("eval\\pcaload.htm");
        ...
        printf("avgaxis\r\n");
         Quiz[58]->WriteAverageAxisTable("eval\\avgaxis.htm");

        printf("dxload\r\n");
         Quiz[58]->WriteDxLoadTable("eval\\dxload.htm");

        printf("avgdx\r\n");
         Quiz[58]->WriteAverageDxTable("eval\\avgdx.htm");

        printf("main\r\n");
         Quiz[58]->WriteLinkReport("eval\\index.htm");
...
//#ifdef ALL
        printf("special reports\r\n");
         ...
         Quiz[46]->WriteRace("eval\\racef14.htm");
         Quiz[47]->WriteRace("eval\\racef15.htm");
...
//       Quiz[51]->WritePhpWeighting("weights.php");
//       Quiz[51]->WritePhpGroupWeighting("group.php");

//       Quiz[9]->MoveWiki("iwiki.txt", "wiki.txt", 0.2);

//        Quiz[48]->WriteWiki("wiki.txt", 0.2, 0.2); // doesn't work!
//        Quiz[51]->WriteWikiCorrelation("wiki.txt", "maxcorr.htm", 147);
//        Quiz[51]->WriteWikiNoncorrelated("wiki.txt", "mincorr.htm", 147);

//        Quiz[34]->WriteQuizWiki("f2.txt");
//        Quiz[54]->WriteQuizWiki("g4.txt");
...
//       Quiz[7]->WritePhpGlobalQuestions("global.php");
        ...
        printf("retest\r\n");
         ...
         Quiz[51]->WriteRetest("eval\\retestg1.htm");
         Quiz[52]->WriteRetest("eval\\retestg2.htm");
         ...
         Quiz[57]->WriteRetest("eval\\retestg7.htm");
         Quiz[58]->WriteRetest("eval\\retestg8.htm");
         Quiz[58]->WriteVersionRetest("eval\\vervar.htm");
        ...
        printf("imgrate\r\n");
         ...
         Quiz[47]->WritePcaGroupCorr("eval\\pcaf15.htm");
         Quiz[48]->WritePcaGroupCorr("eval\\pcage.htm");
         ...
         Quiz[53]->WritePcaGroupCorr("eval\\pcag3.htm");
         Quiz[54]->WritePcaGroupCorr("eval\\pcag4.htm");
         Quiz[55]->WritePcaGroupCorr("eval\\pcag5.htm");
         Quiz[56]->WritePcaGroupCorr("eval\\pcag6.htm");
         Quiz[57]->WritePcaGroupCorr("eval\\pcag7.htm");
         Quiz[58]->WritePcaGroupCorr("eval\\pcag8.htm");
...
//       Quiz[32]->WriteAQ("");
        ...
        printf("version histogram\r\n");
         ...
         Quiz[46]->ExportDiffHistogram("csv\\allf14.csv", POP_TYPE_ALL, FALSE);
         Quiz[47]->ExportDiffHistogram("csv\\allf15.csv", POP_TYPE_ALL, FALSE);
         Quiz[48]->ExportDiffHistogram("csv\\allge.csv", POP_TYPE_ALL, FALSE);
        ...
        printf("conv headers\r\n");
         ...
         Quiz[48]->WriteGroupWeighting("convge.h");
         Quiz[49]->WriteGroupWeighting("convge2.h");
         Quiz[50]->WriteGroupWeighting("convge3.h");
         Quiz[51]->WriteGroupWeighting("convg.h");

        printf("type histograms\r\n");
         Quiz[58]->ExportDiffHistogram("csv\\all.csv", POP_TYPE_ALL, TRUE);

         Quiz[58]->ExportDiffHistogram("csv\\autism.csv", POP_TYPE_AUTISM, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\as.csv", POP_TYPE_AS, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\nt.csv", POP_TYPE_NT_CONTROL, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\soc.csv", POP_TYPE_SOCIAL_PHOBIA, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\add.csv", POP_TYPE_ADD, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\ts.csv", POP_TYPE_TS, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\pa.csv", POP_TYPE_PA, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\bip.csv", POP_TYPE_BIPOLAR, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\schizo.csv", POP_TYPE_SCHIZOPHRENIA, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\syn.csv", POP_TYPE_SYNAESTHESIA, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\dysl.csv", POP_TYPE_DYSLEXIA, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\dysc.csv", POP_TYPE_DYSCALCULIA, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\dysg.csv", POP_TYPE_DYSGRAPHIA, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\ocd.csv", POP_TYPE_OCD, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\odd.csv", POP_TYPE_ODD, TRUE);
         Quiz[58]->ExportDiffHistogram("csv\\dysp.csv", POP_TYPE_DYSPRAXIA, TRUE);
         
         TQuiz::ExportBirthMonthHistogram("csv\\birth.csv");

        printf("DSM\r\n");
         Quiz[58]->WriteDsmReport("eval\\autism.htm", POP_TYPE_AUTISM);
         Quiz[58]->WriteDsmReport("eval\\as.htm", POP_TYPE_AS);
         Quiz[58]->WriteDsmReport("eval\\add.htm", POP_TYPE_ADD);
         Quiz[58]->WriteDsmReport("eval\\ts.htm", POP_TYPE_TS);
         Quiz[58]->WriteDsmReport("eval\\dysp.htm", POP_TYPE_DYSPRAXIA);
         Quiz[58]->WriteDsmReport("eval\\dysl.htm", POP_TYPE_DYSLEXIA);
         Quiz[58]->WriteDsmReport("eval\\dysc.htm", POP_TYPE_DYSCALCULIA);
         Quiz[58]->WriteDsmReport("eval\\ocd.htm", POP_TYPE_OCD);
         Quiz[58]->WriteDsmReport("eval\\odd.htm", POP_TYPE_ODD);
         Quiz[58]->WriteDsmReport("eval\\pa.htm", POP_TYPE_PA);
         Quiz[58]->WriteDsmReport("eval\\dysg.htm", POP_TYPE_DYSGRAPHIA);
         Quiz[58]->WriteDsmReport("eval\\bip.htm", POP_TYPE_BIPOLAR);
         Quiz[58]->WriteDsmReport("eval\\schizo.htm", POP_TYPE_SCHIZOPHRENIA);
         Quiz[58]->WriteDsmReport("eval\\social.htm", POP_TYPE_SOCIAL_PHOBIA);
         
        printf("SQL\r\n");
        Quiz[58]->ExportGlobalSql("db\\global.sql");
        Quiz[58]->ExportQuizVerSql("db\\quizver.sql");
        Quiz[58]->ExportGroupSql("db\\group.sql");
        Quiz[58]->ExportPopTypeSql("db\\poptype.sql");
        Quiz[58]->ExportGlobalCorrSql("db\\gcorr.sql");
        Quiz[58]->ExportGlobalAxisSql("db\\gaxis.sql");
        Quiz[58]->ExportQuizCatPopSql("db\\qcatpop.sql");
        Quiz[58]->ExportQuizGlobalSql("db\\qglobal.sql");
}
