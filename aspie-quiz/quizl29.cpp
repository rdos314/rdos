...
/*##########################################################################
#
#   Name       : TQuizL29::TQuizL29
#
#   Purpose....: Constructor for TQuizL29
#
...
#
##########################################################################*/
TQuizL29::TQuizL29(const char *FileName)
  : TQuiz(196),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL29::~TQuizL29
#
#   Purpose....: Destructor for TQuizL29
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL29::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL29::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL29::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL29::WriteName(TFile &File)
{
    File.Write("L29");
}
...
#
##########################################################################*/
void TQuizL29::WriteLongName(TFile &File)
{
    File.Write("L29");
}
...
void TQuizL29::SetupTexts()
{
  ...
  Quiz[121].Text = "As a child, did you think that dolls, teddy bears and stuffed animals that you played with were living creatures?";
  Quiz[122].Text = "As a child, did you believe in the existence of dwarfs, elves and other fairt tale figures?";
  Quiz[123].Text = "As a child, did you have your own make believe friend or animal?";
  Quiz[124].Text = "As a child, could you easily identify with the main character of a story and/or movie?";
  Quiz[125].Text = "As a child, did you have a feeling you were somebody else (e.g., a princess, an orphan, etc.)?";
  Quiz[126].Text = "As a child, were you encouraged by adults (parents, grandparents, brothers, sisters) to fully indulge yourself in your fantasies and daydreams?";
  Quiz[127].Text = "Did you feel lonely as a child?";
  Quiz[128].Text = "As a child, did you devote your time to playing a musical instrument, dancing, acting, and/or drawing?";
  Quiz[129].Text = "Do you spend more than half the day (daytime) fantasizing or daydreaming?";
  Quiz[130].Text = "Do your friends and/or relatives not know that you have such detailed fantasies?";
  Quiz[131].Text = "Do your fantasies have a realistic intensity?";
  Quiz[132].Text = "Are your fantasies just as lively as a good movie?";
  Quiz[133].Text = "Do you confuse fantasies with real memories?";
  Quiz[134].Text = "Do you start fantasizing when things get boring?";
  Quiz[135].Text = "Do you act as if you are somebody else and completely identify yourself with that role?";
  Quiz[136].Text = "Do you have vivid and lively memories of your childhood?";
  Quiz[137].Text = "Do you recall occurrences before the age of three?";
  Quiz[138].Text = "When you percieve violence on television, do you get so into it that you get upset?";
  Quiz[139].Text = "If you think about something cold, do you actually get cold?";
  Quiz[140].Text = "When you imagine you have eaten rotten food, do you really get nauseous?";
  Quiz[141].Text = "Do you get a feeling that you can predict things that are bound to happen in the future?";
  Quiz[142].Text = "Do you experience thinking of someone and soon afterwards that particulat person calls or shows up?";
  Quiz[143].Text = "Do you feel that you have had an out of body experience?";
  Quiz[144].Text = "When you sing or write someting, do you sometimes have the feeling that someone or something outside yourself directs you?";
  Quiz[145].Text = "During your life, have you had intense religious experiences which influenced you in a very strong manner?";

  Quiz[146].Text = "Do you have dreams, daydreams, nightmares in which your body or someone else's body is being stabbed, injured, or torn apart?";
  Quiz[147].Text = "Do things around you seem to change their size and shape?";
  Quiz[148].Text = "Every time something frightening happens to you, do you have nightmares or fantasies or flashbacks involving the frightening event?";
  Quiz[149].Text = "Do you have often had the experience of different senses coming together. For example, have you felt that you could smell a color, or see a sound, or hear an odor?";
  Quiz[150].Text = "Can your dreams be so vivid that even later you can't tell them from waking reality?";
  Quiz[151].Text = "Do your body sometimes seem to change its size and shape?";
  Quiz[152].Text = "Have you had the experience of someone calling you or speaking your name and not being sure whether it was really happening or you were imagining it?";
  Quiz[153].Text = "Have you had the experience of not knowing whether you were imagining something or it was actually happening?";
  Quiz[154].Text = "Is there a place for everything and everything should be in its place?";
  Quiz[155].Text = "Do you think children need strict discipline?";
  Quiz[156].Text = "In an organization, should everyone have a definite place and a specific role?";
  Quiz[157].Text = "Do you think that a man is a man and a woman is a woman and that it is very important to maintain that distinction?";
  Quiz[158].Text = "Do you like stories that have a definite beginning, middle, and end?";
  Quiz[159].Text = "Can you imagine living with or marrying a person of another race?";
  Quiz[160].Text = "Do you like clear, precise border?";
  Quiz[161].Text = "Are the movies and TV shows you like the best the ones where there are good guys and bad guys and you always know who they are?";
  Quiz[162].Text = "Are good solid frames very important for a picture or a painting?";
  Quiz[163].Text = "Is being dressed neatly and cleanly very important?";
  Quiz[164].Text = "Do you like houses where rooms have definite walls and each room has a definite function?";
  Quiz[165].Text = "Do you agree that East is East and West is West, and never the twain shall meet. (Kipling)?";
  Quiz[166].Text = "Are you a very open person?";
  Quiz[167].Text = "Do you trust people easily?";
  Quiz[168].Text = "Are you always at least a bit on your guard?";
  Quiz[169].Text = "Can you meet someone and trust him or her so completely that you can share just about everything about yourself at the first meeting?";
  Quiz[170].Text = "Do you expect other people to keep a certain distance?";
  Quiz[171].Text = "Are you careful about what you say to people until you get to know them really well?";
  Quiz[172].Text = "Do you get to appointments right on time?";
  Quiz[173].Text = "Do you keep your desk and worktable neat and well organized?";
  Quiz[174].Text = "Are you good at keeping accounts and keeping track of your money?";
  Quiz[175].Text = "Do you have a clear and distinct sense of time?";
  Quiz[176].Text = "Do you know exactly what parts of town are safe and what parts are unsafe?";
  Quiz[177].Text = "Do you have a clear memory of your past and could tell pretty well what happened year by year?";
  Quiz[178].Text = "Are you a down-to-earth, no-nonsense kind of person?";
  Quiz[179].Text = "Do think you would be a good psychotherapist?";
  Quiz[180].Text = "Do you agree that there are no sharp dividing lines between normal people, people with problems, and people who are considered psychotic or crazy?";
  Quiz[181].Text = "Do you think a good teacher must remain in part a child?";
  Quiz[182].Text = "Do you think a good parent has to be a bit of a child too?";
  Quiz[183].Text = "Do you think an artist must in part remain a child?";
  Quiz[184].Text = "Do you agree that a good teacher needs to help a child remain special?";
  Quiz[185].Text = "Do you think children and adults have a lot in common and that they should give themselves a chance to be together without any strict roles?";
  Quiz[186].Text = "Are you easily hurt?";
  Quiz[187].Text = "Are you a very sensitive person?";

  Quiz[188].Text = "Do you have regular depressions?";
  Quiz[189].Text = "Do you have panic attacks?";
  Quiz[190].Text = "Have you been sexually abused?";
  Quiz[191].Text = "Have you been talked into having sex even if you really didn't want to?";
  Quiz[192].Text = "Were you abused by parents as a child?";
  Quiz[193].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[194].Text = "Do you feel as if the thoughts in your head are not your own?";
  Quiz[195].Text = "Have you had paranormal experiences?";

}

/*##########################################################################
#
#   Name       : TQuizL29::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL29::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL29::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
