...
#
##########################################################################*/
void TQuizR2::WriteLongName(TFile &File)
{
	 File.Write("experimental version 2");
}

/*##########################################################################
#
#   Name       : TQuizR2::GetDxData
#
...
#
##########################################################################*/
void TQuizR2::GetDxData(int PopType, int GroupArr[MAX_GROUP_COUNT], int Arr[MAX_SCORE][2], int OnlyNtControl)
{
	TQuizRow Row;
	int res;
	int g;
...
void TQuizR2::SetupTexts()
{
  ...
  Quiz[57].MyGroup = GROUP_ACTIVITY;
  ...
  Quiz[118].MyGroup = GROUP_ACTIVITY;
