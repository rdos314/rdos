...
void TQuizR2::SetupTexts()
{
  ...
  Quiz[107].MyGroup = GROUP_EMOTION;
  Quiz[108].MyGroup = GROUP_EMOTION;
  ...
  Quiz[114].MyGroup = GROUP_EMOTION;
  ...
  Quiz[123].MyGroup = GROUP_REPETITION;
  Quiz[124].MyGroup = GROUP_REPETITION;
  Quiz[125].MyGroup = GROUP_REPETITION;
  Quiz[126].MyGroup = GROUP_REPETITION;
  Quiz[127].MyGroup = GROUP_REPETITION;
  Quiz[128].MyGroup = GROUP_REPETITION;
