...
void TQuizNd::SetupTexts()
{
	...
	Quiz[19].MyGroup = GROUP_MOTOR;
	Quiz[20].MyGroup = GROUP_MOTOR;
	...
	Quiz[58].MyGroup = GROUP_ABILITY;
	Quiz[59].MyGroup = GROUP_ABILITY;
	...
	Quiz[67].MyGroup = GROUP_ABILITY;
	Quiz[68].MyGroup = GROUP_ABILITY;
	Quiz[69].MyGroup = GROUP_NT_RELATION;
	...
	Quiz[125].MyGroup = GROUP_INTROVERT;
	...
	Quiz[136].MyGroup = GROUP_NT_RELATION;
	Quiz[137].MyGroup = GROUP_SOCIAL;
	Quiz[138].MyGroup = GROUP_MIXED;
	Quiz[139].MyGroup = GROUP_MIXED;
	Quiz[140].MyGroup = GROUP_DISABILITY;
	Quiz[141].MyGroup = GROUP_DISABILITY;
	Quiz[142].MyGroup = GROUP_DISABILITY;
	Quiz[143].MyGroup = GROUP_DISABILITY;
	Quiz[144].MyGroup = GROUP_DISABILITY;
	Quiz[145].MyGroup = GROUP_DISABILITY;
	Quiz[146].MyGroup = GROUP_MIXED;
	Quiz[147].MyGroup = GROUP_MIXED;
	Quiz[148].MyGroup = GROUP_INTROVERT;
	...
	Quiz[156].MyGroup = GROUP_DISABILITY;
	Quiz[157].MyGroup = GROUP_DISABILITY;
	Quiz[158].MyGroup = GROUP_DISABILITY;
	Quiz[159].MyGroup = GROUP_DISABILITY;
	Quiz[160].MyGroup = GROUP_DISABILITY;
	Quiz[161].MyGroup = GROUP_DISABILITY;
	Quiz[162].MyGroup = GROUP_DISABILITY;
	Quiz[163].MyGroup = GROUP_DISABILITY;
	Quiz[164].MyGroup = GROUP_DISABILITY;
	Quiz[165].MyGroup = GROUP_DISABILITY;
	Quiz[166].MyGroup = GROUP_DISABILITY;
	Quiz[167].MyGroup = GROUP_DISABILITY;
	Quiz[168].MyGroup = GROUP_DISABILITY;
	Quiz[169].MyGroup = GROUP_DISABILITY;
	Quiz[170].MyGroup = GROUP_MIXED;
	Quiz[171].MyGroup = GROUP_DISABILITY;
	Quiz[172].MyGroup = GROUP_SOCIAL;
	Quiz[173].MyGroup = GROUP_DISABILITY;
	Quiz[174].MyGroup = GROUP_MIXED;
	Quiz[175].MyGroup = GROUP_MIXED;
	Quiz[176].MyGroup = GROUP_MIXED;
	Quiz[177].MyGroup = GROUP_MOTOR;
	Quiz[178].MyGroup = GROUP_DISABILITY;
	...
	Quiz[192].MyGroup = GROUP_DISABILITY;
	Quiz[193].MyGroup = GROUP_DISABILITY;
	Quiz[194].MyGroup = GROUP_DISABILITY;
