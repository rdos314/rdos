...
void TQuizNd::SetupTexts()
{
	...
	Quiz[144].MyGroup = GROUP_DYSC;
	Quiz[145].MyGroup = GROUP_DYSC;
	...
	Quiz[156].MyGroup = GROUP_DYSC;
	Quiz[157].MyGroup = GROUP_DYSC;
	Quiz[158].MyGroup = GROUP_DYSC;
	Quiz[159].MyGroup = GROUP_DYSC;
	Quiz[160].MyGroup = GROUP_DYSC;
	Quiz[161].MyGroup = GROUP_DYSC;
	Quiz[162].MyGroup = GROUP_DYSC;
	...
	Quiz[193].MyGroup = GROUP_DYSC;
	Quiz[194].MyGroup = GROUP_DYSC;
	Quiz[195].MyGroup = GROUP_NT_NVC;
