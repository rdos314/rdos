...
void TQuizNd::SetupTexts()
{
	...
	Quiz[163].MyGroup = GROUP_MATH;
	Quiz[164].MyGroup = GROUP_MATH;
	Quiz[165].MyGroup = GROUP_MATH;
	Quiz[166].MyGroup = GROUP_MATH;
	Quiz[167].MyGroup = GROUP_MATH;
	Quiz[168].MyGroup = GROUP_MATH;
	Quiz[169].MyGroup = GROUP_MATH;
	Quiz[170].MyGroup = GROUP_MIXED;
	Quiz[171].MyGroup = GROUP_MATH;
	Quiz[172].MyGroup = GROUP_SOCIAL;
	Quiz[173].MyGroup = GROUP_MATH;
