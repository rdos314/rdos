...
#
# convbr4.cpp
# Convert exported quiz-br4 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvBr4()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-br4.csv");
    TFile outfile("bin\\quizbr4.bin", 0);
    char *ptr;
