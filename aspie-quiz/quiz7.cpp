...
#
##########################################################################*/
void TQuiz7::WriteLongName(TFile &File)
{
...
#
##########################################################################*/
void TQuiz7::GetDxData(int PopType, int GroupArr[MAX_GROUP_COUNT], int Arr[MAX_SCORE][2], int OnlyNtControl)
{
	TQuizRow Row;
	int res;
	int g;
...
void TQuiz7::SetupTexts()
{
	...
	Quiz[32].MyGroup = GROUP_NT_HUNTING;
	Quiz[33].MyGroup = GROUP_NT_HUNTING;
	Quiz[34].MyGroup = GROUP_NT_HUNTING;
	...
	Quiz[76].MyGroup = GROUP_ASPIE_SENSORY;
	...
	Quiz[97].MyGroup = GROUP_NT_OBSESSION;
	Quiz[98].MyGroup = GROUP_SOCIAL;
	Quiz[99].MyGroup = GROUP_NT_OBSESSION;
	Quiz[100].MyGroup = GROUP_SOCIAL;
	Quiz[101].MyGroup = GROUP_NT_OBSESSION;
	...
	Quiz[130].MyGroup = GROUP_ASPIE_NVC;
	...
	Quiz[156].MyGroup = GROUP_ASPIE_BIOLOGY;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuiz7::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
