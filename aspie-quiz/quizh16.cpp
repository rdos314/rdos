...
/*##########################################################################
#
#   Name       : TQuizH16::TQuizH16
#
#   Purpose....: Constructor for TQuizH16
#
...
#
##########################################################################*/
TQuizH16::TQuizH16(const char *FileName)
  : TQuiz(156),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH16::~TQuizH16
#
#   Purpose....: Destructor for TQuizH16
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH16::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH16::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH16::GetCatCount(int Question)
{
        return 3;
}
...
#
##########################################################################*/
void TQuizH16::WriteName(TFile &File)
{
         File.Write("H16");
}
...
#
##########################################################################*/
void TQuizH16::WriteLongName(TFile &File)
{
         File.Write("H16");
}
...
void TQuizH16::SetupTexts()
{
  ...
  Quiz[150].Text = "Chasing";
  Quiz[151].Text = "Courting";
  Quiz[152].Text = "Fighting";
  Quiz[153].Text = "Following";
  Quiz[154].Text = "Guarding";
  Quiz[155].Text = "Playing";
}

/*##########################################################################
#
#   Name       : TQuizH16::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH16::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH16::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
