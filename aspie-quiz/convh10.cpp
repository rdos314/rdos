...
#
# convh10.cpp
# Convert exported quiz-h10 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvH10()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h10.csv");
    TFile outfile("bin\\quizh10.bin", 0);
    char *ptr;
