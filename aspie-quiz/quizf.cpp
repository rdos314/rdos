...
void TQuizFinal::SetupTexts()
{
  ...
  Quiz[131].MyGroup = GROUP_SEX;
  Quiz[132].MyGroup = GROUP_SEX;
  Quiz[133].MyGroup = GROUP_SEX;
...
void TQuizFinal::SetupCross(TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd, TQuiz *Quiz5, TQuiz *Quiz6, TQuiz *Quiz7, TQuiz *Quiz8, TQuiz *Quiz9, TQuiz *QuizR1, TQuiz *QuizR2, TQuiz *QuizR3, TQuiz *QuizR4, TQuiz *QuizR5, TQuiz *QuizR6, TQuiz *QuizR7, TQuiz *QuizS1, TQuiz *QuizS2, TQuiz *QuizS3, TQuiz *QuizS4, TQuiz *QuizS5, TQuiz *QuizS6, TQuiz *QuizS7, TQuiz *QuizS8, TQuiz *QuizS9, TQuiz *QuizS10, TQuiz *QuizS11, TQuiz *QuizS12, TQuiz *QuizN1, TQuiz *QuizN2, TQuiz *QuizN3, TQuiz *QuizN4)
{
    ...
    DefineCross(QuizN4, 4, 4);
    DefineCross(QuizN4, 5, 5);
    DefineCross(QuizN4, 6, 6);
    DefineCross(QuizN4, 7, 7);
    DefineCross(QuizN4, 8, 8);
    DefineCross(QuizN4, 9, 9);
    DefineCross(QuizN4, 10, 10);
    DefineCross(QuizN4, 11, 11);
    DefineCross(QuizN4, 12, 12);
    DefineCross(QuizN4, 13, 13);
    DefineCross(QuizN4, 14, 14);
    DefineCross(QuizN4, 15, 15);
    DefineCross(QuizN4, 16, 16);
    DefineCross(QuizN4, 17, 17);
    DefineCross(QuizN4, 18, 18);
    DefineCross(QuizN4, 19, 19);
    DefineCross(QuizN4, 20, 20);
    DefineCross(QuizN4, 21, 21);
    DefineCross(QuizN4, 22, 22);
    DefineCross(QuizN4, 23, 23);
    DefineCross(QuizN4, 24, 24);
    DefineCross(QuizN4, 25, 25);
    DefineCross(QuizN4, 26, 26);
    ...
    DefineCross(QuizN4, 34, 33);
    DefineCross(QuizN4, 35, 34);
    DefineCross(QuizN4, 36, 35);
    DefineCross(QuizN4, 37, 36);
    DefineCross(QuizR3, 38, 158);
    DefineCross(QuizN4, 39, 37);
    DefineCross(QuizN4, 40, 38);
    DefineCross(QuizN4, 41, 39);
    DefineCross(QuizN4, 42, 40);
    DefineCross(QuizN4, 43, 41);
    DefineCross(QuizN4, 44, 42);
    DefineCross(QuizN4, 45, 43);
    DefineCross(QuizN4, 46, 44);
    DefineCross(QuizN4, 47, 45);
    DefineCross(QuizN4, 48, 46);
    DefineCross(QuizN4, 49, 156);
    DefineCross(QuizN4, 50, 47);
    DefineCross(QuizN4, 51, 48);
    DefineCross(QuizN4, 52, 49);
    DefineCross(QuizN4, 53, 50);
    DefineCross(QuizN4, 54, 51);
    DefineCross(QuizN4, 55, 52);
    DefineCross(QuizN4, 56, 53);
    ...
    DefineCross(QuizN4, 64, 61);
    DefineCross(QuizN4, 65, 63);
    DefineCross(QuizN4, 66, 64);
    DefineCross(QuizN4, 67, 65);
    DefineCross(QuizN4, 68, 66);
    DefineCross(QuizN4, 69, 67);
    DefineCross(QuizN4, 70, 70);
    DefineCross(QuizN4, 71, 68);
    DefineCross(QuizN4, 72, 69);
    DefineCross(QuizN4, 73, 71);
    DefineCross(QuizN4, 74, 73);
    DefineCross(QuizN4, 75, 72);
    DefineCross(QuizN4, 76, 74);
    DefineCross(QuizN4, 77, 75);
    DefineCross(QuizN4, 78, 76);
    DefineCross(QuizN4, 79, 77);
    DefineCross(QuizN4, 80, 78);
    DefineCross(QuizN4, 81, 81);
    DefineCross(QuizN4, 82, 80);
    DefineCross(QuizN4, 83, 79);
    DefineCross(QuizN4, 84, 82);
    DefineCross(QuizN4, 85, 83);
    DefineCross(QuizN4, 86, 84);
    ...
    DefineCross(QuizN4, 94, 90);
    DefineCross(QuizN4, 95, 92);
    DefineCross(QuizN4, 96, 93);
    DefineCross(QuizN4, 97, 94);
    DefineCross(QuizN4, 98, 95);
    DefineCross(QuizN4, 99, 96);
    DefineCross(QuizN4, 100, 97);
    DefineCross(QuizN4, 101, 98);
    DefineCross(QuizN4, 102, 99);
    DefineCross(QuizN4, 103, 100);
    DefineCross(QuizN4, 104, 101);
    DefineCross(QuizN4, 105, 103);
    DefineCross(QuizN4, 106, 102);
    DefineCross(QuizN4, 107, 104);
    DefineCross(QuizN4, 108, 105);
    DefineCross(QuizN4, 109, 106);
    DefineCross(QuizN4, 110, 107);
    DefineCross(QuizN4, 111, 108);
    DefineCross(QuizN4, 112, 109);
    DefineCross(QuizN4, 113, 110);
    DefineCross(QuizN4, 114, 111);
    DefineCross(QuizN4, 115, 112);
    DefineCross(QuizN4, 116, 113);
    ...
    DefineCross(QuizN4, 124, 121);
    DefineCross(QuizN4, 125, 122);
    DefineCross(QuizN4, 126, 123);
    DefineCross(QuizN4, 127, 124);
    DefineCross(QuizN4, 128, 125);
    DefineCross(QuizN4, 129, 126);
    DefineCross(QuizN4, 130, 127);
    DefineCross(QuizN4, 131, 140);
    DefineCross(QuizN4, 132, 142);
    DefineCross(QuizN4, 133, 143);
    DefineCross(QuizN4, 134, 151);
    DefineCross(QuizN4, 135, 128);
    DefineCross(QuizN4, 136, 129);
    DefineCross(QuizN4, 137, 130);
    DefineCross(QuizN4, 138, 152);
    DefineCross(QuizN4, 139, 131);
    DefineCross(QuizN4, 140, 132);
    DefineCross(QuizN4, 141, 62);
    DefineCross(QuizN4, 142, 133);
    DefineCross(QuizN4, 143, 153);
    DefineCross(QuizN4, 144, 134);
    DefineCross(QuizN4, 145, 135);
