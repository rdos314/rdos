...
void TQuizFinal::SetupTexts()
{
  ...
  Quiz[29].MyGroup = GROUP_NT_SOCIAL;
  ...
  Quiz[0].Text = "¿A menudo se siente usted como si no estuviera sincronizado/a con los demás?";
  Quiz[1].Text = "¿Suele usted estar tan absorto/a en sus intereses especialies que se le olvida todo o ignora todo lo demás?";
  Quiz[2].Text = "¿Su sentido de humor se considera diferente de lo mayoritario o raro?";
  Quiz[3].Text = "¿Se enfoca usted en un tema a la vez y se hace experto/a en aquel tema?";
  Quiz[4].Text = "¿Piensa usted o piensan otros que usted tiene maneras poco convencionales para solucionar problemas?";
  Quiz[5].Text = "¿Tiene usted valores o puntos e vista que son muy anticuados o muy adelantado?";
  Quiz[6].Text = "¿Recuerda y se interesa en las detalles de que otros por lo visto no hacen caso?";
  Quiz[7].Text = "¿Percibe usted diseños en las cosas todo el tiempo?";
  Quiz[8].Text = "¿Necesita usted plazos de tiempo para contemplar solo/a?";
  Quiz[9].Text = "¿Instrucciones verbales lo/la confunden, especialmente varias instrucciones que se dan a la misma vez.?";
  Quiz[10].Text = "¿Suele atascarse tanto en las detalles que se le escapa el concepto más grande?";
  Quiz[11].Text = "¿Lo encuentras difícil hacer varias cosas al mismo tiempo o moverse el foco de una tarea a otra, y por eso usted tiene que terminar una tarea antes de empezar otra?";
  Quiz[12].Text = "¿Le cuesta describir o resumir las cosas como eventos, conversaciones o algo que ha leido?";
  Quiz[13].Text = "¿Tiene que hacer cosas si mismo/a para acordarse de ellas?";
  Quiz[14].Text = "¿Si hay una interrupción, puede ud. volver a lo que estaba haciendo antes?";
  Quiz[15].Text = "¿Le cuesta aprender cosas que no le interesan?";
  Quiz[16].Text = "¿Lo encuentra difícil apuntar notas en lecturas?";
  Quiz[17].Text = "¿Puede seguir varias conversaciones a la misma vez?";
  Quiz[18].Text = "¿Le parece de vital importancia no estar molestado/a cuando se está enfocado/a en los intereses especiales?";
  Quiz[19].Text = "¿Antes de ir a algun lugar or hacer algo, necesita usted tener una imagen mental de lo que va a pasar para prepararse en adelantado y para que se pueda estar mentalmente preparado/a?";
  Quiz[20].Text = "¿Prefiere llevar la misma ropa y/o comer la misma comida todos los días?";
  Quiz[21].Text = "¿Se frustra usted cuando una actividad que le importa mucho está interrumpida?";
  Quiz[22].Text = "¿Se frustra usted si no puede sentarse en su asiento favorito?" ;
  Quiz[23].Text = "¿Tiene usted gran cariño para ciertos objetos favoritos?";
  Quiz[24].Text = "¿Tiene que seguir ciertas rutinas?";
  Quiz[25].Text = "¿Le molesta a usted cuando la gente llega más temprano o más tarde de lo acordado?";
  Quiz[26].Text = "¿Necesita usted listas y horarios para tener las cosas hechas?";
  Quiz[27].Text = "¿Le gusta conocerle a la gente por primera vez?";
  Quiz[28].Text = "¿Sus puntos de visto son típicos de su grupo paritario?";
  Quiz[29].Text = "¿Le gusta ser anfitrión(a) o organizar eventos?";
  Quiz[30].Text = "¿Le interesa la moda última?";
  Quiz[31].Text = "¿Prefiere usted la compañia de gente de su mismo grupo generacional?";
  Quiz[32].Text = "¿Le gusta el chisme?";
  Quiz[33].Text = "¿Usted es muy soñador/a y a menudo está sumido/a en sus pensamientos?";
  Quiz[34].Text = "¿Le cuesta empezar o terminar proyectos?";
  Quiz[35].Text = "¿Se distrae usted facilmente?";
  Quiz[36].Text = "¿Tiene dificultad usted para organizar su trabajo o vida personal?";
  Quiz[37].Text = "¿Es o era usted hiperactivo(a)?";
  Quiz[38].Text = "¿Suele usted dejar cosas para más tarde?";
  Quiz[39].Text = "¿Suele usted atascarse cuando le preguntan cosas en una situación social?";
  Quiz[40].Text = "¿Tiene dificultad con los deportes de equipo otros esfuerzos de grupo?";
  Quiz[41].Text = "¿Le ha sido más difícil para usted que para los demás encontrar y mantener amistades?";
  Quiz[42].Text = "¿Evita usted cuando sea possible hablar cara a cara con una persona que usted no conoce bien?";
  Quiz[43].Text = "¿Se cansa usted mucho después de hacer vida social y tiene que revitalizarse solo/a?";
  Quiz[44].Text = "¿Le molesta estar tocado o abrazado a menos que se sienta preparado o lo haya pedido?";
  Quiz[45].Text = "¿La gente lo/la considera distante o apartado/a?";
  Quiz[46].Text = "¿Le cuesta ser íntimo(a) emocionalmente con otros?";
  Quiz[47].Text = "¿Le molesta tomar la mano?";
  Quiz[48].Text = "¿Prefiere usted hacer las cosas solo/a, incluso si podría usar la ayuda o experiencia de otros?";
  Quiz[49].Text = "¿Le molesta cuando la gente camina detrás de usted?";
  Quiz[50].Text = "¿Le molesta cuando la gente lo/la pasa a visitar sin que esté invitada?";
  Quiz[51].Text = "¿Saludar o decirle “hola” a la gente cuando se conocen te parece natural?";
  Quiz[52].Text = "¿Le molesta leer en alta voz?";
  Quiz[53].Text = "¿La gente hace comentarios sobre sus hábitos y gestos raros?";
  Quiz[54].Text = "¿A veces la gente piensa que está sonriendose en el momento equivocado?";
  Quiz[55].Text = "¿A menudo tiene varios pensamientos que no puede expresar con palabras?";
  Quiz[56].Text = "¿A menudo no sabe usted donde debe ponerse los brazos?";
  Quiz[57].Text = "¿Suele usted hablar demasiado bajito o demasiado fuerte?";
  Quiz[58].Text = "¿Los demás han observado que usted haces expresiones de cara fuera de lo común?";
  Quiz[59].Text = "¿Lo/la han acusado de mirar fijamente?";
  Quiz[60].Text = "¿Otros le han dicho que tiene una postura o un paso impar?";
  Quiz[61].Text = "¿A veces se saca usted las mano o se gira los dedos?";
  Quiz[62].Text = "¿Usted se mece de acá para allá o de lado a lado para consolarse o calmarse cuando está demasiado estimulado/a o entusiasmado/a?";
  Quiz[63].Text = "¿Melodias o ritmos recien oidos le suelen a pegarse y repetirse en la mente?";
  Quiz[64].Text = "¿Durante conversaciones, emplea usted sonidos pequeños que le parece los demás no usan?";
  Quiz[65].Text = "¿Tiene la costumbre de repetirse las últimas palabras suyas o de otros en voz alta (ecolalia)?";
  Quiz[66].Text = "¿Usted se da golpecitos en las orejas o apresiona los ojos (por ejemplo, cuando está pensando, estresado o angustiado?";
  Quiz[67].Text = "¿Juguetea con cosas?";
  Quiz[68].Text = "¿Usa usted clichés o repite frases que vienen de otras situaciones o personas?";
  Quiz[69].Text = "¿Anda usted de un lado para otro cuando está ansioso/a?";
  Quiz[70].Text = "¿Tatamudea usted cuando está estresiado/a?";
  Quiz[71].Text = "¿Suele usted mirar mucho a la gente que le cae bien y mirar muy poco o no mirar a la gente que le cae mal?";
  Quiz[72].Text = "¿Se muerde usted los labios, la mejilla o la lengua (por ejemplo cuando se siente ansioso o nervioso)?";
  Quiz[73].Text = "¿habla ud. a si mismo?";
  Quiz[74].Text = "¿A menudo confunde usted los pronombres? por ejemplo, dice \"tú\" o \"nosotros\" cuando quiere decir \"Yo\" o al revés?";
  Quiz[75].Text = "¿Tiene dificultades para pronunciar bien las palabras?";
  Quiz[76].Text = "¿Se le hace difícil entender como portarse en varias situaciones?";
  Quiz[77].Text = "¿En conversaciones, tiene problemas con coordinación y reciprocidad?";
  Quiz[78].Text = "¿La gente le entiende mal a usted a menudo?" ;
  Quiz[79].Text = "¿Suele usted expresarse las emociones e una manera que pueda desconcertarles a los demás?";
  Quiz[80].Text = "¿Cuando algo le llama la atención, se le puede olvidar que está en una situación social?";
  Quiz[81].Text = "¿No tiene usted conciencia de la normas y límites socials a menos que alguien se los explique?";
  Quiz[82].Text = "¿Suele usted interpretar las cosas literalmente o responder a preguntas retóricas?";
  Quiz[83].Text = "¿Se puede explicar las intenciones de la gente?";
  Quiz[84].Text = "¿Suele usted decir cosas no apropiadas socialmente?";
  Quiz[85].Text = "¿Cuando está hablando por teléfono , sabe usted por instinto cuando le toca hablar?";
  Quiz[86].Text = "¿Tiene talento para responder adecuadamente a cortesias y gestos sociales?";
  Quiz[87].Text = "¿A menudo Habla usted de sus intereses especiales si les interesen a la gente o no?";
  Quiz[88].Text = "¿Sabe usted cuando está esperada una disculpa?";
  Quiz[89].Text = "¿Tiene usted talento para interpretar las expresiones de cara?";
  Quiz[90].Text = "¿Se siente comodo(a) en situaciones románticas?";
  Quiz[91].Text = "¿Lo encuentra fácil describirse los sentimientos?";
  Quiz[92].Text = "¿Tiene usted una voz monótona?";
  Quiz[93].Text = "¿Tiene problemas para reconocer las caras de la gente (prosopagnosia)?";
  Quiz[94].Text = "¿Es usted tan honesto/a y sincero/a que supone que todo el mundo es igual?";
  Quiz[95].Text = "¿Le gusta mirar algo que parpadea o gira?";
  Quiz[96].Text = "¿Le fascina agua que fluye lento?";
  Quiz[97].Text = "¿A veces tiene usted el impulso de saltar sobre cosas?";
  Quiz[98].Text = "¿Le gusta imitar a los sonidos de animales?";
  Quiz[99].Text = "¿Le gusta caminar a punto de pie?";
  Quiz[100].Text = "¿Se ha fascinado por hacer trampas?";
  Quiz[101].Text = "¿Le cuesta apuntar un mensaje por teléfono y pasarlo correctamente a otra persona?";
  Quiz[102].Text = "¿Las cosas se le caen cuando se está enfocando en otras cosas?";
  Quiz[103].Text = "¿Le cuesta llenar un formulario?";
  Quiz[104].Text = "¿Lo encuentra difícil reconover números de teléfono cuando están pronunciados de una manera diferente?";
  Quiz[105].Text = "¿Tiene dificultad para leer la hora en un reloj?";
  Quiz[106].Text = "¿Confunde usted números como 95 y 59?";
  Quiz[107].Text = "¿Sonidos lejanos lo/la distraen de repente?";
  Quiz[108].Text = "¿Siente usted sonidos bajos que otros no sienten?";
  Quiz[109].Text = "¿Le cuesta filtrarse los sonidos del fondo cuando está conversando con alguien?";
  Quiz[110].Text = "¿Se siente  torturado/a por etiquetas en la ropa, por prendas que le quedan apretadas, o ropa hecha de la tela “equivocada”?";
  Quiz[111].Text = "¿Usted es extremadamente sensible o no sensible a dolor físico, o podría usted disfrutar de algunos tipos de dolor?";
  Quiz[112].Text = "¿Sus ojos son muy sensibles a la luz brillante y al resplandor?";
  Quiz[113].Text = "¿Es sensible a cambios de humedad y presión del aire?";
  Quiz[114].Text = "¿Se espanta por instinto por el sonido de un moto?";
  Quiz[115].Text = "¿Le molesta a usted cuando la gente da una patada en el suelo?";
  Quiz[116].Text = "¿Le es más natural para usted pensar en forma de imagines que en forma de palabras?";
  Quiz[117].Text = "¿Le falta conciencia o control del cuerpo?";
  Quiz[118].Text = "¿Le cuesta imitar a o anticipar los movimientos  de los demás? (por ejemplo cuando está aprendiendo pasos de un baile o en la clase de gymnasia)";
  Quiz[119].Text = "¿Tiene usted un mal concepto de la hora el día?";
  Quiz[120].Text = "¿Tiene usted problemas para adivinar la edad de la gente?";
  Quiz[121].Text = "¿Le cuesta  calcular distancia, altura, profundidad, o velocidad?";
  Quiz[122].Text = "¿Tiene dificultad con actividades que requieren precision manual, por ejemplo abrochandose los cordones de zapato, abrochandose botones o manejando cosas pequeñas?";
  Quiz[123].Text = "¿Tiene problemas usted para encontrar lugares nuevos?";
  Quiz[124].Text = "¿Suele usted cerrarse o desvanecerse cuando se siente agobiado/a o abrumado/a?";
  Quiz[125].Text = "¿Le ha sido más difícil lograr cosas solo/a que le es para la mayoria de su grupo coetáneo?";
  Quiz[126].Text = "¿Tiene miedo a veces en situaciones seguras?";
  Quiz[127].Text = "¿Le cuesta aceptar críticas, correciones y direcciones?";
  Quiz[128].Text = "¿Es usted propensa a deprimirse?";
  Quiz[129].Text = "¿Ha estado intimadado/a, abusado/a or alguien se ha aprovechado de usted?";
  Quiz[130].Text = "¿Suele ser impaciente y/o impulsivo/a?";
  Quiz[131].Text = "¿Tiene usted una opinion alternativa de lo que se considera atractivo en el sexo opuesto?";
  Quiz[132].Text = "¿Usted cabe naturalmente en los estereotipos o normas de género?";
  Quiz[133].Text = "¿Tiene preferencias sexuales raras?";
  Quiz[134].Text = "¿Lo encuentra usted natural que los hombres inician relacciones románticas?";
  Quiz[135].Text = "¿A veces no se siente nada aunque los demás esperan  que se sienta algo?";
  Quiz[136].Text = "¿Usted necesita más tiempo en conversaciones para considerar bien su respuesta, lo que puede resultar en una pausa antes de que conteste?";
  Quiz[137].Text = "¿Se ha sentido alguna vez como si estuviera jugando a un juego, pretendiendo ser como la gente alrededor?";
  Quiz[138].Text = "¿Lo encuentra más fácil comprender y comunicarse con la gente que son fuera de lo común que con la gente que se considera “normal”?";
  Quiz[139].Text = "¿Piensa usted o piensan otros que su manera de comer es inusual?";
  Quiz[140].Text = "¿Ha tomado la iniciativa solo para enterarse después que nadie quería que lo hiciera?";
  Quiz[141].Text = "¿Invierte palabras en conversaciones?";
  Quiz[142].Text = "¿Sus intereses son inmaduros?";
  Quiz[143].Text = "¿Si alguien le pidiera describirse, usted se describiría de una manera distante, como si estuviera describiendo a otra persona?";
  Quiz[144].Text = "¿Espera usted que la gente le vayan a comprender los pensamientos, experiencias y opiniones sin que les tengas que decirselos?";

  Quiz[145].Text = "¿Usted se acuerda facilmente de instrucciones verbales?";
  Quiz[146].Text = "¿Trabaja bien en equipo?" ;
  Quiz[147].Text = "¿Tiene usted un buen concepto de lo que se debe hacer en una situación social?";
  Quiz[148].Text = "¿Para usted es fácil adivinar la edad de la gente?";
  Quiz[149].Text = "¿Usted es amable cuando otros lo/la critican, corrigen y dirigen?";
