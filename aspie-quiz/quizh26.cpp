...
/*##########################################################################
#
#   Name       : TQuizH26::TQuizH26
#
#   Purpose....: Constructor for TQuizH26
#
...
#
##########################################################################*/
TQuizH26::TQuizH26(const char *FileName)
  : TQuiz(193),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH26::~TQuizH26
#
#   Purpose....: Destructor for TQuizH26
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH26::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH26::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH26::GetCatCount(int Question)
{
    if (Question >= 192)
        return 5;
    else
...
#
##########################################################################*/
void TQuizH26::WriteName(TFile &File)
{
    File.Write("H26");
}
...
#
##########################################################################*/
void TQuizH26::WriteLongName(TFile &File)
{
    File.Write("H26");
}
...
void TQuizH26::SetupTexts()
{
  ...
  Quiz[192].Text = "Flirting vs chasing";

}

/*##########################################################################
#
#   Name       : TQuizH26::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH26::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH26::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
