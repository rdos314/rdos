...
#
# convl29.cpp
# Convert exported quiz-l29 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 196);
}

/*################## ConvL29 ##########################
*   Purpose....: Convert quiz l29                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL29()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l29.csv");
    TFile outfile("bin\\quizl29.bin", 0);
    char *ptr;
