...
#
# convsw1.cpp
# Convert exported quiz-sw1 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvSw1()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-sw1.csv");
    TFile outfile("bin\\quizsw1.bin", 0);
    char *ptr;
