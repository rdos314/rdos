...
/*##########################################################################
#
#   Name       : TQuizH12::TQuizH12
#
#   Purpose....: Constructor for TQuizH12
#
...
#
##########################################################################*/
TQuizH12::TQuizH12(const char *FileName)
  : TQuiz(150),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH12::~TQuizH12
#
#   Purpose....: Destructor for TQuizH12
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH12::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH12::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH12::GetCatCount(int Question)
{
        return 3;
}
...
#
##########################################################################*/
void TQuizH12::WriteName(TFile &File)
{
         File.Write("H12");
}
...
#
##########################################################################*/
void TQuizH12::WriteLongName(TFile &File)
{
         File.Write("H12");
}
...
#
##########################################################################*/
void TQuizH12::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH12::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
...
/*##################  TQuizH12::WriteEyeResults ##########################
*   Purpose....: Write mind-eye test results                                                   #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH12::WriteEyeResults(const char *filename)
{
    ...
    for (i = 0; i < 28; i++)
    {
        for (j = 0; j < 85; j++)
        {
            val = 1000000 * FAspieEyeArr[i][j] / FAspieEyeCount[i];
            sprintf(str, "0.%06d,", val);
            outfile.Write(str);
        }

        for (j = 0; j < 85; j++)
        {
            val = 1000000 * FNtEyeArr[i][j] / FNtEyeCount[i];
            sprintf(str, "0.%06d,", val);
            outfile.Write(str);
        }
        str[0] = 0xd;
