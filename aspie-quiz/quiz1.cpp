...
void TQuizI::SetupTexts()
{
	...
	Quiz[9].MyGroup = GROUP_REPETITION;
	...
	Quiz[73].MyGroup = GROUP_EMOTION;
	Quiz[74].MyGroup = GROUP_EMOTION;
	Quiz[75].MyGroup = GROUP_EMOTION;
	Quiz[76].MyGroup = GROUP_EMOTION;
	Quiz[77].MyGroup = GROUP_EMOTION;
	Quiz[78].MyGroup = GROUP_EMOTION;
