...
/*##########################################################################
#
#   Name       : TQuizL32::TQuizL32
#
#   Purpose....: Constructor for TQuizL32
#
...
#
##########################################################################*/
TQuizL32::TQuizL32(const char *FileName)
  : TQuiz(240),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL32::~TQuizL32
#
#   Purpose....: Destructor for TQuizL32
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL32::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL32::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL32::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL32::WriteName(TFile &File)
{
    File.Write("L32");
}
...
#
##########################################################################*/
void TQuizL32::WriteLongName(TFile &File)
{
    File.Write("L32");
}
...
void TQuizL32::SetupTexts()
{
  ...
  Quiz[195].Text = "Do you have dreams, daydreams, nightmares in which your body or someone else's body is being stabbed, injured, or torn apart?";
  Quiz[196].Text = "Do things around you seem to change their size and shape?";
  Quiz[197].Text = "Every time something frightening happens to you, do you have nightmares or fantasies or flashbacks involving the frightening event?";
  Quiz[198].Text = "Do you have often had the experience of different senses coming together. For example, have you felt that you could smell a color, or see a sound, or hear an odor?";
  Quiz[199].Text = "Can your dreams be so vivid that even later you can't tell them from waking reality?";
  Quiz[200].Text = "Do your body sometimes seem to change its size and shape?";
  Quiz[201].Text = "Have you had the experience of someone calling you or speaking your name and not being sure whether it was really happening or you were imagining it?";
  Quiz[202].Text = "Have you had the experience of not knowing whether you were imagining something or it was actually happening?";
  Quiz[203].Text = "Is there a place for everything and everything should be in its place?";
  Quiz[204].Text = "Do you think children need strict discipline?";
  Quiz[205].Text = "In an organization, should everyone have a definite place and a specific role?";
  Quiz[206].Text = "Do you think that a man is a man and a woman is a woman and that it is very important to maintain that distinction?";
  Quiz[207].Text = "Do you like stories that have a definite beginning, middle, and end?";
  Quiz[208].Text = "Can you imagine living with or marrying a person of another race?";
  Quiz[209].Text = "Do you like clear, precise border?";
  Quiz[210].Text = "Are the movies and TV shows you like the best the ones where there are good guys and bad guys and you always know who they are?";
  Quiz[211].Text = "Are good solid frames very important for a picture or a painting?";
  Quiz[212].Text = "Is being dressed neatly and cleanly very important?";
  Quiz[213].Text = "Do you like houses where rooms have definite walls and each room has a definite function?";
  Quiz[214].Text = "Do you agree that East is East and West is West, and never the twain shall meet. (Kipling)?";
  Quiz[215].Text = "Are you a very open person?";
  Quiz[216].Text = "Do you trust people easily?";
  Quiz[217].Text = "Are you always at least a bit on your guard?";
  Quiz[218].Text = "Can you meet someone and trust him or her so completely that you can share just about everything about yourself at the first meeting?";
  Quiz[219].Text = "Do you expect other people to keep a certain distance?";
  Quiz[220].Text = "Are you careful about what you say to people until you get to know them really well?";
  Quiz[221].Text = "Do you get to appointments right on time?";
  Quiz[222].Text = "Do you keep your desk and worktable neat and well organized?";
  Quiz[223].Text = "Are you good at keeping accounts and keeping track of your money?";
  Quiz[224].Text = "Do you have a clear and distinct sense of time?";
  Quiz[225].Text = "Do you know exactly what parts of town are safe and what parts are unsafe?";
  Quiz[226].Text = "Do you have a clear memory of your past and could tell pretty well what happened year by year?";
  Quiz[227].Text = "Are you a down-to-earth, no-nonsense kind of person?";
  Quiz[228].Text = "Do think you would be a good psychotherapist?";
  Quiz[229].Text = "Do you agree that there are no sharp dividing lines between normal people, people with problems, and people who are considered psychotic or crazy?";
  Quiz[230].Text = "Do you think a good teacher must remain in part a child?";
  Quiz[231].Text = "Do you think a good parent has to be a bit of a child too?";
  Quiz[232].Text = "Do you think an artist must in part remain a child?";
  Quiz[233].Text = "Do you agree that a good teacher needs to help a child remain special?";
  Quiz[234].Text = "Do you think children and adults have a lot in common and that they should give themselves a chance to be together without any strict roles?";
  Quiz[235].Text = "Are you easily hurt?";
  Quiz[236].Text = "Are you a very sensitive person?";

  Quiz[237].Text = "Do you have regular depressions?";
  Quiz[238].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[239].Text = "Do you feel as if the thoughts in your head are not your own?";

}

/*##########################################################################
#
#   Name       : TQuizL32::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL32::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL32::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
