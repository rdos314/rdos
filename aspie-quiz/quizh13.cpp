...
/*##########################################################################
#
#   Name       : TQuizH13::TQuizH13
#
#   Purpose....: Constructor for TQuizH13
#
...
#
##########################################################################*/
TQuizH13::TQuizH13(const char *FileName)
  : TQuiz(150),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH13::~TQuizH13
#
#   Purpose....: Destructor for TQuizH13
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH13::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH13::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH13::GetCatCount(int Question)
{
        return 3;
}
...
#
##########################################################################*/
void TQuizH13::WriteName(TFile &File)
{
         File.Write("H13");
}
...
#
##########################################################################*/
void TQuizH13::WriteLongName(TFile &File)
{
         File.Write("H13");
}
...
#
##########################################################################*/
void TQuizH13::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH13::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH13::WriteEyeResults(const char *filename)
{
