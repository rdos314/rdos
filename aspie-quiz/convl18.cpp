...
#
# convl18.cpp
# Convert exported quiz-l18 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("L18: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
    printf("\r\n");
}
...
void ConvL18()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l18.csv");
    TFile outfile("bin\\quizl18.bin", 0);
    char *ptr;
