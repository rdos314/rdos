...
/*##########################################################################
#
#   Name       : TQuizG1::TQuizG1
#
#   Purpose....: Constructor for TQuizG1
#
...
#   Name       : TQuizG1::~TQuizG1
#
#   Purpose....: Destructor for TQuizG1
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizG1::GetCatCount(int Question)
{
	return 3;
}
...
#
##########################################################################*/
void TQuizG1::WriteName(TFile &File)
{
	 File.Write("G1");
}
...
#
##########################################################################*/
void TQuizG1::WriteLongName(TFile &File)
{
...
#
##########################################################################*/
void TQuizG1::SetupTexts()
{
}

/*##################  TQuizG1::LoadReferers ##########################
...
#
##########################################################################*/
void TQuizG1::SetupCross(TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd, TQuiz *Quiz5, TQuiz *Quiz6, TQuiz *Quiz7, TQuiz *Quiz8, TQuiz *Quiz9, TQuiz *QuizR1, TQuiz *QuizR2, TQuiz *QuizR3, TQuiz *QuizR4, TQuiz *QuizR5, TQuiz *QuizR6, TQuiz *QuizR7, TQuiz *QuizS1, TQuiz *QuizS2, TQuiz *QuizS3, TQuiz *QuizS4, TQuiz *QuizS5, TQuiz *QuizS6, TQuiz *QuizS7, TQuiz *QuizS8, TQuiz *QuizS9, TQuiz *QuizS10, TQuiz *QuizS11, TQuiz *QuizS12, TQuiz *QuizN1, TQuiz *QuizN2, TQuiz *QuizN3, TQuiz *QuizN4, TQuiz *QuizFI, TQuiz *QuizF1, TQuiz *QuizF2, TQuiz *QuizF3, TQuiz *QuizF4, TQuiz *QuizF5, TQuiz *QuizF6, TQuiz *QuizF7, TQuiz *QuizF8, TQuiz *QuizF9, TQuiz *QuizF10, TQuiz *QuizF11, TQuiz *QuizF12, TQuiz *QuizF13, TQuiz *QuizF14, TQuiz *QuizF15, TQuiz *QuizGE, TQuiz *QuizGE2, TQuiz *QuizGE3)
{
    DefineCross(QuizGE3, 0, 0);
    DefineCross(QuizGE3, 1, 1);
    DefineCross(QuizGE3, 2, 2);
    DefineCross(QuizGE3, 3, 3);
    DefineCross(QuizGE3, 4, 4);
    DefineCross(QuizGE3, 5, 5);
    DefineCross(QuizS10, 6, 12);
    DefineCross(QuizGE3, 7, 6);
    DefineCross(QuizGE3, 8, 7);
    DefineCross(QuizGE3, 9, 8);
    DefineCross(QuizGE3, 10, 9);
    DefineCross(QuizGE3, 11, 10);
    DefineCross(QuizGE3, 12, 11);
    DefineCross(QuizGE3, 13, 12);
    DefineCross(QuizGE3, 14, 13);
    DefineCross(QuizGE3, 15, 14);
    DefineCross(QuizGE3, 16, 15);
    DefineCross(QuizGE3, 17, 16);
    DefineCross(QuizGE3, 18, 17);
    DefineCross(QuizGE3, 19, 18);
    DefineCross(QuizGE3, 20, 19);
    DefineCross(QuizGE3, 21, 20);
    DefineCross(QuizGE3, 22, 21);
    DefineCross(QuizGE3, 23, 22);
    DefineCross(QuizGE3, 24, 23);
    DefineCross(QuizGE3, 25, 24);
    DefineCross(QuizGE3, 26, 49);
    DefineCross(QuizGE3, 27, 60);
    DefineCross(QuizGE3, 28, 26);
    DefineCross(QuizGE3, 29, 27);
    DefineCross(QuizGE3, 30, 28);
    DefineCross(QuizGE3, 31, 29);
    DefineCross(QuizGE3, 32, 94);
    DefineCross(QuizGE3, 33, 32);
    DefineCross(QuizGE3, 34, 33);
    DefineCross(QuizGE3, 35, 34);
    DefineCross(QuizGE3, 36, 35);
    DefineCross(QuizGE3, 37, 36);
    DefineCross(QuizGE3, 38, 37);
    DefineCross(QuizGE3, 39, 38);
    DefineCross(QuizGE3, 40, 39);
    DefineCross(QuizGE3, 41, 40);
    DefineCross(QuizGE3, 42, 41);
    DefineCross(QuizGE3, 43, 42);
    DefineCross(QuizGE3, 44, 43);
    DefineCross(QuizGE3, 45, 44);
    DefineCross(QuizGE3, 46, 45);
    DefineCross(QuizGE3, 47, 46);
    DefineCross(QuizGE3, 48, 48);
    DefineCross(QuizGE3, 49, 51);
    DefineCross(QuizGE3, 50, 52);
    DefineCross(QuizGE3, 51, 53);
    DefineCross(QuizGE3, 52, 54);
    DefineCross(QuizGE3, 53, 55);
    DefineCross(QuizGE3, 54, 56);
    DefineCross(QuizGE3, 55, 102);
    DefineCross(QuizGE3, 56, 59);
    DefineCross(QuizGE3, 57, 25);
    DefineCross(QuizGE3, 58, 106);
    DefineCross(QuizGE3, 59, 61);
    DefineCross(QuizGE3, 60, 62);
    DefineCross(QuizS10, 61, 57);
    DefineCross(QuizGE3, 62, 64);
    DefineCross(QuizGE3, 63, 66);
    DefineCross(QuizGE3, 64, 97);
    DefineCross(QuizGE3, 65, 67);
    DefineCross(QuizGE3, 66, 68);
    DefineCross(QuizGE3, 67, 69);
    DefineCross(QuizGE3, 68, 70);
    DefineCross(QuizGE3, 69, 71);
    DefineCross(QuizGE3, 70, 72);
    DefineCross(QuizGE3, 71, 74);
    DefineCross(QuizGE3, 72, 75);
    DefineCross(QuizGE3, 73, 76);
    DefineCross(QuizGE3, 74, 77);
    DefineCross(QuizGE3, 75, 78);
    DefineCross(QuizGE3, 76, 79);
    DefineCross(QuizGE3, 77, 81);
    DefineCross(QuizGE3, 78, 82);
    DefineCross(QuizGE3, 79, 83);
    DefineCross(QuizGE3, 80, 84);
    DefineCross(QuizGE3, 81, 85);
    DefineCross(QuizGE3, 82, 86);
    DefineCross(QuizGE3, 83, 87);
    DefineCross(QuizGE3, 84, 89);
    DefineCross(QuizGE3, 85, 90);
    DefineCross(QuizGE3, 86, 91);
    DefineCross(QuizGE3, 87, 92);
    DefineCross(QuizGE3, 88, 93);
    DefineCross(QuizGE3, 89, 95);
    DefineCross(QuizGE3, 90, 65);
    DefineCross(QuizGE3, 91, 96);
    DefineCross(QuizGE3, 92, 98);
    DefineCross(QuizN1, 93, 99);
    DefineCross(QuizGE3, 94, 99);
    DefineCross(QuizGE3, 95, 100);
    DefineCross(QuizGE3, 96, 101);
    DefineCross(QuizGE3, 97, 103);
    DefineCross(QuizGE3, 98, 104);
    DefineCross(QuizGE3, 99, 105);
    DefineCross(QuizGE3, 100, 80);
    DefineCross(QuizGE3, 101, 107);
    DefineCross(QuizGE3, 102, 108);
    DefineCross(QuizGE3, 103, 109);
    DefineCross(QuizGE3, 104, 73);
    DefineCross(QuizGE3, 105, 110);
    DefineCross(QuizGE3, 106, 111);
    DefineCross(QuizGE3, 107, 112);
    DefineCross(QuizGE3, 108, 113);
    DefineCross(QuizGE3, 109, 114);
    DefineCross(QuizGE3, 110, 115);
    DefineCross(QuizGE3, 111, 116);
    DefineCross(QuizGE3, 112, 117);
    DefineCross(QuizGE3, 113, 118);
    DefineCross(QuizGE3, 114, 119);
    DefineCross(QuizGE3, 115, 120);
    DefineCross(QuizGE3, 116, 121);
    DefineCross(QuizGE3, 117, 122);
    DefineCross(QuizGE3, 118, 123);
    DefineCross(QuizGE3, 119, 124);
    DefineCross(QuizGE3, 120, 125);
    DefineCross(QuizGE3, 121, 126);
    DefineCross(QuizGE3, 122, 127);
    DefineCross(QuizGE3, 123, 128);
    DefineCross(QuizGE3, 124, 129);
    DefineCross(QuizGE3, 125, 130);
    DefineCross(QuizGE3, 126, 131);
    DefineCross(QuizGE3, 127, 132);
    DefineCross(QuizGE3, 128, 134);
    DefineCross(QuizGE3, 129, 135);
    DefineCross(QuizGE3, 130, 136);
    DefineCross(QuizGE3, 131, 137);
    DefineCross(QuizGE3, 132, 138);
    DefineCross(QuizGE3, 133, 139);
    DefineCross(QuizGE3, 134, 140);
    DefineCross(QuizGE3, 135, 141);
    DefineCross(QuizGE3, 136, 142);
    DefineCross(QuizGE3, 137, 50);
    DefineCross(QuizGE3, 138, 143);
    DefineCross(QuizGE3, 139, 144);
    DefineCross(QuizGE3, 140, 145);
    DefineCross(QuizGE3, 141, 146);
    DefineCross(QuizGE3, 142, 147);
    DefineCross(QuizGE3, 143, 148);
    DefineCross(QuizGE3, 144, 149);
    DefineCross(QuizGE3, 145, 150);
    DefineCross(QuizGE3, 146, 151);
    DefineCross(QuizGE3, 147, 152);
    DefineCross(QuizGE3, 148, 153);
    DefineCross(QuizGE3, 149, 154);
}

/*##########################################################################
#
#   Name       : TQuizG1::GetReferer
#
...
#
##########################################################################*/
void TQuizG1::GetReferer(const char *referer, TPopulation *pop)
{
	int i;
	TReferer *ref;
	TQuizRow Row;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG1::ExportExcelCase(const char *filename, int PcaType)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG1::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG1::ExportExcelGroups(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG1::ImportMvsp(const char *filename, int PcaType)
{
	char buf[MAX_IN_ROW];
	int size;
	char *rowstr;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG1::WriteRace(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG1::WriteRetest(const char *filename)
{
	TQuizRow Row;
	int userid;
	int i;
