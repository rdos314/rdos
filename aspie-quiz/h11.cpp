...
//        WriteUnion();
        ...
        printf("import\r\n");
        Quiz[0]->ImportMvsp("pca-done\\allH11.txt", PCA_TYPE_ALL);
        Quiz[0]->ImportMvsp("pca-done\\maleH11.txt", PCA_TYPE_MALE);
        Quiz[0]->ImportMvsp("pca-done\\femH11.txt", PCA_TYPE_FEMALE);

        printf("details\r\n");

         Quiz[0]->WriteSumaryTable("res\\quizh11.htm", FALSE);

        printf("rel\r\n");

         Quiz[0]->WriteIntercorr("res\\relh11.htm");
