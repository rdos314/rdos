...
/*##########################################################################
#
#   Name       : TQuizK4::TQuizK4
#
#   Purpose....: Constructor for TQuizK4
#
...
#
##########################################################################*/
TQuizK4::TQuizK4(const char *FileName)
  : TQuiz(133),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizK4::~TQuizK4
#
#   Purpose....: Destructor for TQuizK4
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizK4::GetCatCount(int Question)
{
    if (Question < 125)
       return 3;
...
#
##########################################################################*/
void TQuizK4::WriteName(TFile &File)
{
    File.Write("K4");
}
...
#
##########################################################################*/
void TQuizK4::WriteLongName(TFile &File)
{
    File.Write("K4");
}
...
void TQuizK4::SetupTexts()
{
  ...
  Quiz[120].MyGroup = GROUP_NT_ATTACH;
  ...
  Quiz[58].Text = "Do you have, or used to have, imaginary friends and/or relationships?";
  ...
  Quiz[125].Text = "12-14 rate";
  Quiz[126].Text = "15-19 rate";
  Quiz[127].Text = "20-24 rate";
  Quiz[128].Text = "25-30 rate";

  Quiz[129].Text = "12-14 time";
  Quiz[130].Text = "15-19 time";
  Quiz[131].Text = "20-24 time";
  Quiz[132].Text = "25-30 time";

}

/*##########################################################################
#
#   Name       : TQuizK4::LoadPopulations
#
...
#
##########################################################################*/
void TQuizK4::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizK4::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
