...
/*##########################################################################
#
#   Name       : TQuizJ2::TQuizJ2
#
#   Purpose....: Constructor for TQuizJ2
#
...
#
##########################################################################*/
TQuizJ2::TQuizJ2(const char *FileName)
  : TQuiz(124),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizJ2::~TQuizJ2
#
#   Purpose....: Destructor for TQuizJ2
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJ2::GetCatCount(int Question)
{
   return 3;
}
...
#
##########################################################################*/
void TQuizJ2::WriteName(TFile &File)
{
    File.Write("J2");
}
...
#
##########################################################################*/
void TQuizJ2::WriteLongName(TFile &File)
{
    File.Write("J2");
}
...
#
##########################################################################*/
void TQuizJ2::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizJ2::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
