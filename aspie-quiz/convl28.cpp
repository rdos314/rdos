...
#
# convl28.cpp
# Convert exported quiz-l28 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 194);
}

/*################## ConvL28 ##########################
*   Purpose....: Convert quiz l28                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL28()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l28.csv");
    TFile outfile("bin\\quizl28.bin", 0);
    char *ptr;
