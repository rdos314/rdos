...
/*##########################################################################
#
#   Name       : TQuizH8::TQuizH8
#
#   Purpose....: Constructor for TQuizH8
#
...
#
##########################################################################*/
TQuizH8::TQuizH8(const char *FileName)
  : TQuiz(166),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH8::~TQuizH8
#
#   Purpose....: Destructor for TQuizH8
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH8::GetCatCount(int Question)
{
        return 3;
}
...
#
##########################################################################*/
void TQuizH8::WriteName(TFile &File)
{
         File.Write("H8");
}
...
#
##########################################################################*/
void TQuizH8::WriteLongName(TFile &File)
{
         File.Write("H8");
}
...
void TQuizH8::SetupTexts()
{
  ...
  Quiz[150].Text = "Are your dreams and fantasies much like those of others?";
  Quiz[151].Text = "Have you experienced stronger than normal attachments to certain people?";
  Quiz[152].Text = "Are you more sexually attracted to strangers than to people you know well?";
  Quiz[153].Text = "Do you examine the hair of people you like a lot?";
  Quiz[154].Text = "Do you want to always be around your partner (or imaginary partner) and do everything together?";
  Quiz[155].Text = "Do you have compulsive sexual behavior, e.g. spend too much time on sex";
  Quiz[156].Text = "Are you homosexual or bisexual?";
  Quiz[157].Text = "Do you have an interest in or have practised BD/SM?";
  Quiz[158].Text = "Do you prefer to have friends of the opposite gender?";
  Quiz[159].Text = "Do you like to be naked?";
  Quiz[160].Text = "If you were single, would you find casual sex (one-night stands) rewarding?";
  Quiz[161].Text = "Have you been in love with more than one person at the same time?";
  Quiz[162].Text = "Are you asexual?";
  Quiz[163].Text = "Do you dislike sexual intercourse other than as procreation?";
  Quiz[164].Text = "Have you been sexually abused?";
  Quiz[165].Text = "Do you regard love and sex as synonymous?";
}

/*##########################################################################
#
#   Name       : TQuizH8::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH8::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH8::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
