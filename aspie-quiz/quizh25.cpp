...
/*##########################################################################
#
#   Name       : TQuizH25::TQuizH25
#
#   Purpose....: Constructor for TQuizH25
#
...
#
##########################################################################*/
TQuizH25::TQuizH25(const char *FileName)
  : TQuiz(199),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH25::~TQuizH25
#
#   Purpose....: Destructor for TQuizH25
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH25::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH25::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH25::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizH25::WriteName(TFile &File)
{
    File.Write("H25");
}
...
#
##########################################################################*/
void TQuizH25::WriteLongName(TFile &File)
{
         File.Write("H25");
}
...
void TQuizH25::SetupTexts()
{
  ...
  Quiz[195].MyGroup = GROUP_NT_OBSESSION;
...
#
##########################################################################*/
void TQuizH25::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH25::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
