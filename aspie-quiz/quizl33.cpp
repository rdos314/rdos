...
/*##########################################################################
#
#   Name       : TQuizL33::TQuizL33
#
#   Purpose....: Constructor for TQuizL33
#
...
#
##########################################################################*/
TQuizL33::TQuizL33(const char *FileName)
  : TQuiz(177),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL33::~TQuizL33
#
#   Purpose....: Destructor for TQuizL33
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL33::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL33::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL33::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL33::WriteName(TFile &File)
{
    File.Write("L33");
}
...
#
##########################################################################*/
void TQuizL33::WriteLongName(TFile &File)
{
    File.Write("L33");
}
...
void TQuizL33::SetupTexts()
{
  ...
  Quiz[121].Text = "Can you experience things as if they were doubly real?";
  Quiz[122].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[123].Text = "Can you at times somehow feel the presence of someone who is not physically there?";
  Quiz[124].Text = "Have you had experiences with the supernatural?";
  Quiz[125].Text = "Do you feel that you have had an out of body experience?";
  Quiz[126].Text = "Do you get a feeling that you can predict things that are bound to happen in the future?";
  Quiz[127].Text = "Have you had experiences with astrology, seeing the future, UFOs, ESP or a sixth sense?";
  Quiz[128].Text = "Do you believe in clairvoyancy (psychic forces, fortune telling)?";
  Quiz[129].Text = "Do you believe in telepathy (mind-to-mind communication)?";
  Quiz[130].Text = "Do you think you really know what some people mean when they talk about mystical experiences?";
  Quiz[131].Text = "Can you somehow sense the presence of another person before you actually see or hear him/her?";
  Quiz[132].Text = "Have you had the sense that some person or force is around you, even though you cannot see anyone?";
  Quiz[133].Text = "Have you seen things invisible to other people?";
  Quiz[134].Text = "Do you 'step outside' of your usual self and experience a completely different state of being?";
  Quiz[135].Text = "Can you feel as if your mind could envelop the whole world?";
  ...
  Quiz[137].Text = "Are your fantasies just as lively as a good movie?";
  Quiz[138].Text = "Do your fantasies have a realistic intensity?";
  Quiz[139].Text = "Do you start fantasizing when things get boring?";
  Quiz[140].Text = "Do you spend more than half the day (daytime) fantasizing or daydreaming?";
  Quiz[141].Text = "Are your thoughts sometimes so strong that you can almost hear them?";
  Quiz[142].Text = "Do you hear a voice speaking your thoughts aloud?";
  Quiz[143].Text = "If you wish can you imagine things so vividly that it's like watching a good movie or hearing a good story?";
  Quiz[144].Text = "Can thoughts and images come to you without any effort on your part?";
  Quiz[145].Text = "Can you recall certain past experiences so clearly and vividly that it is like living them again?";
  Quiz[146].Text = "Do your thoughts often occur as visual images rather than as words?";
  Quiz[147].Text = "Have you had the experience of not knowing whether you were imagining something or it was actually happening?";
  Quiz[148].Text = "Have you had the experience of someone calling you or speaking your name and not being sure whether it was really happening or you were imagining it?";
  Quiz[149].Text = "Can your dreams be so vivid that even later you can't tell them from waking reality?";
  Quiz[150].Text = "Can you wake from one dream into another?";
  Quiz[151].Text = "Do you confuse fantasies with real memories?";
  Quiz[152].Text = "Do you have often had the experience of different senses coming together. For example, have you felt that you could smell a color, or see a sound, or hear an odor?";
  Quiz[153].Text = "Do different smells have different colors?";
  Quiz[154].Text = "Do textures - such as wool, sand, wood - remind you of colors or music?";
  Quiz[155].Text = "Can music remind you of pictures or changing patterns of color?";
  Quiz[156].Text = "Have you noticed a common event or object that seemed to be a special sign for you?";
  Quiz[157].Text = "Do you see special meanings in advertisements, shop windows, or in the way things are arranged around you?";
  Quiz[158].Text = "Do you feel that things you see on the TV or read in the newspaper have a special meaning for you?";
  Quiz[159].Text = "If you think about something cold, do you actually get cold?";
  Quiz[160].Text = "When you imagine you have eaten rotten food, do you really get nauseous?";
  Quiz[161].Text = "Do different colors have distinctive and special meanings for you?";
  Quiz[162].Text = "Are you often delighted by small things (like the colors in soap bubbles and the five pointed star shape that appears when you cut an apple across the core)?";
  Quiz[163].Text = "Do things around you seem to change their size and shape?";
  Quiz[164].Text = "Do your body sometimes seem to change its size and shape?";
  Quiz[165].Text = "Have you felt that you are communicating with another person telepathically (by mind-to-mind communication)?";
  Quiz[166].Text = "When you look at a person, or yourself in a mirror, have you seen the face change right before your eyes?";
  Quiz[167].Text = "Have you mistaken objects or shadows for people, or noises for voices?";
  Quiz[168].Text = "Do you experience thinking of someone and soon afterwards that particulat person calls or shows up?";
  Quiz[169].Text = "When you sing or write someting, do you sometimes have the feeling that someone or something outside yourself directs you?";
  Quiz[170].Text = "Do you have 'physical memories'; for example, after you've been swimming may feel as if you are still in the water?";
  Quiz[171].Text = "If you stare at a picture and then look away from it, can you sometimes 'see' an image of the picture, almost as if you were still looking at it?";
  Quiz[172].Text = "As a child, did you believe in the existence of dwarfs, elves and other fairt tale figures?";
  Quiz[173].Text = "As a child, did you have a feeling you were somebody else (e.g., a princess, an orphan, etc.)?";
  Quiz[174].Text = "When you percieve violence on television, do you get so into it that you get upset?";
  Quiz[175].Text = "Can other people feel your feelings when they are not there?";
  Quiz[176].Text = "When listening to organ music or other powerful music, do you feel as if you are being lifted into the air?";

}

/*##########################################################################
#
#   Name       : TQuizL33::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL33::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL33::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
