...
#
# convh15.cpp
# Convert exported quiz-h15 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvH15()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h15.csv");
    TFile outfile("bin\\quizh15.bin", 0);
    char *ptr;
