...
void TQuizK9::SetupTexts()
{
  ...
  Quiz[126].MyGroup = GROUP_NT_FRIEND;
  Quiz[127].MyGroup = GROUP_MIXED;
  Quiz[128].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[129].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[130].MyGroup = GROUP_NT_FRIEND;
  ...
  Quiz[148].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[149].MyGroup = GROUP_MIXED;
  Quiz[150].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[151].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[152].MyGroup = GROUP_ASPIE_TALENT;
  Quiz[153].MyGroup = GROUP_ASPIE_TALENT;
  Quiz[154].MyGroup = GROUP_MIXED;
  Quiz[155].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[156].MyGroup = GROUP_MIXED;
  Quiz[157].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[158].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[159].MyGroup = GROUP_MIXED;
  Quiz[160].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[161].MyGroup = GROUP_MIXED;
  Quiz[162].MyGroup = GROUP_MIXED;
  Quiz[163].MyGroup = GROUP_ASPIE_SPIRIT;
  ...
  Quiz[170].MyGroup = GROUP_ASPIE_SPIRIT;
  ...
  Quiz[175].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[176].MyGroup = GROUP_MIXED;
  Quiz[177].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[178].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[179].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[180].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[181].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[182].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[183].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[184].MyGroup = GROUP_MIXED;
  Quiz[185].MyGroup = GROUP_MIXED;
  Quiz[186].MyGroup = GROUP_MIXED;
  Quiz[187].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[188].MyGroup = GROUP_MIXED;
  Quiz[189].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[190].MyGroup = GROUP_MIXED;
  Quiz[191].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[192].MyGroup = GROUP_ASPIE_SPIRIT;
  Quiz[193].MyGroup = GROUP_ASPIE_SPIRIT;
