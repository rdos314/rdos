...
# Copyright (C) 1988-2007, Leif Ekblad
#
...
#
# convn1.cpp
# Convert exported quiz-n1 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-n1 VALUES(";

TFile quizfile("quizn1.bin", 0);
...
char *ProcessRow(char *str)
{
   ...
   int j;
	...
	for (fieldno = 0; fieldno < 226; fieldno++)
	{
		valstr = str;
			...
			*ptr = 0;
			...
			switch (fieldno)
			{
				...
				case 13:
					...
					Row.Quiz[194] = Row.Dyslexia;
					break;

				case 14:
					Row.Dyscalculia = atoi(valstr);
					Row.Quiz[195] = Row.Dyscalculia;
					break;

				case 15:
					Row.Dyspraxia = atoi(valstr);
					Row.Quiz[196] = Row.Dyspraxia;
					break;

				case 16:
					Row.Bipolar = atoi(valstr);
					Row.Quiz[197] = Row.Bipolar;
					break;
				...
				case 22:
					Row.PredAutism = atoi(valstr);
					break;

				case 23:
					Row.PredAs = atoi(valstr);
					break;

				case 24:
					Row.PredAdd = atoi(valstr);
					break;

				case 25:
					Row.PredDyspraxia = atoi(valstr);
					break;

				case 26:
					Row.PredDyslexia = atoi(valstr);
					break;

				case 27:
					Row.PredDyscalculia = atoi(valstr);
					break;

				case 28:
					Row.PredOcd = atoi(valstr);
					break;

				case 29:
					Row.PredBipolar = atoi(valstr);
					break;

				case 30:
					Row.PredSchizo = atoi(valstr);
					break;

				case 31:
					Row.PredSocial = atoi(valstr);
					break;
