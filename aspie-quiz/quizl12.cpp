...
/*##########################################################################
#
#   Name       : TQuizL12::TQuizL12
#
#   Purpose....: Constructor for TQuizL12
#
...
#
##########################################################################*/
TQuizL12::TQuizL12(const char *FileName)
  : TQuiz(124),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL12::~TQuizL12
#
#   Purpose....: Destructor for TQuizL12
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL12::GetPcaCount()
{
        return 4;
}

/*##################  TQuizL12::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL12::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL12::WriteName(TFile &File)
{
    File.Write("L12");
}
...
#
##########################################################################*/
void TQuizL12::WriteLongName(TFile &File)
{
    File.Write("L12");
}
...
void TQuizL12::SetupTexts()
{
  ...
  Quiz[121].Text = "Do you prefer to learn the character of a potential romantic partner through observation rather than conversation?";
  Quiz[122].Text = "Would you discuss relationship issues with your best friends?";
  Quiz[123].Text = "If somebody showed possible romantic interest for you, would you ask friends for help in checking out if it is genuine?";
}

/*##########################################################################
#
#   Name       : TQuizL12::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL12::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL12::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
