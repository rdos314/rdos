...
/*##########################################################################
#
#   Name       : TQuizL8::TQuizL8
#
#   Purpose....: Constructor for TQuizL8
#
...
#
##########################################################################*/
TQuizL8::TQuizL8(const char *FileName)
  : TQuiz(125),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL8::~TQuizL8
#
#   Purpose....: Destructor for TQuizL8
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL8::GetCatCount(int Question)
{
    if (Question >= 121)
        return 12;
    else
...
#
##########################################################################*/
void TQuizL8::WriteName(TFile &File)
{
    File.Write("L8");
}
...
#
##########################################################################*/
void TQuizL8::WriteLongName(TFile &File)
{
    File.Write("L8");
}
...
void TQuizL8::SetupTexts()
{
  ...
  Quiz[121].Text = "Sincere";
  Quiz[122].Text = "Fair";
  Quiz[123].Text = "Greed avoidance";
  Quiz[124].Text = "Modesty";

/*  Quiz[121].Text = "If you want something from a person you dislike, will you act very nicely toward that person in order to get it?";
  Quiz[122].Text = "Would you use flattery to get a raise or promotion at work, even if you thought it would succeed?";
  Quiz[123].Text = "If you want something from someone, would you laugh at that person's worst jokes?";
  Quiz[124].Text = "Would you pretend to like someone just to get that person to do favors for you?";
  Quiz[125].Text = "If you knew that you could never get caught, would you be willing to steal a million dollars?";
  Quiz[126].Text = "Would you be tempted to buy stolen property if you were financially tight?";
  Quiz[127].Text = "Would you never accept a bribe, even if it were very large?";
  Quiz[128].Text = "Would you be tempted to use counterfeit money, if you were sure you could get away with it?";
  Quiz[129].Text = "Is having a lot of money not especially important to you?";
  Quiz[130].Text = "Would you like to live in a very expensive, high-class neighborhood?";
  Quiz[131].Text = "Would you like to be seen driving around in a very expensive car?";
  Quiz[132].Text = "Would you get a lot of pleasure from owning expensive luxury goods?";
  Quiz[133].Text = "Are you an ordinary person who is no better than others?";
  Quiz[134].Text = "Wouldn't you want people to treat you as though you were superior to them?";
  Quiz[135].Text = "Do you think that you are entitled to more respect than the average person is?";
  Quiz[136].Text = "Do you want people to know that you are an important person of high status?";
*/
...
#
##########################################################################*/
void TQuizL8::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL8::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
