...
private:
    ...
    void ExportIPIP(const char *filename);
    void ImportIPIP(const char *filename);
    void CalcIpipCongruence();
    ...
    long double IpipLoadArr[270][10];
    long double IpipCon[5][10];
    long double IpipPcaCon;
