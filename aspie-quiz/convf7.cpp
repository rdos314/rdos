...
#
# convf7.cpp
# Convert exported quiz-f7 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-f7 VALUES(";

TFile quizfile("quizf7.bin", 0);
TFile ancfile("ancf7.bin", 0);
...
char *ProcessRow(char *str)
{
	...
	for (fieldno = 0; fieldno < 246; fieldno++)
	{
		valstr = str;
