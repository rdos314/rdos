...
/*##########################################################################
#
#   Name       : TQuizJ5::TQuizJ5
#
#   Purpose....: Constructor for TQuizJ5
#
...
#
##########################################################################*/
TQuizJ5::TQuizJ5(const char *FileName)
  : TQuiz(121),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizJ5::~TQuizJ5
#
#   Purpose....: Destructor for TQuizJ5
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJ5::GetCatCount(int Question)
{
   return 3;
}
...
#
##########################################################################*/
void TQuizJ5::WriteName(TFile &File)
{
    File.Write("J5");
}
...
#
##########################################################################*/
void TQuizJ5::WriteLongName(TFile &File)
{
    File.Write("J5");
}
...
void TQuizJ5::SetupTexts()
{
  ...
  Quiz[72].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[73].MyGroup = GROUP_ASPIE_CONTACT;
  ...
  Quiz[78].MyGroup = GROUP_NT_CONTACT;
  Quiz[79].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[106].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[107].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[108].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[109].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[110].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[111].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[112].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[113].MyGroup = GROUP_NT_ATTACH;
  Quiz[114].MyGroup = GROUP_NT_ATTACH;
  Quiz[115].MyGroup = GROUP_NT_ATTACH;
  ...
  Quiz[36].Text = "Do you find it hard to tell the age of people?";
  Quiz[37].Text = "Do you have difficulties judging distances, height, depth or speed?";
  Quiz[38].Text = "Do you have a good sense of how much pressure to apply when doing things with your hands?";
  Quiz[39].Text = "Do you have problems recognizing faces (prosopagnosia)?";
  Quiz[40].Text = "Have others commented or have you observed yourself that you make unusual facial expressions?";
  Quiz[41].Text = "Have you been accused of staring?";
  Quiz[42].Text = "Do you wring your hands, rub your hands together or twirl your fingers?";
  Quiz[43].Text = "Do you mistake noises for voices?";
  Quiz[44].Text = "Do you fiddle with things?";
  Quiz[45].Text = "Do you rock back-&-forth or side-to-side (e.g. for comfort, to calm yourself, when excited or overstimulated)?";
  Quiz[46].Text = "In conversations, do you use small sounds that others don't seem to use?";
  Quiz[47].Text = "Do you tap your ears or press your eyes (e.g. when thinking, when stressed or distressed)?";
  Quiz[48].Text = "Have others told you that you have an odd posture or gait?";
  ...
  Quiz[53].Text = "Do you have an urge to observe the habits of humans and/or animals?";
  Quiz[54].Text = "Do you get a pleasurable tingling sensation in the head, scalp or back of the body in response to certain sounds?";
  ...
  Quiz[59].Text = "Do you have an urge to jump over things?";
  Quiz[60].Text = "Do you enjoy spinning in circles?";
  Quiz[61].Text = "Do you have, or used to have, imaginary friends?";
  Quiz[62].Text = "Do you tend to express your feelings in ways that may baffle others?";
  Quiz[63].Text = "Do you tend to say things that are considered socially inappropriate when you are tired, frustrated or when you act naturally?";
  Quiz[64].Text = "Do others often misunderstand you?";
  Quiz[65].Text = "Do you forget you are in a social situation when something gets your attention?";
  Quiz[66].Text = "Is it hard for you to see why some things upset people so much?";
  Quiz[67].Text = "Do people sometimes think you are smiling at the wrong occasion?";
  Quiz[68].Text = "Is your sense of humor different from mainstream or considered odd?";
  Quiz[69].Text = "As a teenager, were you usually unaware of social rules & boundaries unless they were clearly spelled out?";
  Quiz[70].Text = "Do you or others think that you have unconventional ways of solving problems?";
  Quiz[71].Text = "Do you tend to interpret things literally?";
  Quiz[72].Text = "Do you find it easier to understand and communicate with odd & unusual people than with ordinary people?";
  Quiz[73].Text = "Do you have an alternative view of what is attractive in the opposite sex?";
  Quiz[74].Text = "Do you have unusual sexual preferences?";
  Quiz[75].Text = "Do you prefer to construct your own set of spiritual beliefs rather than following existing religions / belief-systems?";
  Quiz[76].Text = "Are you more sexually attracted to strangers than to people you know well?";
  Quiz[77].Text = "Would you accept polyamory if you knew your partner would?";
  Quiz[78].Text = "Do you have a tendency to become stuck when asked questions in social situation?";
  Quiz[79].Text = "Has it been harder for you than for others to keep friends?";
  Quiz[80].Text = "Do you find it hard to be emotionally close to other people?";
  Quiz[81].Text = "Do you stay away from situations where people might express affection for you?";
  Quiz[82].Text = "Do you get very tired after socializing, and need to regenerate alone?";
  Quiz[83].Text = "Do you prefer to keep to yourself?";
  Quiz[84].Text = "Do you find it easy to describe your feelings?";
  Quiz[85].Text = "Do you prefer to only meet people you know, one-on-one, or in small, familiar groups?";
  Quiz[86].Text = "Do you prefer to do things on your own even if you could use others' help or expertise?";
  Quiz[87].Text = "Do you dislike it when people drop by to visit you uninvited?";
  Quiz[88].Text = "Is it hard for you to approach somebody you are attracted to?";
  Quiz[89].Text = "In a conversation, do you tend to focus on your own thoughts rather than on what your listener might be thinking?";
  Quiz[90].Text = "Do you see your own activities as more important than other people's?";
  Quiz[91].Text = "Are you impatient and have low frustration tolerance?";
  Quiz[92].Text = "Do you expect other people to know your thoughts, experiences and opinions without you having to tell them?";
  Quiz[93].Text = "Will you abandon your friends if your activities or ideals clash?";
  Quiz[94].Text = "Do you have difficulty accepting criticism, correction, and direction?";
  Quiz[95].Text = "Do you usually find faults with opinions that you don't share?";
  Quiz[96].Text = "Do you obstruct others' plans?";
  Quiz[97].Text = "Do you have trouble with authority?";
  Quiz[98].Text = "Have you have had long-lasting urges to take revenge?";
  Quiz[99].Text = "Are you good at team-work?";
  Quiz[100].Text = "Do you find it natural to wave or say 'hi' when you meet people?";
  Quiz[101].Text = "Do you enjoy big events even if they are crowded?";
  Quiz[102].Text = "Does it feel natural for you to say 'thank you' and 'sorry'?";
  Quiz[103].Text = "Do you enjoy travel?";
  Quiz[104].Text = "Do you take pride in your appearance?";
  Quiz[105].Text = "Do you enjoy gossip?";
  Quiz[106].Text = "Do you tend to look a lot at people you like and little or not at all at people you dislike?";
  Quiz[107].Text = "Have you experienced stronger than normal attachments to certain people?";
  Quiz[108].Text = "Do you like to follow (walk behind) people you are attached to?";
  Quiz[109].Text = "Do you have an urge to learn the routines of people you know?";
  Quiz[110].Text = "Have people you formed strong attachments to taken advantage of you?";
  Quiz[111].Text = "Do you have a need to confess?";
  Quiz[112].Text = "Do you have odd hair (for example multiple whorls, standing up when short or other peculiarities)?";
  Quiz[113].Text = "Do you like tongue-kissing?";
  Quiz[114].Text = "Do you get great pleasure from making love?";
  Quiz[115].Text = "Are you asexual?";
  Quiz[116].Text = "Do you dislike sexual intercourse other than as procreation?";
  Quiz[117].Text = "Is your sense of humor fairly conventional?";
  Quiz[118].Text = "Can you easily remember verbal instructions?";
  Quiz[119].Text = "Are you gracious about criticism, correction and direction?";
  Quiz[120].Text = "Do you find it easy to estimate the age of people?";
}

/*##########################################################################
#
#   Name       : TQuizJ5::LoadPopulations
#
...
#
##########################################################################*/
void TQuizJ5::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizJ5::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
