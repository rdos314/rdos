...
#
# convl25.cpp
# Convert exported quiz-l25 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvL25()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l25.csv");
    TFile outfile("bin\\quizl25.bin", 0);
    char *ptr;
