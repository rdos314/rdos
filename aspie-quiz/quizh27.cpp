...
/*##########################################################################
#
#   Name       : TQuizH27::TQuizH27
#
#   Purpose....: Constructor for TQuizH27
#
...
#
##########################################################################*/
TQuizH27::TQuizH27(const char *FileName)
  : TQuiz(193),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH27::~TQuizH27
#
#   Purpose....: Destructor for TQuizH27
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH27::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH27::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH27::GetCatCount(int Question)
{
    if (Question >= 192)
        return 5;
    else
...
#
##########################################################################*/
void TQuizH27::WriteName(TFile &File)
{
    File.Write("H26");
}
...
#
##########################################################################*/
void TQuizH27::WriteLongName(TFile &File)
{
    File.Write("H26");
}
...
void TQuizH27::SetupTexts()
{
  ...
  Quiz[192].Text = "Courting vs chasing";

}

/*##########################################################################
#
#   Name       : TQuizH27::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH27::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH27::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
