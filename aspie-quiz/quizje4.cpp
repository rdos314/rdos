...
/*##########################################################################
#
#   Name       : TQuizJE4::TQuizJE4
#
#   Purpose....: Constructor for TQuizJE4
#
...
#   Name       : TQuizJE4::~TQuizJE4
#
#   Purpose....: Destructor for TQuizJE4
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJE4::GetPcaCount()
{
        return 4;
}

/*##################  TQuizJE4::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJE4::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizJE4::WriteName(TFile &File)
{
    File.Write("JE4");
}
...
#
##########################################################################*/
void TQuizJE4::WriteLongName(TFile &File)
{
    File.Write("JE4");
}
...
void TQuizJE4::SetupTexts()
{
  ...
  Quiz[7].MyGroup = GROUP_ASPIE_CONTACT;
  ...
  Quiz[48].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[49].MyGroup = GROUP_ASPIE_NVC;
  Quiz[50].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[51].MyGroup = GROUP_ASPIE_NVC;
  Quiz[52].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[53].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[54].MyGroup = GROUP_MIXED;
  Quiz[55].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[56].MyGroup = GROUP_ASPIE_NVC;
  Quiz[57].MyGroup = GROUP_ASPIE_CONTACT;
  ...
  Quiz[97].MyGroup = GROUP_ASPIE_TALENT;
  ...
  Quiz[135].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[136].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[137].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[138].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[139].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[140].MyGroup = GROUP_ASPIE_CONTACT;
  ...
  Quiz[154].MyGroup = GROUP_ASPIE_CONTACT;
  ...
  Quiz[3].Text = "Do you have strong attachments to certain favorite objects?";
  ...
  Quiz[16].Text = "Do you need a lot of motivation to do things?";
  Quiz[17].Text = "Do you find it difficult to take notes in lectures?";
  Quiz[18].Text = "Are you easily distracted?";
  Quiz[19].Text = "Are you bothered by clothes tags or light touch?";
  Quiz[20].Text = "Do you dislike when people walk behind you?";
  Quiz[21].Text = "Are your eyes extra sensitive to strong light and glare?";
  Quiz[22].Text = "Do you have extra sensitive hearing?";
  ...
  Quiz[25].Text = "Do you instinctively become frightened by the sound of a motor-bike?";
  Quiz[26].Text = "Do you have a very acute sense of smell and/or taste?";
  Quiz[27].Text = "Do you find it hard to recognise phone numbers when said in a different way?";
  Quiz[28].Text = "Do you find it hard to tell the age of people?";
  Quiz[29].Text = "Do you have difficulties judging distances, height, depth or speed?";
  Quiz[30].Text = "Do you have problems finding your way to new places?";
  Quiz[31].Text = "Do you have a good sense of how much pressure to apply when doing things with your hands?";
  Quiz[32].Text = "Do you have problems recognizing faces (prosopagnosia)?";
  Quiz[33].Text = "Do you have trouble reading clocks?";
  Quiz[34].Text = "Do you mix up digits in numbers like 95 and 59?";
  Quiz[35].Text = "Are you sometimes afraid in safe situations?";
  Quiz[36].Text = "Have others commented or have you observed yourself that you make unusual facial expressions?";
  Quiz[37].Text = "Do you often don't know where to put your arms?";
  Quiz[38].Text = "Do you wring your hands, rub your hands together or twirl your fingers?";
  Quiz[39].Text = "Have you been accused of staring?";
  ...
  Quiz[44].Text = "Have others told you that you have an odd posture or gait?";
  Quiz[45].Text = "Do you tap your ears or press your eyes (e.g. when thinking, when stressed or distressed)?";
  Quiz[46].Text = "Do you stutter when stressed?";
  Quiz[47].Text = "Do you bite your lip, cheek or tongue (e.g. when thinking, when anxious or nervous)?";
  Quiz[48].Text = "Do you like to follow (walk behind) people you are attached to?";
  Quiz[49].Text = "Do you pace (e.g. when thinking or anxious)?";
  ...
  Quiz[52].Text = "Do you have an urge to observe the habits of humans and/or animals?";
  Quiz[53].Text = "Do you have an urge to learn the routines of people you know?";
  Quiz[54].Text = "Do you jump between topics when speaking?";
  Quiz[55].Text = "Do you feel an urge to peel flakes off yourself and / or others?";
  Quiz[56].Text = "Do you talk to yourself?";
  Quiz[57].Text = "Do you examine the hair of people you like a lot?";
  Quiz[58].Text = "Do you sometimes mix up pronouns and, for example, say \"you\" or \"we\" when you mean \"me\" or vice versa?";
  Quiz[59].Text = "Do you enjoy walking on your toes?";
  Quiz[60].Text = "Do you have, or used to have, imaginary friends?";
  Quiz[61].Text = "Do you find it difficult to figure out how to behave in various situations?";
  Quiz[62].Text = "Do you have a tendency to become stuck when asked questions in social situation?";
  Quiz[63].Text = "Do you often feel out-of-sync with others?";
  Quiz[64].Text = "Do you tend to express your feelings in ways that may baffle others?";
  Quiz[65].Text = "Do you have problems with timing in conversations?";
  Quiz[66].Text = "Do others often misunderstand you?";
  Quiz[67].Text = "Do you tend to say things that are considered socially inappropriate when you are tired, frustrated or when you act naturally?";
  Quiz[68].Text = "Do you often have lots of thoughts that you find hard to verbalize?";
  Quiz[69].Text = "Do you forget you are in a social situation when something gets your attention?";
  Quiz[70].Text = "Do people sometimes think you are smiling at the wrong occasion?";
  Quiz[71].Text = "Has it been harder for you than for others to keep friends?";
  Quiz[72].Text = "As a teenager, were you usually unaware of social rules & boundaries unless they were clearly spelled out?";
  Quiz[73].Text = "Do you instinctively know when it is your turn to speak when talking on the phone?";
  Quiz[74].Text = "Do you tend to talk either too softly or too loudly?";
  Quiz[75].Text = "Is it hard for you to see why some things upset people so much?";
  Quiz[76].Text = "Do you know when you are expected to offer an apology?";
  Quiz[77].Text = "In conversations, do you need extra time to carefully think out your reply, so that there may be a pause before you answer?";
  ...
  Quiz[84].Text = "Is your sense of humor different from mainstream or considered odd?";
  ...
  Quiz[93].Text = "Do you find it easy to describe your feelings?";
  Quiz[94].Text = "Do you find yourself at ease in romantic situations?";
  Quiz[95].Text = "Do you prefer to keep to yourself?";
  Quiz[96].Text = "Is it hard for you to approach somebody you are attracted to?";
  Quiz[97].Text = "Do you like to visit people one at a time?";
  Quiz[98].Text = "Do you prefer to socialize with familiar friends because you know what to expect from them?";
  Quiz[99].Text = "Do you tend to shut down or have a meltdown when stressed or overwhelmed?";
  Quiz[100].Text = "Do you almost always feel hurried to reach a decision, even when there is no reason to do so?";
  Quiz[101].Text = "Do you become frustrated if an activity that is important to you gets interrupted?";
  Quiz[102].Text = "In a conversation, do you tend to focus on your own thoughts rather than on what your listener might be thinking?";
  Quiz[103].Text = "Do you have certain routines which you need to follow?";
  Quiz[104].Text = "Do you find it disturbing or upsetting when others show up either later or sooner than agreed?";
  Quiz[105].Text = "Do you prefer to do things on your own even if you could use others' help or expertise?";
  Quiz[106].Text = "Do you see your own activities as more important than other people's?";
  Quiz[107].Text = "Do you have difficulty accepting criticism, correction, and direction?";
  Quiz[108].Text = "Do you expect other people to know your thoughts, experiences and opinions without you having to tell them?";
  Quiz[109].Text = "Are you impatient and have low frustration tolerance?";
  Quiz[110].Text = "Will you abandon your friends if your activities or ideals clash?";
  Quiz[111].Text = "Do you usually find faults with opinions that you don't share?";
  Quiz[112].Text = "Do you need lists and schedules in order to get things done?";
  Quiz[113].Text = "Do you have trouble with authority?";
  Quiz[114].Text = "Do you obstruct others' plans?";
  Quiz[115].Text = "Have you have had long-lasting urges to take revenge?";
  Quiz[116].Text = "Do you argue a lot?";
  Quiz[117].Text = "Are you good at team-work?";
  Quiz[118].Text = "Do you dislike shaking hands with strangers?";
  Quiz[119].Text = "Do you get very tired after socializing, and need to regenerate alone?";
  Quiz[120].Text = "Do you prefer to only meet people you know, one-on-one, or in small, familiar groups?";
  Quiz[121].Text = "Do you dislike it when people drop by to visit you uninvited?";
  Quiz[122].Text = "Do you find it natural to wave or say 'hi' when you meet people?";
  Quiz[123].Text = "Do you enjoy big events even if they are crowded?";
  Quiz[124].Text = "Have you felt kinship and belonging to others for all your life?";
  Quiz[125].Text = "Do you enjoy big events even if they are crowded?";
  Quiz[126].Text = "Do you have a clear sense of your identity?";
  Quiz[127].Text = "Do you enjoy hosting or arranging events?";
  Quiz[128].Text = "Do you like to do things spontaneously?";
  Quiz[129].Text = "Do you enjoy travel?";
  Quiz[130].Text = "Do you take pride in your appearance?";
  Quiz[131].Text = "Do you enjoy gossip?";
  Quiz[132].Text = "Do you tend to look a lot at people you like and little or not at all at people you dislike?";
  ...
  Quiz[136].Text = "Do you have favorite places nearby that you need to visit from time to time?";
  ...
  Quiz[141].Text = "Are intimate relationships very important in your life?";
  Quiz[142].Text = "Do you get great pleasure from making love?";
  Quiz[143].Text = "Do you like tongue-kissing?";
...
#
##########################################################################*/
void TQuizJE4::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizJE4::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
