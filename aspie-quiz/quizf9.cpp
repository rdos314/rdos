...
/*##########################################################################
#
#   Name       : TQuizF9::TQuizF9
#
#   Purpose....: Constructor for TQuizF9
#
	...
	FDataFile(FileName)
{
	...
	SetupTexts();
	SetupCross(QuizI, QuizII, QuizIII, QuizNd, Quiz5, Quiz6, Quiz7, Quiz8, Quiz9, QuizR1, QuizR2, QuizR3, QuizR4, QuizR5, QuizR6, QuizR7, QuizS1, QuizS2, QuizS3, QuizS4, QuizS5, QuizS6, QuizS7, QuizS8, QuizS9, QuizS10, QuizS11, QuizS12, QuizN1, QuizN2, QuizN3, QuizN4, QuizFI, QuizF1, QuizF2, QuizF3, QuizF4, QuizF5, QuizF6, QuizF7, QuizF8);
...
#   Name       : TQuizF9::~TQuizF9
#
#   Purpose....: Destructor for TQuizF9
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizF9::GetCatCount(int Question)
{
	return 3;
}
...
#
##########################################################################*/
void TQuizF9::WriteName(TFile &File)
{
	 File.Write("F9");
}
...
#
##########################################################################*/
void TQuizF9::WriteLongName(TFile &File)
{
	 File.Write("final version 9");
}

/*##########################################################################
#
#   Name       : TQuizF9::SetupTexts
#
...
void TQuizF9::SetupTexts()
{
  ...
  Quiz[151].Text = "TS - Do you involuntarily repeat or imitate observed movements of others (echopraxia)?";
  Quiz[152].Text = "TS - Do you repeat vocalizations made by others (echolalia)?";
  Quiz[153].Text = "TS - Do you repeat or echo your own spoken words (stuttering, palilalia)?";
  Quiz[154].Text = "TS - Do you have complex motor tics (eg facial grimaces, pulling cloth, touching people or objects, obscene gesturing or gyrating movements)?";
  Quiz[155].Text = "TS - Do you have complex vocal tics (eg talking to yourself, using socially meaningless sentences)?";
  Quiz[156].Text = "TS - Did you have tics before the age of twelve?";
  Quiz[157].Text = "TS - If you have tics, do the wax and wane?";
  Quiz[158].Text = "TS - If you have tics, did they begin above shoulders";
  Quiz[159].Text = "TS - Do you have five or more motor tic types in the list above?";
  Quiz[160].Text = "TS - Do you have three or more vocal tic types in the list above?";
  Quiz[161].Text = "TS - If you have motor tics, do they affect multiple body locations?";
  Quiz[162].Text = "TS - If you have tics, have they varied with some tics disappearing and new tics appearing over time?";
  Quiz[163].Text = "TS - If you have tics, do you have them even if you are not in a stressful situation?";
  Quiz[164].Text = "TS - If you have tics, are they voluntarily suppressible?";
  Quiz[165].Text = "TS - If you have tics, do you attempt to suppress them?";
  Quiz[166].Text = "TS - If you have tics and you try to suppress them, do they become worse (rebound effect)?";
  Quiz[167].Text = "TS - If you have tics, can you sense their coming beforehand (premonitory sensation)?";
  Quiz[168].Text = "TS - If you have tics, do you sense relief after you had them?";
  Quiz[169].Text = "TS - If you have tics, do a mention or sight of a specific tic induce it (suggestible)?";
  Quiz[170].Text = "TS - Do you have frequent tics (more than one per minute at times)?";
  Quiz[171].Text = "TS - Do you have orchestrated sequences of tics?";
  Quiz[172].Text = "TS - If you have tics, do they cause distress?";
  Quiz[173].Text = "TS - If you have tics, have you sought treatment or diagnosis?";
  Quiz[174].Text = "TS - Have you had tics for a duration of two or more years";
  Quiz[175].Text = "TS - Have your tics been confirmed by one or more reliable observers?";
  Quiz[176].Text = "TS - Do you have an absence of other medical problems that might cause tics (eg prior stimulant therapy, history of encephalitis)?";

}

/*##################  TQuizF9::LoadReferers ##########################
...
#
##########################################################################*/
void TQuizF9::GetReferer(const char *referer, TPopulation *pop)
{
	int i;
	TReferer *ref;
	TQuizRow Row;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF9::ExportExcelCase(const char *filename, int PcaType)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF9::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF9::ExportExcelGroups(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF9::ImportMvsp(const char *filename, int PcaType)
{
	char buf[MAX_IN_ROW];
	int size;
	char *rowstr;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF9::WriteRace(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizF9::WriteRetest(const char *filename)
{
	TQuizRow Row;
	int userid;
	int i;
