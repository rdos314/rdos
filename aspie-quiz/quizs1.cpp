...
#
##########################################################################*/
void TQuizS1::WriteLongName(TFile &File)
{
	 File.Write("stable version 1");
}
...
void TQuizS1::SetupTexts()
{
  ...
  Quiz[61].MyGroup = GROUP_ENVIRONMENT;
  ...
  Quiz[78].MyGroup = GROUP_ACTIVITY;
  ...
  Quiz[86].MyGroup = GROUP_ENVIRONMENT;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizS1::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
