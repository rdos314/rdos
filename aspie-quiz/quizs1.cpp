...
void TQuizS1::SetupTexts()
{
  ...
  Quiz[100].Text = "Do you tend to express your feelings in ways that may baffle others (e.g. banging your head in the wall, or being unable to show anything at all)?";
  ...
  Quiz[100].Text = "Brukar du uttrycka känslor på okonventionella sätt (t ex banka huvudet i väggen eller inte visa något alls)?";
