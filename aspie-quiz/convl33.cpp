...
#
# convl33.cpp
# Convert exported quiz-l33 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 177);
}

/*################## ConvL32 ##########################
*   Purpose....: Convert quiz l32                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL33()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l33.csv");
    TFile outfile("bin\\quizl33.bin", 0);
    char *ptr;
