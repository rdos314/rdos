...
/*##########################################################################
#
#   Name       : TQuizH6::TQuizH6
#
#   Purpose....: Constructor for TQuizH6
#
...
#
##########################################################################*/
TQuizH6::TQuizH6(const char *FileName)
  : TQuiz(186),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH6::~TQuizH6
#
#   Purpose....: Destructor for TQuizH6
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH6::GetCatCount(int Question)
{
        return 3;
}
...
#
##########################################################################*/
void TQuizH6::WriteName(TFile &File)
{
         File.Write("H6");
}
...
#
##########################################################################*/
void TQuizH6::WriteLongName(TFile &File)
{
         File.Write("H6");
}
...
void TQuizH6::SetupTexts()
{
  ...
  Quiz[153].MyGroup = GROUP_ASPIE_SENSORY;
  ...
  Quiz[178].MyGroup = GROUP_ASPIE_HUNTING;
  ...
  Quiz[183].MyGroup = GROUP_ASPIE_HUNTING;
  ...
  Quiz[150].Text = "Have you had the feeling of playing a game to pretend to be like people around you?";
  Quiz[151].Text = "Do you have values & views that are either very old-fashioned or way ahead of their time?";
  Quiz[152].Text = "Is your style and image very important to you?";
  Quiz[153].Text = "If you have to be touched, do you prefer it to be firmly rather than lightly?";
  Quiz[154].Text = "Do you have difficulties judging unseen limits and other people's personal space unless clearly instructed?";
  Quiz[155].Text = "Do you have a need to confess?";
  Quiz[156].Text = "Do you often forget were you put things?";
  Quiz[157].Text = "Do you dislike being hugged when you haven't asked for it?";
  Quiz[158].Text = "Do you have an alternative view of what is attractive in the opposite sex compared to most others?";
  Quiz[159].Text = "Are you insensitive to physical pain, or even enjoy some types of pain?";
  Quiz[160].Text = "Do you dislike shaking hands?";
  Quiz[161].Text = "Are you sensitive to dry air?";
  Quiz[162].Text = "Do you prefer to use others' help or expertise instead of doing things on your own?";
  Quiz[163].Text = "Do you flap your hands (e.g. when excited or upset)?";
  Quiz[164].Text = "Do you prefer to avoid eye-contact?";
  Quiz[165].Text = "Is it harder for you than for others to get over a failed relationship?";
  Quiz[166].Text = "Have you experienced stronger than normal attachments to certain people?";
  Quiz[167].Text = "Do you pull hair?";
  Quiz[168].Text = "Do you skip around while reading, go to the end first, or have trouble staying on track?";
  Quiz[169].Text = "Do you have difficulty coming awake (may need coffee or other stimulant or activity before feeling fully awake)?";
  Quiz[170].Text = "Do you have poor concept of time?";
  Quiz[171].Text = "Do you feel driven by your creativity?";
  Quiz[172].Text = "Can you sense the feelings of animals?";
  Quiz[173].Text = "Are you asexual?";
  Quiz[174].Text = "Do you find it difficult to approach others?";
  Quiz[175].Text = "Do you think highly of yourself?";
  Quiz[176].Text = "Do you prefer to be alone?";
  Quiz[177].Text = "Do you remain calm under pressure?";
  Quiz[178].Text = "Do you enjoy hanging upside down?";
  Quiz[179].Text = "Do you believe in love at first sight?";
  Quiz[180].Text = "Do you prefer to have friends of the opposite gender?";
  Quiz[181].Text = "Does it upset you to see animals in pain?";
  Quiz[182].Text = "Do you have an urge to observe the habits of humans?";
  Quiz[183].Text = "Do you have an urge to observe the habits of animals?";
  Quiz[184].Text = "Do you have an urge to learn the routines of people you know?";
  Quiz[185].Text = "Do you rather know bad news than stay in a state of uncertainty?";
...
#
##########################################################################*/
void TQuizH6::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH6::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
