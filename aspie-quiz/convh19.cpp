...
#
# convh19.cpp
# Convert exported quiz-h19 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvH19()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-h19.csv");
    TFile outfile("bin\\quizh19.bin", 0);
    char *ptr;
