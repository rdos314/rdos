...
/*##########################################################################
#
#   Name       : TQuizH28::TQuizH28
#
#   Purpose....: Constructor for TQuizH28
#
...
#
##########################################################################*/
TQuizH28::TQuizH28(const char *FileName)
  : TQuiz(193),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH28::~TQuizH28
#
#   Purpose....: Destructor for TQuizH28
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH28::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH28::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH28::GetCatCount(int Question)
{
    if (Question >= 192)
        return 2;
    else
...
#
##########################################################################*/
void TQuizH28::WriteName(TFile &File)
{
    File.Write("H28");
}
...
#
##########################################################################*/
void TQuizH28::WriteLongName(TFile &File)
{
    File.Write("H28");
}
...
void TQuizH28::SetupTexts()
{
  ...
  Quiz[192].Text = "Courting";

}

/*##########################################################################
#
#   Name       : TQuizH28::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH28::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH28::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
