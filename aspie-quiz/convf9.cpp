...
#
# convf9.cpp
# Convert exported quiz-f9 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-f9 VALUES(";

TFile quizfile("quizf9.bin", 0);
TFile ancfile("ancf9.bin", 0);
