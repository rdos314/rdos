...
/*##########################################################################
#
#   Name       : TQuizG3::TQuizG3
#
#   Purpose....: Constructor for TQuizG3
#
...
#   Name       : TQuizG3::~TQuizG3
#
#   Purpose....: Destructor for TQuizG3
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizG3::GetCatCount(int Question)
{
    if (Question < 150)
    	return 3;
    else
...
#
##########################################################################*/
void TQuizG3::WriteName(TFile &File)
{
	 File.Write("G3");
}
...
#
##########################################################################*/
void TQuizG3::WriteLongName(TFile &File)
{
	 File.Write("final version 2:3");
}

/*##########################################################################
#
#   Name       : TQuizG3::SetupTexts
#
...
void TQuizG3::SetupTexts()
{
  ...
  Quiz[150].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon1.gif\"> - worried over skeptical";
  Quiz[151].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon2.gif\"> - angry over happy";
  Quiz[152].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon4.gif\"> - innocent over sarcastic";
  Quiz[153].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon5.gif\"> - shocked over cheerful";
  Quiz[154].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon6.gif\"> - fake over friendly";
  Quiz[155].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon7.gif\"> - tired over happy";
  Quiz[156].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon9.gif\"> - bored over hopeful";
  Quiz[157].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon10.gif\"> - frustrated over sneaky";
  Quiz[158].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon11.gif\"> - stupid over funny";
  Quiz[159].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon12.gif\"> - staring over mischevious";
  Quiz[160].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon13.gif\"> - triumphant over cheery";
  Quiz[161].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon14.gif\"> - don't talk to me over hello";
  Quiz[162].Text = "<img border=\"0\" src=\"http://www.rdos.net/smileys/icon15.gif\"> - you over be quiet";
...
#
##########################################################################*/
void TQuizG3::SetupCross(TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd, TQuiz *Quiz5, TQuiz *Quiz6, TQuiz *Quiz7, TQuiz *Quiz8, TQuiz *Quiz9, TQuiz *QuizR1, TQuiz *QuizR2, TQuiz *QuizR3, TQuiz *QuizR4, TQuiz *QuizR5, TQuiz *QuizR6, TQuiz *QuizR7, TQuiz *QuizS1, TQuiz *QuizS2, TQuiz *QuizS3, TQuiz *QuizS4, TQuiz *QuizS5, TQuiz *QuizS6, TQuiz *QuizS7, TQuiz *QuizS8, TQuiz *QuizS9, TQuiz *QuizS10, TQuiz *QuizS11, TQuiz *QuizS12, TQuiz *QuizN1, TQuiz *QuizN2, TQuiz *QuizN3, TQuiz *QuizN4, TQuiz *QuizFI, TQuiz *QuizF1, TQuiz *QuizF2, TQuiz *QuizF3, TQuiz *QuizF4, TQuiz *QuizF5, TQuiz *QuizF6, TQuiz *QuizF7, TQuiz *QuizF8, TQuiz *QuizF9, TQuiz *QuizF10, TQuiz *QuizF11, TQuiz *QuizF12, TQuiz *QuizF13, TQuiz *QuizF14, TQuiz *QuizF15, TQuiz *QuizGE, TQuiz *QuizGE2, TQuiz *QuizGE3, TQuiz *QuizG1, TQuiz *QuizG2)
{
    int i;

    for (i = 0; i < 150; i++)
	    DefineCross(QuizG2, i, i);

	DefineGlobalId(150, 1688);
	DefineGlobalId(151, 1689);
	DefineGlobalId(152, 1690);
	DefineGlobalId(153, 1691);
	DefineGlobalId(154, 1692);
	DefineGlobalId(155, 1693);
	DefineGlobalId(156, 1694);
	DefineGlobalId(157, 1695);
	DefineGlobalId(158, 1696);
	DefineGlobalId(159, 1697);
	DefineGlobalId(160, 1698);
	DefineGlobalId(161, 1699);
	DefineGlobalId(162, 1700);
	DefineGlobalId(163, 1701);
	DefineGlobalId(164, 1702);
	DefineGlobalId(165, 1703);

}

/*##########################################################################
#
#   Name       : TQuizG3::GetReferer
#
...
#
##########################################################################*/
void TQuizG3::GetReferer(const char *referer, TPopulation *pop)
{
	int i;
	TReferer *ref;
	TQuizRow Row;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG3::ExportExcelCase(const char *filename, int PcaType)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG3::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG3::ExportExcelGroups(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG3::ImportMvsp(const char *filename, int PcaType)
{
	char buf[MAX_IN_ROW];
	int size;
	char *rowstr;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG3::WriteRace(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG3::WriteRetest(const char *filename)
{
	TQuizRow Row;
	int userid;
	int i;
