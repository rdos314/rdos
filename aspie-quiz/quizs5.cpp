...
#
##########################################################################*/
void TQuizS5::WriteLongName(TFile &File)
{
	 File.Write("stable version 5");
}
...
void TQuizS5::SetupTexts()
{
  ...
  Quiz[14].MyGroup = GROUP_ASPIE_OBSESSION;
  ...
  Quiz[119].MyGroup = GROUP_ACTIVITY;
  ...
  Quiz[131].MyGroup = GROUP_ASPIE_OBSESSION;
