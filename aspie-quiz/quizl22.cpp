...
/*##########################################################################
#
#   Name       : TQuizL22::TQuizL22
#
#   Purpose....: Constructor for TQuizL22
#
...
#
##########################################################################*/
TQuizL22::TQuizL22(const char *FileName)
  : TQuiz(134),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL22::~TQuizL22
#
#   Purpose....: Destructor for TQuizL22
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL22::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL22::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL22::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizL22::WriteName(TFile &File)
{
    File.Write("L22");
}
...
#
##########################################################################*/
void TQuizL22::WriteLongName(TFile &File)
{
    File.Write("L22");
}
...
void TQuizL22::SetupTexts()
{
  ...
  Quiz[121].Text = "Does it happen that you get feelings from close friends, a romantic interest or partner directly into your mind?";
  Quiz[122].Text = "Does it happen that you get thoughts from close friends, a romantic interest or partner directly into your mind?";
  Quiz[123].Text = "Have you sensed that somebody was around you even when you couldn't see him/her?";
  Quiz[124].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[125].Text = "Do you feel as if electrical devices such as computers can influence the way you think?";
  Quiz[126].Text = "Do you feel as if the thoughts in your head are not your own?";
  Quiz[127].Text = "Do you feel as if you are under the control of some force or power other than yourself?";
  Quiz[128].Text = "Do you see objects, people or animals that other people cannot see?";
  Quiz[129].Text = "Do you think hair is sexually arousing (hair fetishism)?";
  Quiz[130].Text = "Do you think feet are sexually arousing (foot fetishism)?";
  Quiz[131].Text = "Do you think muscles are sexually arousing (muscle fetishism)?";
  Quiz[132].Text = "Do you think hands are sexually arousing (hand fetishism)?";
  Quiz[133].Text = "Do you have a semen fetish?";

}

/*##########################################################################
#
#   Name       : TQuizL22::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL22::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL22::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
