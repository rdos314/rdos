...
#
# convs11.cpp
# Convert exported quiz-s11 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 149);
}

/*##################  ConvS11 ##########################
 *   Purpose....: Conv quiz S11                                                           #
 *   In params..: *                                                          #
 *   Out params.: *                                                          #
 *   Returns....: *                                                          #
 *   Created....: 96-11-20 le                                                #
...
void ConvS11()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-s11.csv");
    TFile outfile("bin\\quizs11.bin", 0);
    char *ptr;
