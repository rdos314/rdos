...
#
# convf12.cpp
# Convert exported quiz-f12 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-f12 VALUES(";

TFile quizfile("quizf12.bin", 0);
TFile ancfile("ancf12.bin", 0);
...
char *ProcessRow(char *str)
{
	...
	for (fieldno = 0; fieldno < 208; fieldno++)
	{
		valstr = str;
