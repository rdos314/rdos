...
#
# convl30.cpp
# Convert exported quiz-l30 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 240);
}

/*################## ConvL30 ##########################
*   Purpose....: Convert quiz l30                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL30()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l30.csv");
    TFile outfile("bin\\quizl30.bin", 0);
    char *ptr;
