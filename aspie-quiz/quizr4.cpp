...
void TQuizR4::SetupTexts()
{
  ...
  Quiz[2].MyGroup = GROUP_NT_OBSESSION;
  ...
  Quiz[77].MyGroup = GROUP_ASPIE_HUNTING;
  ...
  Quiz[133].MyGroup = GROUP_NT_HUNTING;
  Quiz[134].MyGroup = GROUP_NT_HUNTING;
  Quiz[135].MyGroup = GROUP_NT_HUNTING;
  Quiz[136].MyGroup = GROUP_NT_HUNTING;
  Quiz[137].MyGroup = GROUP_NT_HUNTING;
