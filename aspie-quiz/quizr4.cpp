...
void TQuizR4::SetupTexts()
{
  ...
  Quiz[9].MyGroup = GROUP_NONVERBAL;
  ...
  Quiz[86].MyGroup = GROUP_ASPIE_TALENT;
  ...
  Quiz[111].MyGroup = GROUP_ASPIE_BIOLOGY;
  ...
  Quiz[168].MyGroup = GROUP_ASPIE_COMM;
  ...
  Quiz[177].MyGroup = GROUP_NONVERBAL;
  ...
  Quiz[189].MyGroup = GROUP_NONVERBAL;
...
#
##########################################################################*/
void TQuizR4::UpdateReferer(TReferer *ref, int AsResult, int NtResult)
{
	int diff;
