...
/*##########################################################################
#
#   Name       : TQuizJ6::TQuizJ6
#
#   Purpose....: Constructor for TQuizJ6
#
...
#   Name       : TQuizJ6::~TQuizJ6
#
#   Purpose....: Destructor for TQuizJ6
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJ6::GetCatCount(int Question)
{
   if (Question < 126)
       return 3;
   else
...
#
##########################################################################*/
void TQuizJ6::WriteName(TFile &File)
{
    File.Write("J6");
}
...
#
##########################################################################*/
void TQuizJ6::WriteLongName(TFile &File)
{
    File.Write("J6");
}
...
#
##########################################################################*/
void TQuizJ6::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizJ6::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
