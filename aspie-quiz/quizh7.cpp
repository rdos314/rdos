...
/*##########################################################################
#
#   Name       : TQuizH7::TQuizH7
#
#   Purpose....: Constructor for TQuizH7
#
...
#
##########################################################################*/
TQuizH7::TQuizH7(const char *FileName)
  : TQuiz(192),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizH7::~TQuizH7
#
#   Purpose....: Destructor for TQuizH7
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH7::GetCatCount(int Question)
{
        return 3;
}
...
#
##########################################################################*/
void TQuizH7::WriteName(TFile &File)
{
         File.Write("H7");
}
...
#
##########################################################################*/
void TQuizH7::WriteLongName(TFile &File)
{
         File.Write("H7");
}
...
void TQuizH7::SetupTexts()
{
  ...
  Quiz[150].Text = "Did you perceive practical classes like handi-work or gymnasics as hard in school?";
  Quiz[151].Text = "Do you find it easy to describe your feelings and emotions to others?";
  Quiz[152].Text = "Do you dislike or have difficulty with team sports and other group endeavours?";
  Quiz[153].Text = "Do you find it natural to keep track of whom owes whom favours?";
  Quiz[154].Text = "Can you often appreciate people without putting demands on them?";
  Quiz[155].Text = "Do you have irregular eating habits that are adapted to what you are doing right now?";
  Quiz[156].Text = "Are you so honest and sincere yourself that you assume everyone is, and therefore easily miss dishonesty and hidden agendas?";
  Quiz[157].Text = "Are you very interested in environmental issues?";
  Quiz[158].Text = "Have you had an urge to try drugs or illegal substances?";
  Quiz[159].Text = "Do you like to collect items to make a set?";
  Quiz[160].Text = "Do you frequently misplace things?";
  Quiz[161].Text = "Do you appreciate to be in charge of other people?";
  Quiz[162].Text = "Do you have unusual eating patterns?";
  Quiz[163].Text = "Do you have an exceptional ability to put faces to names?";
  Quiz[164].Text = "Do you swear a lot?";
  Quiz[165].Text = "Do you see the value in owning one of a kind?";
  Quiz[166].Text = "Have you felt kinship and belonging to others for most of your life?";
  Quiz[167].Text = "Do you enjoy hosting or arranging events?";
  Quiz[168].Text = "Are you always aware of other things going on around you even when reading or otherwise occupied?";
  Quiz[169].Text = "Are your dreams and fantasies much like those of your friends?";
  Quiz[170].Text = "Do you take on too much because it is easier than having to explain to others how to do it?";
  Quiz[171].Text = "Are you the life of a party?";
  Quiz[172].Text = "Do you sometimes not feel anything at all, even though other people expect you to?";
  Quiz[173].Text = "Do you enjoy listening to gossip?";
  Quiz[174].Text = "Do you talk to put others at ease even when you really have nothing to say?";
  Quiz[175].Text = "Are you often surprised when you find out what people's true motives are?";
  Quiz[176].Text = "Do you dislike eye-contact?";
  Quiz[177].Text = "Are you good at party games?";
  Quiz[178].Text = "Is creating a social identity important for you?";
  Quiz[179].Text = "Can you whistle?";
  Quiz[180].Text = "Do you find it very easy to play games with children that involve pretending?";
  Quiz[181].Text = "Do you know how to tell if someone listening to you is getting bored?";
  Quiz[182].Text = "Do you find yourself drawn more strongly to people than to things?";
  Quiz[183].Text = "Do you instinctively cross your arms when you are in a closed state of mind?";
  Quiz[184].Text = "Is it hard to read maps?";
  Quiz[185].Text = "Are you so honest and sincere yourself that you assume everyone is?";
  Quiz[186].Text = "Do you obstruct others' plans?";
  Quiz[187].Text = "Do you insult people?";
  Quiz[188].Text = "Do you cheat to get ahead?";
  Quiz[189].Text = "Do you love to help others?";
  Quiz[190].Text = "Do you use others for your own ends?";
  Quiz[191].Text = "Are you good at predicting how someone will feel?";
}

/*##########################################################################
#
#   Name       : TQuizH7::LoadPopulations
#
...
#
##########################################################################*/
void TQuizH7::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH7::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
