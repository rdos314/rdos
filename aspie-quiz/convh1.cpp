...
#
# convh1.cpp
# Convert exported quiz-h1 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO `aspie-quiz-h1` VALUES(";

TFile quizfile("quizh1.bin", 0);
TFile ancfile("anch1.bin", 0);
