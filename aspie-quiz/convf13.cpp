...
#
# convf13.cpp
# Convert exported quiz-f13 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 182);
}

/*################## ConvF13 ##########################
*   Purpose....: Convert quiz f13                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvF13()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-f13.csv");
    TFile outfile("bin\\quizf13.bin", 0);
    char *ptr;
