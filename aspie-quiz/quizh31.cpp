...
void TQuizH31::SetupTexts()
{
  ...
  Quiz[183].MyGroup = GROUP_SEX;
  Quiz[184].MyGroup = GROUP_SEX;
  Quiz[185].MyGroup = GROUP_ASPIE_SENSORY;
  Quiz[186].MyGroup = GROUP_ASPIE_TALENT;
  ...
  Quiz[192].MyGroup = GROUP_ASPIE_NVC;
  Quiz[193].MyGroup = GROUP_ASPIE_NVC;
