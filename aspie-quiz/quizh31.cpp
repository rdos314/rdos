...
void TQuizH31::SetupTexts()
{
  ...
  Quiz[17].MyGroup = GROUP_NDNT;
  Quiz[18].MyGroup = GROUP_ASPIE_EMOTION;
  Quiz[19].MyGroup = GROUP_ASPIE_EMOTION;
  Quiz[20].MyGroup = GROUP_ASPIE_EMOTION;
  Quiz[21].MyGroup = GROUP_ASPIE_EMOTION;
  Quiz[22].MyGroup = GROUP_ASPIE_EMOTION;
  Quiz[23].MyGroup = GROUP_ASPIE_EMOTION;
  Quiz[24].MyGroup = GROUP_ASPIE_EMOTION;
  Quiz[25].MyGroup = GROUP_MIXED;
  Quiz[26].MyGroup = GROUP_NT_NVC;
  Quiz[27].MyGroup = GROUP_NT_SOCIAL;
  Quiz[28].MyGroup = GROUP_NT_NVC;
  Quiz[29].MyGroup = GROUP_ASPIE_AUTH;
  Quiz[30].MyGroup = GROUP_NT_SOCIAL;
  Quiz[31].MyGroup = GROUP_NT_SOCIAL;
  Quiz[32].MyGroup = GROUP_NDNT;
  Quiz[33].MyGroup = GROUP_NDNT;
  Quiz[34].MyGroup = GROUP_ASPIE_AUTH;
  Quiz[35].MyGroup = GROUP_MIXED;
  Quiz[36].MyGroup = GROUP_ASPIE_AUTH;
  Quiz[37].MyGroup = GROUP_ASPIE_NVC;
  Quiz[38].MyGroup = GROUP_ASPIE_REL;
  Quiz[39].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[40].MyGroup = GROUP_MIXED;
  Quiz[41].MyGroup = GROUP_NT_TALENT;
  Quiz[42].MyGroup = GROUP_ASPIE_AUTH;
  Quiz[43].MyGroup = GROUP_MIXED;
  Quiz[44].MyGroup = GROUP_MIXED;
  Quiz[45].MyGroup = GROUP_MIXED;
  Quiz[46].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[47].MyGroup = GROUP_ASPIE_AUTH;
  Quiz[48].MyGroup = GROUP_NDNT;
  Quiz[49].MyGroup = GROUP_NT_SOCIAL;
  Quiz[50].MyGroup = GROUP_NT_SOCIAL;
  Quiz[51].MyGroup = GROUP_NDNT;
  Quiz[52].MyGroup = GROUP_NT_EMOTION;
  ...
  Quiz[101].MyGroup = GROUP_NT_EMOTION;
  Quiz[102].MyGroup = GROUP_NT_NVC;
  Quiz[103].MyGroup = GROUP_NDNT;
  ...
  Quiz[146].MyGroup = GROUP_ASPIE_AUTH;
  ...
  Quiz[152].MyGroup = GROUP_ASPIE_AUTH;
  Quiz[153].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[154].MyGroup = GROUP_NDNT;
  Quiz[155].MyGroup = GROUP_NDNT;
  Quiz[156].MyGroup = GROUP_ASPIE_REL;
  Quiz[157].MyGroup = GROUP_ASPIE_REL;
  Quiz[158].MyGroup = GROUP_NT_EMOTION;
  Quiz[159].MyGroup = GROUP_NT_REL;
  Quiz[160].MyGroup = GROUP_NT_EMOTION;
  Quiz[161].MyGroup = GROUP_NT_EMOTION;
  Quiz[162].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[163].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[164].MyGroup = GROUP_ASPIE_TALENT;
  Quiz[165].MyGroup = GROUP_NT_EMOTION;
  Quiz[166].MyGroup = GROUP_NT_EMOTION;
  Quiz[167].MyGroup = GROUP_ASPIE_EMOTION;
  Quiz[168].MyGroup = GROUP_MIXED;
  Quiz[169].MyGroup = GROUP_ASPIE_REL;
  Quiz[170].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[171].MyGroup = GROUP_ASPIE_NVC;
  Quiz[172].MyGroup = GROUP_NT_REL;
  Quiz[173].MyGroup = GROUP_ASPIE_REL;
  Quiz[174].MyGroup = GROUP_NT_REL;
  Quiz[175].MyGroup = GROUP_NT_REL;
  Quiz[176].MyGroup = GROUP_ASPIE_REL;
  Quiz[177].MyGroup = GROUP_NT_REL;
  Quiz[178].MyGroup = GROUP_NT_REL;
  Quiz[179].MyGroup = GROUP_ASPIE_REL;
  Quiz[180].MyGroup = GROUP_ASPIE_REL;
  Quiz[181].MyGroup = GROUP_ASPIE_NVC;
  Quiz[182].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[183].MyGroup = GROUP_ASPIE_AUTH;
  Quiz[184].MyGroup = GROUP_ASPIE_AUTH;
  Quiz[185].MyGroup = GROUP_NDNT;
  Quiz[186].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[187].MyGroup = GROUP_ASPIE_NVC;
  Quiz[188].MyGroup = GROUP_ASPIE_REL;
  Quiz[189].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[190].MyGroup = GROUP_ASPIE_REL;
  Quiz[191].MyGroup = GROUP_ASPIE_NVC;
  Quiz[192].MyGroup = GROUP_ASPIE_REL;
  Quiz[193].MyGroup = GROUP_ASPIE_REL;
