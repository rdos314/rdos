...
void TQuizH31::SetupTexts()
{
  ...
  Quiz[4].MyGroup = GROUP_ASPIE_EMOTION;
  ...
  Quiz[17].MyGroup = GROUP_ASPIE_EMOTION;
  ...
  Quiz[25].MyGroup = GROUP_ASPIE_EMOTION;
  Quiz[26].MyGroup = GROUP_NDNT;
  ...
  Quiz[40].MyGroup = GROUP_ASPIE_REL;
  ...
  Quiz[61].MyGroup = GROUP_ASPIE_EMOTION;
  ...
  Quiz[79].MyGroup = GROUP_ASPIE_REL;
  ...
  Quiz[154].MyGroup = GROUP_ASPIE_REL;
  Quiz[155].MyGroup = GROUP_ASPIE_REL;
  ...
  Quiz[167].MyGroup = GROUP_ASPIE_SENSORY;
