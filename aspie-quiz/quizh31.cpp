...
/*##########################################################################
#
#   Name       : TQuizH31::TQuizH31
#
#   Purpose....: Constructor for TQuizH31
#
...
#   Name       : TQuizH31::~TQuizH31
#
#   Purpose....: Destructor for TQuizH31
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizH31::GetPcaCount()
{
        return 4;
}

/*##################  TQuizH31::GetCatCount ##########################
...
#
##########################################################################*/
void TQuizH31::WriteName(TFile &File)
{
    File.Write("H31");
}
...
#
##########################################################################*/
void TQuizH31::WriteLongName(TFile &File)
{
    File.Write("H31");
}
...
void TQuizH31::SetupTexts()
{
  ...
  Quiz[0].MyGroup = GROUP_NDNT;
  Quiz[1].MyGroup = GROUP_NDNT;
  Quiz[2].MyGroup = GROUP_NDNT;
  Quiz[3].MyGroup = GROUP_ASPIE_TALENT;
  Quiz[4].MyGroup = GROUP_NDNT;
  ...
  Quiz[27].MyGroup = GROUP_NT_CONTACT;
  Quiz[28].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[29].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[30].MyGroup = GROUP_NT_SOCIAL;
  Quiz[31].MyGroup = GROUP_NT_SOCIAL;
  Quiz[32].MyGroup = GROUP_NDNT;
  Quiz[33].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[34].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[35].MyGroup = GROUP_ASPIE_NVC;
  Quiz[36].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[37].MyGroup = GROUP_ASPIE_NVC;
  Quiz[38].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[39].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[40].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[41].MyGroup = GROUP_NT_TALENT;
  Quiz[42].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[43].MyGroup = GROUP_NDNT;
  Quiz[44].MyGroup = GROUP_NDNT;
  Quiz[45].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[46].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[47].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[48].MyGroup = GROUP_NT_NVC;
  Quiz[49].MyGroup = GROUP_NT_CONTACT;
  Quiz[50].MyGroup = GROUP_NT_CONTACT;
  Quiz[51].MyGroup = GROUP_NT_CONTACT;
  Quiz[52].MyGroup = GROUP_NT_CONTACT;
  Quiz[53].MyGroup = GROUP_NT_CONTACT;
  Quiz[54].MyGroup = GROUP_NT_CONTACT;
  Quiz[55].MyGroup = GROUP_NT_NVC;
  Quiz[56].MyGroup = GROUP_NT_CONTACT;
  Quiz[57].MyGroup = GROUP_NT_CONTACT;
  Quiz[58].MyGroup = GROUP_NT_CONTACT;
  Quiz[59].MyGroup = GROUP_NT_CONTACT;
  Quiz[60].MyGroup = GROUP_NT_CONTACT;
  Quiz[61].MyGroup = GROUP_NT_CONTACT;
  Quiz[62].MyGroup = GROUP_ASPIE_NVC;
  Quiz[63].MyGroup = GROUP_NDNT;
  Quiz[64].MyGroup = GROUP_NDNT;
  ...
  Quiz[79].MyGroup = GROUP_ASPIE_ATTACH;
  ...
  Quiz[99].MyGroup = GROUP_NDNT;
  Quiz[100].MyGroup = GROUP_NDNT;
  ...
  Quiz[118].MyGroup = GROUP_NDNT;
  Quiz[119].MyGroup = GROUP_NDNT;
  Quiz[120].MyGroup = GROUP_NT_CONTACT;
  Quiz[121].MyGroup = GROUP_NDNT;
  Quiz[122].MyGroup = GROUP_NDNT;
  ...
  Quiz[142].MyGroup = GROUP_ASPIE_ATTACH;
  ...
  Quiz[167].MyGroup = GROUP_NDNT;
  Quiz[168].MyGroup = GROUP_NDNT;
  Quiz[169].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[170].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[171].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[172].MyGroup = GROUP_NT_ATTACH;
  Quiz[173].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[174].MyGroup = GROUP_NT_ATTACH;
  Quiz[175].MyGroup = GROUP_NT_ATTACH;
  Quiz[176].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[177].MyGroup = GROUP_NT_ATTACH;
  Quiz[178].MyGroup = GROUP_NT_ATTACH;
  Quiz[179].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[180].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[181].MyGroup = GROUP_ASPIE_NVC;
  Quiz[182].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[183].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[184].MyGroup = GROUP_ASPIE_CONTACT;
  Quiz[185].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[186].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[187].MyGroup = GROUP_ASPIE_NVC;
  Quiz[188].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[189].MyGroup = GROUP_ASPIE_SOCIAL;
  Quiz[190].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[191].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[192].MyGroup = GROUP_ASPIE_ATTACH;
  Quiz[193].MyGroup = GROUP_ASPIE_ATTACH;
  ...
  Quiz[150].Text = "Do you tend to put your own needs first?";
  Quiz[151].Text = "Do you believe most people would cheat to get ahead?";
  Quiz[152].Text = "Do you break inconvinient rules?";
  Quiz[153].Text = "Do you threaten to hit people when you get angry?";
  Quiz[154].Text = "Do you only feel safe when you are with people you are close to?";
  Quiz[155].Text = "Do you only feel comfortable when you have the company of people you are attached to?";
  Quiz[156].Text = "Do you worry about being abondoned by the person you love?";
  Quiz[157].Text = "Do you resent it when a person you are attached to spends time away from you?";
  Quiz[158].Text = "Are intimate relationships very important in your life?";
  Quiz[159].Text = "Do you get great pleasure from making love?";
  Quiz[160].Text = "Do you want to share your life with someone?";
  Quiz[161].Text = "Do you avoid getting attached to people?";
  Quiz[162].Text = "Do you usually find faults with opinions that you don't share?";
  Quiz[163].Text = "Do you think that your views are the only right ones?";
  Quiz[164].Text = "Do you tend to like to help people by correcting them?";
  Quiz[165].Text = "Do you rarely share your problems?";
  Quiz[166].Text = "Do you try to avoid to talk about your warm feeling for other people?";
  Quiz[167].Text = "Do you continually watch for signs of danger?";
  Quiz[168].Text = "Do you often wonder about people real motives when the do something nice?";
  Quiz[169].Text = "Have you experienced stronger than normal attachments to certain people?";
  Quiz[170].Text = "Are you more sexually attracted to strangers than to people you know well?";
  Quiz[171].Text = "Do you examine the hair of people you like a lot?";
  Quiz[172].Text = "Do you have compulsive sexual behavior, e.g. spend too much time on sex";
  Quiz[173].Text = "Do you prefer to have friends of the opposite gender?";
  Quiz[174].Text = "Do you like to be naked?";
  Quiz[175].Text = "Do you find casual sex rewarding?";
  Quiz[176].Text = "Have you been in love with more than one person at the same time?";
  Quiz[177].Text = "Are you asexual?";
  Quiz[178].Text = "Do you dislike sexual intercourse other than as procreation?";
  Quiz[179].Text = "Do you regard love and sex as synonymous?";
  Quiz[180].Text = "Is it harder for you than for others to get over a failed relationship?";
  Quiz[181].Text = "Do you jump between topics when speaking?";
  Quiz[182].Text = "Do you think others should have the same friends and enemies as yourself?";
  Quiz[183].Text = "Do you prefer to construct your own set of spiritual beliefs rather than following existing religions / belief-systems?";
  Quiz[184].Text = "Do you find it natural to go through established channels?";
  Quiz[185].Text = "Would you like to sleep all winter?";
  Quiz[186].Text = "Are you strong-willed and stubborn?";
  Quiz[187].Text = "Do you like to relax and do absolutely nothing while pondering on things of interest?";
  Quiz[188].Text = "Do you tend to lean towards your partner when you are at a restaurant or party?";
  Quiz[189].Text = "Do you respond quickly to slights?";
...
#
##########################################################################*/
void TQuizH31::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizH31::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
