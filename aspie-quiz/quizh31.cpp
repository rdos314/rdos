...
void TQuizH31::SetupTexts()
{
  ...
  Quiz[43].MyGroup = GROUP_SEX;
  Quiz[44].MyGroup = GROUP_MIXED;
  Quiz[45].MyGroup = GROUP_ASPIE_SENSORY;
  ...
  Quiz[129].MyGroup = GROUP_NT_TALENT;
  Quiz[130].MyGroup = GROUP_MIXED;
  Quiz[131].MyGroup = GROUP_MIXED;
  Quiz[132].MyGroup = GROUP_NT_TALENT;
  Quiz[133].MyGroup = GROUP_NT_TALENT;
  Quiz[134].MyGroup = GROUP_NT_TALENT;
  ...
  Quiz[143].MyGroup = GROUP_ASPIE_REL;
  ...
  Quiz[168].MyGroup = GROUP_ASPIE_REL;
