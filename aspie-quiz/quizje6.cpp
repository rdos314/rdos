...
/*##########################################################################
#
#   Name       : TQuizJE6::TQuizJE6
#
#   Purpose....: Constructor for TQuizJE6
#
...
#   Name       : TQuizJE6::~TQuizJE6
#
#   Purpose....: Destructor for TQuizJE6
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJE6::GetPcaCount()
{
        return 4;
}

/*##################  TQuizJE6::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJE6::GetCatCount(int Question)
{
    switch (Question)
    {
        case 150:
...
#
##########################################################################*/
void TQuizJE6::WriteName(TFile &File)
{
    File.Write("JE6");
}
...
#
##########################################################################*/
void TQuizJE6::WriteLongName(TFile &File)
{
    File.Write("JE6");
}
...
void TQuizJE6::SetupTexts()
{
  ...
  Quiz[97].MyGroup = GROUP_ASPIE_CONTACT;
  ...
  Quiz[107].MyGroup = GROUP_NT_CONTACT;
  Quiz[108].MyGroup = GROUP_NT_CONTACT;
  Quiz[109].MyGroup = GROUP_NT_CONTACT;
  Quiz[110].MyGroup = GROUP_NT_CONTACT;
  Quiz[111].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[130].MyGroup = GROUP_NT_SOCIAL;
  ...
  Quiz[2].Text = "Do you have certain routines which you need to follow?";
  Quiz[3].Text = "Do you become frustrated if an activity that is important to you gets interrupted?";
  ...
  Quiz[7].Text = "Do you feel an urge to correct people with accurate facts, numbers, spelling, grammar etc., when they get something wrong?";
  ...
  Quiz[10].Text = "Do you have a tendency to become stuck when asked questions in social situation?";
  Quiz[11].Text = "Are you sometimes afraid in safe situations?";
  Quiz[12].Text = "Do you get confused by several verbal instructions at the same time?";
  Quiz[13].Text = "Do you often have lots of thoughts that you find hard to verbalize?";
  Quiz[14].Text = "Do you almost always feel hurried to reach a decision, even when there is no reason to do so?";
  Quiz[15].Text = "In conversations, do you need extra time to carefully think out your reply, so that there may be a pause before you answer?";
  Quiz[16].Text = "Do you have difficulty describing & summarising things for example events, conversations or something you've read?";
  Quiz[17].Text = "Do you find it difficult to take messages on the telephone and pass them on correctly?";
  Quiz[18].Text = "Do you have problems filling out forms?";
  Quiz[19].Text = "Do you stutter when stressed?";
  Quiz[20].Text = "Do you find it very hard to learn things that you are not interested in?";
  Quiz[21].Text = "Do you find it difficult to take notes in lectures?";
  Quiz[22].Text = "Are you easily distracted?";
  Quiz[23].Text = "Do you need a lot of motivation to do things?";
  Quiz[24].Text = "Do you work slowly on jobs you dislike?";
  Quiz[25].Text = "Do you tend to shut down or have a meltdown when stressed or overwhelmed?";
  Quiz[26].Text = "Do you dislike when people walk behind you?";
  Quiz[27].Text = "Are you bothered by clothes tags or light touch?";
  ...
  Quiz[30].Text = "Are your eyes extra sensitive to strong light and glare?";
  Quiz[31].Text = "Are you sensitive to changes in humidity and air pressure?";
  Quiz[32].Text = "Do you instinctively become frightened by the sound of a motor-bike?";
  Quiz[33].Text = "Do you have extra sensitive hearing?";
  Quiz[34].Text = "Do you mix up digits in numbers like 95 and 59?";
  Quiz[35].Text = "Do you have a very acute sense of smell and/or taste?";
  Quiz[36].Text = "Do you have problems with timing in conversations?";
  Quiz[37].Text = "Do you instinctively know when it is your turn to speak when talking on the phone?";
  Quiz[38].Text = "Do you know when you are expected to offer an apology?";
  Quiz[39].Text = "Are you good at interpreting facial expressions?";
  ...
  Quiz[42].Text = "Do you have difficulties judging distances, height, depth or speed?";
  Quiz[43].Text = "Do you find it hard to tell the age of people?";
  Quiz[44].Text = "Do you have a clear sense of your identity?";
  Quiz[45].Text = "Do you have problems finding your way to new places?";
  Quiz[46].Text = "Do you have problems recognizing faces (prosopagnosia)?";
  Quiz[47].Text = "Do you have trouble reading clocks?";
  Quiz[48].Text = "Do you have a good sense of how much pressure to apply when doing things with your hands?";
  Quiz[49].Text = "Have others commented or have you observed yourself that you make unusual facial expressions?";
  Quiz[50].Text = "Have you been accused of staring?";
  Quiz[51].Text = "Do you have strong attachments to certain favorite objects?";
  Quiz[52].Text = "Do you tend to talk either too softly or too loudly?";
  Quiz[53].Text = "Do you mistake noises for voices?";
  Quiz[54].Text = "In conversations, do you use small sounds that others don't seem to use?";
  Quiz[55].Text = "Do you often don't know where to put your arms?";
  Quiz[56].Text = "Do you rock back-&-forth or side-to-side (e.g. for comfort, to calm yourself, when excited or overstimulated)?";
  Quiz[57].Text = "Have others told you that you have an odd posture or gait?";
  Quiz[58].Text = "Do you tap your ears or press your eyes (e.g. when thinking, when stressed or distressed)?";
  Quiz[59].Text = "Do you wring your hands, rub your hands together or twirl your fingers?";
  Quiz[60].Text = "Do you have a fascination for slowly flowing water?";
  Quiz[61].Text = "Do you jump between topics when speaking?";
  Quiz[62].Text = "Do you bite your lip, cheek or tongue (e.g. when thinking, when anxious or nervous)?";
  Quiz[63].Text = "Do you sometimes mix up pronouns and, for example, say \"you\" or \"we\" when you mean \"me\" or vice versa?";
  Quiz[64].Text = "Do you pace (e.g. when thinking or anxious)?";
  Quiz[65].Text = "Do you fiddle with things?";
  Quiz[66].Text = "Do you talk to yourself?";
  Quiz[67].Text = "Do you have, or used to have, imaginary friends?";
  Quiz[68].Text = "Do recently heard tunes or rhythms tend to stick and replay themselves repeatedly in your head?";
  Quiz[69].Text = "Do you enjoy walking on your toes?";
  Quiz[70].Text = "Do you get a pleasurable tingling sensation in the head, scalp or back of the body in response to certain sounds?";
  Quiz[71].Text = "Do you find it difficult to figure out how to behave in various situations?";
  Quiz[72].Text = "Do you forget you are in a social situation when something gets your attention?";
  Quiz[73].Text = "Do you tend to express your feelings in ways that may baffle others?";
  Quiz[74].Text = "Do others often misunderstand you?";
  Quiz[75].Text = "Do you tend to say things that are considered socially inappropriate when you are tired, frustrated or when you act naturally?";
  ...
  Quiz[78].Text = "Are you often surprised what people's motives are ?";
  Quiz[79].Text = "Do you tend to interpret things literally?";
  Quiz[80].Text = "Is it hard for you to see why some things upset people so much?";
  Quiz[81].Text = "Do you or others think that you have unconventional ways of solving problems?";
  Quiz[82].Text = "Is your sense of humor different from mainstream or considered odd?";
  Quiz[83].Text = "Do you have a monotonous voice?";
  Quiz[84].Text = "Do you find it easier to understand and communicate with odd & unusual people than with ordinary people?";
  Quiz[85].Text = "Do you feel an urge to peel flakes off yourself and / or others?";
  Quiz[86].Text = "Have people you formed strong attachments to taken advantage of you?";
  Quiz[87].Text = "Do you have an alternative view of what is attractive in the opposite sex?";
  Quiz[88].Text = "Does highly enjoyable things like sex make you mute?";
  Quiz[89].Text = "Do you have an urge to observe the habits of humans and/or animals?";
  Quiz[90].Text = "Do you tend to look a lot at people you like and little or not at all at people you dislike?";
  Quiz[91].Text = "Do you notice patterns in things all the time?";
  Quiz[92].Text = "Do you naturally fit into the expected gender stereotypes?";
  Quiz[93].Text = "Do you have unusual sexual preferences?";
  ...
  Quiz[95].Text = "Are you more sexually attracted to strangers than to people you know well?";
  Quiz[96].Text = "Do you prefer to have friends of the opposite gender?";
  Quiz[97].Text = "Would you accept polyamory if you knew your partner would?";
  Quiz[98].Text = "Has it been harder for you than for others to keep friends?";
  Quiz[99].Text = "Do you dislike shaking hands with strangers?";
  Quiz[100].Text = "Do you stay away from situations where people might express affection for you?";
  Quiz[101].Text = "Do you find it hard to be emotionally close to other people?";
  Quiz[102].Text = "Do you get very tired after socializing, and need to regenerate alone?";
  Quiz[103].Text = "Do you dislike it when people drop by to visit you uninvited?";
  Quiz[104].Text = "Do you enjoy big events even if they are crowded?";
  Quiz[105].Text = "Do you prefer to only meet people you know, one-on-one, or in small, familiar groups?";
  Quiz[106].Text = "Do you find it easy to describe your feelings?";
  Quiz[107].Text = "Do you prefer to keep to yourself?";
  Quiz[108].Text = "Do you find yourself at ease in romantic situations?";
  Quiz[109].Text = "Do you prefer to do things on your own even if you could use others' help or expertise?";
  Quiz[110].Text = "Is it hard for you to approach somebody you are attracted to?";
  Quiz[111].Text = "Do you prefer to socialize with familiar friends because you know what to expect from them?";
  Quiz[112].Text = "Do you avoid being the centre of attention?";
  Quiz[113].Text = "Do you enjoy hosting or arranging events?";
  Quiz[114].Text = "Do you have difficulty accepting criticism, correction, and direction?";
  Quiz[115].Text = "In a conversation, do you tend to focus on your own thoughts rather than on what your listener might be thinking?";
  Quiz[116].Text = "Do you expect other people to know your thoughts, experiences and opinions without you having to tell them?";
  Quiz[117].Text = "Are you impatient and have low frustration tolerance?";
  Quiz[118].Text = "Will you abandon your friends if your activities or ideals clash?";
  Quiz[119].Text = "Do you obstruct others' plans?";
  Quiz[120].Text = "Do you see your own activities as more important than other people's?";
  Quiz[121].Text = "Do you have trouble with authority?";
  Quiz[122].Text = "Do you usually find faults with opinions that you don't share?";
  Quiz[123].Text = "Have you have had long-lasting urges to take revenge?";
  Quiz[124].Text = "Do you argue a lot?";
  Quiz[125].Text = "Are you good at team-work?";
  Quiz[126].Text = "Do you find it natural to wave or say 'hi' when you meet people?";
  Quiz[127].Text = "Does it feel natural for you to say 'thank you' and 'sorry'?";
  Quiz[128].Text = "Have you felt kinship and belonging to others for all your life?";
  Quiz[129].Text = "Do you enjoy travel?";
  Quiz[130].Text = "Do you take pride in your appearance?";
  Quiz[131].Text = "Do you enjoy gossip?";
  Quiz[132].Text = "Do you like to follow (walk behind) people you are attached to?";
  Quiz[133].Text = "Do you have an urge to learn the routines of people you know?";
  Quiz[134].Text = "Do you tend to become obsessed with a potential partner and cannot let go of him/her?";
  Quiz[135].Text = "Do you have a need to confess?";
  Quiz[136].Text = "Have you experienced stronger than normal attachments to certain people?";
  Quiz[137].Text = "Do you feel an urge to show people you like your favorite places?";
  Quiz[138].Text = "Do you examine the hair of people you like a lot?";
  Quiz[139].Text = "Do you worry that romantic partners won't care as much about you as you care about them?";
  Quiz[140].Text = "Do you only enjoy hugs from people you are attached to?";
  ...
  Quiz[150].Text = "Violett - Rate";
  Quiz[151].Text = "Violett - Time";
  ...
  Quiz[156].Text = "Lilium - Rate";
  Quiz[157].Text = "Lilium - Time";
}

/*##########################################################################
#
#   Name       : TQuizJE6::LoadPopulations
#
...
#
##########################################################################*/
void TQuizJE6::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizJE6::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
