...
#
# convje5.cpp
# Convert exported quiz-je5 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
void ConvJE5()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-je5.csv");
    TFile outfile("bin\\quizje5.bin", 0);
    char *ptr;
