...
#
# quizg4.cpp
# Quiz final version 2, release 4 class
#
#######################################################################*/
...
/*##########################################################################
#
#   Name       : TQuizG4::TQuizG4
#
#   Purpose....: Constructor for TQuizG4
#
...
#   Name       : TQuizG4::~TQuizG4
#
#   Purpose....: Destructor for TQuizG4
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizG4::GetCatCount(int Question)
{
    return 3;
}
...
#
##########################################################################*/
void TQuizG4::WriteName(TFile &File)
{
	 File.Write("G4");
}
...
#
##########################################################################*/
void TQuizG4::WriteLongName(TFile &File)
{
	 File.Write("final version 2:4");
}

/*##########################################################################
#
#   Name       : TQuizG4::SetupTexts
#
...
void TQuizG4::SetupTexts()
{
  ...
  Quiz[150].Text = "Do you think that human beings know what is good and what is evil?";
  Quiz[151].Text = "Do you think that this life is not but a valley of tears?";
  Quiz[152].Text = "Do you think that human beings are born to enjoy life?";
  Quiz[153].Text = "Do you think that just behaviour is always rewarded?";
  Quiz[154].Text = "Do you think that unjust behaviour is always punished?";
  Quiz[155].Text = "Do you think that in this life each one has what one deserves?";
  Quiz[156].Text = "Do living in society limit your freedom?";
  Quiz[157].Text = "Do you think you should sacrifice your wellbeing for the common good?";
  Quiz[158].Text = "Do you feel limited in your actions only by civil law?";
  Quiz[159].Text = "Do you think that in this world, there is more than just what can be seen and felt?";
  Quiz[160].Text = "Do corruption of customs affect just the ones that corrupt?";
  Quiz[161].Text = "Do economic corruption affect just the ones that corrupt?";
  Quiz[162].Text = "Do moral corruption affect just the ones that corrupt?";
  Quiz[163].Text = "Do you not mind to strive for the benefit of others?";
  Quiz[164].Text = "Do you think there is no evil, rather only bad things?";
  Quiz[165].Text = "Do you think that if you know what ‘good’ is, then you can do it?";
  Quiz[166].Text = "Do you think that human beings have both a material and a spiritual component?";
  Quiz[167].Text = "Do you think that the soul is immortal?";
  Quiz[168].Text = "Do you think that a human being is just a physical entity?";
  Quiz[169].Text = "Do you think that emotions and feelings are just physical-chemical reactions?";
  Quiz[170].Text = "Do you think that a mysterious force  in the cosmos guides us towards the good?";
  Quiz[171].Text = "Do you think that the civil law is enough for humans to do good things?";
  Quiz[172].Text = "Do you often behave in a rational way?";
  Quiz[173].Text = "Do you feel more compelled to do evil than to do good things?";
  Quiz[174].Text = "Do you often have a reason to do good things?";
  Quiz[175].Text = "Do you often have a reason to do evil things?";
  Quiz[176].Text = "Do you think it is convenient to do good things regardless of whom it is for?";
  Quiz[177].Text = "Do you find self-reward in doing your work properly?";
  Quiz[178].Text = "Do people work just for money?";
  Quiz[179].Text = "Is there something in you that rules you?";
  Quiz[180].Text = "Do you think that human beings tend at their own perfection as persons?";
  Quiz[181].Text = "Do you sometimes perceive the dark side of reality that leads to evil?";
  Quiz[182].Text = "Do you deem yourself as a spiritual person, even if you do not attend religious services?";
  Quiz[183].Text = "Do meditation and deep silence give you inner peace?";
  Quiz[184].Text = "Do you sometimes feel something transcendent when you look at some landscapes?";
  Quiz[185].Text = "Do you think that living beings are connected in a mysterious way?";
  Quiz[186].Text = "Do you attend religious services on a regular basis?";
  Quiz[187].Text = "Are you a praying person?";
  Quiz[188].Text = "Are you a believer or have faith?";
  Quiz[189].Text = "Do you try to put your religious beliefs into practice?";
  
  Quiz[190].Text = "Do you believe in ghosts and / or supernatural phenomens?";
  Quiz[191].Text = "Are you sensitive to electromagnetic fields?";
  Quiz[192].Text = "Have you had paranormal experiences?";

}

/*##################  TQuizG4::LoadReferers ##########################
...
void TQuizG4::SetupCross(TQuiz *QuizI, TQuiz *QuizII, TQuiz *QuizIII, TQuiz *QuizNd, TQuiz *Quiz5, TQuiz *Quiz6, TQuiz *Quiz7, TQuiz *Quiz8, TQuiz *Quiz9, TQuiz *QuizR1, TQuiz *QuizR2, TQuiz *QuizR3, TQuiz *QuizR4, TQuiz *QuizR5, TQuiz *QuizR6, TQuiz *QuizR7, TQuiz *QuizS1, TQuiz *QuizS2, TQuiz *QuizS3, TQuiz *QuizS4, TQuiz *QuizS5, TQuiz *QuizS6, TQuiz *QuizS7, TQuiz *QuizS8, TQuiz *QuizS9, TQuiz *QuizS10, TQuiz *QuizS11, TQuiz *QuizS12, TQuiz *QuizN1, TQuiz *QuizN2, TQuiz *QuizN3, TQuiz *QuizN4, TQuiz *QuizFI, TQuiz *QuizF1, TQuiz *QuizF2, TQuiz *QuizF3, TQuiz *QuizF4, TQuiz *QuizF5, TQuiz *QuizF6, TQuiz *QuizF7, TQuiz *QuizF8, TQuiz *QuizF9, TQuiz *QuizF10, TQuiz *QuizF11, TQuiz *QuizF12, TQuiz *QuizF13, TQuiz *QuizF14, TQuiz *QuizF15, TQuiz *QuizGE, TQuiz *QuizGE2, TQuiz *QuizGE3, TQuiz *QuizG1, TQuiz *QuizG2, TQuiz *QuizG3)
{
	...
	DefineGlobalId(150, 1704);
	DefineGlobalId(151, 1705);
	DefineGlobalId(152, 1706);
	DefineGlobalId(153, 1707);
	DefineGlobalId(154, 1708);
	DefineGlobalId(155, 1709);
	DefineGlobalId(156, 1710);
	DefineGlobalId(157, 1711);
	DefineGlobalId(158, 1712);
	DefineGlobalId(159, 1713);
	DefineGlobalId(160, 1714);
	DefineGlobalId(161, 1715);
	DefineGlobalId(162, 1716);
	DefineGlobalId(163, 1717);
	DefineGlobalId(164, 1718);
	DefineGlobalId(165, 1719);
	DefineGlobalId(166, 1720);
	DefineGlobalId(167, 1721);
	DefineGlobalId(168, 1722);
	DefineGlobalId(169, 1723);
	DefineGlobalId(170, 1724);
	DefineGlobalId(171, 1725);
	DefineGlobalId(172, 1726);
	DefineGlobalId(173, 1727);
	DefineGlobalId(174, 1728);
	DefineGlobalId(175, 1729);
	DefineGlobalId(176, 1730);
	DefineGlobalId(177, 1731);
	DefineGlobalId(178, 1732);
	DefineGlobalId(179, 1733);
	DefineGlobalId(180, 1734);
	DefineGlobalId(181, 1735);
	DefineGlobalId(182, 1736);
	DefineGlobalId(183, 1737);
	DefineGlobalId(184, 1738);
	DefineGlobalId(185, 1739);
	DefineGlobalId(186, 1740);
	DefineGlobalId(187, 1741);
	DefineGlobalId(188, 1742);
	DefineGlobalId(189, 1743);

	DefineCross(QuizS2, 190, 150);
	DefineCross(QuizR6, 191, 12);
	DefineCross(QuizS2, 192, 152);
	
}

/*##########################################################################
#
#   Name       : TQuizG4::GetReferer
#
...
#
##########################################################################*/
void TQuizG4::GetReferer(const char *referer, TPopulation *pop)
{
	int i;
	TReferer *ref;
	TQuizRow Row;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG4::ExportExcelCase(const char *filename, int PcaType)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG4::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG4::ExportExcelGroups(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG4::ImportMvsp(const char *filename, int PcaType)
{
	char buf[MAX_IN_ROW];
	int size;
	char *rowstr;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG4::WriteRace(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizG4::WriteRetest(const char *filename)
{
	TQuizRow Row;
	int userid;
	int i;
