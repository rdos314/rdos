...
/*##########################################################################
#
#   Name       : TQuizJ7::TQuizJ7
#
#   Purpose....: Constructor for TQuizJ7
#
...
#
##########################################################################*/
TQuizJ7::TQuizJ7(const char *FileName)
  : TQuiz(125),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizJ7::~TQuizJ7
#
#   Purpose....: Destructor for TQuizJ7
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizJ7::GetCatCount(int Question)
{
       return 3;
}
...
#
##########################################################################*/
void TQuizJ7::WriteName(TFile &File)
{
    File.Write("J7");
}
...
#
##########################################################################*/
void TQuizJ7::WriteLongName(TFile &File)
{
    File.Write("J7");
}
...
void TQuizJ7::SetupTexts()
{
  ...
  Quiz[87].MyGroup = GROUP_NT_SOCIAL;
  ...
  Quiz[74].Text = "In a conversation, do you tend to focus on your own thoughts rather than on what your listener might be thinking?";
  Quiz[75].Text = "Do you see your own activities as more important than other people's?";
  Quiz[76].Text = "Are you impatient and have low frustration tolerance?";
  Quiz[77].Text = "Do you expect other people to know your thoughts, experiences and opinions without you having to tell them?";
  Quiz[78].Text = "Will you abandon your friends if your activities or ideals clash?";
  Quiz[79].Text = "Do you have difficulty accepting criticism, correction, and direction?";
  Quiz[80].Text = "Do you usually find faults with opinions that you don't share?";
  Quiz[81].Text = "Do you obstruct others' plans?";
  Quiz[82].Text = "Do you have trouble with authority?";
  Quiz[83].Text = "Have you have had long-lasting urges to take revenge?";
  Quiz[84].Text = "Are you good at team-work?";
  Quiz[85].Text = "Do you find it natural to wave or say 'hi' when you meet people?";
  Quiz[86].Text = "Do you enjoy big events even if they are crowded?";
  Quiz[87].Text = "Does it feel natural for you to say 'thank you' and 'sorry'?";
  Quiz[88].Text = "Do you enjoy travel?";
  Quiz[89].Text = "Do you take pride in your appearance?";
  Quiz[90].Text = "Do you enjoy gossip?";
  Quiz[91].Text = "Do you find it easier to understand and communicate with odd & unusual people than with ordinary people?";
  Quiz[92].Text = "Do you have an alternative view of what is attractive in the opposite sex?";
  ...
  Quiz[96].Text = "Would you consider polyamory (being in love with more than one person) if you knew your partner would not mind?";
  Quiz[97].Text = "Do you have a tendency to become stuck when asked questions in social situation?";
  Quiz[98].Text = "Has it been harder for you than for others to keep friends?";
  Quiz[99].Text = "Do you find it hard to be emotionally close to other people?";
  ...
  Quiz[101].Text = "Do you stay away from situations where people might express affection for you?";
  Quiz[102].Text = "Do you get very tired after socializing, and need to regenerate alone?";
  Quiz[103].Text = "Do you prefer to keep to yourself?";
  Quiz[104].Text = "Do you find it easy to describe your feelings?";
  Quiz[105].Text = "Do you prefer to only meet people you know, one-on-one, or in small, familiar groups?";
  Quiz[106].Text = "Do you prefer to do things on your own even if you could use others' help or expertise?";
  Quiz[107].Text = "Do you dislike it when people drop by to visit you uninvited?";
  Quiz[108].Text = "Is it hard for you to approach somebody you are attracted to?";
  Quiz[109].Text = "Do you tend to look a lot at people you like and little or not at all at people you dislike?";
  ...
  Quiz[114].Text = "Do you have a need to confess?";
  Quiz[115].Text = "Do you have odd hair (for example multiple whorls, standing up when short or other peculiarities)?";
...
#
##########################################################################*/
void TQuizJ7::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizJ7::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
