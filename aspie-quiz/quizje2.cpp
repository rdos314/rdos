...
void TQuizJE2::SetupTexts()
{
  ...
  Quiz[18].MyGroup = GROUP_ASPIE_ATTACH;
  ...
  Quiz[75].MyGroup = GROUP_NT_CONTACT;
  Quiz[76].MyGroup = GROUP_NT_CONTACT;
  Quiz[77].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[89].MyGroup = GROUP_NT_CONTACT;
  ...
  Quiz[95].MyGroup = GROUP_ASPIE_TALENT;
