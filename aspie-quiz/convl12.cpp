...
#
# convl12.cpp
# Convert exported quiz-l12 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("L12: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
    printf("\r\n");
}
...
void ConvL12()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l12.csv");
    TFile outfile("bin\\quizl12.bin", 0);
    char *ptr;
