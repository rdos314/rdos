...
void TQuiz8::SetupTexts()
{
  ...
  Quiz[71].MyGroup = GROUP_CONFORM;
  Quiz[72].MyGroup = GROUP_CONFORM;
  Quiz[73].MyGroup = GROUP_CONFORM;
  Quiz[74].MyGroup = GROUP_CONFORM;
  Quiz[75].MyGroup = GROUP_CONFORM;
  Quiz[76].MyGroup = GROUP_MIXED;
  Quiz[77].MyGroup = GROUP_CONFORM;
  Quiz[78].MyGroup = GROUP_CONFORM;
  Quiz[79].MyGroup = GROUP_CONFORM;
  Quiz[80].MyGroup = GROUP_CONFORM;
  Quiz[81].MyGroup = GROUP_CONFORM;
  Quiz[82].MyGroup = GROUP_CONFORM;
  ...
  Quiz[143].MyGroup = GROUP_RELIGION;
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuiz8::ExportExcelAspie(const char *filename)
{
	TQuizRow Row;
	int i;
	int ival;
