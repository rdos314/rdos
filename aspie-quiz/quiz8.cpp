...
#
##########################################################################*/
void TQuiz8::WriteLongName(TFile &File)
{
...
#
##########################################################################*/
void TQuiz8::GetDxData(int PopType, int GroupArr[MAX_GROUP_COUNT], int Arr[MAX_SCORE][2], int OnlyNtControl)
{
	TQuizRow Row;
	int res;
	int g;
...
void TQuiz8::SetupTexts()
{
  ...
  Quiz[87].MyGroup = GROUP_ASPIE_HUNTING;
  ...
  Quiz[133].MyGroup = GROUP_ASPIE_HUNTING;
