...
#
# convs8.cpp
# Convert exported quiz-s8 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-s8 VALUES(";

TFile quizfile("quizs8.bin", 0);
...
char *ProcessRow(char *str)
{
   ...
   int j;
	...
	for (fieldno = 0; fieldno < 196; fieldno++)
	{
		valstr = str;
			...
			*ptr = 0;
			...
			switch (fieldno)
			{
				...
				case 13:
					...
					Row.Quiz[172] = Row.Dyslexia;
					break;

				case 14:
					Row.Dyscalculia = atoi(valstr);
					Row.Quiz[173] = Row.Dyscalculia;
					break;

				case 15:
					Row.OCD = atoi(valstr);
					Row.Quiz[174] = Row.OCD;
					break;

				case 16:
					Row.ODD = atoi(valstr);
					Row.Quiz[175] = Row.ODD;
					break;

				case 17:
					Row.Bipolar = atoi(valstr);
					Row.Quiz[176] = Row.Bipolar;
					break;
