...
static void ProcessRow(char *str)
{
    ...
    UpdateScore(&Row);
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 157);
}

/*##################  ConvS8 ##########################
 *   Purpose....: Conv quiz S8                                                           #
 *   In params..: *                                                          #
 *   Out params.: *                                                          #
 *   Returns....: *                                                          #
 *   Created....: 96-11-20 le                                                #
...
void ConvS8()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-s8.csv");
    TFile outfile("bin\\quizs8.bin", 0);
    char *ptr;
