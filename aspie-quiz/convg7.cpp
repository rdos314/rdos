...
#
# convg7.cpp
# Convert exported quiz-g7 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-g7 VALUES(";

TFile quizfile("quizg7.bin", 0);
TFile ancfile("ancg7.bin", 0);
