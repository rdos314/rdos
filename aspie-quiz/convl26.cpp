...
#
# convl26.cpp
# Convert exported quiz-l26 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 156);
}

/*################## ConvL26 ##########################
*   Purpose....: Convert quiz l26                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvL26()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l26.csv");
    TFile outfile("bin\\quizl26.bin", 0);
    char *ptr;
