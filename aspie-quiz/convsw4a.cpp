...
#
# convsw4a.cpp
# Convert exported quiz-sw4a to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("SW4a: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
    printf("\r\n");
}
...
void ConvSw4a()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-sw4a.csv");
    TFile outfile("bin\\quizsw4a.bin", 0);
    char *ptr;
