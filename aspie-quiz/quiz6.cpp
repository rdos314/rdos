...
void TQuiz6::SetupTexts()
{
	...
	Quiz[88].MyGroup = GROUP_CONFORM;
	Quiz[89].MyGroup = GROUP_CONFORM;
	Quiz[90].MyGroup = GROUP_CONFORM;
	Quiz[91].MyGroup = GROUP_CONFORM;
	Quiz[92].MyGroup = GROUP_CONFORM;
	Quiz[93].MyGroup = GROUP_CONFORM;
	Quiz[94].MyGroup = GROUP_CONFORM;
	Quiz[95].MyGroup = GROUP_CONFORM;
	...
	Quiz[110].MyGroup = GROUP_CONFORM;
	...
	Quiz[137].MyGroup = GROUP_CONFORM;
