...
void TQuiz6::SetupTexts()
{
	...
	Quiz[102].MyGroup = GROUP_DISABILITY;
	Quiz[103].MyGroup = GROUP_DISABILITY;
	Quiz[104].MyGroup = GROUP_DISABILITY;
	Quiz[105].MyGroup = GROUP_DISABILITY;
	Quiz[106].MyGroup = GROUP_DISABILITY;
	Quiz[107].MyGroup = GROUP_DISABILITY;
	...
	Quiz[137].MyGroup = GROUP_NT_RELATION;
