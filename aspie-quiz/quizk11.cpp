...
/*##########################################################################
#
#   Name       : TQuizK11::TQuizK11
#
#   Purpose....: Constructor for TQuizK11
#
...
#
##########################################################################*/
TQuizK11::TQuizK11(const char *FileName)
  : TQuiz(173),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizK11::~TQuizK11
#
#   Purpose....: Destructor for TQuizK11
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizK11::GetPcaCount()
{
        return 4;
}

/*##################  TQuizK11::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizK11::GetCatCount(int Question)
{
   return 3;
}
...
#
##########################################################################*/
void TQuizK11::WriteName(TFile &File)
{
    File.Write("K11");
}
...
#
##########################################################################*/
void TQuizK11::WriteLongName(TFile &File)
{
    File.Write("K11");
}
...
void TQuizK11::SetupTexts()
{
  ...
  Quiz[91].MyGroup = GROUP_ASPIE_RELATION;
  ...
  Quiz[127].MyGroup = GROUP_NT_RELATION;
  Quiz[128].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[129].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[130].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[131].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[132].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[133].MyGroup = GROUP_ASPIE_RELATION;
  ...
  Quiz[140].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[141].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[142].MyGroup = GROUP_MIXED;
  Quiz[143].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[144].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[145].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[146].MyGroup = GROUP_ASPIE_RELATION;
  Quiz[147].MyGroup = GROUP_NT_SOCIAL;
  Quiz[148].MyGroup = GROUP_NT_RELATION;
  Quiz[149].MyGroup = GROUP_NT_RELATION;
  Quiz[150].MyGroup = GROUP_NT_RELATION;
  Quiz[151].MyGroup = GROUP_NT_RELATION;
  Quiz[152].MyGroup = GROUP_MIXED;
  Quiz[153].MyGroup = GROUP_NT_RELATION;
  ...
  Quiz[127].Text = "Do you enjoy traditional dating?";
  Quiz[128].Text = "Do you think that living beings are connected in a mysterious way?";
  Quiz[129].Text = "Do you think that in this world, there is more than just what can be seen and felt?";
  Quiz[130].Text = "Do human beings have both a material and a spiritual component?";
  Quiz[131].Text = "Is the soul is immortal?";
  Quiz[132].Text = "Do you feel that you are a very special or unusual person?";
  Quiz[133].Text = "Do you feel as if you are, or destined to be someone very important?";
  Quiz[134].Text = "Do you find that establishing a consistent routine enables you to enjoy life more?";
  Quiz[135].Text = "Have your thoughts ever been so vivid that you were worried other people would hear them?";
  Quiz[136].Text = "Would you quickly become impatient and irritated if you would not find a solution to a problem?";
  Quiz[137].Text = "Do you feel irritated when one person disagrees with what everyone else in a group believes?";
  Quiz[138].Text = "Do you feel as if you are being persecuted in some way?";
  Quiz[139].Text = "Do you feel as if there is a conspiracy against you?";
  Quiz[140].Text = "Do you feel as if the world is about to end?";
  Quiz[141].Text = "Do you feel that you have sinned more than the average person?";
  Quiz[142].Text = "Do you feel as if things in magazines or on TV were written especially for you?";
  Quiz[143].Text = "Do you think people can communicate telepathically?";
  Quiz[144].Text = "Do you have psychic abilities?";
  Quiz[145].Text = "Do you believe in the power of witchcraft, voodoo or the occult?";
  Quiz[146].Text = "Do you believe in supernatural phenomens?";
  Quiz[147].Text = "Are you shy?";
  Quiz[148].Text = "Do you find yourself at ease in romantic situations?";
  Quiz[149].Text = "Do you find the usual courting behavior natural?";
  Quiz[150].Text = "Do you find it natural that males take initiatives to start a romantic relationship?";
  Quiz[151].Text = "Do you naturally fit into the expected gender stereotypes?";
  Quiz[152].Text = "Do you typically develop romantic feelings for somebody only after you get to know them better?";
  Quiz[153].Text = "If one relationship ends, can you easily get into another one?";

  Quiz[154].Text = "12 years old";
  Quiz[155].Text = "13 years old";
  Quiz[156].Text = "14 years old";
  Quiz[157].Text = "15 years old";
  Quiz[158].Text = "16 years old";
  Quiz[159].Text = "17 years old";
  Quiz[160].Text = "18 years old";
  Quiz[161].Text = "19 years old";
  Quiz[162].Text = "20 years old";
  Quiz[163].Text = "21 years old";
  Quiz[164].Text = "22 years old";
  Quiz[165].Text = "23 years old";
  Quiz[166].Text = "24 years old";
  Quiz[167].Text = "25 years old";
  Quiz[168].Text = "26 years old";
  Quiz[169].Text = "27 years old";
  Quiz[170].Text = "28 years old";
  Quiz[171].Text = "29 years old";
  Quiz[172].Text = "30 years old";
}

/*##########################################################################
#
#   Name       : TQuizK11::LoadPopulations
#
...
#
##########################################################################*/
void TQuizK11::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizK11::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
