...
/*##########################################################################
#
#   Name       : TQuizL20::TQuizL20
#
#   Purpose....: Constructor for TQuizL20
#
...
#
##########################################################################*/
TQuizL20::TQuizL20(const char *FileName)
  : TQuiz(152),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL20::~TQuizL20
#
#   Purpose....: Destructor for TQuizL20
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL20::GetPcaCount()
{
    return 4;
}

/*##################  TQuizL20::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL20::GetCatCount(int Question)
{
    if (Question < 122)
        return 3;
    else
...
#
##########################################################################*/
void TQuizL20::WriteName(TFile &File)
{
    File.Write("L20");
}
...
#
##########################################################################*/
void TQuizL20::WriteLongName(TFile &File)
{
    File.Write("L20");
}
...
void TQuizL20::SetupTexts()
{
  ...
  Quiz[121].Text = "Do you have a friend?";
  Quiz[122].Text = "When I have had a bad day my friend cheers me up.";
  Quiz[123].Text = "I think it would be difficult to replace my friend.";
  Quiz[124].Text = "It bothers me when my friend is not available when I'm stressed.";
  Quiz[125].Text = "I can trust my friend.";
  Quiz[126].Text = "I become angry with my friend when he/she does not understand me.";
  Quiz[127].Text = "I don't like depending on my friend.";
  Quiz[128].Text = "I worry my friend doesn't really like me.";
  Quiz[129].Text = "I would find it distressing if this friendship ended.";
  Quiz[130].Text = "I know that my friend is loyal.";
  Quiz[131].Text = "I like the closeness I share with my friend.";
  Quiz[132].Text = "I am not sure I can always depend on my friend.";
  Quiz[133].Text = "I would like my friend to be more understanding.";
  Quiz[134].Text = "I let my friend know about things that trouble me.";
  Quiz[135].Text = "I avoid discussing personal things with my friend.";
  Quiz[136].Text = "I can talk things through with my friend.";
  Quiz[137].Text = "I worry about becoming too close to my friend.";
  Quiz[138].Text = "I don't turn to my friend for support when things are difficult.";
  Quiz[139].Text = "I get angry at my friend when I can't get in contact with him/her.";
  Quiz[140].Text = "I don't feel as close to my friend as I would like.";
  Quiz[141].Text = "I seek out my friend when things go wrong.";
  Quiz[142].Text = "I enjoy spending time with my friend.";
  Quiz[143].Text = "I know my friend does like me.";
  Quiz[144].Text = "I feel close to my friend.";
  Quiz[145].Text = "I don't need to rely on my friend.";
  Quiz[146].Text = "Without this friendship, it would be very hard to cope when things are difficult.";
  Quiz[147].Text = "I am confident my friendship will last.";
  Quiz[148].Text = "Outings are more enjoyable when I'm with my friend.";
  Quiz[149].Text = "I am concerned that my friend will find another friend that he/she prefers.";
  Quiz[150].Text = "I am often angry with my friend.";
  Quiz[151].Text = "I know I can rely on my friend.";
}

/*##########################################################################
#
#   Name       : TQuizL20::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL20::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL20::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
