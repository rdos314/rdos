...
#
# convje4.cpp
# Convert exported quiz-je4 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void ProcessRow(char *str)
{
    ...
    HandleRow(&Row);
    AddPca(Row.Gender, Row.BirthYear, Row.AsResult - Row.NtResult, &Row.Quiz[0], 153);
}

/*################## ConvJE4 ##########################
*   Purpose....: Convert quiz je4                                                         #
*   In params..: *                                                          #
*   Out params.: *                                                          #
*   Returns....: *                                                          #
*   Created....: 96-11-20 le                                                #
...
void ConvJE4()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-je4.csv");
    TFile outfile("bin\\quizje4.bin", 0);
    char *ptr;
