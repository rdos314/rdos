...
#
# convl11.cpp
# Convert exported quiz-l11 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
static void HandleRow(TQuizRow *Row)
{
    ...
    printf("L11: %d AS: %d, NT: %d", Row->ID, Row->AsResult, Row->NtResult);
    printf("\r\n");
}
...
void ConvL11()
{
    ...
    int size;
    long pos = 0;
    TFile infile("raw\\aspie-quiz-l11.csv");
    TFile outfile("bin\\quizl11.bin", 0);
    char *ptr;
