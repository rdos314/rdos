...
#
# convn3.cpp
# Convert exported quiz-n3 to binary file
#
########################################################################*/
#include <stdio.h>
#include <string.h>
...
const char InsertString[] = "INSERT INTO aspie-quiz-n3 VALUES(";

TFile quizfile("quizn3.bin", 0);
