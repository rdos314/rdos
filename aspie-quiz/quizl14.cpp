...
/*##########################################################################
#
#   Name       : TQuizL14::TQuizL14
#
#   Purpose....: Constructor for TQuizL14
#
...
#
##########################################################################*/
TQuizL14::TQuizL14(const char *FileName)
  : TQuiz(161),
        FDataFile(FileName)
{
        SetupTexts();
...
#   Name       : TQuizL14::~TQuizL14
#
#   Purpose....: Destructor for TQuizL14
#
#   In params..: *
#   Out params.: *
#   Returns....: *
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL14::GetPcaCount()
{
        return 4;
}

/*##################  TQuizL14::GetCatCount ##########################
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
int TQuizL14::GetCatCount(int Question)
{
    if (Question < 121)
        return 3;
    else
...
#
##########################################################################*/
void TQuizL14::WriteName(TFile &File)
{
    File.Write("L14");
}
...
#
##########################################################################*/
void TQuizL14::WriteLongName(TFile &File)
{
    File.Write("L14");
}
...
void TQuizL14::SetupTexts()
{
  ...
  Quiz[121].Text = "Do you have a crush?";
  Quiz[122].Text = "Do you obsess over somebody?";
  Quiz[123].Text = "Have you recently found it hard to wind down?";
  Quiz[124].Text = "Have you recently been aware of dryness of your mouth?";
  Quiz[125].Text = "Have you recently been unable to experience any positive feeling at all?";
  Quiz[126].Text = "Have you recently experienced breathing difficulty (eg, excessively rapid breathing, breathlessness in the absence of physical exertion)?";
  Quiz[127].Text = "Have you recently found it difficult to work up the initiative to do things?";
  Quiz[128].Text = "Have you recently tended to over-react to situations?";
  Quiz[129].Text = "Have you recently experienced trembling (eg, in the hands)?";
  Quiz[130].Text = "Have you recently felt that you used a lot of nervous energy?";
  Quiz[131].Text = "Have you recently worried about situations in which you might panic and make a fool of yourself?";
  Quiz[132].Text = "Have you recently felt that you had nothing to look forward to?";
  Quiz[133].Text = "Have you recently found yourself getting agitated?";
  Quiz[134].Text = "Have you recently found it difficult to relax?";
  Quiz[135].Text = "Have you recently felt down-hearted and blue?";
  Quiz[136].Text = "Have you recently been intolerant of anything that kept you from getting on with what you were doing?";
  Quiz[137].Text = "Have you recently felt you were close to panic?";
  Quiz[138].Text = "Have you recently been unable to become enthusiastic about anything?";
  Quiz[139].Text = "Have you recently felt you weren't worth much as a person?";
  Quiz[140].Text = "Have you recently felt that you were rather touchy?";
  Quiz[141].Text = "Have you recently been aware of the action of your heart in the absence of physical exertion (eg, sense of heart rate increase, heart missing a beat)?";
  Quiz[142].Text = "Have you recently felt scared without any good reason?";
  Quiz[143].Text = "Have you recently felt that life was meaningless?";

  Quiz[144].Text = "<img width=530 height=215 src=\"http://www.rdos.net/rmet-opt/1.png\">";
  Quiz[145].Text = "<img width=530 height=215 src=\"http://www.rdos.net/rmet-opt/2.png\">";
  Quiz[146].Text = "<img width=530 height=215 src=\"http://www.rdos.net/rmet-opt/3.png\">";
  Quiz[147].Text = "<img width=530 height=215 src=\"http://www.rdos.net/rmet-opt/4.png\">";
  Quiz[148].Text = "<img width=530 height=215 src=\"http://www.rdos.net/rmet-opt/5.png\">";
  Quiz[149].Text = "<img width=530 height=215 src=\"http://www.rdos.net/rmet-opt/6.png\">";
  Quiz[150].Text = "<img width=530 height=215 src=\"http://www.rdos.net/rmet-opt/7.png\">";
  Quiz[151].Text = "<img width=530 height=215 src=\"http://www.rdos.net/rmet-opt/8.png\">";

  Quiz[152].Text = "Clarity #1";
  Quiz[153].Text = "Clarity #2";
  Quiz[154].Text = "Clarity #3";
  Quiz[155].Text = "Clarity #4";
  Quiz[156].Text = "Clarity #5";
  Quiz[157].Text = "Clarity #6";
  Quiz[158].Text = "Clarity #7";
  Quiz[159].Text = "Clarity #8";

  Quiz[160].Text = "Eye score";
}

/*##########################################################################
#
#   Name       : TQuizL14::LoadPopulations
#
...
#
##########################################################################*/
void TQuizL14::GetReferer(const char *referer, TPopulation *pop)
{
}
...
*   Created....: 96-11-20 le                                                #
*##########################################################################*/
void TQuizL14::ImportMvsp(const char *filename, int PcaType)
{
        char buf[MAX_IN_ROW];
        int size;
        char *rowstr;
