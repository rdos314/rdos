...
int GetDir(int node, char *path, int *count);
...
struct TShareHeader *LowGetDir(int node, char *path, int *count)
{
...
struct TShareHeader *LowGetDirEntryAttrib(int node, char *path)
{
