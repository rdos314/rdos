...
;
	...
	RegisterOsGate
;
	mov si,OFFSET create_task
	mov di,OFFSET create_task_name
	xor cl,cl
...
;
;
;		NAME:			INIT_TASK_THREAD
;
;		DESCRIPTION:	Init task thread
;
;		PARAMETERS:		ES		Thread
;						FS:SI	Task / thread name
;						
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

init_task_thread	PROC near
	mov ax,fs
	mov ds,ax
	mov di,OFFSET thread_name
	mov cx,30
init_task_move_name:
	lodsb
	or al,al
	jz init_task_pad_name
	stosb
	loop init_task_move_name
	jmp init_task_done
init_task_pad_name:
	mov al,' '
	rep stosb
...
;		NAME:			INIT_TASK_TSS
;
;		DESCRIPTION:	Init task TSS
;
;		PARAMETERS:		DS		TSS SELECTOR
;						FS:ESI	START ADDRESS
;						
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

init_task_tss	PROC near
	xor cx,cx
	xor bx,bx
	xor edx,edx
	mov [bx],edx
...
;		NAME:			CREATE_TASK
;
;		DESCRIPTION:	Create a task. Obsolete.
;
;		PARAMETERS:		AL		Priority
;						FS:BX	Task gate selector
;						DS:SI	Start address
;						ES:DI	Thread name
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

create_task_name	DB 'Create Task',0

create_task	PROC far
	push ds
	push es
	push fs
	pushad
