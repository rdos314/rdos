...
add_wait_tab:
aw0     DW OFFSET start_wait_for_connection,    SEG code
aw1 DW OFFSET stop_wait_for_connection,         SEG code
aw2     DW OFFSET clear_connection,                             SEG code
aw3     DW OFFSET is_connection_idle,               SEG code
...
add_wait_listen_tab:
al0     DW OFFSET start_wait_for_listen,        SEG code
al1 DW OFFSET stop_wait_for_listen,             SEG code
al2     DW OFFSET clear_listen,                                 SEG code
al3     DW OFFSET is_listen_idle,                       SEG code
