...
int RDOSAPI RdosConfigUsbPacketPipe(int handle, char pipe, int PacketCount);
int RDOSAPI RdosConfigUsbStreamPipe(int handle, char pipe, int BufferSize);
int RDOSAPI RdosConfigUsbRawPipe(int handle, char pipe);
