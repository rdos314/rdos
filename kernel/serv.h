...
int RDOSAPI ServOpenVfsFile(int handle, struct TShareHeader *b);
int RDOSAPI ServAddVfsFileReq(int FileHandle, long long FilePos, long long *SectorBuf, int SectorCount, int SectorSize);
