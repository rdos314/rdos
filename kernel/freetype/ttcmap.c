...
#define TT_NEXT_ULONG   FT_NEXT_ULONG
  ...
  tt_cmap14_variants( TT_CMap    cmap )
  {
    ...
    if ( tt_cmap14_ensure( cmap14, ( count + 1 ) ) )
      return NULL;
                           ...
                           FT_Byte*    p )
  {
    ...
    if ( tt_cmap14_ensure( cmap14, ( cnt + 1 ) ) )
      return NULL;
                              ...
                              FT_Byte    *p )
  {
    ...
    if ( tt_cmap14_ensure( cmap14, ( numMappings + 1 ) ) )
      return NULL;
                           ...
                           FT_UInt32  variantSelector )
  {
    ...
    else
    {
      ...
      if ( tt_cmap14_ensure( cmap14, ( dcnt + numMappings + 1 ) ) )
        return NULL;
