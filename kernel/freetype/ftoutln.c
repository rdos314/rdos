...
#define SCALED( x )  ( ( (x) << shift ) - delta )
  ...
  FT_EXPORT_DEF( FT_Error )
  FT_Outline_New_Internal( FT_UInt      numPoints,
                           FT_Int       numContours,
  ...
  Fail:
    anoutline->flags |= FT_OUTLINE_OWNER;
    FT_Outline_Done_Internal( anoutline );
                  ...
                  FT_Outline  *anoutline )
  {
    ...
    return FT_Outline_New_Internal( numPoints,
  ...
  FT_EXPORT_DEF( FT_Error )
  FT_Outline_Done_Internal( FT_Outline*  outline )
  {
    if ( outline )
    {
                   ...
                   FT_Outline*  outline )
  {
    ...
    return FT_Outline_Done_Internal( outline );
  }
