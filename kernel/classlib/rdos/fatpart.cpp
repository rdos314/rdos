...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFatPartition::TFatPartition(int Disc, unsigned char Type, TPartitionTable *Parent, int Entry, long Start, long Size)
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFat12Partition::TFat12Partition(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
...
{
	return RdosFormatDrive(FDisc, Start, Size, "FAT12");
}
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFat16Partition::TFat16Partition(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
...
{
	return RdosFormatDrive(FDisc, Start, Size, "FAT16");
}
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFat32Partition::TFat32Partition(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
...
{
	return RdosFormatDrive(FDisc, Start, Size, "FAT32");
}
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFsPartition *TFat12PartitionFactory::Open(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
{
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFsPartition *TFat12PartitionFactory::Create(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
{
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFsPartition *TFat16PartitionFactory::Open(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
{
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFsPartition *TFat16PartitionFactory::Create(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
{
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFsPartition *TFat32PartitionFactory::Open(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
{
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFsPartition *TFat32PartitionFactory::Create(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
{
