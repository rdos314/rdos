...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFlashFsPartition::TFlashFsPartition(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
...
{
	return RdosFormatDrive(FDisc, Start, Size, "FLASHFS");
}
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFsPartition *TFlashFsPartitionFactory::Open(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
{
...
*   Created....: 96-10-02 le                                                #
*##########################################################################*/
TFsPartition *TFlashFsPartitionFactory::Create(int Disc, TPartitionTable *Parent, int Entry, long Start, long Size)
{
