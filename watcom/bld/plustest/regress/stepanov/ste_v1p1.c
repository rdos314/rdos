...
#if defined(__GNUG__)
extern template void operator==(reverse_iterator<Double_pointer, Double> const &, reverse_iterator<Double_pointer, Double> const &);
extern template void operator==(reverse_iterator<double_pointer, double> const &, reverse_iterator<double_pointer, double> const &);
extern template void operator==(reverse_iterator<Double *, Double> const &, reverse_iterator<Double *, Double> const &);
extern template void operator==(reverse_iterator<double *, double> const &, reverse_iterator<double *, double> const &);
extern template void operator==(reverse_iterator<reverse_iterator<Double_pointer, Double>, Double> const &, reverse_iterator<reverse_iterator<Double_pointer, Double>, Double> const &);
extern template void operator==(reverse_iterator<reverse_iterator<double_pointer, double>, double> const &, reverse_iterator<reverse_iterator<double_pointer, double>, double> const &);
extern template void operator==(reverse_iterator<reverse_iterator<Double *, Double>, Double> const &, reverse_iterator<reverse_iterator<Double *, Double>, Double> const &);
extern template void operator==(reverse_iterator<reverse_iterator<double *, double>, double> const &, reverse_iterator<reverse_iterator<double *, double>, double> const &);
extern template void operator!=(Double_pointer const &, Double_pointer const &);
extern template void operator!=(double_pointer const &, double_pointer const &);
extern template void operator!=(reverse_iterator<Double_pointer, Double> const &, reverse_iterator<Double_pointer, Double> const &);
extern template void operator!=(reverse_iterator<double_pointer, double> const &, reverse_iterator<double_pointer, double> const &);
extern template void operator!=(reverse_iterator<Double *, Double> const &, reverse_iterator<Double *, Double> const &);
