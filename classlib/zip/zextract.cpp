    ...
    while (ef_len >= EB_HEADSIZE) {
        ...
        switch (ebID) {
            ...
            case EF_ATHEOS:
                ...
                if ((r = test_compr_eb(ef, ebLen, eb_cmpr_offs, NULL))
                    != PK_OK) {
                    if (uO.qflag)
                        Info(1, "%-22s ",
                          FnFilter1(UnzipClass.FCurrFileName));
                    switch (r) {
                        case IZ_EF_TRUNC:
                            ...
                            break;
                        case PK_ERR:
                            Info(1, InvalidComprDataEAs);
                            break;
                        case PK_MEM3:
                        case PK_MEM4:
                            Info(1, NotEnoughMemEAs);
                            break;
                        default:
                            if ((r & 0xff) != PK_ERR)
                                Info(1, UnknErrorEAs);
                          ...
                          unsigned char *eb_ucptr, unsigned long eb_ucsize))
{
    ...
    r = memextract(eb_ucptr, eb_ucsize,
    ...
    switch (method) {
        ...
        default:
            if (uO.tflag)
                ...
                Info(0x401, UnsupportedExtraField, method);
