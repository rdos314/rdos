...
#
##########################################################################*/
TStorageSocketServer::TStorageSocketServer(const char *Name, int StackSize, TSocket *Socket)
...
#
##########################################################################*/
TStorageSocketServerFactory::TStorageSocketServerFactory(int Port, int MaxConnections, int BufferSize)
...
#
##########################################################################*/
void TStorageSocketServerFactory::Init()
{
}
...
TSocketServer *TStorageSocketServerFactory::Create(TSocket *Socket)
{
	...
	server = new TStorageSocketServer("Storage", 0x2000, Socket);
